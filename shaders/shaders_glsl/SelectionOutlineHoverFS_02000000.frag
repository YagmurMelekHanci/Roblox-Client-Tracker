...
void main()
{
    ...
    vec4 f7 = texture2DLod(Texture0Texture, min(f3, CB1[11].xy), 0.0);
    float f8 = f7.x;
    vec4 f9 = texture2DLod(Texture0Texture, min(f4, CB1[11].xy), 0.0);
    float f10 = f9.x;
    vec4 f11 = texture2DLod(Texture0Texture, min(f5, CB1[11].xy), 0.0);
    float f12 = f11.x;
    vec4 f13 = texture2DLod(Texture0Texture, min(f6, CB1[11].xy), 0.0);
    float f14 = f13.x;
    ...
    vec4 f23 = mix(vec4(0.0), vec4(CB6[5].xyz, (texture2DLod(Texture1Texture, min(f22, CB1[11].zw), 0.0).x < texture2DLod(Texture2Texture, min(f22, CB1[12].xy), 0.0).x) ? CB1[2].y : 1.0), vec4(clamp(255.0 * max(abs(f10 - f8), abs(f14 - f12)), 0.0, 1.0)));
