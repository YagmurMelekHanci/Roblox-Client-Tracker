...
void main()
{
    ...
    vec4 f4 = texture2D(Texture0Texture, min((f2 * f1) * CB1[1].xy, CB1[11].xy));
    float f5;
    do
    {
        if (f3 == 0.0)
    ...
    vec4 f10 = texture2D(Texture0Texture, min((f8 * f1) * CB1[1].xy, CB1[11].xy));
    float f11;
    do
    {
        if (f9 == 0.0)
    ...
    vec4 f22 = texture2D(Texture0Texture, min((f20 * f1) * CB1[1].xy, CB1[11].xy));
    float f23;
    do
    {
        if (f21 == 0.0)
    ...
    vec4 f28 = texture2D(Texture0Texture, min((f26 * f1) * CB1[1].xy, CB1[11].xy));
    float f29;
    do
    {
        if (f27 == 0.0)
    ...
    vec4 f34 = texture2D(Texture0Texture, min((f32 * f1) * CB1[1].xy, CB1[11].xy));
    float f35;
    do
    {
        if (f33 == 0.0)
    ...
    gl_FragData[0] = (((((f4 * f5) + (f10 * f11)) + (f16 * f17)) + (f22 * f23)) + (f28 * f29)) + (f34 * f35);
}
