...
void main()
{
    ...
    vec2 f3 = f2 + vec2(-1.5);
    vec2 f4 = f0 - f3;
    vec4 f5 = texture2D(Texture0Texture, min((f3 * f1) * CB1[1].xy, CB1[11].xy));
    float f6 = f4.x;
    float f7;
    do
    {
    ...
    vec2 f15 = f0 - f14;
    vec4 f16 = texture2D(Texture0Texture, min((f14 * f1) * CB1[1].xy, CB1[11].xy));
    float f17 = f15.x;
    float f18;
    do
    {
    ...
    vec2 f26 = f0 - f25;
    vec4 f27 = texture2D(Texture0Texture, min((f25 * f1) * CB1[1].xy, CB1[11].xy));
    float f28 = f26.x;
    float f29;
    do
    {
    ...
    vec2 f37 = f0 - f36;
    vec4 f38 = texture2D(Texture0Texture, min((f36 * f1) * CB1[1].xy, CB1[11].xy));
    float f39 = f37.x;
    float f40;
    do
    {
    ...
    vec2 f48 = f0 - f47;
    vec4 f49 = texture2D(Texture0Texture, min((f47 * f1) * CB1[1].xy, CB1[11].xy));
    float f50 = f48.x;
    float f51;
    do
    {
    ...
    vec2 f59 = f0 - f58;
    vec4 f60 = texture2D(Texture0Texture, min((f58 * f1) * CB1[1].xy, CB1[11].xy));
    float f61 = f59.x;
    float f62;
    do
    {
    ...
    vec2 f70 = f0 - f69;
    vec4 f71 = texture2D(Texture0Texture, min((f69 * f1) * CB1[1].xy, CB1[11].xy));
    float f72 = f70.x;
    float f73;
    do
    {
    ...
    vec2 f81 = f0 - f80;
    vec4 f82 = texture2D(Texture0Texture, min((f80 * f1) * CB1[1].xy, CB1[11].xy));
    float f83 = f81.x;
    float f84;
    do
    {
    ...
    vec2 f92 = f0 - f91;
    vec4 f93 = texture2D(Texture0Texture, min((f91 * f1) * CB1[1].xy, CB1[11].xy));
    float f94 = f92.x;
    float f95;
    do
    {
    ...
    vec2 f103 = f0 - f102;
    vec4 f104 = texture2D(Texture0Texture, min((f102 * f1) * CB1[1].xy, CB1[11].xy));
    float f105 = f103.x;
    float f106;
    do
    {
    ...
    vec2 f114 = f0 - f113;
    vec4 f115 = texture2D(Texture0Texture, min((f113 * f1) * CB1[1].xy, CB1[11].xy));
    float f116 = f114.x;
    float f117;
    do
    {
    ...
    vec2 f125 = f0 - f124;
    vec4 f126 = texture2D(Texture0Texture, min((f124 * f1) * CB1[1].xy, CB1[11].xy));
    float f127 = f125.x;
    float f128;
    do
    {
    ...
    vec2 f136 = f0 - f135;
    vec4 f137 = texture2D(Texture0Texture, min((f135 * f1) * CB1[1].xy, CB1[11].xy));
    float f138 = f136.x;
    float f139;
    do
    {
    ...
    vec2 f147 = f0 - f146;
    vec4 f148 = texture2D(Texture0Texture, min((f146 * f1) * CB1[1].xy, CB1[11].xy));
    float f149 = f147.x;
    float f150;
    do
    {
    ...
    vec2 f158 = f0 - f157;
    vec4 f159 = texture2D(Texture0Texture, min((f157 * f1) * CB1[1].xy, CB1[11].xy));
    float f160 = f158.x;
    float f161;
    do
    {
    ...
    vec2 f169 = f0 - f168;
    vec4 f170 = texture2D(Texture0Texture, min((f168 * f1) * CB1[1].xy, CB1[11].xy));
    float f171 = f169.x;
    float f172;
    do
    {
    ...
    vec2 f180 = f0 - f179;
    vec4 f181 = texture2D(Texture0Texture, min((f179 * f1) * CB1[1].xy, CB1[11].xy));
    float f182 = f180.x;
    float f183;
    do
    {
    ...
    vec2 f191 = f0 - f190;
    vec4 f192 = texture2D(Texture0Texture, min((f190 * f1) * CB1[1].xy, CB1[11].xy));
    float f193 = f191.x;
    float f194;
    do
    {
    ...
    vec2 f202 = f0 - f201;
    vec4 f203 = texture2D(Texture0Texture, min((f201 * f1) * CB1[1].xy, CB1[11].xy));
    float f204 = f202.x;
    float f205;
    do
    {
    ...
    vec2 f213 = f0 - f212;
    vec4 f214 = texture2D(Texture0Texture, min((f212 * f1) * CB1[1].xy, CB1[11].xy));
    float f215 = f213.x;
    float f216;
    do
    {
    ...
    vec2 f224 = f0 - f223;
    vec4 f225 = texture2D(Texture0Texture, min((f223 * f1) * CB1[1].xy, CB1[11].xy));
    float f226 = f224.x;
    float f227;
    do
    {
    ...
    vec2 f235 = f0 - f234;
    vec4 f236 = texture2D(Texture0Texture, min((f234 * f1) * CB1[1].xy, CB1[11].xy));
    float f237 = f235.x;
    float f238;
    do
    {
    ...
    vec2 f246 = f0 - f245;
    vec4 f247 = texture2D(Texture0Texture, min((f245 * f1) * CB1[1].xy, CB1[11].xy));
    float f248 = f246.x;
    float f249;
    do
    {
    ...
    vec2 f257 = f0 - f256;
    vec4 f258 = texture2D(Texture0Texture, min((f256 * f1) * CB1[1].xy, CB1[11].xy));
    float f259 = f257.x;
    float f260;
    do
    {
    ...
    vec2 f268 = f0 - f267;
    vec4 f269 = texture2D(Texture0Texture, min((f267 * f1) * CB1[1].xy, CB1[11].xy));
    float f270 = f268.x;
    float f271;
    do
    {
    ...
    vec2 f279 = f0 - f278;
    vec4 f280 = texture2D(Texture0Texture, min((f278 * f1) * CB1[1].xy, CB1[11].xy));
    float f281 = f279.x;
    float f282;
    do
    {
    ...
    vec2 f290 = f0 - f289;
    vec4 f291 = texture2D(Texture0Texture, min((f289 * f1) * CB1[1].xy, CB1[11].xy));
    float f292 = f290.x;
    float f293;
    do
    {
    ...
    vec2 f301 = f0 - f300;
    vec4 f302 = texture2D(Texture0Texture, min((f300 * f1) * CB1[1].xy, CB1[11].xy));
    float f303 = f301.x;
    float f304;
    do
    {
    ...
    vec2 f312 = f0 - f311;
    vec4 f313 = texture2D(Texture0Texture, min((f311 * f1) * CB1[1].xy, CB1[11].xy));
    float f314 = f312.x;
    float f315;
    do
    {
    ...
    vec2 f323 = f0 - f322;
    vec4 f324 = texture2D(Texture0Texture, min((f322 * f1) * CB1[1].xy, CB1[11].xy));
    float f325 = f323.x;
    float f326;
    do
    {
    ...
    vec2 f334 = f0 - f333;
    vec4 f335 = texture2D(Texture0Texture, min((f333 * f1) * CB1[1].xy, CB1[11].xy));
    float f336 = f334.x;
    float f337;
    do
    {
    ...
    vec2 f06 = f2 + vec2(3.5, -0.5);
    vec2 f07 = f0 - f06;
    vec4 f346 = texture2D(Texture0Texture, min((f06 * f1) * CB1[1].xy, CB1[11].xy));
    float f347 = f07.x;
    float f348;
    do
    {
    ...
    do
    {
        ...
        float f16 = 3.1415927410125732421875 * f351;
        vec2 f19 = sin(vec2(f16, f351 * 1.0471975803375244140625));
        f352 = ((3.0 * f19.x) * f19.y) / (f16 * f16);
        break;
    } while(false);
    vec2 f22 = f2 + vec2(3.5, 0.5);
    vec2 f23 = f0 - f22;
    vec4 f357 = texture2D(Texture0Texture, min((f22 * f1) * CB1[1].xy, CB1[11].xy));
    float f358 = f23.x;
    float f39;
    do
    {
        ...
        f39 = ((3.0 * f361.x) * f361.y) / (f360 * f360);
        break;
    } while(false);
    float f362 = f23.y;
    float f363;
    ...
    vec2 f366 = f2 + vec2(3.5, 1.5);
    vec2 f367 = f0 - f366;
    vec4 f368 = texture2D(Texture0Texture, min((f366 * f1) * CB1[1].xy, CB1[11].xy));
    float f369 = f367.x;
    float f370;
    do
    {
    ...
    do
    {
        ...
        float f375 = 3.1415927410125732421875 * f373;
        vec2 f376 = sin(vec2(f375, f373 * 1.0471975803375244140625));
        f374 = ((3.0 * f376.x) * f376.y) / (f375 * f375);
        break;
    } while(false);
    vec2 f377 = f2 + vec2(3.5, 2.5);
    vec2 f378 = f0 - f377;
    vec4 f379 = texture2D(Texture0Texture, min((f377 * f1) * CB1[1].xy, CB1[11].xy));
    float f380 = f378.x;
    float f381;
    do
    {
        ...
        f381 = ((3.0 * f383.x) * f383.y) / (f382 * f382);
        break;
    } while(false);
    float f384 = f378.y;
    float f385;
    ...
    vec2 f40 = f2 + vec2(3.5);
    vec2 f41 = f0 - f40;
    vec4 f390 = texture2D(Texture0Texture, min((f40 * f1) * CB1[1].xy, CB1[11].xy));
    float f391 = f41.x;
    float f392;
    do
    {
