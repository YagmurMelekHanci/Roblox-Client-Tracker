...
void main()
{
    ...
    vec3 f25 = mix(f18.xyz * CB1[5].w, (min((f22.xyz * (f22.w * 120.0)) + (CB0[13].xyz + (CB0[14].xyz * f23.x)), vec3(CB0[21].w)) + (VARYING2 * ((1.0 - ((step(f24.x, VARYING4.z) * clamp(CB0[29].z + (CB0[29].w * abs(VARYING4.z - 0.5)), 0.0, 1.0)) * f24.y)) * f23.y))) * f18.xyz, vec3(CB1[5].z));
    vec4 f26 = f18;
    f26.x = f25.x;
    vec4 f27 = f26;
    f27.y = f25.y;
