...
void main()
{
    ...
    float f27 = f21.y;
    float f28 = f21.z;
    vec3 f29 = mat3(vec3(CB0[58].xyz), vec3(CB0[59].xyz), vec3(CB0[60].xyz)) * f18;
    bvec3 f30 = bvec3(!(CB0[58].x == 2.0));
    ...
    vec4 f46 = f45;
    f46.w = 1.0;
    vec3 f47 = textureLod(PrefilteredEnvTexture, vec4(f17, 0.0).xyz, max(CB0[18].y, VARYING6.w) * 5.0).xyz;
    bvec3 f48 = bvec3(!(CB0[18].w == 0.0));
    vec3 f49 = mix(vec3(f48.x ? CB0[19].xyz.x : f47.x, f48.y ? CB0[19].xyz.y : f47.y, f48.z ? CB0[19].xyz.z : f47.z), f46.xyz, vec3(VARYING6.w));
    vec4 f50 = f46;
    f50.x = f49.x;
    vec4 f51 = f50;
    f51.y = f49.y;
