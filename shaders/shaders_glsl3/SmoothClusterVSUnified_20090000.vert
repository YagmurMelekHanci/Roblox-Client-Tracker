...
void main()
{
    ...
    vec4 v28 = v26;
    v28.w = (dot(v22, v19) * 20.0) - 19.0;
    gl_Position = v4;
    VARYING0 = vec4(v23, v19.yz, (abs(POSITION.w) > 3.0) ? 0.0 : 1.0);
    ...
    VARYING8 = v5;
    VARYING9 = ((CB4[int(TEXCOORD0.x + 0.5) * 1 + 0] * v23) + (CB4[int(TEXCOORD0.y + 0.5) * 1 + 0] * v19.y)) + (CB4[int(TEXCOORD0.z + 0.5) * 1 + 0] * v19.z);
    VARYING10 = v28;
}
