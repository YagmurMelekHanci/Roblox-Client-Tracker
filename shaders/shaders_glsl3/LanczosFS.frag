...
void main()
{
    ...
    vec2 f8 = f0 - f7;
    vec4 f9 = texture(Texture0Texture, min(min((f7 * f1) * CB1[1].xy, CB1[11].xy), CB1[11].xy));
    float f10 = f8.x;
    float f11;
    do
    {
    ...
    vec2 f18 = f0 - f17;
    vec4 f19 = texture(Texture0Texture, min(min((f17 * f1) * CB1[1].xy, CB1[11].xy), CB1[11].xy));
    float f20 = f18.x;
    float f21;
    do
    {
    ...
    vec2 f28 = f0 - f27;
    vec4 f29 = texture(Texture0Texture, min(min((f27 * f1) * CB1[1].xy, CB1[11].xy), CB1[11].xy));
    float f30 = f28.x;
    float f31;
    do
    {
    ...
    vec2 f38 = f0 - f37;
    vec4 f39 = texture(Texture0Texture, min(min((f37 * f1) * CB1[1].xy, CB1[11].xy), CB1[11].xy));
    float f40 = f38.x;
    float f41;
    do
    {
    ...
    vec2 f48 = f0 - f47;
    vec4 f49 = texture(Texture0Texture, min(min((f47 * f1) * CB1[1].xy, CB1[11].xy), CB1[11].xy));
    float f50 = f48.x;
    float f51;
    do
    {
    ...
    vec2 f58 = f0 - f57;
    vec4 f59 = texture(Texture0Texture, min(min((f57 * f1) * CB1[1].xy, CB1[11].xy), CB1[11].xy));
    float f60 = f58.x;
    float f61;
    do
    {
    ...
    vec2 f68 = f0 - f67;
    vec4 f69 = texture(Texture0Texture, min(min((f67 * f1) * CB1[1].xy, CB1[11].xy), CB1[11].xy));
    float f70 = f68.x;
    float f71;
    do
    {
    ...
    vec2 f77 = f0 - f76;
    vec4 f78 = texture(Texture0Texture, min(min((f76 * f1) * CB1[1].xy, CB1[11].xy), CB1[11].xy));
    float f79 = f77.x;
    float f80;
    do
    {
    ...
    vec2 f86 = f0 - f85;
    vec4 f87 = texture(Texture0Texture, min(min((f85 * f1) * CB1[1].xy, CB1[11].xy), CB1[11].xy));
    float f88 = f86.x;
    float f89;
    do
    {
    ...
    vec2 f95 = f0 - f94;
    vec4 f96 = texture(Texture0Texture, min(min((f94 * f1) * CB1[1].xy, CB1[11].xy), CB1[11].xy));
    float f97 = f95.x;
    float f98;
    do
    {
    ...
    vec2 f104 = f0 - f103;
    vec4 f105 = texture(Texture0Texture, min(min((f103 * f1) * CB1[1].xy, CB1[11].xy), CB1[11].xy));
    float f106 = f104.x;
    float f107;
    do
    {
    ...
    vec2 f113 = f0 - f112;
    vec4 f114 = texture(Texture0Texture, min(min((f112 * f1) * CB1[1].xy, CB1[11].xy), CB1[11].xy));
    float f115 = f113.x;
    float f116;
    do
    {
    ...
    vec2 f123 = f0 - f122;
    vec4 f124 = texture(Texture0Texture, min(min((f122 * f1) * CB1[1].xy, CB1[11].xy), CB1[11].xy));
    float f125 = f123.x;
    float f126;
    do
    {
    ...
    vec2 f132 = f0 - f131;
    vec4 f133 = texture(Texture0Texture, min(min((f131 * f1) * CB1[1].xy, CB1[11].xy), CB1[11].xy));
    float f134 = f132.x;
    float f135;
    do
    {
    ...
    vec2 f141 = f0 - f140;
    vec4 f142 = texture(Texture0Texture, min(min((f140 * f1) * CB1[1].xy, CB1[11].xy), CB1[11].xy));
    float f143 = f141.x;
    float f144;
    do
    {
    ...
    vec2 f150 = f0 - f149;
    vec4 f151 = texture(Texture0Texture, min(min((f149 * f1) * CB1[1].xy, CB1[11].xy), CB1[11].xy));
    float f152 = f150.x;
    float f153;
    do
    {
    ...
    vec2 f159 = f0 - f158;
    vec4 f160 = texture(Texture0Texture, min(min((f158 * f1) * CB1[1].xy, CB1[11].xy), CB1[11].xy));
    float f161 = f159.x;
    float f162;
    do
    {
    ...
    vec2 f168 = f0 - f167;
    vec4 f169 = texture(Texture0Texture, min(min((f167 * f1) * CB1[1].xy, CB1[11].xy), CB1[11].xy));
    float f170 = f168.x;
    float f171;
    do
    {
    ...
    vec2 f178 = f0 - f177;
    vec4 f179 = texture(Texture0Texture, min(min((f177 * f1) * CB1[1].xy, CB1[11].xy), CB1[11].xy));
    float f180 = f178.x;
    float f181;
    do
    {
    ...
    vec2 f187 = f0 - f186;
    vec4 f188 = texture(Texture0Texture, min(min((f186 * f1) * CB1[1].xy, CB1[11].xy), CB1[11].xy));
    float f189 = f187.x;
    float f190;
    do
    {
    ...
    vec2 f196 = f0 - f195;
    vec4 f197 = texture(Texture0Texture, min(min((f195 * f1) * CB1[1].xy, CB1[11].xy), CB1[11].xy));
    float f198 = f196.x;
    float f199;
    do
    {
    ...
    vec2 f205 = f0 - f204;
    vec4 f206 = texture(Texture0Texture, min(min((f204 * f1) * CB1[1].xy, CB1[11].xy), CB1[11].xy));
    float f207 = f205.x;
    float f208;
    do
    {
    ...
    vec2 f214 = f0 - f213;
    vec4 f215 = texture(Texture0Texture, min(min((f213 * f1) * CB1[1].xy, CB1[11].xy), CB1[11].xy));
    float f216 = f214.x;
    float f217;
    do
    {
    ...
    vec2 f223 = f0 - f222;
    vec4 f224 = texture(Texture0Texture, min(min((f222 * f1) * CB1[1].xy, CB1[11].xy), CB1[11].xy));
    float f225 = f223.x;
    float f226;
    do
    {
    ...
    vec2 f233 = f0 - f232;
    vec4 f234 = texture(Texture0Texture, min(min((f232 * f1) * CB1[1].xy, CB1[11].xy), CB1[11].xy));
    float f235 = f233.x;
    float f236;
    do
    {
    ...
    vec2 f242 = f0 - f241;
    vec4 f243 = texture(Texture0Texture, min(min((f241 * f1) * CB1[1].xy, CB1[11].xy), CB1[11].xy));
    float f244 = f242.x;
    float f245;
    do
    {
    ...
    vec2 f251 = f0 - f250;
    vec4 f252 = texture(Texture0Texture, min(min((f250 * f1) * CB1[1].xy, CB1[11].xy), CB1[11].xy));
    float f253 = f251.x;
    float f254;
    do
    {
    ...
    vec2 f260 = f0 - f259;
    vec4 f261 = texture(Texture0Texture, min(min((f259 * f1) * CB1[1].xy, CB1[11].xy), CB1[11].xy));
    float f262 = f260.x;
    float f263;
    do
    {
    ...
    vec2 f269 = f0 - f268;
    vec4 f270 = texture(Texture0Texture, min(min((f268 * f1) * CB1[1].xy, CB1[11].xy), CB1[11].xy));
    float f271 = f269.x;
    float f272;
    do
    {
    ...
    vec2 f278 = f0 - f277;
    vec4 f279 = texture(Texture0Texture, min(min((f277 * f1) * CB1[1].xy, CB1[11].xy), CB1[11].xy));
    float f280 = f278.x;
    float f281;
    do
    {
    ...
    vec2 f288 = f0 - f287;
    vec4 f289 = texture(Texture0Texture, min(min((f287 * f1) * CB1[1].xy, CB1[11].xy), CB1[11].xy));
    float f290 = f288.x;
    float f291;
    do
    {
    ...
    vec2 f297 = f0 - f296;
    vec4 f298 = texture(Texture0Texture, min(min((f296 * f1) * CB1[1].xy, CB1[11].xy), CB1[11].xy));
    float f299 = f297.x;
    float f300;
    do
    {
    ...
    vec2 f306 = f0 - f305;
    vec4 f307 = texture(Texture0Texture, min(min((f305 * f1) * CB1[1].xy, CB1[11].xy), CB1[11].xy));
    float f308 = f306.x;
    float f309;
    do
    {
    ...
    vec2 f315 = f0 - f314;
    vec4 f316 = texture(Texture0Texture, min(min((f314 * f1) * CB1[1].xy, CB1[11].xy), CB1[11].xy));
    float f317 = f315.x;
    float f318;
    do
    {
    ...
    vec2 f324 = f0 - f323;
    vec4 f325 = texture(Texture0Texture, min(min((f323 * f1) * CB1[1].xy, CB1[11].xy), CB1[11].xy));
    float f326 = f324.x;
    float f327;
    do
    {
    ...
    vec2 f333 = f0 - f332;
    vec4 f334 = texture(Texture0Texture, min(min((f332 * f1) * CB1[1].xy, CB1[11].xy), CB1[11].xy));
    float f335 = f333.x;
    float f336;
    do
    {
        ...
        {
            if ((f335 > 3.0) || (f335 < (-3.0)))
            {
                f336 = 0.0;
                break;
            }
        }
        float f337 = 3.1415927410125732421875 * f335;
        f336 = ((3.0 * sin(f337)) * sin(f335 * 1.0471975803375244140625)) / (f337 * f337);
        break;
    } while(false);
    float f338 = f333.y;
    float f339;
    do
    {
        ...
        f339 = ((3.0 * sin(f340)) * sin(f338 * 1.0471975803375244140625)) / (f340 * f340);
        break;
    } while(false);
    _entryPointOutput = (((((((((((((((((((((((((((((((((((f9 * (f11 * f14)) + (f19 * (f21 * f24))) + (f29 * (f31 * f34))) + (f39 * (f41 * f44))) + (f49 * (f51 * f54))) + (f59 * (f61 * f64))) + (f69 * (f71 * f74))) + (f78 * (f80 * f83))) + (f87 * (f89 * f92))) + (f96 * (f98 * f101))) + (f105 * (f107 * f110))) + (f114 * (f116 * f119))) + (f124 * (f126 * f129))) + (f133 * (f135 * f138))) + (f142 * (f144 * f147))) + (f151 * (f153 * f156))) + (f160 * (f162 * f165))) + (f169 * (f171 * f174))) + (f179 * (f181 * f184))) + (f188 * (f190 * f193))) + (f197 * (f199 * f202))) + (f206 * (f208 * f211))) + (f215 * (f217 * f220))) + (f224 * (f226 * f229))) + (f234 * (f236 * f239))) + (f243 * (f245 * f248))) + (f252 * (f254 * f257))) + (f261 * (f263 * f266))) + (f270 * (f272 * f275))) + (f279 * (f281 * f284))) + (f289 * (f291 * f294))) + (f298 * (f300 * f303))) + (f307 * (f309 * f312))) + (f316 * (f318 * f321))) + (f325 * (f327 * f330))) + (f334 * (f336 * f339));
}
