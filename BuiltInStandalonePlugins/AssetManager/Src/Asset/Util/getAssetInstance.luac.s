...
MAIN:
  ...
  SETTABLE R7 R5 R6
  GETTABLEKS R7 R2 K15 ["AssetType"]
  GETTABLEKS R6 R7 K18 ["MeshPart"]
  DUPCLOSURE R7 K19 [PROTO_3]
  CAPTURE VAL R5
  CAPTURE VAL R2
  SETTABLE R7 R5 R6
  GETTABLEKS R7 R2 K15 ["AssetType"]
  GETTABLEKS R6 R7 K20 ["Mesh"]
  DUPCLOSURE R7 K21 [PROTO_4]
  CAPTURE VAL R5
  CAPTURE VAL R2
  SETTABLE R7 R5 R6
  GETTABLEKS R7 R2 K15 ["AssetType"]
  GETTABLEKS R6 R7 K22 ["Image"]
  DUPCLOSURE R7 K23 [PROTO_5]
  SETTABLE R7 R5 R6
  GETTABLEKS R7 R2 K15 ["AssetType"]
  GETTABLEKS R6 R7 K24 ["Audio"]
  DUPCLOSURE R7 K25 [PROTO_6]
  SETTABLE R7 R5 R6
  GETTABLEKS R7 R2 K15 ["AssetType"]
  GETTABLEKS R6 R7 K26 ["Video"]
  DUPCLOSURE R7 K27 [PROTO_7]
  SETTABLE R7 R5 R6
  GETTABLEKS R7 R2 K15 ["AssetType"]
  GETTABLEKS R6 R7 K28 ["Plugin"]
  DUPCLOSURE R7 K29 [PROTO_8]
  SETTABLE R7 R5 R6
  GETTABLEKS R7 R2 K15 ["AssetType"]
  GETTABLEKS R6 R7 K30 ["FontFamily"]
  DUPCLOSURE R7 K31 [PROTO_9]
  SETTABLE R7 R5 R6
  GETTABLEKS R7 R2 K15 ["AssetType"]
  GETTABLEKS R6 R7 K32 ["Place"]
