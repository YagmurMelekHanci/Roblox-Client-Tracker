...
PROTO_3:
  ...
  MOVE R10 R4
  CALL R9 1 1
  GETTABLEKS R10 R7 K2 ["IsLoading"]
  GETUPVAL R12 9
  ...
  LOADK R15 K6 ["Main X-Stroke X-Top X-Column"]
  SETTABLE R15 R13 R14
  DUPTABLE R14 K10 [{"HeaderBar", "Contents", "LoadingBarContainer"}]
  GETUPVAL R16 9
  GETTABLEKS R15 R16 K3 ["createElement"]
  GETUPVAL R16 11
  DUPTABLE R17 K11 [{"LayoutOrder"}]
  NAMECALL R18 R2 K12 ["getNextOrder"]
  CALL R18 1 1
  SETTABLEKS R18 R17 K4 ["LayoutOrder"]
  CALL R15 2 1
  SETTABLEKS R15 R14 K7 ["HeaderBar"]
  LENGTH R16 R8
  JUMPIFNOTEQKN R16 K13 [0] [+9]
  GETUPVAL R15 12
  MOVE R16 R2
  MOVE R17 R9
  MOVE R18 R10
  ...
  JUMP [+15]
  GETUPVAL R15 13
  GETTABLEKS R17 R6 K14 ["ViewType"]
  GETUPVAL R20 14
  GETTABLEKS R19 R20 K14 ["ViewType"]
  GETTABLEKS R18 R19 K15 ["Grid"]
  JUMPIFEQ R17 R18 [+2]
  LOADB R16 0 +1
  LOADB R16 1
  MOVE R17 R10
  MOVE R18 R2
  CALL R15 3 1
  SETTABLEKS R15 R14 K8 ["Contents"]
  JUMPIFNOT R10 [+36]
  GETUPVAL R16 9
  GETTABLEKS R15 R16 K3 ["createElement"]
  GETUPVAL R16 10
  ...
  LOADK R19 K16 ["am-size-full-scrollbar"]
  SETTABLE R19 R17 R18
  DUPTABLE R18 K18 [{"LoadingBar"}]
  GETUPVAL R20 9
  GETTABLEKS R19 R20 K3 ["createElement"]
  GETUPVAL R20 15
  DUPTABLE R21 K20 [{"LayoutOrder", "Progress"}]
  NAMECALL R22 R2 K12 ["getNextOrder"]
  CALL R22 1 1
  SETTABLEKS R22 R21 K4 ["LayoutOrder"]
  GETTABLEKS R22 R7 K21 ["FetchProgress"]
  SETTABLEKS R22 R21 K19 ["Progress"]
  CALL R19 2 1
  SETTABLEKS R19 R18 K17 ["LoadingBar"]
  CALL R15 3 1
  JUMP [+1]
  LOADNIL R15
  SETTABLEKS R15 R14 K9 ["LoadingBarContainer"]
  CALL R11 3 -1
  RETURN R11 -1
...
MAIN:
  ...
  GETTABLEKS R16 R17 K23 ["SearchController"]
  CALL R15 1 1
  GETIMPORT R16 K5 [require]
  GETTABLEKS R19 R0 K19 ["Src"]
  GETTABLEKS R18 R19 K24 ["Hooks"]
  GETTABLEKS R17 R18 K25 ["useFetchProgressInfo"]
  CALL R16 1 1
  ...
  GETTABLEKS R19 R20 K27 ["useItems"]
  CALL R18 1 1
  GETIMPORT R19 K5 [require]
  GETTABLEKS R22 R0 K19 ["Src"]
  GETTABLEKS R21 R22 K24 ["Hooks"]
  GETTABLEKS R20 R21 K28 ["useSearchInfo"]
  CALL R19 1 1
  GETTABLEKS R21 R2 K29 ["Util"]
