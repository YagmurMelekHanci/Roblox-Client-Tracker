...
PROTO_2:
  ...
  JUMPIFNOT R15 [+10]
  GETUPVAL R15 9
  GETTABLEKS R14 R15 K11 ["getImageHelper"]
  GETUPVAL R17 9
  GETTABLEKS R16 R17 K12 ["AvailableImages"]
  GETTABLEKS R15 R16 K13 ["SearchIcon"]
  CALL R14 1 1
  JUMP [+51]
  JUMPIFEQKS R7 K2 [""] [+3]
  MOVE R14 R7
  JUMP [+47]
  GETTABLEKS R15 R10 K14 ["Scope"]
  GETUPVAL R18 10
  GETTABLEKS R17 R18 K14 ["Scope"]
  ...
  LOADK R19 K23 ["am-size-full-topbar X-Left X-Row X-Stroke"]
  SETTABLE R19 R17 R18
  DUPTABLE R18 K26 [{"ScopeTitleContainer", "Options"}]
  GETUPVAL R20 11
  GETTABLEKS R19 R20 K20 ["createElement"]
  GETUPVAL R20 13
  DUPTABLE R21 K29 [{"LayoutOrder", "Text", "Image"}]
  NAMECALL R22 R2 K30 ["getNextOrder"]
  CALL R22 1 1
  SETTABLEKS R22 R21 K21 ["LayoutOrder"]
  SETTABLEKS R13 R21 K27 ["Text"]
  SETTABLEKS R14 R21 K28 ["Image"]
  CALL R19 2 1
  SETTABLEKS R19 R18 K24 ["ScopeTitleContainer"]
  GETUPVAL R20 11
  GETTABLEKS R19 R20 K20 ["createElement"]
  GETUPVAL R20 14
  ...
  SETTABLEKS R22 R21 K21 ["LayoutOrder"]
  CALL R19 2 1
  SETTABLEKS R19 R18 K25 ["Options"]
  CALL R15 3 -1
  RETURN R15 -1
