...
PROTO_9:
  ...
  GETIMPORT R17 K44 [DateTime.fromIsoDate]
  GETTABLEKS R18 R8 K4 ["createTime"]
  CALL R17 1 1
  SETTABLEKS R17 R16 K33 ["Created"]
  GETIMPORT R17 K44 [DateTime.fromIsoDate]
  GETTABLEKS R18 R8 K5 ["updateTime"]
  CALL R17 1 1
  SETTABLEKS R17 R16 K34 ["Modified"]
  GETUPVAL R19 3
  GETTABLEKS R18 R19 K35 ["ModerationStatus"]
  GETTABLEKS R17 R18 K45 ["Placeholder"]
  SETTABLEKS R17 R16 K35 ["ModerationStatus"]
  DUPTABLE R17 K48 [{"Id", "Name", "Scope"}]
  SETTABLEKS R11 R17 K46 ["Id"]
  ...
  MOVE R18 R1
  MOVE R19 R16
  GETIMPORT R17 K51 [table.insert]
  CALL R17 2 0
  GETTABLEKS R18 R16 K36 ["Creator"]
  GETTABLEKS R17 R18 K47 ["Name"]
  GETTABLEKS R18 R16 K36 ["Creator"]
  SETTABLE R18 R2 R17
  FORGLOOP R3 2 [-188]
  RETURN R1 2
...
PROTO_11:
  ...
  GETUPVAL R5 0
  GETTABLEKS R4 R5 K14 ["_fetchAssetsImplAsync"]
  GETUPVAL R5 1
  GETUPVAL R6 2
  GETUPVAL R7 3
  GETUPVAL R8 4
  ...
  GETTABLEKS R10 R11 K12 ["nextPageToken"]
  CALL R4 6 0
  RETURN R0 0
  GETUPVAL R5 1
  GETTABLEKS R4 R5 K15 ["OnFetchFinished"]
...
PROTO_15:
  ...
  GETTABLEKS R9 R10 K12 ["nextPageToken"]
  CALL R4 5 0
  RETURN R0 0
  GETUPVAL R5 1
  GETTABLEKS R4 R5 K15 ["OnFetchFinished"]
...
MAIN:
  ...
  CAPTURE VAL R2
  CAPTURE VAL R1
  SETTABLEKS R15 R12 K41 ["_convertResponseToItemsData"]
  DUPCLOSURE R15 K42 [PROTO_10]
  CAPTURE VAL R12
  SETTABLEKS R15 R12 K43 ["_checkResponse"]
  DUPCLOSURE R15 K44 [PROTO_13]
  CAPTURE VAL R12
  CAPTURE VAL R2
  SETTABLEKS R15 R12 K45 ["_fetchAssetsImplAsync"]
  DUPCLOSURE R15 K46 [PROTO_14]
  CAPTURE VAL R12
  CAPTURE VAL R1
  CAPTURE VAL R3
  CAPTURE VAL R10
  SETTABLEKS R15 R12 K47 ["fetchAssetsAsync"]
  DUPCLOSURE R15 K48 [PROTO_17]
  CAPTURE VAL R3
  CAPTURE VAL R12
  CAPTURE VAL R2
  SETTABLEKS R15 R12 K49 ["_searchAssetsImplAsync"]
  DUPCLOSURE R15 K50 [PROTO_18]
  CAPTURE VAL R12
  SETTABLEKS R15 R12 K51 ["searchAssetsAsync"]
  DUPCLOSURE R15 K52 [PROTO_20]
  CAPTURE VAL R3
  CAPTURE VAL R10
  CAPTURE VAL R2
  SETTABLEKS R15 R12 K53 ["grantUniverseUseAssetsPermissions"]
  DUPCLOSURE R15 K54 [PROTO_21]
  CAPTURE VAL R1
  CAPTURE VAL R10
  SETTABLEKS R15 R12 K55 ["getThumbnailUriForScope"]
  DUPCLOSURE R15 K56 [PROTO_23]
  CAPTURE VAL R12
  CAPTURE VAL R4
  CAPTURE VAL R10
  SETTABLEKS R15 R12 K57 ["getThumbnailForScopeAsync"]
  DUPCLOSURE R15 K58 [PROTO_24]
  CAPTURE VAL R9
  SETTABLEKS R15 R12 K59 ["getThumbnailForItem"]
  DUPCLOSURE R15 K60 [PROTO_26]
  CAPTURE VAL R12
  CAPTURE VAL R4
  SETTABLEKS R15 R12 K61 ["getThumbnailForItemAsync"]
  DUPCLOSURE R15 K62 [PROTO_29]
  CAPTURE VAL R3
  SETTABLEKS R15 R12 K63 ["fetchPluginInfoAsync"]
  RETURN R12 1
