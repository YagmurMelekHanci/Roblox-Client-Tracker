PROTO_0:
  ...
  CALL R6 2 0
  LOADK R8 K10 ["AudioDeviceInput"]
  NAMECALL R6 R5 K4 ["IsA"]
  CALL R6 2 1
  JUMPIFNOT R6 [+13]
  GETTABLEKS R6 R5 K11 ["IsReady"]
  JUMPIFNOT R6 [+10]
  LOADB R6 0
  SETTABLEKS R6 R5 K12 ["Active"]
  FASTCALL2 TABLE_INSERT R0 R5 [+5]
  MOVE R7 R0
  MOVE R8 R5
  GETIMPORT R6 K9 [table.insert]
  CALL R6 2 0
  LOADK R8 K13 ["AudioReverb"]
  NAMECALL R6 R5 K4 ["IsA"]
  CALL R6 2 1
  JUMPIF R6 [+10]
  LOADK R8 K14 ["AudioEcho"]
  NAMECALL R6 R5 K4 ["IsA"]
  CALL R6 2 1
  JUMPIF R6 [+5]
  LOADK R8 K15 ["AudioListener"]
  NAMECALL R6 R5 K4 ["IsA"]
  CALL R6 2 1
  JUMPIFNOT R6 [+3]
  NAMECALL R6 R5 K16 ["Reset"]
  CALL R6 1 0
  FORGLOOP R1 2 [-55]
  GETTABLEN R1 R0 1
  JUMPIFNOT R1 [+5]
