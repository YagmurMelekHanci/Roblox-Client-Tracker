...
PROTO_1:
  ...
  LOADK R1 K2 ["[FLog::PluginManagementFetching] ManagementMainView refreshing plugins"]
  CALL R0 1 0
  GETUPVAL R2 1
  GETTABLEKS R1 R2 K3 ["props"]
  GETTABLEKS R0 R1 K4 ["API"]
  NAMECALL R0 R0 K5 ["get"]
  CALL R0 1 1
  GETUPVAL R3 1
  GETTABLEKS R2 R3 K3 ["props"]
  GETTABLEKS R1 R2 K6 ["dispatchRefreshPlugins"]
  MOVE R2 R1
  MOVE R3 R0
  CALL R2 1 0
  GETUPVAL R3 1
...
MAIN:
  ...
  LOADK R6 K10 ["MarketplaceService"]
  NAMECALL R4 R4 K8 ["GetService"]
  CALL R4 2 1
  GETIMPORT R5 K1 [game]
  LOADK R7 K11 ["PermissionsService"]
  ...
  GETTABLEKS R9 R10 K19 ["PluginHolder"]
  CALL R8 1 1
  GETIMPORT R9 K13 [require]
  GETTABLEKS R12 R1 K17 ["Src"]
  GETTABLEKS R11 R12 K20 ["Thunks"]
  GETTABLEKS R10 R11 K21 ["GetAllPluginPermissions"]
  CALL R9 1 1
  ...
  GETTABLEKS R12 R13 K24 ["MovedDialog"]
  CALL R11 1 1
  GETIMPORT R13 K13 [require]
  GETTABLEKS R15 R1 K14 ["Packages"]
  GETTABLEKS R14 R15 K25 ["Framework"]
  CALL R13 1 1
  GETTABLEKS R12 R13 K26 ["ContextServices"]
  GETTABLEKS R13 R12 K27 ["withContext"]
  GETIMPORT R15 K13 [require]
  GETTABLEKS R17 R1 K14 ["Packages"]
  GETTABLEKS R16 R17 K25 ["Framework"]
  CALL R15 1 1
  GETTABLEKS R14 R15 K28 ["UI"]
  GETIMPORT R16 K13 [require]
  GETTABLEKS R18 R1 K14 ["Packages"]
  GETTABLEKS R17 R18 K25 ["Framework"]
  CALL R16 1 1
  ...
  GETTABLEKS R19 R20 K20 ["Thunks"]
  GETTABLEKS R18 R19 K30 ["UpdateAllPlugins"]
  CALL R17 1 1
  GETIMPORT R18 K13 [require]
  GETTABLEKS R21 R1 K17 ["Src"]
  GETTABLEKS R20 R21 K20 ["Thunks"]
  GETTABLEKS R19 R20 K31 ["RefreshPlugins"]
  CALL R18 1 1
  GETTABLEKS R19 R14 K32 ["Button"]
  GETTABLEKS R20 R15 K33 ["StyleModifier"]
  GETTABLEKS R21 R14 K34 ["LoadingIndicator"]
  GETIMPORT R22 K13 [require]
  GETTABLEKS R23 R1 K35 ["SharedPluginConstants"]
  CALL R22 1 1
  GETTABLEKS R23 R6 K36 ["Component"]
  LOADK R25 K37 ["ManagementMainView"]
  ...
  MOVE R24 R13
  DUPTABLE R25 K54 [{"Plugin", "Localization", "Stylizer", "API", "Analytics"}]
  GETTABLEKS R26 R12 K49 ["Plugin"]
  SETTABLEKS R26 R25 K49 ["Plugin"]
  GETTABLEKS R26 R12 K50 ["Localization"]
  SETTABLEKS R26 R25 K50 ["Localization"]
  GETTABLEKS R26 R12 K51 ["Stylizer"]
  SETTABLEKS R26 R25 K51 ["Stylizer"]
  SETTABLEKS R16 R25 K52 ["API"]
  GETTABLEKS R26 R12 K53 ["Analytics"]
  ...
  DUPCLOSURE R25 K56 [PROTO_17]
  CAPTURE VAL R17
  CAPTURE VAL R18
  CAPTURE VAL R4
  CAPTURE VAL R9
  CAPTURE VAL R5
  GETTABLEKS R26 R7 K57 ["connect"]
  MOVE R27 R24
  MOVE R28 R25
  CALL R26 2 1
  MOVE R27 R23
