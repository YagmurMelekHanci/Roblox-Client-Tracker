...
PROTO_4:
  ...
  LOADK R13 K23 ["Role-Surface X-Fit"]
  SETTABLE R13 R11 R12
  DUPTABLE R12 K26 [{"Layout", "TitleFrame", "Text"}]
  GETUPVAL R14 3
  GETTABLEKS R13 R14 K3 ["createElement"]
  LOADK R14 K27 ["UIListLayout"]
  DUPTABLE R15 K31 [{"Padding", "FillDirection", "SortOrder"}]
  GETIMPORT R16 K33 [UDim.new]
  LOADN R17 0
  LOADN R18 2
  CALL R16 2 1
  SETTABLEKS R16 R15 K28 ["Padding"]
  GETIMPORT R16 K36 [Enum.FillDirection.Vertical]
  ...
  LOADK R17 K38 ["Role-Surface X-Fit X-RowSpace50"]
  SETTABLE R17 R15 R16
  DUPTABLE R16 K40 [{"Title", "Shortcuts"}]
  ...
  LOADK R21 K42 ["X-Fit Text-Title"]
  SETTABLE R21 R19 R20
  LOADB R20 1
  SETTABLEKS R20 R19 K43 ["RichText"]
  CALL R17 2 1
  JUMP [+1]
  LOADNIL R17
  SETTABLEKS R17 R16 K0 ["Title"]
  GETTABLEKS R18 R0 K39 ["Shortcuts"]
  JUMPIFNOT R18 [+39]
  GETUPVAL R18 3
  GETTABLEKS R17 R18 K3 ["createElement"]
  LOADK R18 K41 ["TextLabel"]
  ...
  CALL R20 0 1
  SETTABLEKS R20 R19 K19 ["LayoutOrder"]
  GETTABLEKS R21 R0 K39 ["Shortcuts"]
  LOADK R22 K44 [""]
  GETIMPORT R23 K46 [ipairs]
  MOVE R24 R21
  CALL R23 1 3
  FORGPREP_INEXT R23
  LOADN R28 1
  ...
  GETUPVAL R21 3
  GETTABLEKS R20 R21 K8 ["Tag"]
  LOADK R21 K48 ["X-Fit Text-Label"]
  SETTABLE R21 R19 R20
  CALL R17 2 1
  JUMP [+1]
  LOADNIL R17
  SETTABLEKS R17 R16 K39 ["Shortcuts"]
  CALL R13 3 1
  ...
  GETUPVAL R17 3
  GETTABLEKS R16 R17 K8 ["Tag"]
  LOADK R17 K49 ["Text-Label X-Fit TooltipTextBounds"]
  SETTABLE R17 R15 R16
  CALL R13 2 1
  JUMP [+1]
  LOADNIL R13
  ...
  LOADK R10 K50 ["Component-useTooltip Role-Tooltip X-Fill"]
  SETTABLE R10 R8 R9
  DUPTABLE R9 K53 [{"Wrapper", "StyleLink"}]
  SETTABLEKS R5 R9 K51 ["Wrapper"]
  GETUPVAL R11 3
  GETTABLEKS R10 R11 K3 ["createElement"]
  LOADK R11 K52 ["StyleLink"]
  DUPTABLE R12 K55 [{"StyleSheet"}]
  GETTABLEKS R13 R0 K56 ["Design"]
  SETTABLEKS R13 R12 K54 ["StyleSheet"]
  CALL R10 2 1
...
MAIN:
  ...
  GETTABLEKS R6 R1 K12 ["useCallback"]
  GETTABLEKS R7 R1 K13 ["useEffect"]
  GETTABLEKS R8 R1 K14 ["useRef"]
  ...
  DUPCLOSURE R16 K22 [PROTO_1]
  DUPCLOSURE R17 K23 [PROTO_4]
  CAPTURE VAL R8
  CAPTURE VAL R13
  CAPTURE VAL R7
  CAPTURE VAL R1
