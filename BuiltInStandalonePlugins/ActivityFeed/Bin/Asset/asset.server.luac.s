...
MAIN:
  ...
  LOADK R3 K11 ["AHAddPackageAndScriptEvents"]
  ...
  GETTABLEKS R9 R4 K43 ["getEnableActivityHistory"]
  CALL R8 1 1
  JUMPIF R8 [+1]
  RETURN R0 0
  GETIMPORT R8 K46 [Instance.new]
  LOADK R9 K47 ["Frame"]
  CALL R8 1 1
  GETIMPORT R9 K1 [require]
  GETTABLEKS R11 R5 K37 ["Packages"]
  GETTABLEKS R10 R11 K48 ["React"]
  CALL R9 1 1
  GETIMPORT R10 K1 [require]
  GETTABLEKS R12 R5 K37 ["Packages"]
  GETTABLEKS R11 R12 K49 ["ReactRoblox"]
  CALL R10 1 1
  GETIMPORT R11 K1 [require]
  GETTABLEKS R13 R5 K12 ["Src"]
  GETTABLEKS R12 R13 K50 ["MainPlugin"]
  CALL R11 1 1
  LOADNIL R12
  NEWCLOSURE R13 P4
  CAPTURE VAL R5
  ...
  GETTABLEKS R14 R15 K51 ["Unloading"]
  NEWCLOSURE R16 P5
  CAPTURE REF R12
