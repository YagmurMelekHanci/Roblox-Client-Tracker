...
PROTO_23:
  ...
  NEWTABLE R32 1 0
  GETUPVAL R34 0
  GETTABLEKS R33 R34 K23 ["Tag"]
  GETUPVAL R34 14
  LOADK R35 K24 ["X-Column"]
  LOADK R36 K25 ["Component-ActivityHistoryMain"]
  CALL R34 2 1
  SETTABLE R34 R32 R33
  DUPTABLE R33 K28 [{"EventList", "FilterMenu"}]
  GETUPVAL R35 0
  GETTABLEKS R34 R35 K21 ["createElement"]
  LOADK R35 K22 ["Frame"]
  NEWTABLE R36 4 0
  GETUPVAL R38 0
  GETTABLEKS R37 R38 K23 ["Tag"]
  GETUPVAL R38 14
  LOADK R39 K24 ["X-Column"]
  LOADK R40 K29 ["CX-Invisible"]
  CALL R38 2 1
  SETTABLE R38 R36 R37
  GETUPVAL R37 15
  NAMECALL R37 R37 K30 ["getNextOrder"]
  CALL R37 1 1
  ...
  LOADB R37 0 +1
  LOADB R37 1
  SETTABLEKS R37 R36 K32 ["Visible"]
  DUPTABLE R37 K35 [{"Header", "ActivityHistoryBubbleListContainer"}]
  GETUPVAL R39 0
  GETTABLEKS R38 R39 K21 ["createElement"]
  LOADK R39 K22 ["Frame"]
  NEWTABLE R40 4 0
  GETUPVAL R42 0
  GETTABLEKS R41 R42 K23 ["Tag"]
  GETUPVAL R42 14
  GETTABLEKS R44 R11 K36 ["enabled"]
  JUMPIFNOT R44 [+2]
  ...
  GETTABLEKS R43 R11 K36 ["enabled"]
  JUMPIFNOT R43 [+1]
  JUMPIF R24 [+2]
  LOADNIL R42
  JUMP [+10]
  ...
  NEWTABLE R44 4 0
  GETUPVAL R46 0
  GETTABLEKS R45 R46 K23 ["Tag"]
  GETUPVAL R46 14
  LOADK R47 K51 ["X-Row"]
  LOADK R48 K29 ["CX-Invisible"]
  CALL R46 2 1
  ...
  GETUPVAL R45 15
  NAMECALL R45 R45 K30 ["getNextOrder"]
  CALL R45 1 1
  ...
  NEWTABLE R48 4 0
  GETUPVAL R50 0
  GETTABLEKS R49 R50 K23 ["Tag"]
  GETUPVAL R50 14
  LOADK R51 K59 ["X-Fit"]
  LOADK R52 K29 ["CX-Invisible"]
  CALL R50 2 1
  SETTABLE R50 R48 R49
  GETTABLEKS R49 R22 K13 ["shortString"]
  SETTABLEKS R49 R48 K54 ["Text"]
  GETUPVAL R49 15
  NAMECALL R49 R49 K30 ["getNextOrder"]
  CALL R49 1 1
  ...
  NEWTABLE R52 2 0
  GETUPVAL R54 0
  GETTABLEKS R53 R54 K23 ["Tag"]
  GETUPVAL R54 14
  LOADK R55 K29 ["CX-Invisible"]
  LOADK R56 K63 ["HeaderIcon"]
  CALL R54 2 1
  SETTABLE R54 R52 R53
  GETUPVAL R53 15
  NAMECALL R53 R53 K30 ["getNextOrder"]
  CALL R53 1 1
  SETTABLEKS R53 R52 K31 ["LayoutOrder"]
  ...
  GETUPVAL R57 15
  NAMECALL R57 R57 K30 ["getNextOrder"]
  CALL R57 1 1
  SETTABLEKS R57 R56 K31 ["LayoutOrder"]
  CALL R54 2 1
  ...
  GETTABLEKS R41 R42 K23 ["Tag"]
  GETUPVAL R42 14
  LOADK R43 K29 ["CX-Invisible"]
  CALL R42 1 1
  SETTABLE R42 R40 R41
  GETUPVAL R41 15
  NAMECALL R41 R41 K30 ["getNextOrder"]
  CALL R41 1 1
  ...
  CALL R38 3 1
  SETTABLEKS R38 R37 K34 ["ActivityHistoryBubbleListContainer"]
  CALL R34 3 1
  SETTABLEKS R34 R33 K26 ["EventList"]
  GETUPVAL R35 0
  GETTABLEKS R34 R35 K21 ["createElement"]
  LOADK R35 K22 ["Frame"]
  ...
  GETTABLEKS R38 R39 K21 ["createElement"]
  GETUPVAL R40 9
  GETTABLEKS R39 R40 K27 ["FilterMenu"]
  ...
  CALL R38 2 1
  SETTABLEKS R38 R37 K27 ["FilterMenu"]
  CALL R34 3 1
  SETTABLEKS R34 R33 K27 ["FilterMenu"]
  CALL R30 3 -1
  RETURN R30 -1
