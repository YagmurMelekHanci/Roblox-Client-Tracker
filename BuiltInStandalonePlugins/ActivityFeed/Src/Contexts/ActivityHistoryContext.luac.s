...
MAIN:
  ...
  CALL R3 1 1
  NEWTABLE R4 0 0
  DUPTABLE R5 K21 [{"activityHistoryClient", "showSaveOrPublishPlaceToRobloxFn", "getActivityHistoryManager", "useCollaborators", "usePlaceAndUniverseId", "useConnectToDataModelSessionEffect", "DEPRECATED_openBrowserLink", "openLink", "contextType"}]
  ...
  SETTABLEKS R6 R5 K16 ["usePlaceAndUniverseId"]
  DUPCLOSURE R6 K26 [PROTO_4]
  SETTABLEKS R6 R5 K17 ["useConnectToDataModelSessionEffect"]
  DUPCLOSURE R6 K27 [PROTO_5]
  SETTABLEKS R6 R5 K18 ["DEPRECATED_openBrowserLink"]
  DUPCLOSURE R6 K28 [PROTO_6]
  SETTABLEKS R6 R5 K19 ["openLink"]
