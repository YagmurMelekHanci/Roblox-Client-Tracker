MAIN:
  ...
  CALL R0 3 0
  GETIMPORT R0 K1 [game]
  LOADK R2 K10 ["AnnotationsAddTagging4"]
  LOADB R3 0
  NAMECALL R0 R0 K3 ["DefineFastFlag"]
  CALL R0 3 0
  GETIMPORT R0 K1 [game]
  ...
  NAMECALL R0 R0 K3 ["DefineFastFlag"]
  CALL R0 3 0
  DUPTABLE R0 K28 [{"fflagCOLLAB6176PlaceAnnotations", "fflagAnnotationsModernColors", "fflagAnnotationsEditOperation", "fflagAnnotationsMaxTextLength", "fflagPlaceAnnotationsHotkey", "fflagAnnotationsFocusTextBox", "fflagAnnotationsSubmitOnEnter", "fflagAnnotationsWidgetRestoreFix", "fflagPlaceAnnotationsPublicRelease", "fflagAnnotationsUseNewAnnotationIcons", "fflagAnnotationsAddTagging", "fflagAnnotationsAddTaggingFiltering", "fflagAnnotationsSyncTagging", "fflagAnnotationsHandleNonTC"}]
  ...
  GETIMPORT R1 K1 [game]
  LOADK R3 K35 ["PlaceAnnotationsPublicRelease"]
  NAMECALL R1 R1 K30 ["GetFastFlag"]
  CALL R1 2 1
  ...
  GETIMPORT R1 K1 [game]
  LOADK R3 K10 ["AnnotationsAddTagging4"]
  NAMECALL R1 R1 K30 ["GetFastFlag"]
  CALL R1 2 1
