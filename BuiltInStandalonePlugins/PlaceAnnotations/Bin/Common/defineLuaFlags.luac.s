MAIN:
  ...
  GETIMPORT R1 K1 [game]
  LOADK R3 K12 ["PlaceAnnotationsPublicRelease"]
  NAMECALL R1 R1 K30 ["GetFastFlag"]
  CALL R1 2 1
  ...
  NAMECALL R1 R1 K30 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K19 ["fflagAnnotationsAddTagging"]
  GETIMPORT R1 K1 [game]
  LOADK R3 K8 ["AnnotationsAddTaggingFiltering3"]
  NAMECALL R1 R1 K30 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K20 ["fflagAnnotationsAddTaggingFiltering"]
  GETIMPORT R1 K1 [game]
  LOADK R3 K13 ["AnnotationsSyncTagging"]
  NAMECALL R1 R1 K30 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K21 ["fflagAnnotationsSyncTagging"]
  GETIMPORT R1 K1 [game]
  LOADK R3 K33 ["PlaceAnnotationsIxp"]
  NAMECALL R1 R1 K30 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K22 ["fflagPlaceAnnotationsIxp"]
  GETIMPORT R1 K1 [game]
  ...
  NAMECALL R1 R1 K30 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K26 ["fflagCOLLAB7954AnnotationsLoadRecentReplies"]
  GETIMPORT R1 K1 [game]
  LOADK R3 K11 ["AnnotationsAddTaggingKeyConnects"]
  NAMECALL R1 R1 K30 ["GetFastFlag"]
  CALL R1 2 1
  SETTABLEKS R1 R0 K27 ["fflagAnnotationsAddTaggingKeyConnects"]
  RETURN R0 1
