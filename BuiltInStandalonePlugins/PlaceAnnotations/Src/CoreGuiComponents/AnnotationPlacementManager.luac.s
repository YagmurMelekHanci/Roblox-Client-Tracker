PROTO_0:
  ...
  GETTABLEKS R6 R0 K15 ["Hit"]
  GETTABLEKS R5 R6 K16 ["Position"]
  NAMECALL R3 R2 K17 ["SetAdorneeOffsetFromAbsolutePosition"]
  CALL R3 2 0
  RETURN R2 1
...
PROTO_2:
  ...
  CALL R3 1 0
  GETUPVAL R4 1
  GETTABLEKS R3 R4 K3 ["createAnnotation"]
  GETUPVAL R4 2
  MOVE R5 R0
  CALL R3 2 0
  GETUPVAL R3 3
  GETUPVAL R4 4
  NAMECALL R4 R4 K4 ["GetAnnotationThreads"]
  CALL R4 1 -1
  CALL R3 -1 0
  RETURN R0 0
...
PROTO_4:
  ...
  CALL R2 1 0
  GETUPVAL R3 1
  GETTABLEKS R2 R3 K1 ["syncStandaloneAnnotation"]
  GETUPVAL R3 2
  MOVE R4 R0
  DUPTABLE R5 K3 [{"Resolved"}]
  SETTABLEKS R1 R5 K2 ["Resolved"]
  CALL R2 3 0
  RETURN R0 0
...
PROTO_9:
  ...
  LOADNIL R3
  FORGPREP R1
  GETTABLEKS R6 R5 K1 ["Resolved"]
  JUMPIF R6 [+6]
  GETTABLEKS R6 R5 K2 ["Adornee"]
  JUMPIFNOT R6 [+3]
  GETUPVAL R6 1
  MOVE R7 R5
  CALL R6 1 0
  ...
  CALL R3 2 1
  GETUPVAL R5 0
  GETTABLEKS R4 R5 K9 ["AnnotationResolved"]
  NEWCLOSURE R6 P3
  CAPTURE UPVAL U1
  CAPTURE UPVAL U2
  CAPTURE UPVAL U3
  ...
  CALL R4 2 1
  GETUPVAL R5 0
  LOADK R7 K10 ["Selected"]
  NAMECALL R5 R5 K5 ["GetPropertyChangedSignal"]
  CALL R5 2 1
  NEWCLOSURE R7 P4
  CAPTURE UPVAL U2
  CAPTURE UPVAL U3
  ...
  CALL R5 2 1
  GETUPVAL R7 7
  GETTABLEKS R6 R7 K11 ["Button1Down"]
  NEWCLOSURE R8 P5
  CAPTURE UPVAL U0
  CAPTURE UPVAL U8
  CAPTURE UPVAL U9
  ...
  CALL R6 2 1
  GETUPVAL R8 3
  GETTABLEKS R7 R8 K12 ["Deactivation"]
  NEWCLOSURE R9 P6
  CAPTURE UPVAL U7
...
PROTO_14:
  ...
  GETUPVAL R3 9
  NAMECALL R3 R3 K22 ["GetAbsolutePosition"]
  CALL R3 1 -1
  ...
  GETTABLEKS R5 R6 K5 ["CurrentCamera"]
  GETTABLEKS R4 R5 K27 ["ViewportSize"]
  GETTABLEKS R3 R4 K15 ["X"]
  DIVK R2 R3 K26 [2]
  GETIMPORT R7 K4 [workspace]
  GETTABLEKS R6 R7 K5 ["CurrentCamera"]
  GETTABLEKS R5 R6 K27 ["ViewportSize"]
  ...
  GETTABLEKS R1 R2 K1 ["createElement"]
  GETUPVAL R2 10
  DUPTABLE R3 K30 [{"Position", "Annotation", "OnCancel", "OnReply"}]
  GETIMPORT R4 K14 [UDim2.fromOffset]
  GETTABLEKS R5 R0 K15 ["X"]
  GETTABLEKS R6 R0 K16 ["Y"]
  CALL R4 2 1
  SETTABLEKS R4 R3 K7 ["Position"]
  GETUPVAL R4 9
  SETTABLEKS R4 R3 K28 ["Annotation"]
  NEWCLOSURE R4 P2
  CAPTURE UPVAL U7
  CAPTURE UPVAL U9
  SETTABLEKS R4 R3 K10 ["OnCancel"]
