...
PROTO_13:
  ...
  LOADK R14 K10 ["Frame"]
  DUPTABLE R15 K12 [{"BackgroundTransparency"}]
  LOADN R16 1
  SETTABLEKS R16 R15 K11 ["BackgroundTransparency"]
  DUPTABLE R16 K14 [{"Element"}]
  MOVE R17 R12
  CALL R17 0 1
  SETTABLEKS R17 R16 K13 ["Element"]
  CALL R13 3 -1
  CLOSEUPVALS R8
  RETURN R13 -1
...
MAIN:
  ...
  GETTABLEKS R11 R12 K21 ["TaggingContext"]
  CALL R10 1 1
  GETTABLEKS R9 R10 K21 ["TaggingContext"]
  GETIMPORT R10 K5 [require]
  GETTABLEKS R13 R0 K9 ["Src"]
  ...
  GETTABLEKS R18 R19 K35 ["Types"]
  CALL R17 1 1
  DUPCLOSURE R18 K36 [PROTO_0]
  CAPTURE VAL R16
  DUPCLOSURE R19 K37 [PROTO_13]
  CAPTURE VAL R1
  CAPTURE VAL R8
  CAPTURE VAL R4
  CAPTURE VAL R9
