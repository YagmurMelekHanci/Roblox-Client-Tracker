...
PROTO_4:
  GETUPVAL R2 0
  GETTABLEKS R4 R1 K0 ["UniqueId"]
  LOADB R5 1
  NAMECALL R2 R2 K1 ["FindFirstChild"]
  CALL R2 3 1
  JUMPIFNOT R2 [+11]
  GETUPVAL R4 1
  GETTABLEKS R3 R4 K2 ["syncStandaloneAnnotation"]
  GETUPVAL R4 2
  MOVE R5 R2
  DUPTABLE R6 K4 [{"Contents"}]
  GETTABLEKS R7 R2 K3 ["Contents"]
  SETTABLEKS R7 R6 K3 ["Contents"]
  CALL R3 3 0
  RETURN R0 0
...
MAIN:
  ...
  GETTABLEKS R9 R10 K19 ["createAnnotationBillboard"]
  CALL R8 1 1
  GETIMPORT R9 K5 [require]
  GETTABLEKS R12 R0 K9 ["Src"]
  GETTABLEKS R11 R12 K10 ["Util"]
  GETTABLEKS R10 R11 K20 ["doSelectionRaycast"]
  CALL R9 1 1
  GETIMPORT R10 K5 [require]
  GETTABLEKS R13 R0 K9 ["Src"]
  GETTABLEKS R12 R13 K21 ["Enums"]
  GETTABLEKS R11 R12 K22 ["AnnotationEditingMode"]
  CALL R10 1 1
  GETIMPORT R11 K5 [require]
  GETTABLEKS R14 R0 K9 ["Src"]
  GETTABLEKS R13 R14 K23 ["CoreGuiComponents"]
  GETTABLEKS R12 R13 K24 ["TargetHighlight"]
  CALL R11 1 1
  GETIMPORT R12 K5 [require]
  GETTABLEKS R15 R0 K9 ["Src"]
  GETTABLEKS R14 R15 K25 ["Components"]
  GETTABLEKS R13 R14 K26 ["AddAnnotationPopup"]
  CALL R12 1 1
  GETIMPORT R13 K5 [require]
  GETTABLEKS R16 R0 K9 ["Src"]
  GETTABLEKS R15 R16 K25 ["Components"]
  GETTABLEKS R14 R15 K27 ["AnnotationPopover"]
  CALL R13 1 1
  ...
  GETTABLEKS R16 R17 K32 ["Types"]
  CALL R15 1 1
  GETIMPORT R16 K29 [game]
  LOADK R18 K33 ["AnnotationsService"]
  NAMECALL R16 R16 K31 ["GetService"]
  CALL R16 2 1
  DUPCLOSURE R17 K34 [PROTO_0]
  CAPTURE VAL R14
  DUPCLOSURE R18 K35 [PROTO_13]
  CAPTURE VAL R1
  CAPTURE VAL R16
  CAPTURE VAL R6
  CAPTURE VAL R7
