...
PROTO_1:
  ...
  JUMPIF R1 [+4]
  GETUPVAL R2 0
  GETTABLEKS R1 R2 K0 ["OnScrollToBottom"]
  CALL R1 0 0
  GETUPVAL R1 4
  LOADB R2 1
  CALL R1 1 0
...
PROTO_4:
  ...
  LOADNIL R1
  JUMPIFNOT R0 [+11]
  LOADK R4 K1 ["AbsoluteWindowSize"]
...
PROTO_7:
  ...
  JUMPIFNOT R0 [+50]
  GETUPVAL R3 1
  GETTABLEKS R2 R3 K1 ["OnScrollToBottom"]
  JUMPIFNOT R2 [+46]
  LOADK R4 K2 ["CanvasPosition"]
  ...
  MOVE R1 R2
  GETUPVAL R4 1
  GETTABLEKS R3 R4 K1 ["OnScrollToBottom"]
  FASTCALL1 ASSERT R3 [+2]
  GETIMPORT R2 K6 [assert]
  CALL R2 1 0
  GETUPVAL R3 2
  GETUPVAL R5 3
  GETTABLEKS R7 R0 K2 ["CanvasPosition"]
  GETTABLEKS R6 R7 K7 ["Y"]
  ADD R4 R5 R6
  SUB R2 R3 R4
  LOADN R3 150
  JUMPIFNOTLE R2 R3 [+11]
  GETUPVAL R2 4
  JUMPIF R2 [+4]
  GETUPVAL R3 1
  GETTABLEKS R2 R3 K1 ["OnScrollToBottom"]
