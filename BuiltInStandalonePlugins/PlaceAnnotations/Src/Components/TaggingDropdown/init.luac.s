...
PROTO_11:
  ...
  GETUPVAL R0 2
  JUMPIFNOTEQKN R0 K1 [-2] [+24]
  GETUPVAL R1 0
  GETTABLEKS R0 R1 K0 ["current"]
  NAMECALL R0 R0 K2 ["CaptureFocus"]
  CALL R0 1 0
  GETUPVAL R1 3
  GETTABLEKS R0 R1 K3 ["fflagAnnotationsAddTaggingKeyConnects"]
  JUMPIFNOT R0 [+6]
  GETUPVAL R1 0
  GETTABLEKS R0 R1 K0 ["current"]
  GETUPVAL R1 1
...
PROTO_24:
  ...
  JUMPIFEQKS R0 K5 [" "] [+8]
  LOADK R7 K8 ["%w"]
  NAMECALL R5 R0 K9 ["match"]
  CALL R5 2 1
  JUMPIF R5 [+20]
  JUMPIFEQKS R0 K10 ["_"] [+19]
  GETUPVAL R5 7
  JUMPIFNOT R5 [+12]
  GETUPVAL R5 5
  LOADB R6 0
...
PROTO_30:
  ...
  GETUPVAL R45 8
  GETTABLEKS R44 R45 K28 ["fflagAnnotationsAddTaggingKeyConnects"]
  JUMPIFNOT R44 [+9]
  GETUPVAL R43 9
  LOADK R44 K29 ["Component-DropdownItem"]
  ...
  CALL R43 2 1
  JUMP [+1]
  LOADK R43 K29 ["Component-DropdownItem"]
  SETTABLE R43 R41 R42
  GETUPVAL R44 8
  GETTABLEKS R43 R44 K28 ["fflagAnnotationsAddTaggingKeyConnects"]
  JUMPIFNOT R43 [+2]
  MOVE R42 R37
  JUMP [+1]
  LOADNIL R42
  SETTABLEKS R42 R41 K31 ["LayoutOrder"]
  GETTABLEKS R42 R38 K19 ["Username"]
  SETTABLEKS R42 R41 K32 ["key"]
  DUPTABLE R42 K35 [{"Avatar", "TextLabel"}]
  GETUPVAL R44 4
  GETTABLEKS R43 R44 K20 ["createElement"]
  LOADK R44 K36 ["ImageLabel"]
  NEWTABLE R45 4 0
  LOADN R46 1
  SETTABLEKS R46 R45 K31 ["LayoutOrder"]
  ...
  LOADN R50 24
  CALL R46 4 1
  SETTABLEKS R46 R45 K39 ["Size"]
  LOADK R47 K40 ["rbxthumb://type=AvatarHeadShot&id=%*&filters=circular&w=48&h=48"]
  GETTABLEKS R49 R38 K41 ["UserId"]
  NAMECALL R47 R47 K42 ["format"]
  CALL R47 2 1
  MOVE R46 R47
  SETTABLEKS R46 R45 K43 ["Image"]
  GETUPVAL R47 4
  GETTABLEKS R46 R47 K27 ["Tag"]
  LOADK R47 K44 ["Component-Avatar"]
  SETTABLE R47 R45 R46
  CALL R43 2 1
  SETTABLEKS R43 R42 K33 ["Avatar"]
  GETUPVAL R44 4
  GETTABLEKS R43 R44 K20 ["createElement"]
  LOADK R44 K34 ["TextLabel"]
  NEWTABLE R45 4 0
  LOADN R46 2
  SETTABLEKS R46 R45 K31 ["LayoutOrder"]
  GETTABLEKS R46 R38 K19 ["Username"]
  SETTABLEKS R46 R45 K8 ["Text"]
  GETIMPORT R46 K48 [Enum.TextXAlignment.Left]
  SETTABLEKS R46 R45 K46 ["TextXAlignment"]
  GETUPVAL R47 4
  GETTABLEKS R46 R47 K27 ["Tag"]
  LOADK R47 K49 ["X-Fit"]
  SETTABLE R47 R45 R46
  CALL R43 2 1
  SETTABLEKS R43 R42 K34 ["TextLabel"]
  CALL R39 3 1
  ...
  CAPTURE VAL R28
  CAPTURE UPVAL U0
  DUPCLOSURE R38 K51 [PROTO_21]
  DUPCLOSURE R39 K52 [PROTO_22]
  NEWCLOSURE R40 P19
  CAPTURE VAL R8
  CAPTURE VAL R18
  CAPTURE VAL R14
  ...
  LENGTH R45 R30
  LOADN R46 0
  JUMPIFNOTLT R46 R45 [+56]
  GETUPVAL R45 11
  GETTABLEKS R44 R45 K53 ["createPortal"]
  GETUPVAL R46 4
  GETTABLEKS R45 R46 K20 ["createElement"]
  LOADK R46 K54 ["CanvasGroup"]
  NEWTABLE R47 8 0
  SETTABLEKS R23 R47 K55 ["Position"]
  SETTABLEKS R25 R47 K39 ["Size"]
  GETTABLEKS R48 R1 K56 ["AutomaticSize"]
  SETTABLEKS R48 R47 K56 ["AutomaticSize"]
  GETUPVAL R50 4
  GETTABLEKS R49 R50 K23 ["Event"]
  GETTABLEKS R48 R49 K25 ["MouseEnter"]
  GETUPVAL R51 8
  GETTABLEKS R50 R51 K28 ["fflagAnnotationsAddTaggingKeyConnects"]
  JUMPIF R50 [+3]
  NEWCLOSURE R49 P24
  CAPTURE VAL R5
  JUMP [+1]
  ...
  GETUPVAL R50 4
  GETTABLEKS R49 R50 K23 ["Event"]
  GETTABLEKS R48 R49 K26 ["MouseLeave"]
  GETUPVAL R51 8
  GETTABLEKS R50 R51 K28 ["fflagAnnotationsAddTaggingKeyConnects"]
  JUMPIF R50 [+3]
  NEWCLOSURE R49 P25
  ...
  SETTABLE R49 R47 R48
  GETUPVAL R49 4
  GETTABLEKS R48 R49 K27 ["Tag"]
  LOADK R49 K57 ["Component-Dropdown X-Column"]
  SETTABLE R49 R47 R48
  MOVE R48 R33
  CALL R45 3 1
  MOVE R46 R2
