...
PROTO_9:
  ...
  GETTABLEKS R19 R1 K40 ["Hidden"]
  NOT R18 R19
  SETTABLEKS R18 R17 K41 ["Visible"]
  GETUPVAL R20 4
  ...
  GETUPVAL R19 7
  LOADK R20 K42 ["Component-DropdownButton"]
  GETTABLEKS R21 R1 K43 ["ImageTag"]
  GETUPVAL R24 4
  GETTABLEKS R23 R24 K34 ["Tag"]
  GETTABLE R22 R1 R23
  ...
  CALL R19 4 1
  SETTABLE R19 R17 R18
  DUPTABLE R18 K45 [{"Dropdown"}]
  JUMPIFNOT R8 [+53]
  GETUPVAL R20 8
  GETTABLEKS R19 R20 K46 ["createPortal"]
  GETUPVAL R21 4
  GETTABLEKS R20 R21 K29 ["createElement"]
  LOADK R21 K47 ["CanvasGroup"]
  NEWTABLE R22 8 0
  SETTABLEKS R13 R22 K48 ["Position"]
  GETTABLEKS R23 R1 K49 ["Size"]
  SETTABLEKS R23 R22 K49 ["Size"]
  GETTABLEKS R23 R1 K50 ["AutomaticSize"]
  SETTABLEKS R23 R22 K50 ["AutomaticSize"]
  GETUPVAL R25 4
  GETTABLEKS R24 R25 K32 ["Event"]
  GETTABLEKS R23 R24 K51 ["MouseEnter"]
  NEWCLOSURE R24 P5
  CAPTURE VAL R7
  SETTABLE R24 R22 R23
  GETUPVAL R25 4
  GETTABLEKS R24 R25 K32 ["Event"]
  GETTABLEKS R23 R24 K52 ["MouseLeave"]
  NEWCLOSURE R24 P6
  CAPTURE VAL R7
  SETTABLE R24 R22 R23
  GETUPVAL R25 4
  GETTABLEKS R24 R25 K53 ["Change"]
  GETTABLEKS R23 R24 K54 ["AbsoluteSize"]
  NEWCLOSURE R24 P7
  CAPTURE VAL R12
  SETTABLE R24 R22 R23
  GETUPVAL R24 4
  GETTABLEKS R23 R24 K34 ["Tag"]
  LOADK R24 K55 ["Component-Dropdown X-Column"]
  SETTABLE R24 R22 R23
  MOVE R23 R14
  CALL R20 3 1
  MOVE R21 R2
  ...
  JUMP [+1]
  LOADNIL R19
  SETTABLEKS R19 R18 K44 ["Dropdown"]
  CALL R15 3 -1
  RETURN R15 -1
