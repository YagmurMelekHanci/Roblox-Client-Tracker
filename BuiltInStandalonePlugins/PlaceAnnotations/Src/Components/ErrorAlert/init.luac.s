...
PROTO_1:
  ...
  CALL R5 2 1
  SETTABLE R5 R3 R4
  DUPTABLE R4 K15 [{"UIPadding", "Icon", "Text", "CloseWrapper"}]
  GETTABLEKS R5 R0 K11 ["UIPadding"]
  SETTABLEKS R5 R4 K11 ["UIPadding"]
  GETUPVAL R6 0
  ...
  GETTABLEKS R5 R6 K2 ["createElement"]
  LOADK R6 K3 ["Frame"]
  DUPTABLE R7 K22 [{"LayoutOrder", "Size"}]
  LOADN R8 3
  SETTABLEKS R8 R7 K4 ["LayoutOrder"]
  ...
  DUPTABLE R8 K27 [{"CloseIcon"}]
  GETUPVAL R10 0
  GETTABLEKS R9 R10 K2 ["createElement"]
  LOADK R10 K28 ["ImageButton"]
  NEWTABLE R11 4 0
  ...
  SETTABLE R13 R11 R12
  CALL R9 2 1
  SETTABLEKS R9 R8 K26 ["CloseIcon"]
  CALL R5 3 1
  JUMP [+1]
  LOADNIL R5
  SETTABLEKS R5 R4 K14 ["CloseWrapper"]
  CALL R1 3 -1
  RETURN R1 -1
