...
PROTO_12:
  ...
  LOADK R14 K9 ["Frame"]
  DUPTABLE R15 K14 [{"LayoutOrder", "ZIndex", "Size", "BackgroundTransparency"}]
  LOADN R16 255
  SETTABLEKS R16 R15 K10 ["LayoutOrder"]
  LOADN R16 100
  SETTABLEKS R16 R15 K11 ["ZIndex"]
  ...
  DUPTABLE R16 K19 [{"Alert"}]
  GETUPVAL R18 3
  GETTABLEKS R17 R18 K8 ["createElement"]
  GETUPVAL R18 9
  DUPTABLE R19 K25 [{"Message", "AnchorPoint", "Position", "Size", "IsPopup", "OnClose"}]
  GETUPVAL R20 10
  MOVE R21 R8
  GETTABLEKS R22 R0 K7 ["Annotation"]
  MOVE R23 R2
  CALL R20 3 1
  SETTABLEKS R20 R19 K20 ["Message"]
  GETIMPORT R20 K27 [Vector2.new]
  LOADK R21 K28 [0.5]
  LOADN R22 0
  CALL R20 2 1
  SETTABLEKS R20 R19 K21 ["AnchorPoint"]
  ...
  LOADB R20 1
  SETTABLEKS R20 R19 K23 ["IsPopup"]
  NEWCLOSURE R20 P1
  CAPTURE VAL R9
  CAPTURE UPVAL U4
  SETTABLEKS R20 R19 K24 ["OnClose"]
  CALL R17 2 1
  SETTABLEKS R17 R16 K18 ["Alert"]
  CALL R13 3 1
  JUMP [+1]
  LOADNIL R13
  GETUPVAL R15 3
  ...
  GETUPVAL R18 11
  LOADK R19 K31 ["Component-AnnotationListCard"]
  JUMPIFNOT R6 [+2]
  LOADK R20 K32 ["Selected"]
  JUMP [+1]
  LOADNIL R20
  CALL R18 2 1
  SETTABLE R18 R16 R17
  DUPTABLE R17 K34 [{"BackgroundFrame"}]
  GETUPVAL R19 3
  GETTABLEKS R18 R19 K8 ["createElement"]
  LOADK R19 K9 ["Frame"]
  NEWTABLE R20 0 0
  DUPTABLE R21 K36 [{"Card"}]
  GETUPVAL R23 3
  GETTABLEKS R22 R23 K8 ["createElement"]
  LOADK R23 K37 ["TextButton"]
  NEWTABLE R24 8 0
  ...
  GETTABLEKS R25 R26 K41 ["MouseButton1Click"]
  NEWCLOSURE R26 P2
  CAPTURE VAL R3
  CAPTURE VAL R7
  CAPTURE UPVAL U7
  ...
  GETUPVAL R27 3
  GETTABLEKS R26 R27 K40 ["Event"]
  GETTABLEKS R25 R26 K42 ["MouseEnter"]
  NEWCLOSURE R26 P3
  CAPTURE VAL R3
  CAPTURE VAL R5
  SETTABLE R26 R24 R25
  GETUPVAL R27 3
  GETTABLEKS R26 R27 K40 ["Event"]
  GETTABLEKS R25 R26 K43 ["MouseLeave"]
  NEWCLOSURE R26 P4
  CAPTURE VAL R5
  SETTABLE R26 R24 R25
  GETUPVAL R26 3
  GETTABLEKS R25 R26 K30 ["Tag"]
  GETUPVAL R26 11
  LOADK R27 K44 ["X-Center X-Column"]
  JUMPIFNOT R4 [+2]
  LOADK R28 K45 ["Hovered"]
  JUMP [+1]
  LOADNIL R28
  JUMPIFNOT R6 [+2]
  LOADK R29 K32 ["Selected"]
  JUMP [+1]
  LOADNIL R29
  CALL R26 3 1
  SETTABLE R26 R24 R25
  DUPTABLE R25 K50 [{"ErrorBanner", "Header", "Comment", "ReplyCount"}]
  SETTABLEKS R13 R25 K46 ["ErrorBanner"]
  GETUPVAL R27 3
  GETTABLEKS R26 R27 K8 ["createElement"]
  GETUPVAL R27 13
  DUPTABLE R28 K52 [{"Annotation", "DataModel"}]
  GETTABLEKS R29 R0 K7 ["Annotation"]
  SETTABLEKS R29 R28 K7 ["Annotation"]
  LOADK R29 K53 ["Standalone"]
  SETTABLEKS R29 R28 K51 ["DataModel"]
  DUPTABLE R29 K56 [{"MoreIcon", "ResolveButton"}]
  GETUPVAL R32 7
  GETTABLEKS R31 R32 K57 ["fflagAnnotationsCardDoubleClickZoom"]
  JUMPIFNOT R31 [+76]
  GETUPVAL R31 3
  GETTABLEKS R30 R31 K8 ["createElement"]
  GETUPVAL R31 14
  DUPTABLE R32 K61 [{"DropdownItems", "OnSelect", "Disabled"}]
  DUPTABLE R33 K64 [{"ZoomTo", "Delete"}]
  LOADK R36 K65 ["Dropdown"]
  LOADK R37 K62 ["ZoomTo"]
  NAMECALL R34 R2 K66 ["getText"]
  CALL R34 3 1
  SETTABLEKS R34 R33 K62 ["ZoomTo"]
  GETTABLEKS R36 R0 K7 ["Annotation"]
  GETTABLEKS R35 R36 K67 ["AuthorId"]
  GETUPVAL R36 15
  NAMECALL R36 R36 K68 ["GetUserId"]
  CALL R36 1 1
  ...
  NEWTABLE R36 4 0
  LOADK R39 K65 ["Dropdown"]
  LOADK R40 K69 ["DeleteThread"]
  NAMECALL R37 R2 K66 ["getText"]
  CALL R37 3 1
  SETTABLEKS R37 R36 K39 ["Text"]
  GETUPVAL R39 3
  GETTABLEKS R38 R39 K40 ["Event"]
  GETTABLEKS R37 R38 K70 ["Activated"]
  NEWCLOSURE R38 P5
  CAPTURE UPVAL U12
  CAPTURE VAL R1
  CAPTURE VAL R0
  ...
  GETUPVAL R38 3
  GETTABLEKS R37 R38 K30 ["Tag"]
  LOADK R38 K71 ["Component-DropdownItem Delete"]
  SETTABLE R38 R36 R37
  CALL R34 2 1
  JUMP [+1]
  LOADNIL R34
  SETTABLEKS R34 R33 K63 ["Delete"]
  SETTABLEKS R33 R32 K58 ["DropdownItems"]
  NEWCLOSURE R33 P6
  CAPTURE VAL R2
  CAPTURE UPVAL U12
  CAPTURE VAL R1
  CAPTURE VAL R0
  SETTABLEKS R33 R32 K59 ["OnSelect"]
  GETUPVAL R35 4
  GETTABLEKS R34 R35 K72 ["InProgress"]
  JUMPIFEQ R8 R34 [+2]
  LOADB R33 0 +1
  LOADB R33 1
  SETTABLEKS R33 R32 K60 ["Disabled"]
  CALL R30 2 1
  JUMP [+62]
  GETTABLEKS R32 R0 K7 ["Annotation"]
  GETTABLEKS R31 R32 K67 ["AuthorId"]
  GETUPVAL R32 15
  NAMECALL R32 R32 K68 ["GetUserId"]
  CALL R32 1 1
  JUMPIFNOTEQ R31 R32 [+52]
  GETUPVAL R31 3
  GETTABLEKS R30 R31 K8 ["createElement"]
  GETUPVAL R31 14
  DUPTABLE R32 K73 [{"DropdownItems", "Disabled"}]
  NEWTABLE R33 0 1
  GETUPVAL R35 3
  GETTABLEKS R34 R35 K8 ["createElement"]
  LOADK R35 K37 ["TextButton"]
  ...
  JUMP [+1]
  LOADNIL R30
  SETTABLEKS R30 R29 K54 ["MoreIcon"]
  GETUPVAL R31 3
  GETTABLEKS R30 R31 K8 ["createElement"]
  GETUPVAL R31 16
  DUPTABLE R32 K76 [{"Resolved", "OnClick", "Disabled"}]
  GETTABLEKS R34 R0 K7 ["Annotation"]
  GETTABLEKS R33 R34 K74 ["Resolved"]
  SETTABLEKS R33 R32 K74 ["Resolved"]
  NEWCLOSURE R33 P8
  CAPTURE UPVAL U12
  CAPTURE VAL R1
  CAPTURE VAL R0
  SETTABLEKS R33 R32 K75 ["OnClick"]
  GETUPVAL R35 4
  GETTABLEKS R34 R35 K72 ["InProgress"]
  JUMPIFEQ R8 R34 [+2]
  LOADB R33 0 +1
  ...
  SETTABLEKS R33 R32 K60 ["Disabled"]
  CALL R30 2 1
  SETTABLEKS R30 R29 K55 ["ResolveButton"]
  CALL R26 3 1
  SETTABLEKS R26 R25 K47 ["Header"]
  GETUPVAL R27 3
  GETTABLEKS R26 R27 K8 ["createElement"]
  GETUPVAL R27 17
  DUPTABLE R28 K77 [{"LayoutOrder", "Annotation"}]
  LOADN R29 0
  SETTABLEKS R29 R28 K10 ["LayoutOrder"]
  GETTABLEKS R29 R0 K7 ["Annotation"]
  SETTABLEKS R29 R28 K7 ["Annotation"]
  CALL R26 2 1
  SETTABLEKS R26 R25 K48 ["Comment"]
  GETTABLEKS R28 R0 K7 ["Annotation"]
  GETTABLEKS R27 R28 K49 ["ReplyCount"]
  JUMPIFEQKN R27 K78 [0] [+50]
  GETUPVAL R27 3
  GETTABLEKS R26 R27 K8 ["createElement"]
  LOADK R27 K79 ["TextLabel"]
  DUPTABLE R28 K80 [{"Text", "LayoutOrder"}]
  GETTABLEKS R31 R0 K7 ["Annotation"]
  GETTABLEKS R30 R31 K49 ["ReplyCount"]
  JUMPIFNOTEQKN R30 K81 [1] [+7]
  LOADK R31 K35 ["Card"]
  LOADK R32 K82 ["SingleReply"]
  NAMECALL R29 R2 K66 ["getText"]
  CALL R29 3 1
  JUMP [+25]
  LOADK R31 K35 ["Card"]
  LOADK R32 K83 ["ManyReplies"]
  DUPTABLE R33 K85 [{"replyCount"}]
  GETTABLEKS R36 R0 K7 ["Annotation"]
  GETTABLEKS R35 R36 K49 ["ReplyCount"]
  LOADN R36 100
  JUMPIFNOTLT R35 R36 [+10]
  GETIMPORT R34 K88 [string.format]
  LOADK R35 K89 ["%d"]
  GETTABLEKS R37 R0 K7 ["Annotation"]
  GETTABLEKS R36 R37 K49 ["ReplyCount"]
  CALL R34 2 1
  JUMP [+1]
  LOADK R34 K90 ["99+"]
  SETTABLEKS R34 R33 K84 ["replyCount"]
  NAMECALL R29 R2 K66 ["getText"]
  CALL R29 4 1
  ...
  JUMP [+1]
  LOADNIL R26
  SETTABLEKS R26 R25 K49 ["ReplyCount"]
  CALL R22 3 1
  SETTABLEKS R22 R21 K35 ["Card"]
  CALL R18 3 1
  SETTABLEKS R18 R17 K33 ["BackgroundFrame"]
  CALL R14 3 -1
  RETURN R14 -1
