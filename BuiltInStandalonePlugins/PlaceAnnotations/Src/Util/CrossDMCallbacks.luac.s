...
PROTO_4:
  ...
  CALL R0 1 1
  LOADK R1 K1 ["rbxasset://textures/PlaceAnnotations/Cursor.png"]
...
PROTO_7:
  ...
  JUMP [+1]
  LOADNIL R4
  LOADK R7 K14 ["BeginAddAnnotation"]
  NEWCLOSURE R8 P4
  CAPTURE VAL R0
  NAMECALL R5 R0 K5 ["OnInvoke"]
  CALL R5 3 1
  LOADK R8 K15 ["EndAddAnnotation"]
  NEWCLOSURE R9 P5
  CAPTURE VAL R0
  NAMECALL R6 R0 K5 ["OnInvoke"]
  CALL R6 3 1
...
PROTO_8:
  ...
  CALL R0 1 1
  LOADK R1 K3 ["rbxasset://textures/PlaceAnnotations/Cursor.png"]
...
PROTO_16:
  ...
  CALL R1 3 0
  LOADK R3 K2 ["DEPRECATED_EditAnnotation"]
  DUPCLOSURE R4 K3 [PROTO_9]
  CAPTURE UPVAL U0
  NAMECALL R1 R0 K1 ["OnInvoke"]
  CALL R1 3 0
  LOADK R3 K4 ["EditAnnotation"]
  DUPCLOSURE R4 K5 [PROTO_10]
  CAPTURE UPVAL U0
  NAMECALL R1 R0 K1 ["OnInvoke"]
  CALL R1 3 0
  LOADK R3 K6 ["ResolveAnnotation"]
  DUPCLOSURE R4 K7 [PROTO_11]
  CAPTURE UPVAL U0
  NAMECALL R1 R0 K1 ["OnInvoke"]
  CALL R1 3 0
  LOADK R3 K8 ["ZoomTo"]
  DUPCLOSURE R4 K9 [PROTO_12]
  CAPTURE UPVAL U0
  CAPTURE UPVAL U2
  NAMECALL R1 R0 K1 ["OnInvoke"]
  CALL R1 3 0
  LOADK R3 K10 ["DeleteAnnotation"]
  DUPCLOSURE R4 K11 [PROTO_13]
  CAPTURE UPVAL U0
  NAMECALL R1 R0 K1 ["OnInvoke"]
  CALL R1 3 0
  LOADK R3 K12 ["LoadResolvedAnnotations"]
  DUPCLOSURE R4 K13 [PROTO_14]
  CAPTURE UPVAL U0
  NAMECALL R1 R0 K1 ["OnInvoke"]
  CALL R1 3 0
  LOADK R3 K14 ["SetVisibility"]
  DUPCLOSURE R4 K15 [PROTO_15]
  CAPTURE UPVAL U0
  NAMECALL R1 R0 K1 ["OnInvoke"]
  CALL R1 3 0
  RETURN R0 0
...
MAIN:
  ...
  LOADK R7 K17 ["AnnotationsService"]
  NAMECALL R5 R5 K18 ["GetService"]
  CALL R5 2 1
  DUPTABLE R6 K21 [{"registerStandaloneCallbacks", "registerEditCallbacks"}]
  DUPCLOSURE R7 K22 [PROTO_7]
  CAPTURE VAL R5
  CAPTURE VAL R2
  SETTABLEKS R7 R6 K19 ["registerStandaloneCallbacks"]
  DUPCLOSURE R7 K23 [PROTO_16]
  CAPTURE VAL R5
  CAPTURE VAL R1
  CAPTURE VAL R4
  SETTABLEKS R7 R6 K20 ["registerEditCallbacks"]
  RETURN R6 1
