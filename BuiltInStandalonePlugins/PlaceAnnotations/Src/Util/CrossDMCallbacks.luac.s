...
PROTO_7:
  ...
  MOVE R4 R0
  MOVE R5 R1
  NAMECALL R2 R2 K0 ["EditAnnotation"]
  CALL R2 3 0
  RETURN R0 0
...
PROTO_13:
  ...
  CALL R1 3 0
  LOADK R3 K2 ["EditAnnotation"]
  DUPCLOSURE R4 K3 [PROTO_7]
  CAPTURE UPVAL U0
  NAMECALL R1 R0 K1 ["OnInvoke"]
  CALL R1 3 0
  LOADK R3 K4 ["ResolveAnnotation"]
  ...
  NAMECALL R1 R0 K1 ["OnInvoke"]
  CALL R1 3 0
  LOADK R3 K8 ["DeleteAnnotation"]
  DUPCLOSURE R4 K9 [PROTO_10]
  CAPTURE UPVAL U0
  NAMECALL R1 R0 K1 ["OnInvoke"]
  CALL R1 3 0
  LOADK R3 K10 ["LoadResolvedAnnotations"]
  DUPCLOSURE R4 K11 [PROTO_11]
  CAPTURE UPVAL U0
  NAMECALL R1 R0 K1 ["OnInvoke"]
  CALL R1 3 0
  LOADK R3 K12 ["SetVisibility"]
