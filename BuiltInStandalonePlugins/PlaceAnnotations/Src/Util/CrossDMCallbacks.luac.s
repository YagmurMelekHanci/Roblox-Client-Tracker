...
PROTO_18:
  ...
  CALL R2 3 1
  LOADK R5 K3 ["DEPRECATED_EditAnnotation"]
  DUPCLOSURE R6 K4 [PROTO_8]
  CAPTURE UPVAL U0
  NAMECALL R3 R0 K1 ["OnInvoke"]
  CALL R3 3 1
  LOADK R6 K5 ["EditAnnotation"]
  DUPCLOSURE R7 K6 [PROTO_9]
  CAPTURE UPVAL U0
  NAMECALL R4 R0 K1 ["OnInvoke"]
  CALL R4 3 1
  LOADK R7 K7 ["ResolveAnnotation"]
  DUPCLOSURE R8 K8 [PROTO_10]
  CAPTURE UPVAL U0
  NAMECALL R5 R0 K1 ["OnInvoke"]
  CALL R5 3 1
  LOADK R8 K9 ["ZoomTo"]
  DUPCLOSURE R9 K10 [PROTO_11]
  CAPTURE UPVAL U0
  CAPTURE UPVAL U2
  NAMECALL R6 R0 K1 ["OnInvoke"]
  CALL R6 3 1
  LOADK R9 K11 ["DeleteAnnotation"]
  DUPCLOSURE R10 K12 [PROTO_12]
  CAPTURE UPVAL U0
  NAMECALL R7 R0 K1 ["OnInvoke"]
  CALL R7 3 1
  LOADK R10 K13 ["SelectAnnotation"]
  DUPCLOSURE R11 K14 [PROTO_13]
  CAPTURE UPVAL U0
  CAPTURE UPVAL U3
  NAMECALL R8 R0 K1 ["OnInvoke"]
  CALL R8 3 1
  LOADK R11 K15 ["LoadResolvedAnnotations"]
  DUPCLOSURE R12 K16 [PROTO_14]
  CAPTURE UPVAL U0
  NAMECALL R9 R0 K1 ["OnInvoke"]
  CALL R9 3 1
  LOADK R12 K17 ["SetVisibility"]
  DUPCLOSURE R13 K18 [PROTO_15]
  CAPTURE UPVAL U0
  NAMECALL R10 R0 K1 ["OnInvoke"]
  CALL R10 3 1
  GETTABLEKS R11 R0 K19 ["Unloading"]
  NEWCLOSURE R13 P10
  CAPTURE VAL R1
  CAPTURE VAL R3
  CAPTURE VAL R4
  ...
  CAPTURE VAL R9
  CAPTURE VAL R10
  NAMECALL R11 R11 K20 ["Once"]
  CALL R11 2 0
  LOADK R13 K21 ["SyncEditAnnotation"]
  DUPCLOSURE R14 K22 [PROTO_17]
  CAPTURE UPVAL U0
  NAMECALL R11 R0 K1 ["OnInvoke"]
  CALL R11 3 0
  RETURN R0 0
...
MAIN:
  ...
  LOADK R8 K18 ["AnnotationsService"]
  NAMECALL R6 R6 K19 ["GetService"]
  CALL R6 2 1
  DUPTABLE R7 K22 [{"registerStandaloneCallbacks", "registerEditCallbacks"}]
  DUPCLOSURE R8 K23 [PROTO_5]
  CAPTURE VAL R6
  CAPTURE VAL R2
  SETTABLEKS R8 R7 K20 ["registerStandaloneCallbacks"]
  DUPCLOSURE R8 K24 [PROTO_18]
  CAPTURE VAL R6
  CAPTURE VAL R1
  CAPTURE VAL R4
  CAPTURE VAL R5
  SETTABLEKS R8 R7 K21 ["registerEditCallbacks"]
  RETURN R7 1
