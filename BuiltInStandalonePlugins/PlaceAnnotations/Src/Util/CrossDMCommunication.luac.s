...
PROTO_15:
  ...
  CALL R3 3 0
  GETUPVAL R4 4
  GETTABLEKS R3 R4 K7 ["fflagAnnotationsAddTaggingFiltering"]
  JUMPIFNOT R3 [+7]
  GETUPVAL R3 5
  GETUPVAL R4 2
  MOVE R5 R1
...
PROTO_17:
  ...
  CALL R3 2 0
  GETUPVAL R4 1
  GETTABLEKS R3 R4 K26 ["fflagAnnotationsAddTaggingFiltering"]
  JUMPIFNOT R3 [+85]
  GETTABLEKS R4 R1 K0 ["Parent"]
  JUMPIFNOT R4 [+10]
  GETTABLEKS R4 R1 K0 ["Parent"]
  ...
  MOVE R5 R3
  CALL R4 1 1
  NAMECALL R5 R1 K15 ["GetStringUniqueId"]
  CALL R5 1 1
  NAMECALL R6 R3 K15 ["GetStringUniqueId"]
  CALL R6 1 1
  JUMPIFNOTEQ R5 R6 [+4]
  SETTABLEKS R4 R2 K27 ["TaggedUsersInThread"]
  JUMP [+9]
  GETUPVAL R6 0
  GETTABLEKS R5 R6 K28 ["syncStandaloneAnnotation"]
  MOVE R6 R0
  MOVE R7 R3
  DUPTABLE R8 K29 [{"TaggedUsersInThread"}]
  SETTABLEKS R4 R8 K27 ["TaggedUsersInThread"]
  CALL R5 3 0
  GETTABLEKS R5 R1 K13 ["TaggedUsers"]
  JUMPIFEQKNIL R5 [+13]
  LOADK R7 K13 ["TaggedUsers"]
  NAMECALL R5 R1 K24 ["GetPropertyChangedSignal"]
  CALL R5 2 1
  NEWCLOSURE R7 P3
  CAPTURE UPVAL U3
  CAPTURE VAL R1
  ...
  CALL R5 2 0
  NAMECALL R5 R1 K30 ["GetChildren"]
  CALL R5 1 3
  FORGPREP R5
  GETTABLEKS R10 R9 K31 ["RequestCompleted"]
  NEWCLOSURE R12 P4
  CAPTURE UPVAL U4
  CAPTURE VAL R9
  CAPTURE UPVAL U0
  ...
  CALL R10 2 0
  GETTABLEKS R10 R9 K13 ["TaggedUsers"]
  JUMPIFEQKNIL R10 [+13]
  LOADK R12 K13 ["TaggedUsers"]
  NAMECALL R10 R9 K24 ["GetPropertyChangedSignal"]
  CALL R10 2 1
  NEWCLOSURE R12 P5
  CAPTURE UPVAL U5
  CAPTURE VAL R1
  ...
  CALL R10 2 0
  FORGLOOP R5 2 [-27]
  GETTABLEKS R3 R1 K32 ["RequestInitiated"]
  NEWCLOSURE R5 P6
  CAPTURE UPVAL U0
  CAPTURE VAL R0
  CAPTURE VAL R1
  ...
  NAMECALL R3 R3 K25 ["Connect"]
  CALL R3 2 0
  GETTABLEKS R3 R1 K31 ["RequestCompleted"]
  NEWCLOSURE R5 P7
  CAPTURE UPVAL U0
  CAPTURE VAL R0
  CAPTURE VAL R1
  ...
  NAMECALL R3 R3 K25 ["Connect"]
  CALL R3 2 0
  GETTABLEKS R3 R1 K33 ["Destroying"]
  NEWCLOSURE R5 P8
  CAPTURE VAL R0
  CAPTURE VAL R1
  NAMECALL R3 R3 K34 ["Once"]
  CALL R3 2 0
  LOADK R5 K35 ["CreateAnnotation"]
  MOVE R6 R2
  NAMECALL R3 R0 K36 ["Invoke"]
  CALL R3 3 0
  RETURN R0 0
...
MAIN:
  ...
  CALL R9 1 1
  GETTABLEKS R8 R9 K19 ["MaybeUpdateTaggedUsersInThreadFromRequest"]
  GETIMPORT R10 K5 [require]
  GETTABLEKS R13 R0 K9 ["Src"]
  GETTABLEKS R12 R13 K14 ["Util"]
  GETTABLEKS R11 R12 K17 ["TaggedUsersUtils"]
  CALL R10 1 1
  GETTABLEKS R9 R10 K20 ["UpdateAnnotationOrParentTaggedUsersInThread"]
  GETIMPORT R11 K5 [require]
  GETTABLEKS R14 R0 K9 ["Src"]
  GETTABLEKS R13 R14 K14 ["Util"]
  GETTABLEKS R12 R13 K17 ["TaggedUsersUtils"]
  CALL R11 1 1
  GETTABLEKS R10 R11 K21 ["UpdateAnnotationTaggedUsersInThread"]
  GETIMPORT R11 K5 [require]
  GETTABLEKS R13 R0 K9 ["Src"]
  ...
  SETTABLEKS R13 R12 K24 ["setAnnotationResolved"]
  DUPCLOSURE R13 K25 [PROTO_1]
  SETTABLEKS R13 R12 K26 ["beginAddAnnotation"]
  DUPCLOSURE R13 K27 [PROTO_2]
  SETTABLEKS R13 R12 K28 ["zoomTo"]
  DUPCLOSURE R13 K29 [PROTO_3]
  SETTABLEKS R13 R12 K30 ["deleteAnnotation"]
  DUPCLOSURE R13 K31 [PROTO_4]
  SETTABLEKS R13 R12 K32 ["loadResolvedAnnotations"]
  DUPCLOSURE R13 K33 [PROTO_5]
  SETTABLEKS R13 R12 K34 ["setVisibility"]
  NEWTABLE R13 8 0
  DUPCLOSURE R14 K35 [PROTO_6]
  SETTABLEKS R14 R13 K36 ["syncStandaloneAnnotation"]
  ...
  CAPTURE VAL R4
  CAPTURE VAL R6
  SETTABLEKS R14 R13 K38 ["createAnnotation"]
  DUPCLOSURE R14 K39 [PROTO_18]
  SETTABLEKS R14 R13 K40 ["selectionChanged"]
  DUPCLOSURE R14 K41 [PROTO_19]
  SETTABLEKS R14 R13 K24 ["setAnnotationResolved"]
  DUPCLOSURE R14 K42 [PROTO_20]
  SETTABLEKS R14 R13 K30 ["deleteAnnotation"]
  DUPCLOSURE R14 K43 [PROTO_21]
  SETTABLEKS R14 R13 K28 ["zoomTo"]
  NEWTABLE R14 2 0
  DUPCLOSURE R15 K44 [PROTO_22]
  SETTABLEKS R15 R14 K45 ["DEPRECATED_editAnnotation"]
  DUPCLOSURE R15 K46 [PROTO_23]
  SETTABLEKS R15 R14 K47 ["editAnnotation"]
  DUPTABLE R15 K51 [{"Standalone", "Edit", "Shared"}]
  SETTABLEKS R12 R15 K48 ["Standalone"]
  SETTABLEKS R13 R15 K49 ["Edit"]
  SETTABLEKS R14 R15 K50 ["Shared"]
  RETURN R15 1
