...
PROTO_18:
  ...
  CALL R6 1 3
  FORGPREP R6
  GETTABLEKS R11 R10 K31 ["RequestCompleted"]
  NEWCLOSURE R13 P4
  CAPTURE UPVAL U4
  CAPTURE VAL R10
  CAPTURE VAL R1
  ...
  CALL R11 2 0
  FORGLOOP R6 2 [-28]
  GETTABLEKS R4 R1 K32 ["RequestInitiated"]
  NEWCLOSURE R6 P6
  CAPTURE UPVAL U0
  CAPTURE VAL R0
  CAPTURE VAL R1
  ...
  NAMECALL R4 R4 K25 ["Connect"]
  CALL R4 2 0
  GETTABLEKS R4 R1 K31 ["RequestCompleted"]
  NEWCLOSURE R6 P7
  CAPTURE UPVAL U0
  CAPTURE VAL R0
  CAPTURE VAL R1
...
MAIN:
  ...
  SETTABLEKS R14 R13 K36 ["endAddAnnotation"]
  DUPCLOSURE R14 K37 [PROTO_7]
  SETTABLEKS R14 R13 K38 ["syncStandaloneAnnotation"]
  ...
  CAPTURE VAL R4
  CAPTURE VAL R6
  SETTABLEKS R14 R13 K40 ["createAnnotation"]
  DUPCLOSURE R14 K41 [PROTO_19]
  SETTABLEKS R14 R13 K42 ["selectionChanged"]
  DUPCLOSURE R14 K43 [PROTO_20]
  SETTABLEKS R14 R13 K24 ["setAnnotationResolved"]
  DUPCLOSURE R14 K44 [PROTO_21]
  SETTABLEKS R14 R13 K30 ["deleteAnnotation"]
  DUPCLOSURE R14 K45 [PROTO_22]
  SETTABLEKS R14 R13 K28 ["zoomTo"]
  NEWTABLE R14 2 0
  DUPCLOSURE R15 K46 [PROTO_23]
  SETTABLEKS R15 R14 K47 ["DEPRECATED_editAnnotation"]
  DUPCLOSURE R15 K48 [PROTO_24]
  SETTABLEKS R15 R14 K49 ["editAnnotation"]
  DUPTABLE R15 K53 [{"Standalone", "Edit", "Shared"}]
  SETTABLEKS R12 R15 K50 ["Standalone"]
  SETTABLEKS R13 R15 K51 ["Edit"]
  SETTABLEKS R14 R15 K52 ["Shared"]
  RETURN R15 1
