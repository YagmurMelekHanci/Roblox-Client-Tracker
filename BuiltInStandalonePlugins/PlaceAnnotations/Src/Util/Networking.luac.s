...
PROTO_3:
  ...
  SETTABLE R4 R2 R3
  GETUPVAL R4 0
  GETTABLEKS R3 R4 K4 ["GROUPS_INFO_TEST_URL"]
  LOADK R4 K5 ["{\"memberCount\":3}"]
  SETTABLE R4 R2 R3
  SETTABLEKS R2 R0 K6 ["apis"]
  JUMPIFNOT R1 [+10]
  MOVE R2 R1
  LOADNIL R3
  LOADNIL R4
  FORGPREP R2
  GETTABLEKS R7 R0 K6 ["apis"]
  GETTABLE R8 R1 R5
  SETTABLE R8 R7 R5
  FORGLOOP R2 1 [-5]
  RETURN R0 0
...
MAIN:
  ...
  SETTABLE R10 R8 R9
  GETTABLEKS R9 R6 K23 ["GROUPS_INFO_TEST_URL"]
  LOADK R10 K24 ["{\"memberCount\":3}"]
  SETTABLE R10 R8 R9
  SETTABLEKS R8 R7 K17 ["apis"]
  DUPCLOSURE R8 K25 [PROTO_0]
  CAPTURE VAL R7
  SETTABLEKS R8 R7 K26 ["new"]
  DUPCLOSURE R8 K27 [PROTO_1]
  SETTABLEKS R8 R7 K28 ["parseJson"]
  DUPCLOSURE R8 K29 [PROTO_2]
  CAPTURE VAL R3
  SETTABLEKS R8 R7 K30 ["request"]
  DUPCLOSURE R8 K31 [PROTO_3]
  CAPTURE VAL R6
  LOADNIL R9
  DUPTABLE R10 K33 [{"Networking", "mock"}]
  GETTABLEKS R12 R2 K34 ["isCli"]
  CALL R12 0 1
  JUMPIFNOT R12 [+2]
  MOVE R11 R7
  JUMP [+1]
