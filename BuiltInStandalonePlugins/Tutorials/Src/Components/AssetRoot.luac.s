...
PROTO_7:
  ...
  GETIMPORT R5 K40 [game]
  MOVE R6 R3
  GETTABLEKS R7 R0 K25 ["localization"]
  GETTABLEKS R8 R0 K31 ["toolboxConnection"]
  GETTABLEKS R9 R1 K41 ["Plugin"]
  CALL R4 5 1
  SETTABLEKS R4 R0 K42 ["tutorial"]
  GETTABLEKS R6 R0 K42 ["tutorial"]
  NAMECALL R4 R0 K43 ["loadTutorial"]
  CALL R4 2 0
  NEWCLOSURE R3 P2
  CAPTURE VAL R0
  SETTABLEKS R3 R0 K44 ["onBack"]
  NEWCLOSURE R3 P3
  CAPTURE VAL R0
  SETTABLEKS R3 R0 K45 ["onNext"]
  DUPCLOSURE R3 K46 [PROTO_5]
  CAPTURE UPVAL U8
  SETTABLEKS R3 R0 K47 ["onQuit"]
  NEWCLOSURE R3 P5
  CAPTURE VAL R0
  SETTABLEKS R3 R0 K48 ["onSelectTopic"]
  RETURN R0 0
...
MAIN:
  ...
  GETTABLEKS R33 R30 K48 ["TourWidget"]
  CALL R32 1 1
  GETTABLEKS R33 R1 K49 ["PureComponent"]
  LOADK R35 K50 ["AssetRoot"]
  ...
  DUPCLOSURE R34 K54 [PROTO_9]
  SETTABLEKS R34 R33 K55 ["didMount"]
  DUPCLOSURE R34 K56 [PROTO_10]
  SETTABLEKS R34 R33 K57 ["createWidget"]
  DUPCLOSURE R34 K58 [PROTO_11]
  SETTABLEKS R34 R33 K59 ["willUnmount"]
  DUPCLOSURE R34 K60 [PROTO_21]
  CAPTURE VAL R1
  CAPTURE VAL R9
  CAPTURE VAL R18
  CAPTURE VAL R20
  ...
  CAPTURE VAL R8
  CAPTURE VAL R22
  SETTABLEKS R34 R33 K61 ["loadTutorial"]
  DUPCLOSURE R34 K62 [PROTO_25]
  CAPTURE VAL R1
  CAPTURE VAL R32
  CAPTURE VAL R14
  CAPTURE VAL R16
