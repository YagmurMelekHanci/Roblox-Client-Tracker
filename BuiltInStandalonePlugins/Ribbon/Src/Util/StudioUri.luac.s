...
MAIN:
  ...
  CAPTURE VAL R3
  SETTABLEKS R5 R4 K10 ["toString"]
  DUPCLOSURE R5 K11 [PROTO_1]
  SETTABLEKS R5 R4 K12 ["equals"]
  DUPCLOSURE R5 K13 [PROTO_2]
  CAPTURE VAL R2
  SETTABLEKS R5 R4 K14 ["child"]
  DUPCLOSURE R5 K15 [PROTO_3]
  SETTABLEKS R5 R4 K16 ["isNull"]
  DUPCLOSURE R5 K17 [PROTO_4]
  SETTABLEKS R5 R4 K18 ["isValid"]
  DUPCLOSURE R5 K19 [PROTO_5]
  SETTABLEKS R5 R4 K20 ["fromAction"]
  DUPCLOSURE R5 K21 [PROTO_6]
  SETTABLEKS R5 R4 K22 ["fromSetting"]
  DUPCLOSURE R5 K23 [PROTO_7]
  SETTABLEKS R5 R4 K24 ["fromWidget"]
  RETURN R4 1
