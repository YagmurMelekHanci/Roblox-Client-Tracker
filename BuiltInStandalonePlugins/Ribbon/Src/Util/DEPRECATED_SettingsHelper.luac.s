...
MAIN:
  ...
  GETTABLEKS R11 R12 K20 ["getFFlagTestingControlsOptOut"]
  CALL R10 1 1
  CALL R10 0 1
  NEWTABLE R11 0 14
  DUPTABLE R12 K26 [{"Uri", "Text", "Tooltip", "Enabled", "Value"}]
  MOVE R13 R3
  LOADK R14 K27 ["BuilderTools"]
  LOADK R15 K28 ["PartShape"]
  CALL R13 2 1
  SETTABLEKS R13 R12 K21 ["Uri"]
  LOADK R13 K29 ["Setting_Part"]
  ...
  MOVE R14 R3
  LOADK R15 K27 ["BuilderTools"]
  LOADK R16 K31 ["EffectType"]
  CALL R14 2 1
  SETTABLEKS R14 R13 K21 ["Uri"]
  LOADK R14 K32 ["Setting_Effect"]
  ...
  MOVE R15 R3
  LOADK R16 K27 ["BuilderTools"]
  LOADK R17 K33 ["ConstraintType"]
  CALL R15 2 1
  SETTABLEKS R15 R14 K21 ["Uri"]
  LOADK R15 K34 ["Setting_Constraint"]
  ...
  LOADK R18 K36 ["CreateScript"]
  CALL R16 2 1
  SETTABLEKS R16 R15 K21 ["Uri"]
  LOADK R16 K37 ["Setting_Script"]
  SETTABLEKS R16 R15 K22 ["Text"]
  LOADK R16 K38 ["Tooltip_Script"]
  ...
  MOVE R17 R3
  LOADK R18 K27 ["BuilderTools"]
  LOADK R19 K39 ["Group"]
  CALL R17 2 1
  SETTABLEKS R17 R16 K21 ["Uri"]
  LOADK R17 K40 ["Setting_Group"]
  SETTABLEKS R17 R16 K22 ["Text"]
  LOADK R17 K41 ["Tooltip_Group"]
  ...
  LOADK R20 K42 ["FormatScript"]
  CALL R18 2 1
  SETTABLEKS R18 R17 K21 ["Uri"]
  LOADK R18 K43 ["Setting_Format"]
  SETTABLEKS R18 R17 K22 ["Text"]
  LOADK R18 K44 ["Tooltip_Format"]
  ...
  MOVE R19 R3
  LOADK R20 K35 ["ScriptTools"]
  LOADK R21 K45 ["Find"]
  CALL R19 2 1
  SETTABLEKS R19 R18 K21 ["Uri"]
  LOADK R19 K46 ["Setting_Find"]
  ...
  MOVE R20 R3
  LOADK R21 K27 ["BuilderTools"]
  LOADK R22 K47 ["InsertGui"]
  CALL R20 2 1
  SETTABLEKS R20 R19 K21 ["Uri"]
  LOADK R20 K48 ["Setting_GUI"]
  SETTABLEKS R20 R19 K22 ["Text"]
  LOADK R20 K49 ["Tooltip_GUI"]
  ...
  MOVE R21 R3
  LOADK R22 K27 ["BuilderTools"]
  LOADK R23 K50 ["InsertUIFrame"]
  CALL R21 2 1
  SETTABLEKS R21 R20 K21 ["Uri"]
  LOADK R21 K51 ["Setting_Frame"]
  ...
  MOVE R22 R3
  LOADK R23 K27 ["BuilderTools"]
  LOADK R24 K52 ["InsertUILabel"]
  CALL R22 2 1
  SETTABLEKS R22 R21 K21 ["Uri"]
  LOADK R22 K53 ["Setting_Label"]
  ...
  MOVE R23 R3
  LOADK R24 K27 ["BuilderTools"]
  LOADK R25 K54 ["InsertUIInput"]
  CALL R23 2 1
  SETTABLEKS R23 R22 K21 ["Uri"]
  LOADK R23 K55 ["Setting_Input"]
  ...
  MOVE R24 R3
  LOADK R25 K27 ["BuilderTools"]
  LOADK R26 K56 ["InsertUIAppearance"]
  CALL R24 2 1
  SETTABLEKS R24 R23 K21 ["Uri"]
  LOADK R24 K57 ["Setting_Appearance"]
  ...
  MOVE R25 R3
  LOADK R26 K27 ["BuilderTools"]
  LOADK R27 K58 ["InsertUILayout"]
  CALL R25 2 1
  SETTABLEKS R25 R24 K21 ["Uri"]
  LOADK R25 K59 ["Setting_Layout"]
  ...
  MOVE R26 R3
  LOADK R27 K27 ["BuilderTools"]
  LOADK R28 K60 ["InsertUIConstraint"]
  CALL R26 2 1
  SETTABLEKS R26 R25 K21 ["Uri"]
  LOADK R26 K61 ["Setting_UIConstraint"]
  ...
  DUPTABLE R14 K26 [{"Uri", "Text", "Tooltip", "Enabled", "Value"}]
  MOVE R15 R3
  LOADK R16 K62 ["RunTools"]
  LOADK R17 K63 ["RunMode"]
  CALL R15 2 1
  SETTABLEKS R15 R14 K21 ["Uri"]
  LOADK R15 K64 ["Setting_RunMode"]
  SETTABLEKS R15 R14 K22 ["Text"]
  LOADK R15 K30 [""]
  SETTABLEKS R15 R14 K23 ["Tooltip"]
  LOADB R15 1
