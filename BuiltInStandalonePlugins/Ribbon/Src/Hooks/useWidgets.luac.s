...
MAIN:
  ...
  LOADK R11 K25 ["BugFixWhichIsAUseWidgets"]
  LOADB R12 0
  NAMECALL R9 R9 K26 ["DefineFastFlag"]
  CALL R9 3 1
  DUPTABLE R10 K32 [{"Widgets", "pendingRegisters", "pendingDeregisters", "registeredWidgets", "running"}]
  LOADNIL R11
  SETTABLEKS R11 R10 K27 ["Widgets"]
  NEWTABLE R11 0 0
  SETTABLEKS R11 R10 K28 ["pendingRegisters"]
  NEWTABLE R11 0 0
  SETTABLEKS R11 R10 K29 ["pendingDeregisters"]
  NEWTABLE R11 0 0
  SETTABLEKS R11 R10 K30 ["registeredWidgets"]
  LOADB R11 0
  SETTABLEKS R11 R10 K31 ["running"]
  DUPCLOSURE R11 K33 [PROTO_1]
  CAPTURE VAL R3
  CAPTURE VAL R10
  CAPTURE VAL R2
  SETTABLEKS R11 R10 K34 ["flush"]
  ...
  CAPTURE VAL R7
  CAPTURE VAL R10
  SETTABLEKS R11 R10 K38 ["register"]
  DUPCLOSURE R11 K39 [PROTO_5]
  CAPTURE VAL R7
  CAPTURE VAL R10
  SETTABLEKS R11 R10 K40 ["deregister"]
  DUPCLOSURE R11 K41 [PROTO_6]
  CAPTURE VAL R6
  CAPTURE VAL R10
  RETURN R11 1
