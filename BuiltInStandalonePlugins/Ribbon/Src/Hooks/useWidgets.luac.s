...
MAIN:
  ...
  LOADK R10 K20 ["BugFixWhichIsAUseWidgets"]
  LOADB R11 0
  NAMECALL R8 R8 K21 ["DefineFastFlag"]
  CALL R8 3 1
  DUPTABLE R9 K27 [{"Widgets", "pendingRegisters", "pendingDeregisters", "registeredWidgets", "running"}]
  LOADNIL R10
  SETTABLEKS R10 R9 K22 ["Widgets"]
  NEWTABLE R10 0 0
  SETTABLEKS R10 R9 K23 ["pendingRegisters"]
  NEWTABLE R10 0 0
  SETTABLEKS R10 R9 K24 ["pendingDeregisters"]
  NEWTABLE R10 0 0
  SETTABLEKS R10 R9 K25 ["registeredWidgets"]
  LOADB R10 0
  SETTABLEKS R10 R9 K26 ["running"]
  DUPCLOSURE R10 K28 [PROTO_1]
  CAPTURE VAL R3
  CAPTURE VAL R9
  CAPTURE VAL R2
  SETTABLEKS R10 R9 K29 ["flush"]
  DUPCLOSURE R10 K30 [PROTO_3]
  CAPTURE VAL R9
  SETTABLEKS R10 R9 K31 ["run"]
  DUPCLOSURE R10 K32 [PROTO_4]
  CAPTURE VAL R8
  CAPTURE VAL R7
  CAPTURE VAL R9
  SETTABLEKS R10 R9 K33 ["register"]
  DUPCLOSURE R10 K34 [PROTO_5]
  CAPTURE VAL R7
  CAPTURE VAL R9
  SETTABLEKS R10 R9 K35 ["deregister"]
