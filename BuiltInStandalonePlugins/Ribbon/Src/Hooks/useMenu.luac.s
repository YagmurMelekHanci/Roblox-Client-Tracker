...
PROTO_9:
  ...
  GETUPVAL R11 6
  JUMPIFNOT R11 [+12]
  GETTABLEKS R11 R9 K11 ["closeTime"]
  JUMPIFNOT R11 [+9]
  GETIMPORT R11 K14 [os.clock]
  CALL R11 0 1
  GETTABLEKS R13 R9 K11 ["closeTime"]
  ADDK R12 R13 K15 [0.5]
  JUMPIFNOTLT R11 R12 [+2]
  RETURN R0 0
  GETUPVAL R11 6
  JUMPIFNOT R11 [+11]
  GETUPVAL R12 7
  FASTCALL2K ASSERT R12 K16 [+4]
  LOADK R13 K16 ["TooltipSettings is not imported"]
  GETIMPORT R11 K18 [assert]
  CALL R11 2 0
  GETUPVAL R12 7
  GETTABLEKS R11 R12 K19 ["cancelShowTooltip"]
  CALL R11 0 0
  GETTABLEKS R11 R9 K20 ["root"]
  GETUPVAL R14 8
  GETTABLEKS R13 R14 K21 ["provide"]
  NEWTABLE R14 0 4
  GETUPVAL R15 9
  GETUPVAL R16 10
  GETUPVAL R17 2
  ...
  DUPTABLE R19 K24 [{"depth", "menuOnLeft"}]
  SETTABLEKS R4 R19 K1 ["depth"]
  MOVE R20 R3
  JUMPIF R20 [+3]
  GETUPVAL R21 1
  GETTABLEKS R20 R21 K23 ["menuOnLeft"]
  SETTABLEKS R20 R19 K23 ["menuOnLeft"]
  CALL R18 1 -1
  SETLIST R14 R15 -1 [1]
  DUPTABLE R15 K26 [{"Main"}]
  GETUPVAL R17 12
  ...
  GETUPVAL R21 13
  JUMPIFNOT R21 [+2]
  LOADK R20 K30 ["Role-Menu X-Fill"]
  JUMP [+1]
  LOADK R20 K31 ["Role-Surface100 X-Fill X-PadTabMenu"]
  ...
  CAPTURE VAL R10
  CAPTURE VAL R8
  SETTABLEKS R23 R22 K38 ["OnResize"]
  GETUPVAL R24 12
  GETTABLEKS R23 R24 K29 ["Tag"]
  LOADK R24 K39 ["X-RowSpace150 X-Top X-Fit"]
  ...
  DUPTABLE R22 K41 [{"StyleSheet"}]
  GETUPVAL R23 9
  NAMECALL R23 R23 K2 ["get"]
  CALL R23 1 1
  SETTABLEKS R23 R22 K40 ["StyleSheet"]
  CALL R20 2 1
  SETTABLEKS R20 R19 K33 ["StyleLink"]
  CALL R16 3 1
  SETTABLEKS R16 R15 K25 ["Main"]
  CALL R13 2 -1
  NAMECALL R11 R11 K42 ["render"]
  CALL R11 -1 0
  GETUPVAL R11 3
  DUPTABLE R12 K47 [{"TargetWidgetUri", "TargetAnchorPoint", "SubjectAnchorPoint", "Offset"}]
  SETTABLEKS R1 R12 K43 ["TargetWidgetUri"]
  GETIMPORT R13 K49 [Vector2.new]
  LOADN R14 0
  LOADN R15 1
  CALL R13 2 1
  SETTABLEKS R13 R12 K44 ["TargetAnchorPoint"]
  GETIMPORT R13 K49 [Vector2.new]
  LOADN R14 0
  LOADN R15 0
  CALL R13 2 1
  SETTABLEKS R13 R12 K45 ["SubjectAnchorPoint"]
  GETIMPORT R13 K49 [Vector2.new]
  LOADN R14 0
  LOADN R15 0
  CALL R13 2 1
  SETTABLEKS R13 R12 K46 ["Offset"]
  MOVE R13 R2
  CALL R11 2 1
  MOVE R14 R8
  MOVE R15 R11
...
MAIN:
  ...
  GETTABLEKS R13 R12 K22 ["Localization"]
  ...
  GETTABLEKS R16 R17 K25 ["DesignContext"]
  CALL R15 1 1
  GETIMPORT R16 K5 [require]
  GETTABLEKS R19 R0 K12 ["Src"]
  GETTABLEKS R18 R19 K26 ["Hooks"]
  GETTABLEKS R17 R18 K27 ["MenuSettings"]
  CALL R16 1 1
  JUMPIFNOT R7 [+10]
  GETIMPORT R17 K5 [require]
  GETTABLEKS R20 R0 K12 ["Src"]
  GETTABLEKS R19 R20 K26 ["Hooks"]
  GETTABLEKS R18 R19 K28 ["TooltipSettings"]
  CALL R17 1 1
  JUMP [+1]
  LOADNIL R17
  GETTABLEKS R18 R16 K29 ["menus"]
  GETTABLEKS R19 R12 K30 ["ContextItem"]
  LOADK R22 K31 ["Menu"]
  NAMECALL R20 R19 K32 ["createSimple"]
  CALL R20 2 1
  GETIMPORT R21 K5 [require]
  GETTABLEKS R24 R0 K12 ["Src"]
  GETTABLEKS R23 R24 K13 ["SharedFlags"]
  GETTABLEKS R22 R23 K33 ["getFFlagMaterialPickerRenameGrabsMouseProp"]
  CALL R21 1 1
  JUMPIFNOT R6 [+2]
  LOADN R22 20
  JUMP [+1]
