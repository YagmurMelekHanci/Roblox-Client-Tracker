...
PROTO_1:
  ...
  LOADNIL R6
  SETTABLEKS R6 R5 K4 ["controls"]
  GETTABLEKS R6 R5 K5 ["onClose"]
  JUMPIFNOT R6 [+3]
  GETTABLEKS R6 R5 K5 ["onClose"]
  CALL R6 0 0
  GETTABLEKS R6 R5 K6 ["root"]
  LOADNIL R8
  NAMECALL R6 R6 K7 ["render"]
  CALL R6 2 0
  GETIMPORT R6 K10 [task.spawn]
  NEWCLOSURE R7 P0
  CAPTURE VAL R5
  CALL R6 1 0
  FORGLOOP R1 2 [-38]
...
PROTO_8:
  ...
  SETTABLEKS R0 R9 K46 ["controls"]
  GETUPVAL R12 14
  DUPTABLE R13 K49 [{"isOpen", "widgetUriString"}]
  LOADB R14 1
  SETTABLEKS R14 R13 K47 ["isOpen"]
  GETUPVAL R15 15
  GETTABLEKS R14 R15 K50 ["toString"]
  MOVE R15 R1
  CALL R14 1 1
  SETTABLEKS R14 R13 K48 ["widgetUriString"]
  CALL R12 1 0
  GETIMPORT R12 K53 [task.defer]
  NEWCLOSURE R13 P1
  CAPTURE VAL R5
  CAPTURE UPVAL U15
  CAPTURE VAL R1
