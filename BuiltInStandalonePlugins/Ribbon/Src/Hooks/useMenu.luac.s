...
PROTO_9:
  ...
  GETUPVAL R24 16
  LOADK R25 K39 ["X-RowSpace150 X-Top X-Fit"]
  GETUPVAL R27 17
  CALL R27 0 1
  JUMPIFNOT R27 [+9]
  LOADK R27 K40 ["data-testid=%*"]
  GETUPVAL R29 18
  MOVE R30 R1
  CALL R29 1 1
  NAMECALL R27 R27 K5 ["format"]
  CALL R27 2 1
  MOVE R26 R27
  JUMP [+1]
  LOADNIL R26
...
MAIN:
  ...
  GETTABLEKS R13 R5 K22 ["ContextServices"]
  GETTABLEKS R14 R13 K23 ["Localization"]
  GETTABLEKS R15 R13 K24 ["Plugin"]
  JUMPIFNOT R6 [+3]
  GETTABLEKS R16 R13 K25 ["Design"]
  JUMP [+9]
  ...
  CALL R16 1 1
  GETTABLEKS R17 R5 K27 ["Styling"]
  GETTABLEKS R18 R17 K28 ["joinTags"]
  GETIMPORT R19 K5 [require]
  GETTABLEKS R22 R0 K12 ["Src"]
  GETTABLEKS R21 R22 K29 ["Hooks"]
  GETTABLEKS R20 R21 K30 ["MenuSettings"]
  CALL R19 1 1
  JUMPIFNOT R7 [+10]
  GETIMPORT R20 K5 [require]
  GETTABLEKS R23 R0 K12 ["Src"]
  GETTABLEKS R22 R23 K29 ["Hooks"]
  GETTABLEKS R21 R22 K31 ["TooltipSettings"]
  CALL R20 1 1
  JUMP [+1]
  LOADNIL R20
  GETTABLEKS R21 R19 K32 ["menus"]
  GETTABLEKS R22 R13 K33 ["ContextItem"]
  LOADK R25 K34 ["Menu"]
  NAMECALL R23 R22 K35 ["createSimple"]
  CALL R23 2 1
  GETIMPORT R24 K5 [require]
  GETTABLEKS R27 R0 K12 ["Src"]
  GETTABLEKS R26 R27 K13 ["SharedFlags"]
  GETTABLEKS R25 R26 K36 ["getFFlagMaterialPickerRenameGrabsMouseProp"]
  CALL R24 1 1
  GETIMPORT R25 K5 [require]
  GETTABLEKS R28 R0 K12 ["Src"]
  GETTABLEKS R27 R28 K13 ["SharedFlags"]
  GETTABLEKS R26 R27 K37 ["getFFlagRibbonAddTestIds"]
  CALL R25 1 1
  JUMPIFNOT R6 [+2]
  LOADN R26 20
  JUMP [+1]
