...
PROTO_13:
  ...
  GETTABLEKS R11 R9 K2 ["Uri"]
  CALL R10 1 1
  SETTABLE R9 R4 R10
  FORGLOOP R5 2 [-8]
  GETUPVAL R5 7
  MOVE R7 R1
  NAMECALL R5 R5 K0 ["GetAsync"]
  CALL R5 2 1
  NEWTABLE R6 0 0
  MOVE R7 R5
  LOADNIL R8
  ...
  FORGLOOP R7 2 [-8]
  GETUPVAL R7 8
  DUPTABLE R8 K6 [{"Controls", "Actions", "Settings"}]
  GETUPVAL R9 5
  SETTABLEKS R9 R8 K3 ["Controls"]
  SETTABLEKS R4 R8 K4 ["Actions"]
  SETTABLEKS R6 R8 K5 ["Settings"]
  CALL R7 1 0
  NEWTABLE R7 0 0
  NEWCLOSURE R8 P1
  CAPTURE UPVAL U8
  ...
  LENGTH R17 R7
  LOADN R18 0
  JUMPIFNOTLT R18 R17 [+5]
  GETIMPORT R17 K9 [task.defer]
  MOVE R18 R16
  CALL R17 1 0
  NEWCLOSURE R17 P6
  CAPTURE VAL R9
...
MAIN:
  ...
  CALL R9 1 1
  GETTABLEKS R10 R9 K22 ["filter"]
  GETIMPORT R11 K5 [require]
  GETTABLEKS R14 R0 K8 ["Src"]
  GETTABLEKS R13 R14 K13 ["Util"]
  GETTABLEKS R12 R13 K23 ["isControlEnabledFromFlags"]
  CALL R11 1 1
