...
PROTO_4:
  ...
  GETUPVAL R9 4
  LOADK R10 K9 ["Role-Surface X-PadTooltip X-RowSpace50 X-FitY X-Middle"]
  GETUPVAL R12 5
  CALL R12 0 1
  JUMPIFNOT R12 [+10]
  ...
  DUPTABLE R8 K18 [{"Icon", "Content"}]
  GETTABLEKS R10 R0 K2 ["Icon"]
  JUMPIFNOT R10 [+25]
  GETUPVAL R10 3
  GETTABLEKS R9 R10 K3 ["createElement"]
  LOADK R10 K19 ["ImageLabel"]
  DUPTABLE R11 K23 [{"Image", "BackgroundTransparency", "Size", "LayoutOrder"}]
  ...
  LOADK R13 K26 ["Role-Surface X-Fit X-ColumnSpace25"]
  SETTABLE R13 R11 R12
  DUPTABLE R12 K28 [{"TitleFrame", "Text"}]
  GETUPVAL R14 3
  ...
  LOADK R17 K29 ["Role-Surface X-Fit X-RowSpace50"]
  SETTABLE R17 R15 R16
  DUPTABLE R16 K31 [{"Title", "Shortcuts"}]
  ...
  LOADK R21 K33 ["X-Fit Text-Title"]
  SETTABLE R21 R19 R20
  CALL R17 2 1
  JUMP [+1]
  LOADNIL R17
  SETTABLEKS R17 R16 K0 ["Title"]
  GETTABLEKS R18 R0 K30 ["Shortcuts"]
  JUMPIFNOT R18 [+39]
  GETUPVAL R18 3
  GETTABLEKS R17 R18 K3 ["createElement"]
  LOADK R18 K32 ["TextLabel"]
  ...
  CALL R20 0 1
  SETTABLEKS R20 R19 K22 ["LayoutOrder"]
  GETTABLEKS R21 R0 K30 ["Shortcuts"]
  LOADK R22 K34 [""]
  ...
  GETUPVAL R21 3
  GETTABLEKS R20 R21 K8 ["Tag"]
  LOADK R21 K38 ["X-Fit Text-Label"]
  SETTABLE R21 R19 R20
  CALL R17 2 1
  JUMP [+1]
  LOADNIL R17
  SETTABLEKS R17 R16 K30 ["Shortcuts"]
  CALL R13 3 1
  SETTABLEKS R13 R12 K27 ["TitleFrame"]
  ...
  GETUPVAL R17 3
  GETTABLEKS R16 R17 K8 ["Tag"]
  LOADK R17 K39 ["Text-Label X-Fit TooltipTextBounds"]
  SETTABLE R17 R15 R16
  CALL R13 2 1
  JUMP [+1]
  LOADNIL R13
  ...
  LOADK R10 K40 ["Role-Tooltip X-Fill"]
  SETTABLE R10 R8 R9
  DUPTABLE R9 K43 [{"Wrapper", "StyleLink"}]
  SETTABLEKS R5 R9 K41 ["Wrapper"]
  GETUPVAL R11 3
  GETTABLEKS R10 R11 K3 ["createElement"]
  LOADK R11 K42 ["StyleLink"]
  DUPTABLE R12 K45 [{"StyleSheet"}]
  GETTABLEKS R13 R0 K46 ["Design"]
  SETTABLEKS R13 R12 K44 ["StyleSheet"]
  CALL R10 2 1
  SETTABLEKS R10 R9 K42 ["StyleLink"]
  CALL R6 3 -1
  RETURN R6 -1
...
PROTO_8:
  ...
  CALL R4 2 1
  LOADK R7 K6 ["Panels"]
  NAMECALL R5 R0 K8 ["GetPluginComponent"]
  CALL R5 2 1
  GETUPVAL R6 2
  GETUPVAL R9 3
  ...
  GETUPVAL R10 5
  MOVE R11 R1
  DUPTABLE R12 K12 [{"Design", "OnResize"}]
  SETTABLEKS R2 R12 K10 ["Design"]
  NEWCLOSURE R13 P0
  CAPTURE VAL R5
  CAPTURE VAL R4
  SETTABLEKS R13 R12 K11 ["OnResize"]
  CALL R10 2 -1
  CALL R8 -1 -1
  ...
  LOADN R9 0
  CALL R7 2 1
  GETTABLEKS R8 R1 K17 ["Location"]
  JUMPIFNOT R8 [+67]
  GETTABLEKS R8 R1 K17 ["Location"]
  JUMPIFNOTEQKS R8 K18 ["Above"] [+14]
  ...
  MOVE R7 R8
  MOVE R10 R4
  DUPTABLE R11 K27 [{"TargetWidgetUri", "TargetAnchorPoint", "SubjectAnchorPoint", "Offset", "AutoHide"}]
  GETTABLEKS R12 R1 K28 ["Uri"]
  SETTABLEKS R12 R11 K22 ["TargetWidgetUri"]
  SETTABLEKS R6 R11 K23 ["TargetAnchorPoint"]
  SETTABLEKS R7 R11 K24 ["SubjectAnchorPoint"]
  GETIMPORT R12 K16 [Vector2.new]
  LOADN R13 0
  LOADN R14 0
  CALL R12 2 1
  SETTABLEKS R12 R11 K25 ["Offset"]
  GETUPVAL R13 6
  JUMPIFNOT R13 [+2]
  LOADB R12 1
  JUMP [+1]
  LOADNIL R12
  SETTABLEKS R12 R11 K26 ["AutoHide"]
  NAMECALL R8 R5 K29 ["SetAttachmentAsync"]
  CALL R8 3 0
  GETUPVAL R8 7
  GETTABLEKS R9 R8 K30 ["uniqueTooltipId"]
  ADDK R9 R9 K31 [1]
  SETTABLEKS R9 R8 K30 ["uniqueTooltipId"]
  GETUPVAL R9 7
  GETTABLEKS R8 R9 K30 ["uniqueTooltipId"]
  GETIMPORT R9 K33 [delay]
  GETUPVAL R11 7
...
MAIN:
  ...
  GETTABLEKS R8 R9 K15 ["getFFlagStudioHideTooltipsOnBlur"]
  CALL R7 1 1
