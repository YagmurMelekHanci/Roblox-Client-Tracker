...
PROTO_3:
  ...
  GETUPVAL R13 8
  LOADK R14 K30 ["Component-RibbonSelectInput Role-Surface X-CornerS X-Row X-Middle"]
  ...
  JUMPIFNOT R3 [+2]
  LOADK R16 K34 ["State-Focus"]
  JUMP [+1]
  LOADNIL R16
  GETUPVAL R18 9
  CALL R18 0 1
  JUMPIFNOT R18 [+10]
  LOADK R18 K35 ["data-testid=%*"]
  GETUPVAL R20 10
  ...
  CALL R13 5 1
  SETTABLE R13 R11 R12
  DUPTABLE R12 K39 [{"Value", "DropdownIcon"}]
  GETUPVAL R14 6
  ...
  GETUPVAL R17 8
  LOADK R18 K41 ["Role-Surface X-Fill X-Row X-RowSpace50 X-Middle"]
  CALL R17 1 1
  SETTABLE R17 R15 R16
  DUPTABLE R16 K42 [{"Icon", "Text"}]
  JUMPIFNOT R6 [+18]
  GETUPVAL R18 6
  ...
  GETTABLEKS R20 R21 K29 ["Tag"]
  GETUPVAL R21 8
  LOADK R22 K48 ["Role-Surface X-Fill"]
  CALL R21 1 1
  SETTABLE R21 R19 R20
  CALL R17 2 1
  SETTABLEKS R17 R16 K14 ["Text"]
  CALL R13 3 1
  SETTABLEKS R13 R12 K37 ["Value"]
  GETUPVAL R14 6
  GETTABLEKS R13 R14 K20 ["createElement"]
  ...
  GETTABLEKS R16 R17 K29 ["Tag"]
  GETUPVAL R17 8
  LOADK R18 K45 ["Role-Surface"]
  JUMPIFNOT R3 [+2]
  LOADK R19 K49 ["Icon-Up"]
  JUMP [+1]
  LOADNIL R19
  CALL R17 2 1
  SETTABLE R17 R15 R16
  CALL R13 2 1
  SETTABLEKS R13 R12 K38 ["DropdownIcon"]
  CALL R9 3 -1
  CLOSEUPVALS R1
  RETURN R9 -1
