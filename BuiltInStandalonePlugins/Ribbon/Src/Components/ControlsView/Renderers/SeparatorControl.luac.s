PROTO_0:
  ...
  JUMPIFNOT R5 [+4]
  GETUPVAL R5 0
  GETTABLEKS R4 R5 K5 ["ControlIndex"]
  JUMP [+3]
  GETUPVAL R5 0
...
PROTO_1:
  ...
  JUMPIFNOT R13 [+2]
  LOADK R12 K26 ["Role-DividerH"]
  JUMP [+1]
  LOADK R12 K27 ["Role-DividerV"]
  MOVE R13 R1
  CALL R10 3 1
  SETTABLE R10 R8 R9
  GETUPVAL R11 3
  GETTABLEKS R10 R11 K28 ["Event"]
  GETTABLEKS R9 R10 K29 ["InputBegan"]
  NEWCLOSURE R10 P0
  CAPTURE VAL R0
  CAPTURE UPVAL U5
  SETTABLE R10 R8 R9
  DUPTABLE R9 K31 [{"Divider"}]
  GETUPVAL R10 2
  LOADK R11 K32 ["Frame"]
  CALL R10 1 1
  SETTABLEKS R10 R9 K30 ["Divider"]
  CALL R6 3 -1
  RETURN R6 -1
...
MAIN:
  ...
  GETTABLEKS R5 R6 K12 ["getFFlagUseIndexForMovingControls"]
  CALL R4 1 1
  CALL R4 0 1
