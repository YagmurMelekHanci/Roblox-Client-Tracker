...
PROTO_6:
  ...
  LOADK R3 K0 ["FFlagRibbonTabOverflowMenuAddTab must be enabled to use Tab"]
  ...
  CALL R4 0 -1
  CALL R3 -1 1
  GETTABLEKS R5 R0 K6 ["ContextMenuItems"]
  JUMPIFNOT R5 [+3]
  GETTABLEKS R4 R0 K6 ["ContextMenuItems"]
  JUMP [+2]
  NEWTABLE R4 0 0
  GETUPVAL R5 6
  GETTABLEKS R6 R0 K3 ["Uri"]
  MOVE R7 R4
  LOADNIL R8
  GETTABLEKS R9 R0 K7 ["OnContextMenuItemSelected"]
  CALL R5 4 1
  GETTABLEKS R6 R0 K4 ["Editing"]
  JUMPIFNOT R6 [+55]
  GETUPVAL R6 7
  LOADK R7 K8 ["TextBox"]
  NEWTABLE R8 8 0
  SETTABLEKS R1 R8 K9 ["ref"]
  GETTABLEKS R9 R0 K10 ["Text"]
  SETTABLEKS R9 R8 K10 ["Text"]
  LOADB R9 0
  SETTABLEKS R9 R8 K11 ["ClearTextOnFocus"]
  GETTABLEKS R9 R0 K12 ["LayoutOrder"]
  SETTABLEKS R9 R8 K12 ["LayoutOrder"]
  GETUPVAL R10 8
  GETTABLEKS R9 R10 K13 ["Tag"]
  GETUPVAL R10 9
  LOADK R11 K14 ["Component-RibbonTab X-CornerM X-PadTab State-Editing X-Fit"]
  GETUPVAL R13 10
  CALL R13 0 1
  JUMPIFNOT R13 [+10]
  LOADK R13 K15 ["data-testid=%*"]
  GETUPVAL R15 11
  GETTABLEKS R16 R0 K3 ["Uri"]
  CALL R15 1 1
  ...
  GETTABLEKS R9 R10 K18 ["FocusLost"]
  NEWCLOSURE R10 P2
  CAPTURE VAL R0
  SETTABLE R10 R8 R9
  GETUPVAL R11 8
  GETTABLEKS R10 R11 K19 ["Change"]
  GETTABLEKS R9 R10 K20 ["TextFits"]
  DUPCLOSURE R10 K21 [PROTO_4]
  SETTABLE R10 R8 R9
  CALL R6 2 -1
  RETURN R6 -1
  GETTABLEKS R7 R0 K22 ["Enabled"]
  JUMPIFNOTEQKNIL R7 [+3]
  LOADB R6 1
  JUMP [+2]
  GETTABLEKS R6 R0 K22 ["Enabled"]
  GETUPVAL R7 7
  LOADK R8 K23 ["TextButton"]
  NEWTABLE R9 8 0
  SETTABLEKS R1 R9 K9 ["ref"]
  GETTABLEKS R10 R0 K10 ["Text"]
  ...
  GETUPVAL R11 9
  LOADK R12 K24 ["Component-RibbonTab X-CornerM X-Fit X-PadTab"]
  JUMPIF R6 [+2]
  LOADK R13 K25 ["State-Disabled"]
  JUMP [+6]
  GETTABLEKS R14 R0 K26 ["Selected"]
  JUMPIFNOT R14 [+2]
  LOADK R13 K27 ["State-Selected"]
  JUMP [+1]
  LOADK R13 K28 ["State-Default"]
  GETUPVAL R15 10
  CALL R15 0 1
  JUMPIFNOT R15 [+10]
  LOADK R15 K15 ["data-testid=%*"]
  GETUPVAL R17 11
  GETTABLEKS R18 R0 K3 ["Uri"]
  CALL R17 1 1
  ...
  GETTABLEKS R12 R0 K30 ["OnSelected"]
  JUMPIFNOT R12 [+4]
  NEWCLOSURE R11 P4
  CAPTURE VAL R0
  CAPTURE VAL R3
  ...
  GETUPVAL R12 8
  GETTABLEKS R11 R12 K17 ["Event"]
  GETTABLEKS R10 R11 K31 ["MouseButton2Click"]
  LENGTH R12 R4
  LOADN R13 0
...
MAIN:
  ...
  GETTABLEKS R4 R5 K11 ["getFFlagRibbonAddTestIds"]
  CALL R3 1 1
  GETIMPORT R4 K5 [require]
  GETTABLEKS R7 R0 K9 ["Src"]
  GETTABLEKS R6 R7 K10 ["SharedFlags"]
  GETTABLEKS R5 R6 K12 ["getFFlagRibbonTabOverflowMenuAddTab"]
  CALL R4 1 1
  GETIMPORT R5 K5 [require]
  GETTABLEKS R8 R0 K9 ["Src"]
  GETTABLEKS R7 R8 K13 ["Util"]
  GETTABLEKS R6 R7 K14 ["uriToTestId"]
  CALL R5 1 1
  GETIMPORT R6 K5 [require]
  GETTABLEKS R9 R0 K9 ["Src"]
  GETTABLEKS R8 R9 K15 ["Hooks"]
  GETTABLEKS R7 R8 K16 ["useSelectionMenuView"]
  CALL R6 1 1
  GETIMPORT R7 K5 [require]
  GETTABLEKS R10 R0 K9 ["Src"]
  GETTABLEKS R9 R10 K15 ["Hooks"]
  GETTABLEKS R8 R9 K17 ["useWidgets"]
  CALL R7 1 1
