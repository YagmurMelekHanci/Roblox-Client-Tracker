MAIN:
  ...
  MOVE R9 R2
  JUMPIFNOT R3 [+2]
  LOADK R10 K36 ["> ImageLabel"]
  JUMP [+1]
  LOADK R10 K37 [">> #Avatar"]
  DUPTABLE R11 K40 [{"AnchorPoint", "BorderSizePixel", "Position", "Size", "BackgroundColor3"}]
  LOADK R12 K19 ["$AnchorCenter"]
  SETTABLEKS R12 R11 K15 ["AnchorPoint"]
  LOADK R12 K41 ["$BorderNone"]
  ...
  LOADK R12 K42 ["$SemanticColorComponentMediaFill"]
  SETTABLEKS R12 R11 K39 ["BackgroundColor3"]
  NEWTABLE R12 0 2
  MOVE R13 R2
  ...
  MOVE R14 R2
  LOADK R15 K43 [".Idle"]
  DUPTABLE R16 K44 [{"Size"}]
  LOADK R17 K45 ["$AvatarXS"]
