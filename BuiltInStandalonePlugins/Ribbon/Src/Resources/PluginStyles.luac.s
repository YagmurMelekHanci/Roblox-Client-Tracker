MAIN:
  ...
  GETTABLEKS R5 R6 K12 ["getFFlagRibbonDynamicBackground"]
  CALL R4 1 1
  CALL R4 0 1
  NEWTABLE R5 0 59
  MOVE R6 R2
  ...
  CALL R33 2 1
  MOVE R34 R2
  LOADK R35 K12 ["getFFlagRibbonDynamicBackground"]
  ...
  LOADK R35 K12 ["getFFlagRibbonDynamicBackground"]
  DUPTABLE R36 K264 [{"Image"}]
  LOADK R37 K17 ["SourceSans"]
  SETTABLEKS R37 R36 K196 ["Image"]
  CALL R34 2 1
  MOVE R35 R2
  LOADK R36 K14 ["Font"]
  DUPTABLE R37 K264 [{"Image"}]
  LOADK R38 K18 [Enum.Font.SourceSans]
  SETTABLEKS R38 R37 K196 ["Image"]
  CALL R35 2 1
  MOVE R36 R2
  LOADK R37 K0 ["script"]
  ...
  NEWTABLE R21 0 9
  MOVE R22 R2
  LOADK R23 K20 ["BackgroundTransparency"]
  ...
  CALL R23 2 1
  MOVE R24 R2
  LOADK R25 K22 [{"BackgroundTransparency", "BorderSizePixel"}]
  ...
  NEWTABLE R28 0 2
  MOVE R29 R2
  LOADK R30 K20 ["BackgroundTransparency"]
  NEWTABLE R31 0 0
  NEWTABLE R32 0 1
  MOVE R33 R2
  ...
  CALL R29 3 1
  MOVE R30 R2
  LOADK R31 K22 [{"BackgroundTransparency", "BorderSizePixel"}]
  ...
  NEWTABLE R31 0 3
  MOVE R32 R2
  LOADK R33 K20 ["BackgroundTransparency"]
  NEWTABLE R34 0 0
  NEWTABLE R35 0 1
  MOVE R36 R2
  ...
  CALL R32 3 1
  MOVE R33 R2
  LOADK R34 K22 [{"BackgroundTransparency", "BorderSizePixel"}]
  DUPTABLE R35 K46 [{"Size"}]
  ...
  LOADK R34 K22 [{"BackgroundTransparency", "BorderSizePixel"}]
  DUPTABLE R35 K264 [{"Image"}]
  LOADK R36 K23 ["$BackgroundTransparent"]
  SETTABLEKS R36 R35 K196 ["Image"]
  CALL R33 2 1
  MOVE R34 R2
  LOADK R35 K24 ["$BorderNone"]
  DUPTABLE R36 K264 [{"Image"}]
  LOADK R37 K25 [".Role-Surface100"]
  SETTABLEKS R37 R36 K196 ["Image"]
  CALL R34 2 1
  MOVE R35 R2
  ...
  NEWTABLE R33 0 3
  MOVE R34 R2
  LOADK R35 K22 [{"BackgroundTransparency", "BorderSizePixel"}]
  DUPTABLE R36 K264 [{"Image"}]
  ...
  CALL R15 3 1
  MOVE R16 R2
  LOADK R17 K117 ["HorizontalScrollBarInset"]
  DUPTABLE R18 K221 [{"AutoButtonColor", "Text", "Size"}]
  LOADB R19 0
  SETTABLEKS R19 R18 K167 ["AutoButtonColor"]
  LOADK R19 K170 [""]
  ...
  MOVE R20 R2
  LOADK R21 K66 ["::UIListLayout"]
  DUPTABLE R22 K375 [{"HorizontalFlex"}]
  GETIMPORT R23 K378 [Enum.UIFlexAlignment.Fill]
  SETTABLEKS R23 R22 K374 ["HorizontalFlex"]
  CALL R20 2 1
  MOVE R21 R2
  LOADK R22 K60 ["::UIPadding"]
  DUPTABLE R23 K90 [{"PaddingLeft", "PaddingRight", "PaddingTop", "PaddingBottom"}]
  ...
  CALL R21 2 1
  MOVE R22 R2
  LOADK R23 K123 [Enum.AutomaticSize.XY]
  NEWTABLE R24 0 0
  NEWTABLE R25 0 1
  MOVE R26 R2
  LOADK R27 K66 ["::UIListLayout"]
  DUPTABLE R28 K375 [{"HorizontalFlex"}]
  GETIMPORT R29 K378 [Enum.UIFlexAlignment.Fill]
  SETTABLEKS R29 R28 K374 ["HorizontalFlex"]
  CALL R26 2 -1
  SETLIST R25 R26 -1 [1]
  CALL R22 3 1
  MOVE R23 R2
  LOADK R24 K124 ["fromScale"]
  DUPTABLE R25 K46 [{"Size"}]
  LOADK R26 K178 ["$IconSmall"]
  SETTABLEKS R26 R25 K45 ["Size"]
  NEWTABLE R26 0 1
  MOVE R27 R2
  LOADK R28 K125 [UDim2.fromScale]
  DUPTABLE R29 K384 [{"FlexMode", "ShrinkRation"}]
  GETIMPORT R30 K387 [Enum.UIFlexMode.Custom]
  SETTABLEKS R30 R29 K382 ["FlexMode"]
  LOADN R30 0
  SETTABLEKS R30 R29 K383 ["ShrinkRation"]
  CALL R27 2 -1
  SETLIST R26 R27 -1 [1]
  CALL R23 3 1
  MOVE R24 R2
  LOADK R25 K132 [{"AnchorPoint", "AutomaticSize", "Position", "Size"}]
  DUPTABLE R26 K228 [{"LayoutOrder"}]
  LOADN R27 0
  SETTABLEKS R27 R26 K74 ["LayoutOrder"]
  NEWTABLE R27 0 1
  MOVE R28 R2
  LOADK R29 K229 [".Right"]
  DUPTABLE R30 K228 [{"LayoutOrder"}]
  LOADN R31 3
  SETTABLEKS R31 R30 K74 ["LayoutOrder"]
  CALL R28 2 -1
  ...
  CALL R24 3 1
  MOVE R25 R2
  LOADK R26 K133 [Enum.AutomaticSize.None]
  DUPTABLE R27 K390 [{"BorderSizePixel", "BackgroundTransparency", "Image", "LayoutOrder"}]
  LOADK R28 K24 ["$BorderNone"]
  SETTABLEKS R28 R27 K21 ["BorderSizePixel"]
  LOADN R28 1
  SETTABLEKS R28 R27 K20 ["BackgroundTransparency"]
  LOADK R28 K135 ["CornerRadius"]
  SETTABLEKS R28 R27 K196 ["Image"]
  LOADN R28 4
  SETTABLEKS R28 R27 K74 ["LayoutOrder"]
  NEWTABLE R28 0 1
  MOVE R29 R2
  LOADK R30 K136 [{"CornerRadius"}]
  DUPTABLE R31 K264 [{"Image"}]
  LOADK R32 K137 ["$GlobalRadiusXSmall"]
  SETTABLEKS R32 R31 K196 ["Image"]
  CALL R29 2 -1
  SETLIST R28 R29 -1 [1]
  CALL R25 3 1
  MOVE R26 R2
  LOADK R27 K138 [".X-CornerS ::UICorner"]
  DUPTABLE R28 K397 [{"Font", "TextSize", "TextTruncate", "TextXAlignment", "LayoutOrder"}]
  LOADK R29 K34 ["$FontWeight400"]
  SETTABLEKS R29 R28 K14 ["Font"]
  LOADK R29 K98 ["$FontSize150"]
  SETTABLEKS R29 R28 K32 ["TextSize"]
  GETIMPORT R29 K399 [Enum.TextTruncate.AtEnd]
  SETTABLEKS R29 R28 K395 ["TextTruncate"]
  GETIMPORT R29 K400 [Enum.TextXAlignment.Left]
  SETTABLEKS R29 R28 K396 ["TextXAlignment"]
  LOADN R29 2
  SETTABLEKS R29 R28 K74 ["LayoutOrder"]
  CALL R26 2 1
  MOVE R27 R2
  ...
  NEWTABLE R30 0 2
  MOVE R31 R2
  LOADK R32 K138 [".X-CornerS ::UICorner"]
  DUPTABLE R33 K42 [{"TextColor3"}]
  LOADK R34 K35 ["$SemanticColorContentMuted"]
  SETTABLEKS R34 R33 K31 ["TextColor3"]
  CALL R31 2 1
  MOVE R32 R2
  LOADK R33 K132 [{"AnchorPoint", "AutomaticSize", "Position", "Size"}]
  DUPTABLE R34 K182 [{"ImageTransparency"}]
  LOADK R35 K145 [".X-PadRibbonTool ::UIPadding"]
  SETTABLEKS R35 R34 K181 ["ImageTransparency"]
  CALL R32 2 -1
  SETLIST R30 R31 -1 [1]
  CALL R27 3 1
  MOVE R28 R2
  LOADK R29 K146 [".X-PadSplitButtonTool ::UIPadding"]
  DUPTABLE R30 K107 [{"BackgroundColor3", "BackgroundTransparency"}]
  LOADK R31 K52 ["$SemanticColorDivider"]
  SETTABLEKS R31 R30 K26 ["BackgroundColor3"]
  LOADK R31 K53 ["$SemanticColorDividerTransparency"]
  SETTABLEKS R31 R30 K20 ["BackgroundTransparency"]
  NEWTABLE R31 0 2
  MOVE R32 R2
  LOADK R33 K138 [".X-CornerS ::UICorner"]
  DUPTABLE R34 K42 [{"TextColor3"}]
  LOADK R35 K103 ["$SemanticColorContentStandard"]
  SETTABLEKS R35 R34 K31 ["TextColor3"]
  CALL R32 2 1
  MOVE R33 R2
  LOADK R34 K132 [{"AnchorPoint", "AutomaticSize", "Position", "Size"}]
  DUPTABLE R35 K182 [{"ImageTransparency"}]
  LOADN R36 0
  SETTABLEKS R36 R35 K181 ["ImageTransparency"]
  CALL R33 2 -1
  SETLIST R31 R32 -1 [1]
  CALL R28 3 1
  MOVE R29 R2
  ...
  NEWTABLE R32 0 3
  MOVE R33 R2
  LOADK R34 K236 ["::UIStroke"]
  DUPTABLE R35 K305 [{"ApplyStrokeMode", "Color", "Thickness"}]
  GETIMPORT R36 K241 [Enum.ApplyStrokeMode.Border]
  SETTABLEKS R36 R35 K237 ["ApplyStrokeMode"]
  LOADK R36 K50 ["> Frame"]
  SETTABLEKS R36 R35 K206 ["Color"]
  LOADK R36 K242 ["$BorderMedium"]
  SETTABLEKS R36 R35 K238 ["Thickness"]
  CALL R33 2 1
  MOVE R34 R2
  LOADK R35 K138 [".X-CornerS ::UICorner"]
  DUPTABLE R36 K42 [{"TextColor3"}]
  LOADK R37 K103 ["$SemanticColorContentStandard"]
  SETTABLEKS R37 R36 K31 ["TextColor3"]
  CALL R34 2 1
  MOVE R35 R2
  LOADK R36 K132 [{"AnchorPoint", "AutomaticSize", "Position", "Size"}]
  DUPTABLE R37 K182 [{"ImageTransparency"}]
  LOADN R38 0
  SETTABLEKS R38 R37 K181 ["ImageTransparency"]
  CALL R35 2 -1
  SETLIST R32 R33 -1 [1]
  CALL R29 3 1
  MOVE R30 R2
  ...
  SETLIST R5 R6 -1 [49]
  MOVE R6 R3
  LOADK R7 K147 [".X-PadSplitButtonDropdown :: UIPadding"]
  MOVE R8 R5
  DUPTABLE R9 K405 [{"Size", "SizeDense"}]
  ...
  LOADN R14 20
  CALL R10 4 1
  SETTABLEKS R10 R9 K404 ["SizeDense"]
  CALL R6 3 -1
  RETURN R6 -1
