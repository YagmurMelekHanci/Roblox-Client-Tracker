...
PROTO_5:
  ...
  JUMPIFNOT R3 [+58]
  GETUPVAL R4 3
  GETTABLEKS R3 R4 K5 ["getWorldBoundingBox"]
  GETUPVAL R4 2
  CALL R3 1 1
  GETUPVAL R4 4
  CALL R4 0 1
  JUMPIFNOT R4 [+28]
  LOADK R4 K6 ["absolute"]
  SETTABLEKS R4 R2 K7 ["positionOrigin"]
  DUPTABLE R4 K10 [{"x", "z"}]
  GETTABLEKS R6 R3 K11 ["Position"]
  GETTABLEKS R5 R6 K12 ["X"]
  SETTABLEKS R5 R4 K8 ["x"]
  GETTABLEKS R6 R3 K11 ["Position"]
  GETTABLEKS R5 R6 K13 ["Z"]
  SETTABLEKS R5 R4 K9 ["z"]
  SETTABLEKS R4 R2 K14 ["position"]
  GETUPVAL R4 2
  NAMECALL R4 R4 K15 ["GetPivot"]
  CALL R4 1 1
  GETTABLEKS R6 R4 K11 ["Position"]
  SUB R5 R4 R6
  SETTABLEKS R5 R2 K16 ["offsetCFrame"]
  JUMP [+22]
  GETUPVAL R5 3
  GETTABLEKS R4 R5 K17 ["getRequestCFrame"]
  GETTABLEKS R5 R0 K18 ["requestId"]
  CALL R4 1 1
  GETTABLEKS R7 R3 K11 ["Position"]
  NAMECALL R5 R4 K19 ["PointToObjectSpace"]
  CALL R5 2 1
  DUPTABLE R6 K10 [{"x", "z"}]
  GETTABLEKS R7 R5 K12 ["X"]
  SETTABLEKS R7 R6 K8 ["x"]
  GETTABLEKS R7 R5 K13 ["Z"]
  SETTABLEKS R7 R6 K9 ["z"]
  SETTABLEKS R6 R2 K14 ["position"]
  GETUPVAL R3 1
  CALL R3 0 1
  JUMPIFNOT R3 [+5]
  GETUPVAL R4 2
  GETTABLEKS R3 R4 K20 ["Parent"]
  SETTABLEKS R3 R2 K21 ["parentInstance"]
  GETUPVAL R3 5
  SETTABLEKS R3 R1 K22 ["altDataId"]
  GETUPVAL R2 0
  GETUPVAL R3 6
  SETTABLEKS R3 R2 K23 ["assetId"]
  GETUPVAL R2 7
  LOADB R3 1
  SETTABLEKS R3 R2 K24 ["deferedSelection"]
  GETUPVAL R2 1
  CALL R2 0 1
  JUMPIF R2 [+11]
  GETUPVAL R3 3
  GETTABLEKS R2 R3 K25 ["isAssetCached"]
  GETUPVAL R3 6
  CALL R2 1 1
  JUMPIF R2 [+5]
  GETUPVAL R3 3
  GETTABLEKS R2 R3 K26 ["loadAssetAsync"]
  GETUPVAL R3 6
  CALL R2 1 0
  GETUPVAL R2 8
  GETTABLEKS R4 R0 K18 ["requestId"]
  LOADK R5 K27 ["InsertAsset"]
  GETTABLEKS R6 R0 K1 ["arguments"]
  NAMECALL R2 R2 K28 ["ExecuteCommandAsync"]
  CALL R2 4 0
  GETUPVAL R5 9
  GETTABLEKS R4 R5 K29 ["guidToInfo"]
  GETUPVAL R5 5
  GETTABLE R3 R4 R5
  GETTABLEKS R2 R3 K30 ["instance"]
  GETUPVAL R3 10
  NAMECALL R3 R3 K31 ["Get"]
  CALL R3 1 1
  LOADB R4 0
  LOADN R7 1
  LENGTH R5 R3
  ...
  GETUPVAL R5 10
  MOVE R7 R3
  NAMECALL R5 R5 K32 ["Set"]
  CALL R5 2 0
  GETUPVAL R5 2
  LOADK R7 K33 ["AssetId"]
  NAMECALL R5 R5 K34 ["GetAttribute"]
  CALL R5 2 1
  LOADK R8 K33 ["AssetId"]
  NAMECALL R6 R2 K34 ["GetAttribute"]
  CALL R6 2 1
  GETUPVAL R7 11
  GETTABLEKS R9 R0 K18 ["requestId"]
  MOVE R10 R5
  MOVE R11 R6
  NAMECALL R7 R7 K35 ["AlternativeAssetSelected"]
  CALL R7 4 0
  GETUPVAL R7 2
  LOADNIL R8
  ...
  GETUPVAL R7 7
  LOADB R8 0
  SETTABLEKS R8 R7 K24 ["deferedSelection"]
  GETUPVAL R7 12
  SUBK R7 R7 K36 [1]
  SETUPVAL R7 12
  GETUPVAL R7 13
  NAMECALL R7 R7 K37 ["Fire"]
  CALL R7 1 0
  RETURN R0 0
