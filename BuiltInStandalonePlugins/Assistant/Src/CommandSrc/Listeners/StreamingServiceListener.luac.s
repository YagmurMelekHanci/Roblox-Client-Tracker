...
PROTO_1:
  ...
  MOVE R5 R3
  LOADK R6 K4 ["Camera not found"]
  GETIMPORT R4 K6 [assert]
  CALL R4 2 0
  GETTABLEKS R5 R3 K8 ["ViewportSize"]
  MULK R4 R5 K7 [0.5]
  GETTABLEKS R7 R4 K9 ["X"]
  GETTABLEKS R8 R4 K10 ["Y"]
  NAMECALL R5 R3 K11 ["ViewportPointToRay"]
  CALL R5 3 1
  GETTABLEKS R8 R4 K9 ["X"]
  LOADN R9 0
  NAMECALL R6 R3 K11 ["ViewportPointToRay"]
  CALL R6 3 1
  LOADN R9 0
  GETTABLEKS R10 R4 K10 ["Y"]
  NAMECALL R7 R3 K11 ["ViewportPointToRay"]
  CALL R7 3 1
  GETTABLEKS R10 R5 K12 ["Direction"]
  GETTABLEKS R9 R10 K13 ["Unit"]
  GETTABLEKS R12 R6 K12 ["Direction"]
  GETTABLEKS R11 R12 K13 ["Unit"]
  NAMECALL R9 R9 K14 ["Dot"]
  CALL R9 2 1
  FASTCALL1 MATH_ACOS R9 [+2]
  GETIMPORT R8 K17 [math.acos]
  CALL R8 1 1
  GETTABLEKS R11 R5 K12 ["Direction"]
  GETTABLEKS R10 R11 K13 ["Unit"]
  GETTABLEKS R13 R7 K12 ["Direction"]
  GETTABLEKS R12 R13 K13 ["Unit"]
  NAMECALL R10 R10 K14 ["Dot"]
  CALL R10 2 1
  FASTCALL1 MATH_ACOS R10 [+2]
  GETIMPORT R9 K17 [math.acos]
  CALL R9 1 1
  ...
  GETTABLEKS R14 R2 K10 ["Y"]
  GETTABLEKS R15 R2 K21 ["Z"]
  FASTCALL MATH_MAX [+2]
  ...
  GETIMPORT R15 K26 [math.tan]
  CALL R15 1 1
  DIV R13 R14 R15
  FASTCALL2K MATH_MAX R13 K27 [+4]
  LOADK R14 K27 [20]
  GETIMPORT R12 K23 [math.max]
  CALL R12 2 1
  GETTABLEKS R13 R3 K28 ["CFrame"]
  GETTABLEKS R16 R13 K29 ["LookVector"]
  MUL R15 R16 R12
  SUB R14 R1 R15
  GETIMPORT R16 K31 [CFrame.new]
  MOVE R17 R14
  CALL R16 1 1
  GETTABLEKS R17 R13 K32 ["Rotation"]
  MUL R15 R16 R17
  GETUPVAL R16 1
  MOVE R18 R3
  GETIMPORT R19 K34 [TweenInfo.new]
  LOADK R20 K35 [0.22]
  GETIMPORT R21 K39 [Enum.EasingStyle.Cubic]
  GETIMPORT R22 K42 [Enum.EasingDirection.Out]
  CALL R19 3 1
  DUPTABLE R20 K44 [{"CFrame", "Focus"}]
  SETTABLEKS R15 R20 K28 ["CFrame"]
  GETIMPORT R21 K31 [CFrame.new]
  MOVE R22 R1
  CALL R21 1 1
  SETTABLEKS R21 R20 K43 ["Focus"]
  NAMECALL R16 R16 K45 ["Create"]
  CALL R16 4 1
  NAMECALL R17 R16 K46 ["Play"]
  CALL R17 1 0
  RETURN R0 0
...
PROTO_2:
  ...
  CALL R13 2 0
  GETUPVAL R14 0
  GETTABLEKS R13 R14 K12 ["guid2instance"]
  GETTABLE R9 R13 R5
  JUMPIFNOT R9 [+12]
  NEWTABLE R10 0 1
  MOVE R11 R9
  ...
  MOVE R8 R5
  MOVE R9 R2
  NAMECALL R6 R0 K13 ["getActionInstanceFromGuid"]
  CALL R6 3 -1
  RETURN R6 -1
...
PROTO_5:
  ...
  NAMECALL R3 R3 K7 ["IsA"]
  CALL R3 2 1
  JUMPIFNOT R3 [+58]
  GETUPVAL R4 3
  GETTABLEKS R3 R4 K8 ["getWorldBoundingBox"]
  GETUPVAL R4 2
  CALL R3 1 1
  GETUPVAL R4 4
  CALL R4 0 1
  JUMPIFNOT R4 [+28]
  LOADK R4 K9 ["absolute"]
  SETTABLEKS R4 R2 K10 ["positionOrigin"]
  DUPTABLE R4 K13 [{"x", "z"}]
  GETTABLEKS R6 R3 K14 ["Position"]
  GETTABLEKS R5 R6 K15 ["X"]
  SETTABLEKS R5 R4 K11 ["x"]
  GETTABLEKS R6 R3 K14 ["Position"]
  GETTABLEKS R5 R6 K16 ["Z"]
  SETTABLEKS R5 R4 K12 ["z"]
  SETTABLEKS R4 R2 K17 ["position"]
  GETUPVAL R4 2
  NAMECALL R4 R4 K18 ["GetPivot"]
  CALL R4 1 1
  GETTABLEKS R6 R4 K14 ["Position"]
  SUB R5 R4 R6
  SETTABLEKS R5 R2 K19 ["offsetCFrame"]
  JUMP [+22]
  GETUPVAL R5 3
  GETTABLEKS R4 R5 K20 ["getRequestCFrame"]
  GETTABLEKS R5 R0 K21 ["requestId"]
  CALL R4 1 1
  GETTABLEKS R7 R3 K14 ["Position"]
  NAMECALL R5 R4 K22 ["PointToObjectSpace"]
  CALL R5 2 1
  DUPTABLE R6 K13 [{"x", "z"}]
  GETTABLEKS R7 R5 K15 ["X"]
  SETTABLEKS R7 R6 K11 ["x"]
  GETTABLEKS R7 R5 K16 ["Z"]
  SETTABLEKS R7 R6 K12 ["z"]
  SETTABLEKS R6 R2 K17 ["position"]
  GETUPVAL R3 1
  CALL R3 0 1
  JUMPIFNOT R3 [+5]
  GETUPVAL R4 2
  GETTABLEKS R3 R4 K23 ["Parent"]
  SETTABLEKS R3 R2 K24 ["parentInstance"]
  GETUPVAL R3 5
  SETTABLEKS R3 R1 K25 ["altDataId"]
  GETUPVAL R2 0
  GETUPVAL R3 6
  SETTABLEKS R3 R2 K26 ["assetId"]
  GETUPVAL R2 7
  LOADB R3 1
  SETTABLEKS R3 R2 K27 ["deferedSelection"]
  GETUPVAL R2 1
  CALL R2 0 1
  JUMPIF R2 [+11]
  GETUPVAL R3 3
  GETTABLEKS R2 R3 K28 ["isAssetCached"]
  GETUPVAL R3 6
  CALL R2 1 1
  JUMPIF R2 [+5]
  GETUPVAL R3 3
  GETTABLEKS R2 R3 K29 ["loadAssetAsync"]
  GETUPVAL R3 6
  CALL R2 1 0
  GETUPVAL R2 8
  GETTABLEKS R4 R0 K21 ["requestId"]
  LOADK R5 K30 ["InsertAsset"]
  GETTABLEKS R6 R0 K1 ["arguments"]
  NAMECALL R2 R2 K31 ["ExecuteCommandAsync"]
  CALL R2 4 0
  GETUPVAL R5 9
  GETTABLEKS R4 R5 K32 ["guidToInfo"]
  GETUPVAL R5 5
  GETTABLE R3 R4 R5
  GETTABLEKS R2 R3 K33 ["instance"]
  GETUPVAL R3 10
  NAMECALL R3 R3 K34 ["Get"]
  CALL R3 1 1
  LOADB R4 0
  LOADN R7 1
  LENGTH R5 R3
  ...
  GETUPVAL R5 10
  MOVE R7 R3
  NAMECALL R5 R5 K35 ["Set"]
  CALL R5 2 0
  GETUPVAL R5 2
  LOADK R7 K36 ["AssetId"]
  NAMECALL R5 R5 K37 ["GetAttribute"]
  CALL R5 2 1
  LOADK R8 K36 ["AssetId"]
  NAMECALL R6 R2 K37 ["GetAttribute"]
  CALL R6 2 1
  GETUPVAL R7 11
  GETTABLEKS R9 R0 K21 ["requestId"]
  MOVE R10 R5
  MOVE R11 R6
  NAMECALL R7 R7 K38 ["AlternativeAssetSelected"]
  CALL R7 4 0
  GETUPVAL R7 2
  LOADNIL R8
  SETTABLEKS R8 R7 K23 ["Parent"]
  GETUPVAL R7 7
  LOADB R8 0
  SETTABLEKS R8 R7 K27 ["deferedSelection"]
  GETUPVAL R7 12
  SUBK R7 R7 K39 [1]
  SETUPVAL R7 12
  GETUPVAL R7 13
...
PROTO_12:
  ...
  CALL R0 1 1
  GETUPVAL R3 0
  GETTABLEKS R2 R3 K2 ["lastSelectedInstances"]
  FASTCALL2K ASSERT R2 K3 [+4]
  LOADK R3 K3 ["lastSelectedInstances is nil"]
  GETIMPORT R1 K5 [assert]
  CALL R1 2 0
  GETUPVAL R3 0
  GETTABLEKS R2 R3 K6 ["actionClickCursor"]
  FASTCALL2K ASSERT R2 K7 [+4]
  LOADK R3 K7 ["actionClickCursor is nil"]
  GETIMPORT R1 K5 [assert]
  CALL R1 2 0
  LENGTH R1 R0
  JUMPIFNOTEQKN R1 K8 [0] [+29]
  GETUPVAL R3 0
  GETTABLEKS R2 R3 K2 ["lastSelectedInstances"]
  LENGTH R1 R2
  JUMPIFNOTEQKN R1 K9 [1] [+23]
  GETUPVAL R3 0
  GETTABLEKS R2 R3 K2 ["lastSelectedInstances"]
  GETTABLEN R1 R2 1
  GETIMPORT R3 K11 [workspace]
  NAMECALL R1 R1 K12 ["IsDescendantOf"]
  CALL R1 2 1
  JUMPIF R1 [+12]
  GETUPVAL R1 0
  GETUPVAL R5 0
  GETTABLEKS R4 R5 K6 ["actionClickCursor"]
  SUBK R3 R4 K9 [1]
  GETUPVAL R6 2
  LENGTH R5 R6
  ADDK R4 R5 K9 [1]
  MOD R2 R3 R4
  SETTABLEKS R2 R1 K6 ["actionClickCursor"]
  RETURN R0 0
  GETUPVAL R2 3
  GETTABLEKS R1 R2 K13 ["shallowEqual"]
  MOVE R2 R0
  GETUPVAL R4 0
  GETTABLEKS R3 R4 K2 ["lastSelectedInstances"]
  CALL R1 2 1
  JUMPIF R1 [+28]
  GETUPVAL R2 0
  GETTABLEKS R1 R2 K14 ["_selectionListener"]
  JUMPIFNOT R1 [+10]
  GETUPVAL R2 0
  GETTABLEKS R1 R2 K14 ["_selectionListener"]
  ...
  GETUPVAL R1 0
  LOADNIL R2
  SETTABLEKS R2 R1 K14 ["_selectionListener"]
  GETIMPORT R1 K18 [table.clear]
  GETUPVAL R3 0
  GETTABLEKS R2 R3 K2 ["lastSelectedInstances"]
  CALL R1 1 0
  GETUPVAL R1 0
  LOADNIL R2
  SETTABLEKS R2 R1 K2 ["lastSelectedInstances"]
  GETUPVAL R1 0
  LOADNIL R2
  SETTABLEKS R2 R1 K6 ["actionClickCursor"]
  RETURN R0 0
...
PROTO_15:
  JUMPIFNOTEQKS R1 K0 ["attribution"] [+55]
  MOVE R5 R2
  ...
  RETURN R10 -1
  JUMP [+30]
  JUMPIFNOTEQKS R1 K5 ["assetId"] [+29]
  MOVE R5 R2
  NAMECALL R3 R0 K1 ["getActionInstance"]
  CALL R3 2 3
  LENGTH R6 R3
...
PROTO_22:
  ...
  GETTABLEN R4 R3 1
  LOADK R8 K1 ["MaterialVariant"]
  NAMECALL R6 R4 K2 ["IsA"]
  CALL R6 2 1
  FASTCALL2K ASSERT R6 K3 [+4]
  LOADK R7 K3 ["MaterialVariant expected"]
  GETIMPORT R5 K5 [assert]
  CALL R5 2 0
  SETTABLEKS R1 R4 K6 ["StudsPerTile"]
  JUMPIFNOT R2 [+3]
  GETIMPORT R5 K10 [Enum.MaterialPattern.Organic]
  JUMP [+2]
  GETIMPORT R5 K12 [Enum.MaterialPattern.Regular]
...
MAIN:
  ...
  GETTABLEKS R6 R7 K8 ["CommandSrc"]
  ...
  GETTABLEKS R8 R9 K8 ["CommandSrc"]
  GETTABLEKS R7 R8 K9 ["Commands"]
  GETTABLEKS R6 R7 K16 ["DisplayError"]
  CALL R5 1 1
  GETIMPORT R6 K6 [require]
  GETTABLEKS R10 R1 K7 ["Src"]
  ...
  GETTABLEKS R10 R11 K8 ["CommandSrc"]
  GETTABLEKS R9 R10 K19 ["ContextCollectors"]
  GETTABLEKS R8 R9 K20 ["RecentInstancesContext"]
  CALL R7 1 1
  GETIMPORT R8 K6 [require]
  GETTABLEKS R10 R1 K14 ["Packages"]
  GETTABLEKS R9 R10 K21 ["SharedPluginConstants"]
  CALL R8 1 1
  GETIMPORT R9 K6 [require]
  GETTABLEKS R12 R1 K7 ["Src"]
  GETTABLEKS R11 R12 K8 ["CommandSrc"]
  GETTABLEKS R10 R11 K22 ["Types"]
  CALL R9 1 1
  GETIMPORT R10 K6 [require]
  GETTABLEKS R13 R1 K7 ["Src"]
  GETTABLEKS R12 R13 K8 ["CommandSrc"]
  GETTABLEKS R11 R12 K23 ["Utils"]
  CALL R10 1 1
  GETTABLEKS R11 R3 K24 ["GetService"]
  LOADK R12 K25 ["ChangeHistoryService"]
  CALL R11 1 1
  GETTABLEKS R12 R3 K24 ["GetService"]
  LOADK R13 K26 ["MemStorageService"]
  CALL R12 1 1
  GETTABLEKS R13 R3 K24 ["GetService"]
  LOADK R14 K27 ["StreamingService"]
  CALL R13 1 1
  GETTABLEKS R14 R3 K24 ["GetService"]
  LOADK R15 K28 ["ChatbotUIService"]
  CALL R14 1 1
  GETTABLEKS R15 R3 K24 ["GetService"]
  LOADK R16 K29 ["TweenService"]
  CALL R15 1 1
  GETTABLEKS R16 R3 K24 ["GetService"]
  LOADK R17 K30 ["HttpService"]
  CALL R16 1 1
  GETTABLEKS R17 R3 K24 ["GetService"]
  LOADK R18 K31 ["Selection"]
  CALL R17 1 1
  GETTABLEKS R18 R3 K24 ["GetService"]
  LOADK R19 K32 ["ConversationalAIAcceptanceService"]
  CALL R18 1 1
  GETIMPORT R20 K6 [require]
  GETTABLEKS R23 R1 K7 ["Src"]
  GETTABLEKS R22 R23 K33 ["Flags"]
  GETTABLEKS R21 R22 K34 ["FFlagConvAIAddCommandSearchInsertAsset"]
  CALL R20 1 1
  GETTABLEKS R19 R20 K35 ["Get"]
  GETIMPORT R21 K6 [require]
  GETTABLEKS R24 R1 K7 ["Src"]
  GETTABLEKS R23 R24 K33 ["Flags"]
  GETTABLEKS R22 R23 K36 ["FFlagConvAIFirstVariationFix"]
  CALL R21 1 1
  GETTABLEKS R20 R21 K35 ["Get"]
  GETIMPORT R22 K6 [require]
  GETTABLEKS R25 R1 K7 ["Src"]
  GETTABLEKS R24 R25 K33 ["Flags"]
  GETTABLEKS R23 R24 K37 ["FFlagConvAIFixEmptyBubbleBug"]
  CALL R22 1 1
  GETTABLEKS R21 R22 K35 ["Get"]
  GETIMPORT R23 K6 [require]
  GETTABLEKS R26 R1 K7 ["Src"]
  GETTABLEKS R25 R26 K33 ["Flags"]
  GETTABLEKS R24 R25 K38 ["FFlagConvAIFixStreamCreationTiming"]
  CALL R23 1 1
  GETTABLEKS R22 R23 K35 ["Get"]
  GETIMPORT R24 K6 [require]
  GETTABLEKS R27 R1 K7 ["Src"]
  GETTABLEKS R26 R27 K33 ["Flags"]
  GETTABLEKS R25 R26 K39 ["FFlagConvAI_ConditionalDropdown"]
  CALL R24 1 1
  GETTABLEKS R23 R24 K35 ["Get"]
  GETIMPORT R25 K6 [require]
  GETTABLEKS R28 R1 K7 ["Src"]
  GETTABLEKS R27 R28 K33 ["Flags"]
  GETTABLEKS R26 R27 K40 ["FFlagFixCurrentCameraPlacement"]
  CALL R25 1 1
  GETTABLEKS R24 R25 K35 ["Get"]
  LOADB R25 0
  NEWCLOSURE R26 P0
  CAPTURE VAL R22
  CAPTURE REF R25
  CAPTURE VAL R21
  SETGLOBAL R26 K41 ["handleCachedPacketsForStream"]
  DUPCLOSURE R26 K42 [PROTO_1]
  CAPTURE VAL R10
  CAPTURE VAL R15
  DUPCLOSURE R27 K43 [PROTO_2]
  CAPTURE VAL R2
  SETTABLEKS R27 R0 K44 ["getActionInstance"]
  DUPCLOSURE R27 K45 [PROTO_3]
  CAPTURE VAL R2
  CAPTURE VAL R23
  SETTABLEKS R27 R0 K46 ["getActionInstanceFromGuid"]
  DUPCLOSURE R27 K47 [PROTO_4]
  CAPTURE VAL R20
  CAPTURE VAL R2
  SETTABLEKS R27 R0 K48 ["onShiftAssetToId"]
  ...
  CAPTURE VAL R18
  CAPTURE VAL R26
  SETTABLEKS R27 R0 K50 ["onShiftAssetVariant"]
  ...
  CAPTURE VAL R29
  CAPTURE VAL R14
  SETTABLEKS R30 R0 K55 ["onAction"]
  DUPCLOSURE R30 K56 [PROTO_15]
  CAPTURE VAL R2
  CAPTURE VAL R10
  CAPTURE VAL R6
  SETTABLEKS R30 R0 K57 ["getPluginInfo"]
  DUPCLOSURE R30 K58 [PROTO_31]
  CAPTURE VAL R13
  CAPTURE VAL R16
  CAPTURE VAL R14
  CAPTURE VAL R7
  ...
  CAPTURE VAL R5
  CAPTURE VAL R10
  DUPCLOSURE R31 K59 [PROTO_32]
  CAPTURE VAL R13
  SETTABLEKS R31 R0 K60 ["destroy"]
  DUPCLOSURE R31 K61 [PROTO_33]
  CAPTURE VAL R0
  CAPTURE VAL R30
  SETTABLEKS R31 R0 K62 ["new"]
  CLOSEUPVALS R25
  RETURN R0 1
