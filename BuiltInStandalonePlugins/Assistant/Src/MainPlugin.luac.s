...
PROTO_9:
  ...
  GETUPVAL R5 0
  SETTABLEKS R3 R5 K4 ["plugin"]
  GETUPVAL R6 1
  GETTABLEKS R5 R6 K5 ["provide"]
  DUPTABLE R6 K11 [{"Plugin", "Mouse", "Stylizer", "Localization", "Analytics", "Design"}]
  GETUPVAL R8 2
  ...
  GETUPVAL R8 3
  GETTABLEKS R7 R8 K12 ["new"]
  GETTABLEKS R8 R0 K17 ["design"]
  CALL R7 1 1
  SETTABLEKS R7 R6 K10 ["Design"]
  DUPTABLE R7 K19 [{"MainWidget"}]
  GETUPVAL R8 4
  GETUPVAL R9 5
  NEWTABLE R10 16 0
  LOADK R11 K20 ["Assistant"]
  ...
  DUPTABLE R11 K47 [{"App"}]
  GETUPVAL R12 4
  GETUPVAL R13 7
  DUPTABLE R14 K48 [{"Plugin"}]
  SETTABLEKS R3 R14 K2 ["Plugin"]
  CALL R12 2 1
  SETTABLEKS R12 R11 K46 ["App"]
  CALL R8 3 1
...
MAIN:
  ...
  GETTABLEKS R15 R16 K27 ["Contexts"]
  GETTABLEKS R14 R15 K28 ["StudioPluginContext"]
  CALL R13 1 1
  GETTABLEKS R14 R3 K29 ["createElement"]
