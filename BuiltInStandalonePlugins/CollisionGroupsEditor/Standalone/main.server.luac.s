PROTO_0:
  ...
  JUMPIFNOT R1 [+6]
  GETUPVAL R1 4
  LOADK R3 K15 ["Roact tree"]
  GETUPVAL R4 2
  NAMECALL R1 R1 K16 ["addRoactTree"]
  CALL R1 3 0
  RETURN R0 0
...
MAIN:
  ...
  CALL R3 2 1
  NAMECALL R3 R3 K13 ["HasInternalPermission"]
  CALL R3 1 1
  GETIMPORT R4 K4 [require]
  GETTABLEKS R6 R0 K14 ["Plugin"]
  GETTABLEKS R5 R6 K15 ["MainPlugin"]
  CALL R4 1 1
  SETGLOBAL R4 K15 ["MainPlugin"]
  LOADNIL R4
  LOADNIL R5
  NEWCLOSURE R6 P0
  CAPTURE VAL R0
  ...
  GETTABLEKS R8 R9 K18 ["Unloading"]
  MOVE R10 R7
