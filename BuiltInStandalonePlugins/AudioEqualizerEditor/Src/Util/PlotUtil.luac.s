...
PROTO_6:
  ...
  GETUPVAL R8 0
  GETTABLEKS R7 R8 K5 ["getYMin"]
  CALL R7 0 1
  GETUPVAL R9 0
  GETTABLEKS R8 R9 K6 ["getYMax"]
  CALL R8 0 -1
  FASTCALL MATH_CLAMP [+2]
  GETIMPORT R5 K9 [math.clamp]
  CALL R5 -1 1
  GETUPVAL R11 0
  GETTABLEKS R10 R11 K5 ["getYMin"]
  CALL R10 0 1
  SUB R9 R5 R10
  GETUPVAL R12 0
  GETTABLEKS R11 R12 K6 ["getYMax"]
  CALL R11 0 1
  GETUPVAL R13 0
...
PROTO_7:
  ...
  GETUPVAL R5 0
  GETTABLEKS R4 R5 K1 ["log2"]
  GETUPVAL R6 0
  GETTABLEKS R5 R6 K2 ["getXMax"]
  CALL R5 0 -1
  CALL R4 -1 1
  MUL R2 R3 R4
  ...
  SUBRK R4 R3 K5 ["Y"]
  GETUPVAL R6 0
  GETTABLEKS R5 R6 K1 ["log2"]
  GETUPVAL R7 0
  GETTABLEKS R6 R7 K4 ["getXMin"]
  CALL R6 0 -1
  CALL R5 -1 1
  MUL R3 R4 R5
  ADD R1 R2 R3
  ...
  CALL R3 3 1
  GETUPVAL R8 1
  DIVRK R7 R3 K8 [math.clamp]
  POW R6 R3 R7
  GETUPVAL R9 0
  GETTABLEKS R8 R9 K9 ["getYMax"]
  CALL R8 0 1
  GETUPVAL R10 0
  GETTABLEKS R9 R10 K10 ["getYMin"]
  CALL R9 0 1
  SUB R7 R8 R9
  MUL R5 R6 R7
  GETUPVAL R7 0
  GETTABLEKS R6 R7 K10 ["getYMin"]
  CALL R6 0 1
  ADD R4 R5 R6
