...
PROTO_16:
  ...
  JUMPIFNOT R4 [+6]
  GETUPVAL R39 9
  GETTABLEKS R38 R39 K37 ["EnableGrayHoverDeviceEmulator"]
  JUMPIFNOT R38 [+2]
  LOADK R37 K38 ["Hovered"]
  JUMP [+1]
  LOADNIL R37
  CALL R33 4 1
  SETTABLE R33 R31 R32
  GETUPVAL R34 2
  GETTABLEKS R33 R34 K39 ["Event"]
  GETTABLEKS R32 R33 K40 ["InputBegan"]
  SETTABLE R24 R31 R32
  GETUPVAL R34 2
  GETTABLEKS R33 R34 K39 ["Event"]
  GETTABLEKS R32 R33 K41 ["MouseEnter"]
  NEWCLOSURE R33 P8
  CAPTURE VAL R5
  SETTABLE R33 R31 R32
  GETUPVAL R34 2
  GETTABLEKS R33 R34 K39 ["Event"]
  GETTABLEKS R32 R33 K42 ["MouseLeave"]
  NEWCLOSURE R33 P9
  CAPTURE VAL R5
  SETTABLE R33 R31 R32
  CALL R29 2 1
...
MAIN:
  ...
  GETTABLEKS R8 R9 K17 ["MockableEngineFeatures"]
  CALL R7 1 1
  ...
  CALL R9 1 1
  GETTABLEKS R10 R2 K20 ["THUMBSTICK_KEYCODE_TO_THUMBSTICK_CLICK"]
