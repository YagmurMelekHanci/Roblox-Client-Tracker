PROTO_0:
  ...
  JUMPIFNOTEQ R0 R2 [+32]
  GETUPVAL R3 0
  GETTABLEKS R2 R3 K15 ["EnableVRControllers"]
  JUMPIFNOT R2 [+21]
  JUMPIFNOT R1 [+18]
  GETIMPORT R2 K18 [string.find]
  MOVE R3 R1
  GETUPVAL R5 1
  GETTABLEKS R4 R5 K19 ["QUEST3_EMULATED_DEVICE_ID"]
  CALL R2 2 1
  JUMPIF R2 [+8]
  GETIMPORT R2 K18 [string.find]
  MOVE R3 R1
  GETUPVAL R5 1
  GETTABLEKS R4 R5 K20 ["META_QUEST_3_NAME"]
  CALL R2 2 1
  JUMPIFNOT R2 [+2]
  LOADK R2 K21 ["Quest3"]
  RETURN R2 1
  LOADK R2 K22 ["Quest2"]
  RETURN R2 1
  JUMPIFNOTEQKS R1 K23 ["Quest 3"] [+3]
  LOADK R2 K21 ["Quest3"]
  RETURN R2 1
  LOADK R2 K22 ["Quest2"]
  RETURN R2 1
