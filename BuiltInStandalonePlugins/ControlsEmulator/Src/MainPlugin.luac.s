...
PROTO_37:
  ...
  MOVE R2 R4
  DUPTABLE R3 K10 [{"enabled", "wrapperRef", "activeInputs", "isVRConnected", "DEPRECATED_vrActiveUserCFrame", "activeVRUserCFrames"}]
  SETTABLEKS R2 R3 K4 ["enabled"]
  LOADNIL R4
  SETTABLEKS R4 R3 K5 ["wrapperRef"]
  NEWTABLE R4 0 0
  SETTABLEKS R4 R3 K6 ["activeInputs"]
  LOADB R4 0
  SETTABLEKS R4 R3 K7 ["isVRConnected"]
  GETIMPORT R4 K14 [Enum.UserCFrame.Head]
  SETTABLEKS R4 R3 K8 ["DEPRECATED_vrActiveUserCFrame"]
  NEWTABLE R4 4 0
  GETIMPORT R5 K14 [Enum.UserCFrame.Head]
  LOADB R6 1
  SETTABLE R6 R4 R5
  GETIMPORT R5 K16 [Enum.UserCFrame.LeftHand]
  LOADB R6 1
  SETTABLE R6 R4 R5
  GETIMPORT R5 K18 [Enum.UserCFrame.RightHand]
  LOADB R6 1
  SETTABLE R6 R4 R5
  SETTABLEKS R4 R3 K9 ["activeVRUserCFrames"]
  SETTABLEKS R3 R0 K19 ["state"]
  GETUPVAL R4 1
  GETTABLEKS R3 R4 K20 ["createRef"]
  CALL R3 0 1
  SETTABLEKS R3 R0 K21 ["callbacksRef"]
  LOADNIL R3
  SETTABLEKS R3 R0 K22 ["connEmulatedDeviceChanged"]
  NEWCLOSURE R3 P0
  CAPTURE UPVAL U2
  CAPTURE UPVAL U3
  CAPTURE UPVAL U4
  CAPTURE VAL R0
  SETTABLEKS R3 R0 K23 ["updateEmulatedDevice"]
  LOADNIL R3
  SETTABLEKS R3 R0 K24 ["connVRActiveUserCFrameChanged"]
  NEWCLOSURE R3 P1
  CAPTURE VAL R0
  CAPTURE UPVAL U0
  CAPTURE UPVAL U2
  CAPTURE UPVAL U5
  SETTABLEKS R3 R0 K25 ["connectToVRActiveUserCFrameChanged"]
  NEWCLOSURE R3 P2
  CAPTURE VAL R0
  CAPTURE UPVAL U2
  CAPTURE UPVAL U3
  CAPTURE UPVAL U4
  SETTABLEKS R3 R0 K26 ["connectToEmulatedDeviceChange"]
  GETTABLEKS R6 R0 K27 ["props"]
  GETTABLEKS R5 R6 K28 ["Plugin"]
  GETTABLEKS R4 R5 K29 ["MultipleDocumentInterfaceInstance"]
  GETTABLEKS R3 R4 K30 ["FocusedDataModelSession"]
  NEWCLOSURE R4 P3
  CAPTURE UPVAL U6
  CAPTURE VAL R3
  NEWCLOSURE R5 P4
  ...
  CAPTURE UPVAL U2
  CAPTURE UPVAL U7
  SETTABLEKS R7 R0 K31 ["toggleEnabled"]
  NEWCLOSURE R7 P7
  CAPTURE VAL R0
  CAPTURE UPVAL U4
  CAPTURE UPVAL U6
  CAPTURE UPVAL U2
  CAPTURE VAL R3
  SETTABLEKS R7 R0 K32 ["onClose"]
  NEWCLOSURE R7 P8
  CAPTURE VAL R0
  SETTABLEKS R7 R0 K33 ["onRestore"]
  NEWCLOSURE R7 P9
  CAPTURE VAL R0
  SETTABLEKS R7 R0 K34 ["onWidgetEnabledChanged"]
  NEWCLOSURE R7 P10
  CAPTURE VAL R0
  CAPTURE UPVAL U2
  CAPTURE UPVAL U8
  ...
  CAPTURE UPVAL U4
  CAPTURE UPVAL U0
  SETTABLEKS R7 R0 K35 ["onDockWidgetCreated"]
  GETTABLEKS R9 R0 K27 ["props"]
  GETTABLEKS R8 R9 K28 ["Plugin"]
  GETTABLEKS R7 R8 K36 ["Unloading"]
  NEWCLOSURE R9 P11
  CAPTURE VAL R0
  NAMECALL R7 R7 K37 ["Connect"]
  CALL R7 2 0
  GETGLOBAL R7 K38 ["getLocalization"]
  CALL R7 0 1
  SETTABLEKS R7 R0 K39 ["localization"]
  GETUPVAL R9 9
  GETTABLEKS R8 R9 K40 ["Analytics"]
  GETTABLEKS R7 R8 K41 ["new"]
  DUPCLOSURE R8 K42 [PROTO_36]
  NEWTABLE R9 0 0
  CALL R7 2 1
  SETTABLEKS R7 R0 K43 ["analytics"]
  GETUPVAL R8 10
  GETTABLEKS R7 R8 K41 ["new"]
  CALL R7 0 1
  SETTABLEKS R7 R0 K44 ["DEPRECATED_stylizer"]
  GETUPVAL R7 11
  GETTABLEKS R8 R1 K28 ["Plugin"]
  CALL R7 1 1
  SETTABLEKS R7 R0 K45 ["design"]
  RETURN R0 0
...
MAIN:
  ...
  DUPCLOSURE R40 K62 [PROTO_41]
  CAPTURE VAL R26
  CAPTURE VAL R34
  SETTABLEKS R40 R38 K63 ["didUpdate"]
  DUPCLOSURE R40 K64 [PROTO_47]
  CAPTURE VAL R1
  CAPTURE VAL R25
  CAPTURE VAL R24
  CAPTURE VAL R34
