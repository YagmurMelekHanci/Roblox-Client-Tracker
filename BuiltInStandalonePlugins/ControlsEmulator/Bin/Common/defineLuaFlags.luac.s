...
MAIN:
  ...
  NAMECALL R0 R0 K3 ["DefineFastFlag"]
  CALL R0 3 0
  DUPTABLE R0 K10 [{"getFFlagEnableControlsEmulator", "getFFlagEnableVRControllers", "getFFlagEnableGrayHoverDeviceEmulator", "getFFlagFixEmulatorConnectionSignals", "getFFlagFixEmulatorSetup"}]
  ...
  SETTABLEKS R1 R0 K8 ["getFFlagFixEmulatorConnectionSignals"]
  DUPCLOSURE R1 K15 [PROTO_4]
  SETTABLEKS R1 R0 K9 ["getFFlagFixEmulatorSetup"]
  RETURN R0 1
