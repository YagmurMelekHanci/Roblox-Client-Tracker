...
MAIN:
  ...
  LOADK R16 K28 ["RibbonControlsRefactor"]
  NAMECALL R14 R14 K27 ["GetFastFlag"]
  CALL R14 2 1
  GETTABLEKS R15 R1 K29 ["PureComponent"]
  LOADK R17 K30 ["DebuggerToolbarButtons"]
  ...
  SETTABLEKS R16 R15 K35 ["addAction"]
  ...
  CAPTURE VAL R13
  CAPTURE VAL R14
  SETTABLEKS R16 R15 K39 ["renderButtons"]
  DUPCLOSURE R16 K40 [PROTO_14]
  CAPTURE VAL R1
  CAPTURE VAL R9
  SETTABLEKS R16 R15 K41 ["render"]
  GETTABLEKS R16 R4 K42 ["withContext"]
  DUPTABLE R17 K43 [{"Analytics", "PluginActions"}]
  SETTABLEKS R5 R17 K10 ["Analytics"]
  SETTABLEKS R6 R17 K11 ["PluginActions"]
  CALL R16 1 1
  MOVE R17 R15
  CALL R16 1 1
  MOVE R15 R16
  GETTABLEKS R16 R2 K44 ["connect"]
