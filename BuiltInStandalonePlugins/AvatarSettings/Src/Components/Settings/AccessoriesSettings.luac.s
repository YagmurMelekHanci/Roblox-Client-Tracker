PROTO_0:
  ...
  SETTABLE R7 R5 R6
  DUPTABLE R6 K10 [{"AccessoriesScaleSection", "CustomAccessoriesSection", "AccessoryBehaviorsSection"}]
  GETUPVAL R7 3
  GETUPVAL R8 5
  ...
  CALL R7 2 1
  SETTABLEKS R7 R6 K7 ["AccessoriesScaleSection"]
  GETUPVAL R7 3
  GETUPVAL R8 6
  DUPTABLE R9 K12 [{"layoutOrder"}]
  MOVE R10 R2
  ...
  SETTABLEKS R10 R9 K11 ["layoutOrder"]
  CALL R7 2 1
  SETTABLEKS R7 R6 K8 ["CustomAccessoriesSection"]
  GETUPVAL R7 3
  GETUPVAL R8 7
  DUPTABLE R9 K12 [{"layoutOrder"}]
  MOVE R10 R2
  ...
  SETTABLEKS R10 R9 K11 ["layoutOrder"]
  CALL R7 2 1
  SETTABLEKS R7 R6 K9 ["AccessoryBehaviorsSection"]
  CALL R3 3 -1
  RETURN R3 -1
...
MAIN:
  ...
  GETTABLEKS R3 R4 K8 ["AccessoriesSettings"]
  GETTABLEKS R2 R3 K9 ["AccessoriesScaleSection"]
  CALL R1 1 1
  GETIMPORT R2 K5 [require]
  GETTABLEKS R6 R0 K6 ["Src"]
  GETTABLEKS R5 R6 K7 ["Components"]
  GETTABLEKS R4 R5 K8 ["AccessoriesSettings"]
  GETTABLEKS R3 R4 K10 ["AccessoryBehaviorsSection"]
  CALL R2 1 1
  ...
  GETTABLEKS R6 R7 K8 ["AccessoriesSettings"]
  GETTABLEKS R5 R6 K13 ["CustomAccessoriesSection"]
  CALL R4 1 1
