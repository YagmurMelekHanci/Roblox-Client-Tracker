MAIN:
  ...
  CALL R2 1 1
  GETTABLEKS R3 R2 K16 ["getFFlagEnableEditor"]
  CALL R3 0 1
  JUMPIF R3 [+1]
  RETURN R0 0
  ...
  GETTABLEKS R5 R6 K19 ["AssetUtil"]
  CALL R4 1 1
  GETTABLEKS R5 R4 K20 ["setup"]
  GETIMPORT R6 K1 [plugin]
  CALL R5 1 0
  GETTABLEKS R5 R3 K21 ["get"]
  CALL R5 0 1
  GETTABLEKS R6 R3 K22 ["Asset"]
  JUMPIFEQ R5 R6 [+2]
  RETURN R0 0
  GETIMPORT R5 K7 [require]
  GETTABLEKS R8 R0 K13 ["Bin"]
  GETTABLEKS R7 R8 K14 ["Common"]
  GETTABLEKS R6 R7 K20 ["setup"]
  CALL R5 1 1
