...
PROTO_6:
  ...
  GETTABLEKS R11 R12 K7 ["itemStarted"]
  NAMECALL R9 R9 K8 ["HasItem"]
  CALL R9 2 1
  JUMPIFNOT R9 [+3]
  MOVE R9 R4
  CALL R9 0 0
  ...
  GETUPVAL R13 2
  GETTABLEKS R12 R13 K4 ["fromHost"]
  GETTABLEKS R11 R12 K9 ["starting"]
  MOVE R12 R4
  NAMECALL R9 R0 K6 ["OnInvokeSuspendOverride"]
  CALL R9 3 1
  MOVE R7 R9
  NEWCLOSURE R9 P3
  CAPTURE REF R7
