...
MAIN:
  ...
  CALL R3 0 1
  DUPTABLE R4 K26 [{"EXPERIENCES_SEARCH_URL", "TEMPLATES_SEARCH_URL", "PLACES_SEARCH_URL", "GROUPS_SEARCH_URL", "EXPERIENCES_ICON_URL", "TEAM_CREATE_ACTIVE_SESSION_MEMBERS_URL", "AVATAR_ICON_URL", "MULTI_AGE_RECOMMENDATION", "MULTI_CREATOR_ELIGIBILITY", "MULTI_TEAM_CREATE_STATUS", "ACTIVATE_UNIVERSE", "DEACTIVATE_UNIVERSE", "UNIVERSE_CONFIGURATION", "UNIVERSE_DATA", "TEAMCREATE_MEMBERSHIPS"}]
  DUPTABLE R5 K28 [{"Prefix", "Url"}]
  GETTABLEKS R6 R3 K29 ["APIS_URL"]
  SETTABLEKS R6 R5 K27 ["Prefix"]
  DUPCLOSURE R6 K30 [PROTO_0]
  SETTABLEKS R6 R5 K9 ["Url"]
  SETTABLEKS R5 R4 K11 ["EXPERIENCES_SEARCH_URL"]
  DUPTABLE R5 K28 [{"Prefix", "Url"}]
  GETTABLEKS R6 R3 K31 ["DEVELOP_URL"]
  SETTABLEKS R6 R5 K27 ["Prefix"]
  ...
  DUPTABLE R5 K28 [{"Prefix", "Url"}]
  GETTABLEKS R6 R3 K35 ["THUMBNAILS_URL"]
  SETTABLEKS R6 R5 K27 ["Prefix"]
  DUPCLOSURE R6 K36 [PROTO_4]
  SETTABLEKS R6 R5 K9 ["Url"]
  SETTABLEKS R5 R4 K15 ["EXPERIENCES_ICON_URL"]
  DUPTABLE R5 K28 [{"Prefix", "Url"}]
  GETTABLEKS R6 R3 K29 ["APIS_URL"]
  SETTABLEKS R6 R5 K27 ["Prefix"]
  DUPCLOSURE R6 K37 [PROTO_5]
  SETTABLEKS R6 R5 K9 ["Url"]
