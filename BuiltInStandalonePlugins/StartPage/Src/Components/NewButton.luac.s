PROTO_0:
  ...
  JUMP [+7]
  GETUPVAL R0 1
  LOADK R2 K1 [95206881]
  LOADK R3 K2 [28220420]
  LOADB R4 0
  NAMECALL R0 R0 K0 ["openPlace"]
  CALL R0 4 0
  GETUPVAL R0 3
...
MAIN:
  ...
  GETTABLEKS R14 R15 K25 ["StartPageTelemetryEvent"]
  CALL R13 1 1
  GETIMPORT R14 K5 [require]
  GETTABLEKS R17 R0 K15 ["Src"]
  GETTABLEKS R16 R17 K20 ["SharedFlags"]
  GETTABLEKS R15 R16 K26 ["getFStringStudioDefaultNewTemplatePlaceId"]
  CALL R14 1 1
  CALL R14 0 1
  GETIMPORT R15 K5 [require]
  GETTABLEKS R18 R0 K15 ["Src"]
  GETTABLEKS R17 R18 K20 ["SharedFlags"]
  GETTABLEKS R16 R17 K27 ["getFFlagLuaStartPagePlaceIdHardcodeRemoval"]
  CALL R15 1 1
  CALL R15 0 1
