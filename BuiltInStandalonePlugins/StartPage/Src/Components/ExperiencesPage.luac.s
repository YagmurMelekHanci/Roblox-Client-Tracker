...
PROTO_14:
  ...
  GETUPVAL R6 6
  DUPTABLE R7 K9 [{"Size", "PageName", "Tabs", "CanSwapBetweenViews", "IsDefaultGridView", "HasSearchBar", "IsAlertVisible"}]
  GETUPVAL R9 7
  JUMPIFNOT R9 [+2]
  LOADNIL R8
  JUMP [+2]
  ...
  LOADK R14 K25 ["ExperiencesPage.Group"]
  ...
  DUPTABLE R11 K16 [{"Title", "FailedTitle", "Key", "PageComponent", "Dropdowns"}]
  LOADK R14 K17 ["Plugin"]
  LOADK R15 K30 ["ExperiencesPage.Shared"]
  NAMECALL R12 R1 K19 ["getText"]
  CALL R12 3 1
  SETTABLEKS R12 R11 K11 ["Title"]
  LOADK R14 K17 ["Plugin"]
  LOADK R15 K31 ["NoSharedExperiencesToDisplay"]
  NAMECALL R12 R1 K19 ["getText"]
  CALL R12 3 1
  SETTABLEKS R12 R11 K12 ["FailedTitle"]
  LOADK R12 K32 ["Shared"]
  SETTABLEKS R12 R11 K13 ["Key"]
  GETUPVAL R12 10
  SETTABLEKS R12 R11 K14 ["PageComponent"]
  DUPTABLE R12 K24 [{"SortDropdown", "DefaultSortIndex"}]
  SETTABLEKS R4 R12 K22 ["SortDropdown"]
  LOADN R13 4
  SETTABLEKS R13 R12 K23 ["DefaultSortIndex"]
  SETTABLEKS R12 R11 K15 ["Dropdowns"]
  DUPTABLE R12 K16 [{"Title", "FailedTitle", "Key", "PageComponent", "Dropdowns"}]
  LOADK R15 K17 ["Plugin"]
  LOADK R16 K33 ["ExperiencesPage.Local"]
  NAMECALL R13 R1 K19 ["getText"]
  CALL R13 3 1
  SETTABLEKS R13 R12 K11 ["Title"]
  LOADK R15 K17 ["Plugin"]
  LOADK R16 K34 ["NoLocalFilesToDisplay"]
  NAMECALL R13 R1 K19 ["getText"]
  CALL R13 3 1
  SETTABLEKS R13 R12 K12 ["FailedTitle"]
  LOADK R13 K35 ["Local"]
  SETTABLEKS R13 R12 K13 ["Key"]
  GETUPVAL R13 11
  SETTABLEKS R13 R12 K14 ["PageComponent"]
  NEWTABLE R13 0 0
  SETTABLEKS R13 R12 K15 ["Dropdowns"]
  SETLIST R8 R9 4 [1]
  ...
  GETUPVAL R9 12
  ANDK R8 R9 K36 [True]
  SETTABLEKS R8 R7 K8 ["IsAlertVisible"]
  CALL R5 2 -1
  RETURN R5 -1
...
MAIN:
  ...
  GETTABLEKS R9 R10 K16 ["getFFlagLuaStartPageAlertForUsersTextChat"]
  CALL R8 1 1
  CALL R8 0 1
  ...
  GETTABLEKS R20 R21 K32 ["DiscoverExperiences"]
  CALL R19 1 1
  JUMP [+9]
  GETIMPORT R19 K5 [require]
  GETTABLEKS R22 R0 K11 ["Src"]
  GETTABLEKS R21 R22 K31 ["DEPRECATED_Network"]
  GETTABLEKS R20 R21 K32 ["DiscoverExperiences"]
  CALL R19 1 1
  JUMPIFNOT R5 [+10]
  ...
  GETTABLEKS R21 R22 K33 ["DiscoverRecents"]
  CALL R20 1 1
  JUMP [+9]
  GETIMPORT R20 K5 [require]
  GETTABLEKS R23 R0 K11 ["Src"]
  GETTABLEKS R22 R23 K31 ["DEPRECATED_Network"]
  GETTABLEKS R21 R22 K33 ["DiscoverRecents"]
  CALL R20 1 1
  GETIMPORT R21 K5 [require]
  GETTABLEKS R24 R0 K11 ["Src"]
  GETTABLEKS R23 R24 K29 ["Network"]
  GETTABLEKS R22 R23 K34 ["DiscoverCreatorEligibilityAndOpenPlace"]
  CALL R21 1 1
  ...
  GETTABLEKS R30 R31 K44 ["getFFlagLuaStartPageAtomicTestsFixes"]
  CALL R29 1 1
  GETIMPORT R30 K5 [require]
  GETTABLEKS R33 R0 K11 ["Src"]
  GETTABLEKS R32 R33 K12 ["SharedFlags"]
  GETTABLEKS R31 R32 K45 ["getFFlagLuaStartPageWrappedTitles"]
  CALL R30 1 1
  CALL R30 0 1
  ...
  LOADN R37 62
  CALL R33 4 1
  DUPCLOSURE R34 K49 [PROTO_0]
  CAPTURE VAL R10
  CAPTURE VAL R23
  DUPTABLE R35 K54 [{"searchKey", "isArchived", "isTemplates", "pageSize"}]
  LOADK R36 K55 ["Experiences"]
  SETTABLEKS R36 R35 K50 ["searchKey"]
  LOADB R36 0
  SETTABLEKS R36 R35 K51 ["isArchived"]
  LOADB R36 0
  SETTABLEKS R36 R35 K52 ["isTemplates"]
  LOADN R36 30
  SETTABLEKS R36 R35 K53 ["pageSize"]
  DUPCLOSURE R36 K56 [PROTO_4]
  CAPTURE VAL R12
  CAPTURE VAL R35
  CAPTURE VAL R1
  CAPTURE VAL R15
