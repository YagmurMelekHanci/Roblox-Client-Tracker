...
PROTO_22:
  ...
  LOADK R23 K28 ["X-Fill X-Transparent"]
  SETTABLE R23 R21 R22
  DUPTABLE R22 K32 [{"DarkShadow", "Dropdown", "FocusedSearchBar"}]
  JUMPIFNOT R5 [+26]
  LENGTH R24 R5
  LOADN R25 0
  ...
  CAPTURE VAL R6
  CAPTURE VAL R0
  SETTABLEKS R26 R25 K35 ["OnClick"]
  GETUPVAL R27 1
  GETTABLEKS R26 R27 K8 ["Tag"]
  LOADK R27 K36 ["X-Fill StartPage-StandardDarkBackground"]
  SETTABLE R27 R25 R26
  CALL R23 2 1
  JUMP [+1]
  LOADNIL R23
  SETTABLEKS R23 R22 K29 ["DarkShadow"]
  JUMPIFNOT R5 [+69]
  LENGTH R24 R5
  LOADN R25 3
  ...
  GETTABLEKS R23 R24 K1 ["createElement"]
  GETUPVAL R24 7
  DUPTABLE R25 K44 [{"Size", "Position", "Query", "BaseQuery", "ResultComponent", "AreSearchResultsLoading", "Dropdowns", "InitialContentHasLoaded", "MoreExperiencesRequested"}]
  GETIMPORT R26 K23 [UDim2.new]
  LOADN R27 0
  GETTABLEKS R29 R7 K46 ["X"]
  ADDK R28 R29 K45 [40]
  LOADN R29 0
  LOADN R30 188
  CALL R26 4 1
  ...
  GETIMPORT R26 K23 [UDim2.new]
  LOADN R27 0
  GETTABLEKS R29 R9 K46 ["X"]
  SUBK R28 R29 K47 [20]
  LOADN R29 0
  GETTABLEKS R31 R9 K48 ["Y"]
  SUBK R30 R31 K47 [20]
  CALL R26 4 1
  JUMP [+5]
  GETIMPORT R26 K50 [UDim2.fromScale]
  LOADN R27 0
  LOADN R28 0
  CALL R26 2 1
  SETTABLEKS R26 R25 K4 ["Position"]
  SETTABLEKS R5 R25 K37 ["Query"]
  GETTABLEKS R26 R0 K38 ["BaseQuery"]
  SETTABLEKS R26 R25 K38 ["BaseQuery"]
  GETTABLEKS R26 R0 K39 ["ResultComponent"]
  SETTABLEKS R26 R25 K39 ["ResultComponent"]
  SETTABLEKS R3 R25 K40 ["AreSearchResultsLoading"]
  NEWTABLE R26 0 0
  SETTABLEKS R26 R25 K41 ["Dropdowns"]
  NEWCLOSURE R26 P6
  CAPTURE VAL R4
  SETTABLEKS R26 R25 K42 ["InitialContentHasLoaded"]
  NEWCLOSURE R26 P7
  CAPTURE VAL R0
  CAPTURE VAL R5
  CAPTURE VAL R6
  CAPTURE VAL R2
  SETTABLEKS R26 R25 K43 ["MoreExperiencesRequested"]
  CALL R23 2 1
  JUMP [+1]
  LOADNIL R23
  SETTABLEKS R23 R22 K30 ["Dropdown"]
  GETUPVAL R24 1
  GETTABLEKS R23 R24 K1 ["createElement"]
  LOADK R24 K2 ["Frame"]
  NEWTABLE R25 4 0
  GETIMPORT R26 K23 [UDim2.new]
  LOADN R27 0
  GETTABLEKS R28 R7 K46 ["X"]
  LOADN R29 0
  GETTABLEKS R30 R7 K48 ["Y"]
  CALL R26 4 1
  SETTABLEKS R26 R25 K3 ["Size"]
  JUMPIFNOT R9 [+10]
  GETIMPORT R26 K23 [UDim2.new]
  LOADN R27 0
  GETTABLEKS R28 R9 K46 ["X"]
  LOADN R29 0
  GETTABLEKS R30 R9 K48 ["Y"]
  CALL R26 4 1
  JUMP [+5]
  GETIMPORT R26 K50 [UDim2.fromScale]
  LOADN R27 0
  ...
  CALL R26 2 1
  SETTABLEKS R26 R25 K4 ["Position"]
  LOADK R26 K26 [999999]
  SETTABLEKS R26 R25 K51 ["ZIndex"]
  GETUPVAL R27 1
  GETTABLEKS R26 R27 K8 ["Tag"]
  LOADK R27 K52 ["StartPage-Border StartPage-PageBackground StartPage-RoundedCorner16"]
  SETTABLE R27 R25 R26
  NEWTABLE R26 0 1
  GETUPVAL R28 1
  GETTABLEKS R27 R28 K1 ["createElement"]
  GETUPVAL R28 2
  DUPTABLE R29 K54 [{"Size", "OnFocused", "OnFocusLost", "OnTextChanged", "OnCancelled", "IsFocused", "Text", "Type"}]
  ...
  NEWCLOSURE R30 P9
  CAPTURE VAL R4
  SETTABLEKS R30 R29 K25 ["OnFocusLost"]
  NEWCLOSURE R30 P10
  CAPTURE VAL R1
  CAPTURE VAL R6
  CAPTURE VAL R4
  ...
  SETLIST R26 R27 -1 [1]
  CALL R23 3 1
  SETTABLEKS R23 R22 K31 ["FocusedSearchBar"]
  CALL R19 3 -1
  SETLIST R18 R19 -1 [1]
  CALL R15 3 1
  JUMP [+1]
...
MAIN:
  ...
  GETTABLEKS R4 R5 K10 ["getFFlagLuaStartPageAtomicTestsFixes"]
  CALL R3 1 1
  CALL R3 0 1
  ...
  GETTABLEKS R8 R4 K16 ["useContext"]
  ...
  GETTABLEKS R30 R31 K40 ["Network"]
  GETTABLEKS R29 R30 K41 ["DiscoverCreatorEligibilityAndOpenPlace"]
  CALL R28 1 1
  JUMP [+9]
  GETIMPORT R28 K5 [require]
  GETTABLEKS R31 R0 K6 ["Src"]
  GETTABLEKS R30 R31 K42 ["DEPRECATED_Network"]
  GETTABLEKS R29 R30 K41 ["DiscoverCreatorEligibilityAndOpenPlace"]
  CALL R28 1 1
