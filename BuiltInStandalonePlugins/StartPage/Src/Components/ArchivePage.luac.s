...
MAIN:
  ...
  GETTABLEKS R23 R24 K34 ["getFFlagLuaStartPagePlaceOpenAttributionTelemetry"]
  CALL R22 1 1
  CALL R22 0 1
  GETTABLEKS R23 R10 K35 ["StudioService"]
  GETIMPORT R24 K5 [require]
  GETTABLEKS R28 R0 K11 ["Src"]
  GETTABLEKS R27 R28 K19 ["Util"]
  GETTABLEKS R26 R27 K36 ["Telemetry"]
  GETTABLEKS R25 R26 K37 ["TelemetryContext"]
  CALL R24 1 1
  GETIMPORT R25 K5 [require]
  GETTABLEKS R29 R0 K11 ["Src"]
  GETTABLEKS R28 R29 K19 ["Util"]
  GETTABLEKS R27 R28 K36 ["Telemetry"]
  GETTABLEKS R26 R27 K38 ["StartPageTelemetryEvent"]
  CALL R25 1 1
  ...
  CAPTURE VAL R7
  CAPTURE VAL R19
  DUPTABLE R29 K47 [{"searchKey", "isArchived", "isTemplates", "pageSize"}]
  LOADK R30 K48 ["Archive"]
  SETTABLEKS R30 R29 K43 ["searchKey"]
  LOADB R30 1
  SETTABLEKS R30 R29 K44 ["isArchived"]
  LOADB R30 0
  SETTABLEKS R30 R29 K45 ["isTemplates"]
  LOADN R30 30
  SETTABLEKS R30 R29 K46 ["pageSize"]
