...
MAIN:
  ...
  GETTABLEKS R22 R23 K33 ["getFFlagLuaStartPagePlaceOpenAttributionTelemetry"]
  CALL R21 1 1
  CALL R21 0 1
  ...
  GETTABLEKS R25 R26 K35 ["Telemetry"]
  GETTABLEKS R24 R25 K36 ["TelemetryContext"]
  CALL R23 1 1
  GETIMPORT R24 K5 [require]
  GETTABLEKS R28 R0 K11 ["Src"]
  GETTABLEKS R27 R28 K19 ["Util"]
  GETTABLEKS R26 R27 K35 ["Telemetry"]
  GETTABLEKS R25 R26 K37 ["StartPageTelemetryEvent"]
  CALL R24 1 1
  ...
  CAPTURE VAL R7
  CAPTURE VAL R19
  DUPTABLE R28 K46 [{"searchKey", "isArchived", "isTemplates", "pageSize"}]
  LOADK R29 K47 ["Archive"]
  SETTABLEKS R29 R28 K42 ["searchKey"]
  LOADB R29 1
  SETTABLEKS R29 R28 K43 ["isArchived"]
  LOADB R29 0
  SETTABLEKS R29 R28 K44 ["isTemplates"]
  LOADN R29 30
  SETTABLEKS R29 R28 K45 ["pageSize"]
