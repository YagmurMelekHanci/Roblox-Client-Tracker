...
MAIN:
  ...
  GETTABLEKS R23 R24 K34 ["getFFlagLuaStartPageWrappedTitles"]
  CALL R22 1 1
  GETIMPORT R23 K5 [require]
  GETTABLEKS R26 R0 K11 ["Src"]
  GETTABLEKS R25 R26 K12 ["SharedFlags"]
  GETTABLEKS R24 R25 K35 ["getFFlagLuaStartPagePlaceOpenAttributionTelemetry"]
  CALL R23 1 1
  CALL R23 0 1
  GETTABLEKS R24 R10 K36 ["StudioService"]
  ...
  CAPTURE VAL R7
  CAPTURE VAL R19
  DUPTABLE R30 K48 [{"searchKey", "isArchived", "isTemplates", "pageSize"}]
  LOADK R31 K49 ["Archive"]
  SETTABLEKS R31 R30 K44 ["searchKey"]
  LOADB R31 1
  SETTABLEKS R31 R30 K45 ["isArchived"]
  LOADB R31 0
  SETTABLEKS R31 R30 K46 ["isTemplates"]
  LOADN R31 30
  SETTABLEKS R31 R30 K47 ["pageSize"]
