...
MAIN:
  ...
  GETTABLEKS R7 R1 K13 ["keys"]
  GETTABLEKS R8 R2 K14 ["ContextServices"]
  GETTABLEKS R9 R8 K15 ["withContext"]
  GETTABLEKS R10 R8 K16 ["Analytics"]
  GETTABLEKS R11 R8 K17 ["Localization"]
  GETTABLEKS R12 R2 K18 ["UI"]
  GETTABLEKS R13 R12 K19 ["Pane"]
  GETTABLEKS R14 R12 K20 ["TextInput"]
  GETTABLEKS R15 R12 K21 ["TreeTable"]
  GETTABLEKS R17 R0 K22 ["Src"]
  GETTABLEKS R16 R17 K23 ["Actions"]
  GETIMPORT R17 K5 [require]
  GETTABLEKS R18 R16 K24 ["SetExpandedSections"]
  CALL R17 1 1
  GETIMPORT R18 K5 [require]
  GETTABLEKS R19 R16 K25 ["SetHistoryField"]
  CALL R18 1 1
  GETTABLEKS R20 R0 K22 ["Src"]
  GETTABLEKS R19 R20 K26 ["Components"]
  GETIMPORT R20 K5 [require]
  GETTABLEKS R21 R19 K27 ["LayerViewCell"]
  CALL R20 1 1
  GETTABLEKS R22 R0 K22 ["Src"]
  GETTABLEKS R21 R22 K28 ["Thunks"]
  GETIMPORT R22 K5 [require]
  GETTABLEKS R23 R21 K29 ["SetOverride"]
  CALL R22 1 1
  GETTABLEKS R24 R0 K22 ["Src"]
  GETTABLEKS R23 R24 K30 ["Util"]
  GETIMPORT R24 K5 [require]
  GETTABLEKS R25 R23 K31 ["Constants"]
  CALL R24 1 1
  GETIMPORT R25 K5 [require]
  GETTABLEKS R26 R23 K32 ["debugFlags"]
  CALL R25 1 1
  ...
  DUPTABLE R28 K39 [{"layerDetails", "props", "state", "watches"}]
  DUPTABLE R29 K41 [{"Formatters"}]
  DUPTABLE R30 K43 [{"weight"}]
  SETTABLEKS R27 R30 K42 ["weight"]
  SETTABLEKS R30 R29 K40 ["Formatters"]
  SETTABLEKS R29 R28 K35 ["layerDetails"]
  DUPTABLE R29 K47 [{"Editable", "Overrides", "History"}]
  LOADB R30 1
  SETTABLEKS R30 R29 K44 ["Editable"]
  LOADB R30 1
  SETTABLEKS R30 R29 K45 ["Overrides"]
  LOADB R30 1
  SETTABLEKS R30 R29 K46 ["History"]
  SETTABLEKS R29 R28 K36 ["props"]
  DUPTABLE R29 K48 [{"History"}]
  LOADB R30 1
  SETTABLEKS R30 R29 K46 ["History"]
  SETTABLEKS R29 R28 K37 ["state"]
  DUPTABLE R29 K48 [{"History"}]
  LOADB R30 1
  SETTABLEKS R30 R29 K46 ["History"]
  SETTABLEKS R29 R28 K38 ["watches"]
  DUPTABLE R29 K54 [{"number", "string", "boolean", "Vector2", "Vector3"}]
  DUPTABLE R30 K56 [{"Type", "History"}]
  LOADK R31 K57 ["Number"]
  SETTABLEKS R31 R30 K55 ["Type"]
  LOADB R31 1
  SETTABLEKS R31 R30 K46 ["History"]
  SETTABLEKS R30 R29 K49 ["number"]
  DUPTABLE R30 K58 [{"Type"}]
  LOADK R31 K59 ["Text"]
  SETTABLEKS R31 R30 K55 ["Type"]
  SETTABLEKS R30 R29 K50 ["string"]
  DUPTABLE R30 K58 [{"Type"}]
  LOADK R31 K60 ["Checkbox"]
  SETTABLEKS R31 R30 K55 ["Type"]
  SETTABLEKS R30 R29 K51 ["boolean"]
  DUPTABLE R30 K63 [{"Type", "Components", "GetValue", "GetComponents", "History"}]
  LOADK R31 K64 ["Vector"]
  SETTABLEKS R31 R30 K55 ["Type"]
  NEWTABLE R31 0 2
  LOADK R32 K65 ["X"]
  LOADK R33 K66 ["Y"]
  SETLIST R31 R32 2 [1]
  SETTABLEKS R31 R30 K26 ["Components"]
  DUPCLOSURE R31 K67 [PROTO_1]
  SETTABLEKS R31 R30 K61 ["GetValue"]
  DUPCLOSURE R31 K68 [PROTO_2]
  SETTABLEKS R31 R30 K62 ["GetComponents"]
  LOADB R31 1
  SETTABLEKS R31 R30 K46 ["History"]
  SETTABLEKS R30 R29 K52 ["Vector2"]
  DUPTABLE R30 K63 [{"Type", "Components", "GetValue", "GetComponents", "History"}]
  LOADK R31 K64 ["Vector"]
  SETTABLEKS R31 R30 K55 ["Type"]
  NEWTABLE R31 0 3
  ...
  SETLIST R31 R32 3 [1]
  SETTABLEKS R31 R30 K26 ["Components"]
  DUPCLOSURE R31 K70 [PROTO_3]
  SETTABLEKS R31 R30 K61 ["GetValue"]
  DUPCLOSURE R31 K71 [PROTO_4]
  SETTABLEKS R31 R30 K62 ["GetComponents"]
  LOADB R31 1
  SETTABLEKS R31 R30 K46 ["History"]
  SETTABLEKS R30 R29 K53 ["Vector3"]
  GETTABLEKS R30 R3 K72 ["PureComponent"]
  LOADK R32 K73 ["LayerView"]
  NAMECALL R30 R30 K74 ["extend"]
  CALL R30 2 1
  DUPCLOSURE R31 K75 [PROTO_11]
  CAPTURE VAL R6
  CAPTURE VAL R24
  SETTABLEKS R31 R30 K76 ["init"]
  DUPCLOSURE R31 K77 [PROTO_12]
  DUPCLOSURE R32 K78 [PROTO_14]
  CAPTURE VAL R28
  CAPTURE VAL R7
  CAPTURE VAL R5
  CAPTURE VAL R24
  ...
  CAPTURE VAL R32
  DUPCLOSURE R34 K80 [PROTO_17]
  CAPTURE VAL R25
  CAPTURE VAL R32
  DUPCLOSURE R35 K81 [PROTO_18]
  CAPTURE VAL R34
  CAPTURE VAL R3
  SETTABLEKS R35 R30 K82 ["getDerivedStateFromProps"]
  DUPCLOSURE R35 K83 [PROTO_20]
  CAPTURE VAL R0
  CAPTURE VAL R5
  CAPTURE VAL R25
  CAPTURE VAL R3
  ...
  CAPTURE VAL R20
  CAPTURE VAL R13
  SETTABLEKS R35 R30 K84 ["render"]
  MOVE R35 R9
  DUPTABLE R36 K85 [{"Analytics", "Localization"}]
  SETTABLEKS R10 R36 K16 ["Analytics"]
  SETTABLEKS R11 R36 K17 ["Localization"]
  CALL R35 1 1
  MOVE R36 R30
  CALL R35 1 1
  MOVE R30 R35
  DUPCLOSURE R35 K86 [PROTO_21]
  DUPCLOSURE R36 K87 [PROTO_25]
  CAPTURE VAL R17
  CAPTURE VAL R22
  CAPTURE VAL R18
  GETTABLEKS R37 R4 K88 ["connect"]
  MOVE R38 R35
  MOVE R39 R36
  CALL R37 2 1
  MOVE R38 R30
