...
PROTO_13:
  ...
  JUMPIFEQKNIL R18 [+22]
  MOVE R15 R18
  DUPTABLE R21 K13 [{"Id", "Icon", "Tooltip"}]
  GETUPVAL R24 2
  GETTABLEKS R23 R24 K14 ["LAYERVIEW_ACTIONS"]
  GETTABLEKS R22 R23 K15 ["Clear"]
  SETTABLEKS R22 R21 K10 ["Id"]
  LOADK R22 K16 ["rbxasset://textures/CompositorDebugger/clear.png"]
  SETTABLEKS R22 R21 K11 ["Icon"]
  LOADK R22 K17 ["ClearOverride"]
  SETTABLEKS R22 R21 K12 ["Tooltip"]
  FASTCALL2 TABLE_INSERT R16 R21 [+4]
  MOVE R20 R16
  GETIMPORT R19 K9 [table.insert]
  CALL R19 2 0
  DUPTABLE R18 K21 [{"name", "id", "path"}]
  SETTABLEKS R14 R18 K18 ["name"]
  MOVE R20 R2
  LOADK R21 K22 ["|"]
  GETIMPORT R22 K24 [table.concat]
  MOVE R23 R17
  LOADK R24 K22 ["|"]
  CALL R22 2 1
  CONCAT R19 R20 R22
  SETTABLEKS R19 R18 K19 ["id"]
  DUPTABLE R19 K27 [{"id", "section", "field"}]
  SETTABLEKS R1 R19 K19 ["id"]
  SETTABLEKS R2 R19 K25 ["section"]
  SETTABLEKS R17 R19 K26 ["field"]
  SETTABLEKS R19 R18 K20 ["path"]
  FASTCALL1 TYPEOF R15 [+3]
  MOVE R20 R15
  GETIMPORT R19 K29 [typeof]
  CALL R19 1 1
  JUMPIFNOTEQKS R19 K7 ["table"] [+23]
  DUPTABLE R20 K32 [{"Value", "Actions"}]
  LOADK R21 K33 [""]
  SETTABLEKS R21 R20 K30 ["Value"]
  SETTABLEKS R16 R20 K31 ["Actions"]
  SETTABLEKS R20 R18 K34 ["value"]
  NEWTABLE R20 0 0
  SETTABLEKS R20 R18 K35 ["children"]
  GETUPVAL R20 3
  GETTABLEKS R21 R18 K35 ["children"]
  MOVE R22 R1
  MOVE R23 R2
  MOVE R24 R15
  MOVE R25 R4
  ...
  LOADK R23 K38 ["rbxasset://textures/CompositorDebugger/history.png"]
  SETTABLEKS R23 R22 K11 ["Icon"]
  LOADK R23 K39 ["ViewHistory"]
