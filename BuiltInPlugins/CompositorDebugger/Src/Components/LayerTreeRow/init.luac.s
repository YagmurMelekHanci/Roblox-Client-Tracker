...
MAIN:
  ...
  CALL R25 1 1
  DUPTABLE R26 K39 [{"Tree", "Weight", "Timestamp"}]
  LOADN R27 250
  SETTABLEKS R27 R26 K37 ["Tree"]
  LOADN R27 40
  SETTABLEKS R27 R26 K38 ["Weight"]
  LOADN R27 100
  SETTABLEKS R27 R26 K32 ["Timestamp"]
  GETTABLEKS R27 R2 K40 ["Component"]
  LOADK R29 K41 ["LayerTreeRow"]
  NAMECALL R27 R27 K42 ["extend"]
  CALL R27 2 1
  DUPCLOSURE R28 K43 [PROTO_2]
  CAPTURE VAL R2
  SETTABLEKS R28 R27 K44 ["init"]
  DUPCLOSURE R28 K45 [PROTO_3]
  CAPTURE VAL R19
  CAPTURE VAL R20
  SETTABLEKS R28 R27 K46 ["getContents"]
  ...
  SETTABLEKS R28 R27 K52 ["shouldComponentUpdate"]
  DUPCLOSURE R28 K53 [PROTO_9]
  CAPTURE VAL R24
  CAPTURE VAL R23
  CAPTURE VAL R26
  CAPTURE VAL R20
  ...
  DUPTABLE R28 K56 [{"ExpandableRoot"}]
  LOADB R29 1
  SETTABLEKS R29 R28 K55 ["ExpandableRoot"]
  SETTABLEKS R28 R27 K57 ["defaultProps"]
  MOVE R28 R7
  DUPTABLE R29 K58 [{"Analytics", "Localization"}]
  SETTABLEKS R8 R29 K17 ["Analytics"]
  SETTABLEKS R9 R29 K18 ["Localization"]
  CALL R28 1 1
  MOVE R29 R27
  CALL R28 1 1
  MOVE R27 R28
