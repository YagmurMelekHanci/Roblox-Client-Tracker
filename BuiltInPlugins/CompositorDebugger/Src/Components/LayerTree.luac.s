...
PROTO_3:
  GETUPVAL R2 0
  GETTABLEKS R1 R2 K0 ["getFFlagLayerDebugDraw"]
  CALL R1 0 1
  JUMPIFNOT R1 [+8]
  GETUPVAL R3 1
  GETTABLEKS R2 R3 K1 ["props"]
  GETTABLEKS R1 R2 K2 ["SetLayerSelection"]
  MOVE R2 R0
  CALL R1 1 0
  JUMP [+13]
  MOVE R1 R0
  ...
  GETTABLEKS R6 R7 K3 ["SetSelectedLayer"]
  MOVE R7 R4
  CALL R6 1 0
  FORGLOOP R1 2 [-8]
  GETUPVAL R3 1
  GETTABLEKS R2 R3 K1 ["props"]
  GETTABLEKS R1 R2 K4 ["SetScrubberOffset"]
  GETUPVAL R4 1
  GETTABLEKS R3 R4 K1 ["props"]
  GETTABLEKS R2 R3 K5 ["HistoryOffset"]
  CALL R1 1 0
  GETUPVAL R3 1
  GETTABLEKS R2 R3 K1 ["props"]
  GETTABLEKS R1 R2 K6 ["ClearHistoryField"]
  CALL R1 0 0
  GETUPVAL R1 1
  DUPTABLE R3 K8 [{"Selection"}]
  SETTABLEKS R0 R3 K7 ["Selection"]
...
MAIN:
  ...
  GETTABLEKS R26 R0 K30 ["Bin"]
  GETTABLEKS R25 R26 K31 ["Common"]
  GETTABLEKS R24 R25 K32 ["defineLuaFlags"]
  CALL R23 1 1
