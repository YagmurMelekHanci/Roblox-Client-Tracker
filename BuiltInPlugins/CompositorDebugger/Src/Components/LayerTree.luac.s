...
PROTO_14:
  DUPTABLE R1 K3 [{"ClearHistoryField", "SetScrubberOffset", "SetSelectedLayer"}]
  NEWCLOSURE R2 P0
  CAPTURE VAL R0
  CAPTURE UPVAL U0
  ...
  CAPTURE VAL R0
  CAPTURE UPVAL U1
  SETTABLEKS R2 R1 K1 ["SetScrubberOffset"]
  NEWCLOSURE R2 P2
  CAPTURE VAL R0
  CAPTURE UPVAL U2
...
MAIN:
  ...
  CAPTURE VAL R21
  SETGLOBAL R24 K36 ["updateTreeViewItems"]
  DUPCLOSURE R24 K37 [PROTO_8]
  CAPTURE VAL R5
  SETTABLEKS R24 R23 K38 ["getDerivedStateFromProps"]
  ...
  MOVE R24 R7
  DUPTABLE R25 K41 [{"Analytics", "Localization"}]
  SETTABLEKS R8 R25 K14 ["Analytics"]
  SETTABLEKS R9 R25 K15 ["Localization"]
  CALL R24 1 1
  MOVE R25 R23
  CALL R24 1 1
  MOVE R23 R24
  DUPCLOSURE R24 K42 [PROTO_10]
  DUPCLOSURE R25 K43 [PROTO_14]
  CAPTURE VAL R14
  CAPTURE VAL R19
  CAPTURE VAL R13
  GETTABLEKS R26 R4 K44 ["connect"]
  MOVE R27 R24
  MOVE R28 R25
  CALL R26 2 1
  MOVE R27 R23
