...
PROTO_12:
  ...
  MUL R15 R16 R17
  CALL R13 2 1
  GETTABLEKS R14 R0 K14 ["make2dPosition"]
  MOVE R15 R4
  CALL R14 1 1
  GETTABLEKS R17 R2 K15 ["min"]
  SUB R16 R14 R17
  GETTABLEKS R18 R2 K16 ["max"]
  GETTABLEKS R19 R2 K15 ["min"]
  SUB R17 R18 R19
  DIV R15 R16 R17
  GETIMPORT R16 K19 [Vector2.new]
  GETTABLEKS R19 R2 K13 ["size"]
  GETTABLEKS R18 R19 K20 ["X"]
  GETTABLEKS R19 R15 K20 ["X"]
  MUL R17 R18 R19
  GETTABLEKS R20 R2 K13 ["size"]
  GETTABLEKS R19 R20 K21 ["Y"]
  GETTABLEKS R21 R15 K21 ["Y"]
  SUBRK R20 R8 K21 ["Y"]
  MUL R18 R19 R20
  CALL R16 2 1
  LOADK R18 K22 ["Trail"]
  ...
  GETUPVAL R19 2
  NEWTABLE R20 8 0
  SETTABLEKS R16 R20 K26 ["From"]
  SETTABLEKS R13 R20 K27 ["To"]
  GETUPVAL R22 3
  GETTABLEKS R21 R22 K22 ["Trail"]
  SETTABLEKS R21 R20 K28 ["ZIndex"]
  GETIMPORT R21 K30 [Color3.new]
  LOADN R22 1
  LOADN R23 0
  LOADN R24 0
  CALL R21 3 1
  SETTABLEKS R21 R20 K31 ["Color"]
  GETUPVAL R23 0
  GETTABLEKS R22 R23 K7 ["BLEND_TRAIL_LENGTH"]
  DIV R21 R7 R22
  SETTABLEKS R21 R20 K32 ["Transparency"]
  GETUPVAL R22 1
