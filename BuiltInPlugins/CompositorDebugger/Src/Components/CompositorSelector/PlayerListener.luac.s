...
PROTO_2:
  ...
  GETTABLEKS R1 R2 K2 ["IsSelectedInstanceValid"]
  MOVE R2 R0
  CALL R1 1 1
  JUMPIFNOT R1 [+8]
  GETUPVAL R3 1
  GETTABLEKS R2 R3 K1 ["props"]
  GETTABLEKS R1 R2 K3 ["OnValidSelection"]
  MOVE R2 R0
  CALL R1 1 0
  RETURN R0 0
  GETUPVAL R2 1
  GETTABLEKS R1 R2 K4 ["descendantAddedEvent"]
  JUMPIFNOT R1 [+6]
  GETUPVAL R3 1
  GETTABLEKS R2 R3 K4 ["descendantAddedEvent"]
  GETTABLEKS R1 R2 K5 ["Disconnect"]
  CALL R1 0 0
  GETUPVAL R1 1
  GETTABLEKS R2 R0 K6 ["DescendantAdded"]
  NEWCLOSURE R4 P0
  CAPTURE UPVAL U1
  CAPTURE VAL R0
  NAMECALL R2 R2 K7 ["Connect"]
  CALL R2 2 1
  SETTABLEKS R2 R1 K4 ["descendantAddedEvent"]
  RETURN R0 0
  GETUPVAL R3 1
  GETTABLEKS R2 R3 K1 ["props"]
  GETTABLEKS R1 R2 K8 ["CheckSelectedInstance"]
  MOVE R2 R0
  CALL R1 1 2
  GETUPVAL R5 2
  GETTABLEKS R4 R5 K9 ["INSTANCE_CHECK"]
  GETTABLEKS R3 R4 K10 ["Valid"]
  JUMPIFNOTEQ R1 R3 [+9]
  GETUPVAL R5 1
  GETTABLEKS R4 R5 K1 ["props"]
  GETTABLEKS R3 R4 K3 ["OnValidSelection"]
  MOVE R4 R0
  CALL R3 1 0
  RETURN R0 0
  GETUPVAL R5 2
  GETTABLEKS R4 R5 K9 ["INSTANCE_CHECK"]
  GETTABLEKS R3 R4 K11 ["MissingHasCompositorAttribute"]
  JUMPIFNOTEQ R1 R3 [+13]
  GETUPVAL R3 1
  GETTABLEKS R4 R2 K12 ["AttributeChanged"]
  NEWCLOSURE R6 P1
  CAPTURE UPVAL U2
  CAPTURE UPVAL U1
  CAPTURE VAL R0
  ...
  CALL R4 2 1
  SETTABLEKS R4 R3 K13 ["onAttributeChangedEvent"]
  RETURN R0 0
...
MAIN:
  ...
  CALL R6 1 1
  GETTABLEKS R7 R3 K19 ["PureComponent"]
  LOADK R9 K20 ["PlayerListener"]
  ...
  SETTABLEKS R8 R7 K27 ["willUnmount"]
  DUPCLOSURE R8 K28 [PROTO_7]
  SETTABLEKS R8 R7 K29 ["render"]
  RETURN R7 1
