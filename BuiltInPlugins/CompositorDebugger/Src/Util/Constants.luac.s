MAIN:
  PREPVARARGS 0
  DUPTABLE R0 K10 [{"EVENTS", "FOLDERS", "LAYER_TABS", "LAYERVIEW_ACTIONS", "SETTINGS", "DEFAULT_TIMECONTROLS_INTERVAL", "FRAMERATE", "SKIP_UI_FRAMES", "TIMECONTROLS_INVERVALS", "GIZMOS"}]
  DUPTABLE R1 K14 [{"DebugData", "PropertyOverrides", "DebugPose"}]
  LOADK R2 K11 ["DebugData"]
  SETTABLEKS R2 R1 K11 ["DebugData"]
  LOADK R2 K12 ["PropertyOverrides"]
  SETTABLEKS R2 R1 K12 ["PropertyOverrides"]
  LOADK R2 K13 ["DebugPose"]
  SETTABLEKS R2 R1 K13 ["DebugPose"]
  SETTABLEKS R1 R0 K0 ["EVENTS"]
  DUPTABLE R1 K19 [{"CompositorDebugger", "Server", "Client", "Gizmos"}]
  ...
  DUPTABLE R1 K44 [{"SphereRadius"}]
  LOADK R2 K45 [0.05]
  SETTABLEKS R2 R1 K43 ["SphereRadius"]
  SETTABLEKS R1 R0 K9 ["GIZMOS"]
  RETURN R0 1
