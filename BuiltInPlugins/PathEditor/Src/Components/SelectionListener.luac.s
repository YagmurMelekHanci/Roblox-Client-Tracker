...
PROTO_6:
  ...
  GETTABLEKS R2 R3 K11 ["SelectedObject"]
  JUMPIFEQKNIL R2 [+11]
  JUMPIF R1 [+9]
  GETUPVAL R3 1
  GETTABLEKS R2 R3 K12 ["dispatchSelectPathCleared"]
  CALL R2 0 0
  GETUPVAL R2 0
  NAMECALL R2 R2 K13 ["disableActions"]
  CALL R2 1 0
  RETURN R0 0
  GETUPVAL R4 0
  GETTABLEKS R3 R4 K10 ["props"]
  ...
  JUMPIFNOT R1 [+15]
  GETUPVAL R3 1
  GETTABLEKS R2 R3 K14 ["dispatchSelectPath"]
  GETUPVAL R4 0
  GETTABLEKS R3 R4 K0 ["selectedObject"]
  CALL R2 1 0
  GETUPVAL R2 0
  GETUPVAL R5 0
  GETTABLEKS R4 R5 K15 ["UniversalActions"]
  NAMECALL R2 R2 K16 ["enableActions"]
  CALL R2 2 0
  RETURN R0 0
  GETUPVAL R3 1
...
PROTO_7:
  ...
  JUMPIFNOT R6 [+12]
  GETUPVAL R8 2
  GETTABLEKS R7 R8 K7 ["dispatchSelectPath"]
  MOVE R8 R5
  CALL R7 1 0
  GETUPVAL R7 3
  GETUPVAL R10 3
  GETTABLEKS R9 R10 K8 ["UniversalActions"]
  NAMECALL R7 R7 K9 ["enableActions"]
  CALL R7 2 0
  GETUPVAL R7 3
  SETTABLEKS R5 R7 K10 ["selectedObject"]
  GETUPVAL R7 3
  DUPTABLE R9 K13 [{"selectedObjectChangedConn", "selectedObjectParentChangedConn"}]
  GETTABLEKS R10 R5 K14 ["Changed"]
  GETUPVAL R12 4
  NAMECALL R10 R10 K15 ["Connect"]
  CALL R10 2 1
  SETTABLEKS R10 R9 K11 ["selectedObjectChangedConn"]
  GETTABLEKS R11 R5 K6 ["Parent"]
  GETTABLEKS R10 R11 K14 ["Changed"]
  GETUPVAL R12 5
  NAMECALL R10 R10 K15 ["Connect"]
  CALL R10 2 1
  SETTABLEKS R10 R9 K12 ["selectedObjectParentChangedConn"]
...
MAIN:
  ...
  LOADK R23 K30 ["PathEditorRBXTelemetryFixes"]
