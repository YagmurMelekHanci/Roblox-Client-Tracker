...
MAIN:
  ...
  GETTABLEKS R4 R1 K9 ["Bin"]
  GETTABLEKS R3 R4 K10 ["getFFlagCollaborationActions"]
  CALL R2 1 1
  CALL R2 0 1
  ...
  GETTABLEKS R18 R19 K30 ["AnalyticsHandlers"]
  CALL R17 1 1
  GETTABLEKS R19 R5 K29 ["Util"]
  GETTABLEKS R18 R19 K31 ["CrossPluginCommunication"]
  ...
  CALL R20 2 1
  DUPTABLE R21 K42 [{"DataModel", "PluginType", "PluginId", "Category", "ItemId"}]
  LOADK R22 K43 ["Standalone"]
  SETTABLEKS R22 R21 K37 ["DataModel"]
  LOADK R22 K44 ["Unknown"]
  SETTABLEKS R22 R21 K38 ["PluginType"]
  LOADK R22 K45 ["LiveCollaborators"]
  SETTABLEKS R22 R21 K39 ["PluginId"]
  LOADK R22 K46 ["Actions"]
  SETTABLEKS R22 R21 K40 ["Category"]
  LOADK R22 K47 ["Toggle"]
  SETTABLEKS R22 R21 K41 ["ItemId"]
  ...
  CAPTURE VAL R0
  CAPTURE VAL R2
  SETTABLEKS R22 R20 K51 ["componentWillUnmount"]
