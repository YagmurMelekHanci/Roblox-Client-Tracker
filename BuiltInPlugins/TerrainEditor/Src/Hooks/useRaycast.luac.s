...
PROTO_6:
  ...
  GETTABLE R9 R10 R11
  GETUPVAL R11 3
  GETTABLEKS R10 R11 K8 ["IgnoreParts"]
  GETTABLE R8 R9 R10
  JUMPIF R8 [+25]
  GETUPVAL R8 5
  MOVE R10 R7
  ...
  JUMPIFNOT R3 [+9]
  JUMPIFNOT R8 [+8]
  GETTABLEKS R9 R8 K37 ["Distance"]
  GETTABLEKS R10 R3 K37 ["Distance"]
  JUMPIFNOTLT R9 R10 [+19]
  MOVE R3 R8
  JUMP [+16]
  JUMPIFNOT R8 [+15]
  MOVE R3 R8
  ...
  MOVE R3 R4
  GETUPVAL R5 16
  GETTABLEKS R4 R5 K43 ["current"]
  GETUPVAL R6 17
  GETTABLEKS R5 R6 K44 ["Pending"]
  JUMPIFNOTEQ R4 R5 [+86]
  GETUPVAL R4 16
  GETUPVAL R6 17
  GETTABLEKS R5 R6 K45 ["Active"]
  SETTABLEKS R5 R4 K43 ["current"]
  JUMP [+78]
  GETUPVAL R5 16
  GETTABLEKS R4 R5 K43 ["current"]
  JUMPIFNOTEQKS R4 K45 ["Active"] [+19]
  DUPTABLE R4 K41 [{"Distance", "Instance", "Material", "Normal", "Position"}]
  LOADN R5 255
  SETTABLEKS R5 R4 K37 ["Distance"]
  LOADNIL R5
  ...
  DUPTABLE R7 K50 [{"Distance", "Normal", "Position"}]
  SUB R9 R5 R0
  ...
  MUL R8 R1 R9
  ADD R7 R0 R8
  DUPTABLE R8 K50 [{"Distance", "Normal", "Position"}]
  SUB R10 R7 R0
  ...
  MOVE R3 R8
  GETUPVAL R8 16
  GETTABLEKS R7 R8 K43 ["current"]
  GETUPVAL R9 17
  GETTABLEKS R8 R9 K44 ["Pending"]
  JUMPIFNOTEQ R7 R8 [+7]
  GETUPVAL R7 16
  GETUPVAL R9 17
  GETTABLEKS R8 R9 K51 ["Inactive"]
  SETTABLEKS R8 R7 K43 ["current"]
  GETUPVAL R4 20
  GETUPVAL R5 1
  GETUPVAL R7 9
  ...
  GETTABLE R6 R7 R8
  GETUPVAL R8 3
  GETTABLEKS R7 R8 K55 ["Snapping"]
  GETTABLE R5 R6 R7
  GETUPVAL R6 23
  GETIMPORT R7 K57 [table.clone]
  MOVE R8 R3
  CALL R7 1 -1
  CALL R6 -1 0
  JUMPIFEQKNIL R5 [+45]
  GETUPVAL R7 24
  GETTABLEKS R6 R7 K58 ["Off"]
  JUMPIFEQ R5 R6 [+40]
  GETUPVAL R6 25
  GETTABLEKS R7 R3 K1 ["Position"]
  CALL R6 1 1
  ...
  GETTABLE R8 R9 R10
  GETUPVAL R10 3
  GETTABLEKS R9 R10 K59 ["FixedYPlane"]
  GETTABLE R7 R8 R9
  JUMPIFNOT R7 [+18]
  GETTABLEKS R8 R6 K60 ["X"]
  GETUPVAL R11 1
  GETUPVAL R13 2
  GETTABLEKS R12 R13 K7 ["BrushSettings"]
  GETTABLE R10 R11 R12
  GETUPVAL R12 3
  GETTABLEKS R11 R12 K61 ["FixedYPlanePosition"]
  GETTABLE R9 R10 R11
  GETTABLEKS R10 R6 K62 ["Z"]
  FASTCALL VECTOR [+2]
  GETIMPORT R7 K64 [Vector3.new]
  CALL R7 3 1
  MOVE R6 R7
  SUB R8 R6 R0
...
PROTO_14:
  ...
  CALL R7 1 2
  GETUPVAL R9 1
  GETIMPORT R10 K12 [CFrame.lookAt]
  ...
  CALL R11 2 0
  GETUPVAL R11 1
  DUPTABLE R12 K15 [{"CacheID", "CachePoint"}]
  LOADNIL R13
  SETTABLEKS R13 R12 K13 ["CacheID"]
  LOADK R13 K9 [{0, 0, 0}]
  SETTABLEKS R13 R12 K14 ["CachePoint"]
  CALL R11 1 2
  GETUPVAL R13 1
  NAMECALL R14 R3 K16 ["isMouseMoveReserved"]
  CALL R14 1 -1
  CALL R13 -1 2
  GETUPVAL R15 4
  LOADNIL R16
  ...
  CALL R17 0 1
  GETUPVAL R20 6
  GETTABLEKS R19 R20 K17 ["MaterialSettings"]
  GETTABLE R18 R1 R19
  GETUPVAL R19 7
  NEWCLOSURE R20 P1
  CAPTURE VAL R1
  ...
  NEWTABLE R21 0 1
  GETUPVAL R25 6
  GETTABLEKS R24 R25 K18 ["BrushSettings"]
  GETTABLE R23 R1 R24
  GETUPVAL R25 8
  GETTABLEKS R24 R25 K19 ["BrushSize"]
  ...
  NEWTABLE R22 0 4
  GETUPVAL R26 6
  GETTABLEKS R25 R26 K18 ["BrushSettings"]
  GETTABLE R24 R1 R25
  GETUPVAL R26 8
  GETTABLEKS R25 R26 K20 ["TemporarySmooth"]
  GETTABLE R23 R24 R25
  GETUPVAL R27 6
  GETTABLEKS R26 R27 K18 ["BrushSettings"]
  GETTABLE R25 R1 R26
  GETUPVAL R27 8
  GETTABLEKS R26 R27 K21 ["PlaneLock"]
  GETTABLE R24 R25 R26
  JUMPIFNOT R18 [+5]
  GETUPVAL R27 11
  GETTABLEKS R26 R27 K22 ["TargetMaterial"]
  ...
  CAPTURE VAL R16
  NEWTABLE R25 0 12
  NAMECALL R27 R3 K23 ["IsMouseDown"]
  CALL R27 1 1
  JUMPIFNOT R27 [+2]
  MOVE R26 R9
  JUMP [+1]
  ...
  MOVE R29 R20
  GETUPVAL R33 6
  GETTABLEKS R32 R33 K18 ["BrushSettings"]
  GETTABLE R31 R1 R32
  GETUPVAL R33 8
  GETTABLEKS R32 R33 K24 ["IgnoreParts"]
  GETTABLE R30 R31 R32
  GETUPVAL R34 6
  GETTABLEKS R33 R34 K18 ["BrushSettings"]
  GETTABLE R32 R1 R33
  GETUPVAL R34 8
  GETTABLEKS R33 R34 K25 ["IgnoreWater"]
  GETTABLE R31 R32 R33
  GETUPVAL R35 6
  GETTABLEKS R34 R35 K18 ["BrushSettings"]
  GETTABLE R33 R1 R34
  GETUPVAL R35 8
  GETTABLEKS R34 R35 K26 ["Snapping"]
  GETTABLE R32 R33 R34
  GETUPVAL R36 6
  GETTABLEKS R35 R36 K18 ["BrushSettings"]
  GETTABLE R34 R1 R35
  GETUPVAL R36 8
  GETTABLEKS R35 R36 K27 ["FixedYPlane"]
  GETTABLE R33 R34 R35
  GETUPVAL R37 6
  GETTABLEKS R36 R37 K18 ["BrushSettings"]
  GETTABLE R35 R1 R36
  GETUPVAL R37 8
  GETTABLEKS R36 R37 K28 ["FixedYPlanePosition"]
  GETTABLE R34 R35 R36
  GETUPVAL R38 6
  GETTABLEKS R37 R38 K18 ["BrushSettings"]
  GETTABLE R36 R1 R37
  GETUPVAL R38 8
  GETTABLEKS R37 R38 K29 ["PlaneTransform"]
  GETTABLE R35 R36 R37
  GETUPVAL R39 6
  GETTABLEKS R38 R39 K18 ["BrushSettings"]
  GETTABLE R37 R1 R38
  GETUPVAL R39 8
  GETTABLEKS R38 R39 K21 ["PlaneLock"]
  GETTABLE R36 R37 R38
  MOVE R37 R0
  SETLIST R25 R26 12 [1]
  CALL R23 2 1
  GETUPVAL R24 25
  GETTABLEKS R25 R4 K30 ["Button1Down"]
  NEWCLOSURE R26 P6
  CAPTURE VAL R20
  CAPTURE VAL R12
  CAPTURE UPVAL U16
  ...
  CALL R24 3 0
  GETUPVAL R24 25
  GETTABLEKS R25 R4 K31 ["Button1Up"]
  NEWCLOSURE R26 P7
  CAPTURE VAL R11
  CAPTURE UPVAL U16
  CAPTURE VAL R12
  ...
  CALL R24 3 0
  GETUPVAL R24 25
  GETTABLEKS R25 R3 K32 ["MouseMoveAction"]
  NEWCLOSURE R26 P8
  CAPTURE VAL R13
  CAPTURE VAL R14
  NEWTABLE R27 0 1
  ...
  MOVE R24 R5
  MOVE R25 R7
  GETTABLEKS R26 R16 K33 ["current"]
  RETURN R24 3
...
MAIN:
  ...
  GETTABLEKS R30 R31 K44 ["getFFlagTerrainEditorPartsInFrontOfCacheFix"]
  CALL R29 1 1
