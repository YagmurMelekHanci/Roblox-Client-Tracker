...
PROTO_1:
  ...
  GETUPVAL R14 9
  LOADK R16 K17 ["Brush"]
  NAMECALL R14 R14 K18 ["use"]
  CALL R14 2 1
  GETTABLEKS R16 R14 K19 ["CenterRadiusMultiplier"]
  GETTABLEKS R17 R10 K20 ["Distance"]
  MUL R15 R16 R17
  GETTABLEKS R16 R14 K21 ["CenterTransparency"]
  GETTABLEKS R17 R14 K22 ["Color"]
  GETTABLEKS R18 R14 K23 ["MainTransparency"]
  GETUPVAL R21 6
  GETTABLEKS R20 R21 K12 ["Manual"]
  JUMPIFNOTEQ R7 R20 [+3]
  MOVE R19 R8
  JUMP [+9]
  GETIMPORT R19 K26 [CFrame.lookAt]
  FASTCALL VECTOR [+2]
  GETIMPORT R20 K29 [Vector3.new]
  CALL R20 0 1
  GETTABLEKS R21 R11 K30 ["Normal"]
  CALL R19 2 1
  GETUPVAL R20 8
  GETUPVAL R23 2
  GETTABLEKS R22 R23 K16 ["PivotPosition"]
  GETTABLE R21 R2 R22
  GETTABLEKS R22 R11 K31 ["Position"]
  MOVE R23 R6
  CALL R20 3 1
  LOADB R21 1
  GETUPVAL R23 6
  ...
  GETTABLEKS R24 R8 K31 ["Position"]
  SUB R23 R8 R24
  ADD R22 R23 R20
  JUMP [+7]
  GETIMPORT R22 K26 [CFrame.lookAt]
  MOVE R23 R20
  GETTABLEKS R25 R11 K30 ["Normal"]
  ADD R24 R20 R25
  CALL R22 2 1
