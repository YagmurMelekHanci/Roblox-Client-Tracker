...
MAIN:
  ...
  LOADK R13 K22 ["TerrainEditorBlockDoubleMouseDown"]
  LOADB R14 0
  ...
  CALL R12 1 1
  GETTABLEKS R13 R12 K25 ["BrushMode"]
  GETTABLEKS R14 R12 K26 ["BrushSettings"]
  GETTABLEKS R15 R12 K27 ["MaterialSettings"]
  GETTABLEKS R16 R12 K28 ["PluginAction"]
  LOADK R19 K29 ["ShortcutController"]
  NAMECALL R17 R3 K30 ["extend"]
  CALL R17 2 1
  ...
  SETTABLEKS R18 R17 K34 ["isMouseMoveReserved"]
  DUPCLOSURE R18 K35 [PROTO_7]
  SETTABLEKS R18 R17 K36 ["isMouseDownReserved"]
  DUPCLOSURE R18 K37 [PROTO_8]
  SETTABLEKS R18 R17 K38 ["isAltDown"]
  DUPCLOSURE R18 K39 [PROTO_9]
  SETTABLEKS R18 R17 K40 ["isShiftDown"]
  DUPCLOSURE R18 K41 [PROTO_10]
  SETTABLEKS R18 R17 K42 ["isControlDown"]
  DUPCLOSURE R18 K43 [PROTO_11]
  SETTABLEKS R18 R17 K44 ["isBDown"]
  DUPCLOSURE R18 K45 [PROTO_21]
  CAPTURE VAL R14
  CAPTURE VAL R10
  SETTABLEKS R18 R17 K46 ["onBrushChanged"]
  MOVE R18 R9
  CALL R18 0 1
  JUMPIFNOT R18 [+11]
  DUPCLOSURE R18 K47 [PROTO_26]
  CAPTURE VAL R7
  CAPTURE VAL R8
  CAPTURE VAL R15
  SETTABLEKS R18 R17 K48 ["onMaterialPicked"]
  DUPCLOSURE R18 K49 [PROTO_28]
  CAPTURE VAL R13
  SETTABLEKS R18 R17 K50 ["onBrushMode"]
  JUMP [+10]
  DUPCLOSURE R18 K51 [PROTO_33]
  CAPTURE VAL R7
  CAPTURE VAL R8
  CAPTURE VAL R15
  SETTABLEKS R18 R17 K48 ["onMaterialPicked"]
  DUPCLOSURE R18 K52 [PROTO_35]
  CAPTURE VAL R13
  SETTABLEKS R18 R17 K50 ["onBrushMode"]
  DUPCLOSURE R18 K53 [PROTO_37]
  SETTABLEKS R18 R17 K54 ["onTemporarySmooth"]
  DUPCLOSURE R18 K55 [PROTO_40]
  CAPTURE VAL R16
  SETTABLEKS R18 R17 K56 ["onToggleEdit"]
  DUPCLOSURE R18 K57 [PROTO_41]
  CAPTURE VAL R14
  CAPTURE VAL R15
  SETTABLEKS R18 R17 K58 ["registerShortcut"]
  DUPCLOSURE R18 K59 [PROTO_42]
  CAPTURE VAL R14
  CAPTURE VAL R15
  SETTABLEKS R18 R17 K60 ["supportsShortcut"]
  DUPCLOSURE R18 K61 [PROTO_43]
  SETTABLEKS R18 R17 K62 ["getMouse"]
  DUPCLOSURE R18 K63 [PROTO_44]
  SETTABLEKS R18 R17 K64 ["IsMouseDown"]
  DUPCLOSURE R18 K65 [PROTO_45]
  SETTABLEKS R18 R17 K66 ["Enable"]
  DUPCLOSURE R18 K67 [PROTO_46]
  SETTABLEKS R18 R17 K68 ["Disable"]
  DUPCLOSURE R18 K69 [PROTO_47]
  SETTABLEKS R18 R17 K70 ["SetEnabled"]
  DUPCLOSURE R18 K71 [PROTO_48]
  SETTABLEKS R18 R17 K72 ["Connect"]
  RETURN R17 1
