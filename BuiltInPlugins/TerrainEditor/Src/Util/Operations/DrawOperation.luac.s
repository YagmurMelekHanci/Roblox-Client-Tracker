...
PROTO_1:
  ...
  GETTABLEKS R12 R9 K26 ["Material"]
  GETIMPORT R13 K29 [Enum.Material.Air]
  JUMPIFNOTEQ R12 R13 [+7]
  NAMECALL R12 R1 K30 ["skipBudget"]
  CALL R12 1 0
  LOADB R12 1
  LOADN R13 0
  RETURN R12 2
  ...
  GETUPVAL R15 1
  GETTABLEKS R14 R15 K31 ["MaterialSettings"]
  GETTABLE R12 R13 R14
  GETUPVAL R15 5
  GETTABLEKS R14 R15 K32 ["AutoMaterial"]
  GETTABLE R13 R12 R14
  GETUPVAL R16 5
  GETTABLEKS R15 R16 K33 ["SourceMaterial"]
  GETTABLE R14 R12 R15
  GETUPVAL R18 6
  GETTABLEKS R17 R18 K34 ["Sphere"]
  JUMPIFNOTEQ R8 R17 [+3]
  MOVE R16 R6
  JUMP [+1]
  MOVE R16 R5
  GETUPVAL R18 7
  GETTABLEKS R17 R18 K35 ["VoxelResolution"]
  MUL R15 R16 R17
  GETUPVAL R18 7
  GETTABLEKS R17 R18 K35 ["VoxelResolution"]
  MUL R16 R6 R17
  MULK R17 R16 K36 [0.5]
  GETUPVAL R19 8
  GETTABLEKS R18 R19 K37 ["Add"]
  ...
  SUBK R17 R17 K38 [1]
  JUMP [+2]
  GETIMPORT R14 K29 [Enum.Material.Air]
  GETUPVAL R18 9
  GETUPVAL R21 2
  GETTABLEKS R20 R21 K40 ["PivotPosition"]
  GETTABLE R19 R3 R20
  ...
  LOADNIL R22
  FORGPREP R20
  GETTABLEKS R25 R2 K41 ["LastPosition"]
  JUMPIFNOTEQ R24 R25 [+16]
  JUMPIF R13 [+14]
  NAMECALL R25 R1 K30 ["skipBudget"]
  CALL R25 1 0
  GETUPVAL R26 0
  ...
  LOADN R26 0
  RETURN R25 2
  SETTABLEKS R24 R2 K41 ["LastPosition"]
  GETUPVAL R25 11
  MOVE R26 R24
  MOVE R27 R17
  MOVE R28 R15
  ...
  LOADN R31 2
  GETUPVAL R33 7
  GETTABLEKS R32 R33 K35 ["VoxelResolution"]
  MUL R30 R31 R32
  ...
  SUB R31 R32 R33
  MULK R30 R31 K36 [0.5]
  SUB R32 R26 R25
  GETUPVAL R34 7
  GETTABLEKS R33 R34 K35 ["VoxelResolution"]
  DIV R31 R32 R33
  GETUPVAL R33 4
  GETTABLEKS R32 R33 K46 ["Terrain"]
  MOVE R34 R29
  GETUPVAL R36 7
  GETTABLEKS R35 R36 K35 ["VoxelResolution"]
  ...
  CALL R39 1 1
  GETUPVAL R41 7
  GETTABLEKS R40 R41 K35 ["VoxelResolution"]
  LOADB R41 0
  GETUPVAL R43 6
  GETTABLEKS R42 R43 K34 ["Sphere"]
  ...
  GETIMPORT R76 K29 [Enum.Material.Air]
  SETTABLE R76 R66 R72
  JUMPIFNOTEQKN R75 K38 [1] [+6]
  GETIMPORT R76 K29 [Enum.Material.Air]
  ...
  MOVE R53 R29
  GETUPVAL R55 7
  GETTABLEKS R54 R55 K35 ["VoxelResolution"]
  MOVE R55 R38
  MOVE R56 R39
