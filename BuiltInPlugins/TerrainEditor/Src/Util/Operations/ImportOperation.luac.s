...
PROTO_1:
  ...
  LOADK R9 K14 [{4, 4, 4}]
  SUB R6 R6 R9
  GETIMPORT R9 K16 [Region3.new]
  MOVE R10 R5
  MOVE R11 R6
  CALL R9 2 1
  GETUPVAL R13 5
  GETTABLEKS R12 R13 K17 ["Heightmap"]
  GETTABLE R11 R1 R12
  GETTABLEKS R10 R11 K18 ["Image"]
  JUMPIF R10 [+7]
  GETUPVAL R11 0
  GETTABLEKS R10 R11 K19 ["State"]
  LOADN R11 1
  SETTABLEKS R11 R10 K20 ["Progress"]
  RETURN R0 0
  GETUPVAL R14 5
  GETTABLEKS R13 R14 K17 ["Heightmap"]
  GETTABLE R12 R1 R13
  GETTABLEKS R11 R12 K18 ["Image"]
  GETTABLEKS R10 R11 K21 ["File"]
  NAMECALL R10 R10 K22 ["GetTemporaryId"]
  CALL R10 1 1
  GETUPVAL R14 5
  GETTABLEKS R13 R14 K23 ["Colormap"]
  GETTABLE R12 R1 R13
  GETTABLEKS R11 R12 K18 ["Image"]
  JUMPIFNOT R11 [+6]
  GETTABLEKS R12 R11 K21 ["File"]
  NAMECALL R12 R12 K22 ["GetTemporaryId"]
  CALL R12 1 1
  JUMP [+1]
  LOADK R12 K24 [""]
  GETUPVAL R13 6
  ...
  MOVE R17 R12
  GETUPVAL R20 5
  GETTABLEKS R19 R20 K25 ["DefaultMaterial"]
  GETTABLE R18 R1 R19
  NAMECALL R13 R13 K26 ["ImportHeightmap"]
  CALL R13 5 0
  GETUPVAL R14 0
  GETTABLEKS R13 R14 K19 ["State"]
  LOADN R14 1
  SETTABLEKS R14 R13 K20 ["Progress"]
  RETURN R0 0
