...
PROTO_1:
  ...
  GETTABLEN R36 R37 1
  LENGTH R35 R36
  GETTABLEKS R41 R17 K34 ["Y"]
  GETTABLEKS R42 R20 K34 ["Y"]
  SUB R40 R41 R42
  GETUPVAL R42 5
  ...
  ADDK R37 R38 K33 [1]
  LOADN R38 1
  FASTCALL3 MATH_CLAMP R37 R38 R34
  MOVE R39 R34
  GETIMPORT R36 K39 [math.clamp]
  CALL R36 3 1
  ...
  DIV R39 R40 R41
  SUB R37 R38 R39
  MULK R39 R37 K40 [256]
  FASTCALL1 MATH_FLOOR R39 [+2]
  GETIMPORT R38 K37 [math.floor]
  CALL R38 1 1
  DIVK R37 R38 K40 [256]
  LOADB R38 0
  GETUPVAL R40 4
  ...
  LOADB R38 1
  GETUPVAL R41 4
  GETTABLEKS R40 R41 K41 ["Cylinder"]
  ...
  SUB R41 R42 R43
  GETTABLEKS R44 R20 K42 ["Z"]
  GETUPVAL R46 10
  MULK R45 R46 K23 [0.5]
  SUB R43 R44 R45
  GETTABLEKS R44 R26 K42 ["Z"]
  SUB R42 R43 R44
  LOADNIL R43
  LOADNIL R44
  LOADNIL R45
  GETIMPORT R46 K45 [os.clock]
  CALL R46 0 1
  LOADN R49 1
  MOVE R47 R33
  LOADN R48 1
  ...
  MOVE R57 R58
  MUL R61 R57 R10
  MULK R60 R61 K49 [0.25]
  FASTCALL1 MATH_LOG R6 [+3]
  MOVE R63 R6
  GETIMPORT R62 K52 [math.log]
  CALL R62 1 1
  DIVK R61 R62 K50 [8]
  MUL R59 R60 R61
  GETUPVAL R61 5
  GETTABLEKS R60 R61 K53 ["MinimumOccupancy"]
  FASTCALL2 MATH_MAX R59 R60 [+3]
  GETIMPORT R58 K55 [math.max]
  CALL R58 2 1
  MUL R62 R57 R10
  MULK R61 R62 K49 [0.25]
  FASTCALL1 MATH_LOG R6 [+3]
  MOVE R64 R6
  GETIMPORT R63 K52 [math.log]
  CALL R63 1 1
  DIVK R62 R63 K50 [8]
  MUL R60 R61 R62
  GETUPVAL R62 5
  GETTABLEKS R61 R62 K53 ["MinimumOccupancy"]
  FASTCALL2 MATH_MAX R60 R61 [+3]
  GETIMPORT R59 K55 [math.max]
  CALL R59 2 1
  LOADB R60 0
  JUMPIFNOT R12 [+78]
  LOADN R63 1
  ...
  JUMP [0]
  JUMPIFNOT R9 [+4]
  GETIMPORT R68 K60 [Enum.Material.Water]
  JUMPIFEQ R65 R68 [+11]
  JUMPIFNOT R65 [+9]
  JUMPIFEQ R64 R67 [+8]
  ...
  MOVE R68 R37
  JUMPIFNOTEQKN R68 K56 [0] [+3]
  GETIMPORT R66 K62 [Enum.Material.Air]
  JUMPIFNOT R9 [+4]
  GETIMPORT R69 K60 [Enum.Material.Water]
  JUMPIFEQ R66 R69 [+8]
  GETTABLE R69 R52 R64
  SETTABLE R68 R69 R56
  GETTABLE R69 R53 R64
  SETTABLE R66 R69 R56
  JUMPIFEQKN R59 K56 [0] [+2]
  FORNLOOP R62
  FORNLOOP R54
  FORNLOOP R47
  GETUPVAL R50 13
  GETTABLEKS R49 R50 K63 ["NormalizeBrushTimer"]
  MOVE R50 R46
  MOVE R51 R6
  MOVE R52 R5
  CALL R49 3 -1
  NAMECALL R47 R1 K64 ["addTimeStatistic"]
  CALL R47 -1 0
  GETUPVAL R48 9
  ...
  MOVE R51 R31
  MOVE R52 R32
  NAMECALL R47 R47 K65 ["WriteVoxels"]
  CALL R47 5 0
  FORGLOOP R22 2 [-386]
  GETUPVAL R23 0
