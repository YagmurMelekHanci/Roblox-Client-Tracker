...
PROTO_3:
  ...
  GETUPVAL R1 1
  NAMECALL R1 R1 K5 ["GetAudioApiByDefault"]
  CALL R1 1 1
  JUMPIFNOT R1 [+13]
  GETIMPORT R1 K8 [Instance.new]
  LOADK R2 K9 ["AudioPlayer"]
  CALL R1 1 1
  LOADK R2 K10 ["rbxassetid://%d"]
  GETUPVAL R4 2
  NAMECALL R2 R2 K11 ["format"]
  CALL R2 2 1
  SETTABLEKS R2 R1 K12 ["AssetId"]
  MOVE R0 R1
  JUMP [+59]
  GETIMPORT R1 K8 [Instance.new]
  LOADK R2 K13 ["Sound"]
  ...
  NAMECALL R2 R2 K11 ["format"]
  CALL R2 2 1
  SETTABLEKS R2 R1 K14 ["SoundId"]
  MOVE R0 R1
  JUMP [+46]
  GETUPVAL R1 0
  GETIMPORT R3 K16 [Enum.AssetType.Image]
  GETTABLEKS R2 R3 K4 ["Value"]
  ...
  NAMECALL R2 R2 K11 ["format"]
  CALL R2 2 1
  SETTABLEKS R2 R1 K18 ["Texture"]
  MOVE R0 R1
  JUMP [+26]
  GETUPVAL R1 3
  JUMPIFNOT R1 [+20]
  GETUPVAL R1 0
  GETIMPORT R3 K20 [Enum.AssetType.Video]
  GETTABLEKS R2 R3 K4 ["Value"]
  JUMPIFNOTEQ R1 R2 [+14]
  GETIMPORT R1 K8 [Instance.new]
  LOADK R2 K21 ["VideoFrame"]
  CALL R1 1 1
  LOADK R2 K10 ["rbxassetid://%d"]
  GETUPVAL R4 2
  NAMECALL R2 R2 K11 ["format"]
  CALL R2 2 1
  SETTABLEKS R2 R1 K19 ["Video"]
  MOVE R0 R1
  JUMP [+4]
  GETUPVAL R1 4
  GETUPVAL R2 2
  ...
  FASTCALL1 TYPE R0 [+3]
  MOVE R2 R0
  GETIMPORT R1 K23 [type]
  CALL R1 1 1
  JUMPIFNOTEQKS R1 K24 ["string"] [+5]
  GETUPVAL R1 5
  MOVE R2 R0
  CALL R1 1 0
  RETURN R0 0
