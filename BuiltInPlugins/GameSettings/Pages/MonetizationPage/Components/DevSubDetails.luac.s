...
MAIN:
  ...
  GETTABLEKS R14 R15 K25 ["DevSubListItemText"]
  CALL R13 1 1
  GETIMPORT R14 K8 [require]
  GETTABLEKS R17 R2 K11 ["Src"]
  GETTABLEKS R16 R17 K26 ["Actions"]
  GETTABLEKS R15 R16 K27 ["AddChange"]
  CALL R14 1 1
  GETIMPORT R15 K8 [require]
  GETTABLEKS R17 R1 K28 ["Thunks"]
  GETTABLEKS R16 R17 K29 ["AddDevSubKeyChange"]
  CALL R15 1 1
  GETIMPORT R16 K8 [require]
  GETTABLEKS R18 R1 K28 ["Thunks"]
  GETTABLEKS R17 R18 K30 ["DevSubModeration"]
  CALL R16 1 1
  GETIMPORT R17 K8 [require]
  GETTABLEKS R19 R2 K9 ["Packages"]
  GETTABLEKS R18 R19 K31 ["Framework"]
  CALL R17 1 1
  GETTABLEKS R18 R17 K24 ["ContextServices"]
  GETTABLEKS R19 R18 K32 ["withContext"]
  GETTABLEKS R20 R17 K33 ["UI"]
  GETTABLEKS R21 R20 K34 ["Button"]
  GETTABLEKS R22 R20 K35 ["HoverArea"]
  GETTABLEKS R23 R20 K36 ["Image"]
  GETTABLEKS R24 R20 K37 ["Pane"]
  GETTABLEKS R25 R20 K38 ["Separator"]
  GETTABLEKS R26 R20 K39 ["SelectInput"]
  GETTABLEKS R27 R20 K40 ["TextInput"]
  GETTABLEKS R28 R20 K41 ["TitledFrame"]
  GETTABLEKS R29 R17 K12 ["Util"]
  GETTABLEKS R30 R29 K42 ["GetTextSize"]
  GETTABLEKS R31 R3 K43 ["FitFrameOnAxis"]
  GETTABLEKS R32 R29 K44 ["LayoutOrderIterator"]
  GETTABLEKS R33 R9 K45 ["Component"]
  LOADK R35 K46 ["DeveloperSubscriptionDetails"]
  NAMECALL R33 R33 K47 ["extend"]
  CALL R33 2 1
  GETIMPORT R34 K1 [game]
  LOADK R36 K48 ["DeveloperSubscriptionsMaxRobuxPrice"]
  LOADN R37 208
  NAMECALL R34 R34 K49 ["DefineFastInt"]
  CALL R34 3 1
  DUPCLOSURE R35 K50 [PROTO_10]
  CAPTURE VAL R4
  CAPTURE VAL R11
  SETTABLEKS R35 R33 K51 ["init"]
  ...
  CAPTURE VAL R26
  CAPTURE VAL R24
  SETTABLEKS R35 R33 K53 ["render"]
  MOVE R35 R19
  DUPTABLE R36 K56 [{"Stylizer", "Localization", "Dialog"}]
  GETTABLEKS R37 R18 K54 ["Stylizer"]
  SETTABLEKS R37 R36 K54 ["Stylizer"]
  GETTABLEKS R37 R18 K55 ["Localization"]
  SETTABLEKS R37 R36 K55 ["Localization"]
  SETTABLEKS R12 R36 K22 ["Dialog"]
  CALL R35 1 1
  MOVE R36 R33
  CALL R35 1 1
  MOVE R33 R35
  GETIMPORT R35 K8 [require]
  GETTABLEKS R38 R2 K11 ["Src"]
  GETTABLEKS R37 R38 K57 ["Networking"]
  GETTABLEKS R36 R37 K58 ["settingFromState"]
  CALL R35 1 1
  GETTABLEKS R36 R8 K59 ["connect"]
  DUPCLOSURE R37 K60 [PROTO_16]
  CAPTURE VAL R35
  CAPTURE VAL R6
  DUPCLOSURE R38 K61 [PROTO_20]
  CAPTURE VAL R14
  CAPTURE VAL R15
  CAPTURE VAL R16
  CALL R36 2 1
