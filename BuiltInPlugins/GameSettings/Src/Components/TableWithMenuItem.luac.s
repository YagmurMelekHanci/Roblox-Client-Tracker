...
MAIN:
  ...
  GETTABLEKS R8 R7 K13 ["HoverArea"]
  GETTABLEKS R9 R7 K14 ["DropdownMenu"]
  GETTABLEKS R10 R1 K15 ["FitTextLabel"]
  GETTABLEKS R11 R7 K16 ["Tooltip"]
  GETIMPORT R12 K18 [game]
  LOADK R14 K19 ["TextService"]
  NAMECALL R12 R12 K20 ["GetService"]
  CALL R12 2 1
  GETTABLEKS R13 R2 K21 ["PureComponent"]
  LOADK R15 K22 ["TableWithMenuItem"]
  ...
  CAPTURE VAL R8
  CAPTURE VAL R3
  SETTABLEKS R16 R13 K29 ["renderMenuItem"]
  DUPCLOSURE R16 K30 [PROTO_12]
  CAPTURE VAL R14
  CAPTURE VAL R15
  CAPTURE VAL R12
  CAPTURE VAL R2
  ...
  MOVE R16 R6
  DUPTABLE R17 K34 [{"Stylizer", "Mouse"}]
  GETTABLEKS R18 R5 K32 ["Stylizer"]
