...
PROTO_25:
  ...
  CALL R7 0 1
  JUMPIFNOT R7 [+5]
  GETTABLEKS R7 R1 K14 ["Network"]
  GETTABLEKS R6 R7 K15 ["networkInterface"]
  JUMP [+1]
  LOADNIL R6
  GETUPVAL R8 2
  CALL R8 0 1
  JUMPIFNOT R8 [+4]
  GETTABLEKS R8 R1 K16 ["instances"]
  GETTABLEN R7 R8 1
  JUMP [+1]
  LOADNIL R7
  GETUPVAL R9 2
  CALL R9 0 1
  JUMPIFNOT R9 [+9]
  GETTABLEKS R10 R0 K10 ["state"]
  GETTABLEKS R9 R10 K17 ["currentSelectedRadioButtonKey"]
  JUMPIFEQKS R9 K18 ["AvatarItem"] [+2]
  LOADB R8 0 +1
  LOADB R8 1
  JUMP [+1]
  LOADNIL R8
  ...
  CALL R4 0 1
  JUMPIFNOT R4 [+10]
  GETTABLEKS R4 R1 K19 ["onCategoryChange"]
  JUMPIFNOT R4 [+7]
  GETTABLEKS R4 R1 K19 ["onCategoryChange"]
  GETTABLEKS R6 R0 K10 ["state"]
  GETTABLEKS R5 R6 K17 ["currentSelectedRadioButtonKey"]
  CALL R4 1 0
  GETTABLEKS R5 R3 K8 ["type"]
  GETUPVAL R7 4
  GETTABLEKS R6 R7 K20 ["isCatalogAsset"]
  ...
  CALL R4 0 1
  JUMPIFNOT R4 [+24]
  GETTABLEKS R4 R1 K22 ["setValidationState"]
  JUMPIFNOT R4 [+9]
  GETTABLEKS R4 R1 K22 ["setValidationState"]
  GETUPVAL R7 5
  GETTABLEKS R6 R7 K23 ["VALIDATION_STATE"]
  GETTABLEKS R5 R6 K24 ["BEGIN"]
  CALL R4 1 0
  RETURN R0 0
  DUPTABLE R6 K26 [{"validationState"}]
  GETUPVAL R9 5
  GETTABLEKS R8 R9 K23 ["VALIDATION_STATE"]
  GETTABLEKS R7 R8 K24 ["BEGIN"]
  SETTABLEKS R7 R6 K25 ["validationState"]
  NAMECALL R4 R0 K4 ["setState"]
  CALL R4 2 0
  RETURN R0 0
  DUPCLOSURE R6 K27 [PROTO_24]
  CAPTURE UPVAL U6
  NAMECALL R4 R0 K4 ["setState"]
  CALL R4 2 0
  RETURN R0 0
...
MAIN:
  ...
  GETTABLEKS R33 R34 K46 ["CheckAvatarAssetPrivacy"]
  CALL R32 1 1
  GETTABLEKS R35 R0 K18 ["Core"]
  ...
  GETTABLEKS R38 R11 K51 ["AssetConfigConstants"]
  CALL R37 1 1
  ...
  GETTABLEKS R43 R11 K27 ["SharedFlags"]
  GETTABLEKS R42 R43 K57 ["getFFlagEnableUGCBundleUploadBodyScale"]
  CALL R41 1 1
  GETIMPORT R42 K10 [require]
  GETTABLEKS R45 R0 K18 ["Core"]
  GETTABLEKS R44 R45 K58 ["Flags"]
  GETTABLEKS R43 R44 K59 ["getFFlagRequireBodyColorsForBodyUpload"]
  CALL R42 1 1
  GETIMPORT R43 K10 [require]
  GETTABLEKS R45 R11 K27 ["SharedFlags"]
  GETTABLEKS R44 R45 K60 ["getFFlagEnableUGCForAllChecks"]
  CALL R43 1 1
  GETIMPORT R44 K10 [require]
  GETTABLEKS R47 R0 K18 ["Core"]
  GETTABLEKS R46 R47 K58 ["Flags"]
  GETTABLEKS R45 R46 K61 ["getFFlagEnableUploadingShoes"]
  CALL R44 1 1
  GETIMPORT R45 K10 [require]
  GETTABLEKS R48 R0 K18 ["Core"]
  GETTABLEKS R47 R48 K58 ["Flags"]
  GETTABLEKS R46 R47 K62 ["getFFlagToolboxMoveCreatorDropdown"]
  CALL R45 1 1
  GETIMPORT R46 K10 [require]
  GETTABLEKS R49 R0 K18 ["Core"]
  GETTABLEKS R48 R49 K58 ["Flags"]
  GETTABLEKS R47 R48 K63 ["getFFlagToolboxErrorMessageBoxScrollable"]
  CALL R46 1 1
  GETIMPORT R47 K10 [require]
  GETTABLEKS R50 R0 K18 ["Core"]
  GETTABLEKS R49 R50 K58 ["Flags"]
  GETTABLEKS R48 R49 K64 ["getFFlagCheckAvatarAssetPrivacy"]
  CALL R47 1 1
  GETIMPORT R48 K10 [require]
  GETTABLEKS R51 R0 K18 ["Core"]
  GETTABLEKS R50 R51 K58 ["Flags"]
  GETTABLEKS R49 R50 K65 ["getFFlagToolboxErrorMessageBoxResizable"]
  CALL R48 1 1
  GETIMPORT R49 K5 [game]
  LOADK R51 K66 ["ToolboxConfigAssetTypeAgeIDVerificationLink"]
  LOADK R52 K67 ["https://en.help.roblox.com/hc/en-us/articles/4407282410644-Age-ID-Verification"]
  NAMECALL R49 R49 K68 ["DefineFastString"]
  CALL R49 3 1
  GETIMPORT R50 K5 [game]
  LOADK R52 K69 ["ToolboxConfigAssetTypePremiumLink"]
  LOADK R53 K70 ["https://www.roblox.com/premium/membership"]
  NAMECALL R50 R50 K68 ["DefineFastString"]
  CALL R50 3 1
  GETIMPORT R51 K5 [game]
  LOADK R53 K71 ["ToolboxFixUGCBundleValidationCryoThingy1"]
  LOADB R54 0
  NAMECALL R51 R51 K54 ["DefineFastFlag"]
  CALL R51 3 1
  GETIMPORT R52 K5 [game]
  LOADK R54 K72 ["ToolboxHideAssetTypePublishAnim"]
  LOADB R55 0
  NAMECALL R52 R52 K54 ["DefineFastFlag"]
  CALL R52 3 1
  GETIMPORT R53 K5 [game]
  LOADK R55 K73 ["ToolboxRemoveRestrictedAssetWarning2"]
  NAMECALL R53 R53 K74 ["GetFastFlag"]
  CALL R53 2 1
  GETTABLEKS R54 R5 K75 ["PureComponent"]
  LOADK R56 K76 ["ConfigAssetType"]
  NAMECALL R54 R54 K77 ["extend"]
  CALL R54 2 1
  MOVE R56 R43
  CALL R56 0 1
  JUMPIFNOT R56 [+2]
  ...
  LOADK R60 K53 ["BodyFirstInAssetsCategory"]
  NAMECALL R58 R58 K74 ["GetFastFlag"]
  CALL R58 2 1
  JUMPIFNOT R58 [+22]
  NEWTABLE R58 0 3
  GETTABLEKS R60 R37 K78 ["UGCBundleTypes"]
  GETTABLEKS R59 R60 K79 ["Body"]
  GETTABLEKS R61 R37 K78 ["UGCBundleTypes"]
  GETTABLEKS R60 R61 K80 ["DynamicHead"]
  MOVE R62 R44
  CALL R62 0 1
  JUMPIFNOT R62 [+5]
  GETTABLEKS R62 R37 K78 ["UGCBundleTypes"]
  GETTABLEKS R61 R62 K81 ["Shoes"]
  JUMP [+1]
  LOADNIL R61
  SETLIST R58 R59 3 [1]
  MOVE R57 R58
  ...
  LOADNIL R58
  JUMP [+16]
  DUPTABLE R58 K87 [{"NONE", "BEGIN", "VALIDATING", "SUCCESS", "FAILURE"}]
  LOADK R59 K88 ["None"]
  SETTABLEKS R59 R58 K82 ["NONE"]
  LOADK R59 K89 ["Begin"]
  SETTABLEKS R59 R58 K83 ["BEGIN"]
  LOADK R59 K90 ["Validating"]
  SETTABLEKS R59 R58 K84 ["VALIDATING"]
  LOADK R59 K91 ["Success"]
  SETTABLEKS R59 R58 K85 ["SUCCESS"]
  LOADK R59 K92 ["Failure"]
  SETTABLEKS R59 R58 K86 ["FAILURE"]
  DUPCLOSURE R59 K93 [PROTO_0]
  CAPTURE VAL R13
  DUPCLOSURE R60 K94 [PROTO_1]
  DUPCLOSURE R61 K95 [PROTO_16]
  CAPTURE VAL R45
  CAPTURE VAL R58
  CAPTURE VAL R40
  CAPTURE VAL R13
  ...
  CAPTURE VAL R12
  CAPTURE VAL R39
  SETTABLEKS R61 R54 K96 ["init"]
  DUPCLOSURE R61 K97 [PROTO_17]
  CAPTURE VAL R45
  SETTABLEKS R61 R54 K98 ["getAvatarItemCategoryErrorsPrimaryText"]
  DUPCLOSURE R61 K99 [PROTO_18]
  CAPTURE VAL R45
  SETTABLEKS R61 R54 K100 ["getAvatarItemCategoryErrors"]
  DUPCLOSURE R61 K101 [PROTO_19]
  SETTABLEKS R61 R54 K102 ["selectedRadioButtonKeyFor"]
  DUPCLOSURE R61 K103 [PROTO_20]
  SETTABLEKS R61 R54 K104 ["isAvatarItemCategorySelected"]
  DUPCLOSURE R61 K105 [PROTO_25]
  CAPTURE VAL R3
  CAPTURE VAL R45
  CAPTURE VAL R47
  CAPTURE VAL R43
  ...
  CAPTURE VAL R37
  CAPTURE VAL R58
  SETTABLEKS R61 R54 K106 ["onAssetTypeChanged"]
  DUPCLOSURE R61 K107 [PROTO_32]
  CAPTURE VAL R40
  CAPTURE VAL R13
  CAPTURE VAL R12
  CAPTURE VAL R45
  ...
  CAPTURE VAL R41
  CAPTURE VAL R42
  SETTABLEKS R61 R54 K108 ["startUGCBundleValidation"]
  DUPCLOSURE R61 K109 [PROTO_34]
  CAPTURE VAL R45
  CAPTURE VAL R37
  CAPTURE VAL R3
  CAPTURE VAL R58
  SETTABLEKS R61 R54 K110 ["resetValidation"]
  DUPCLOSURE R61 K111 [PROTO_35]
  SETTABLEKS R61 R54 K112 ["cancelValidationTasks"]
  DUPCLOSURE R61 K113 [PROTO_36]
  SETTABLEKS R61 R54 K114 ["getErrorMessageWithCount"]
  DUPCLOSURE R61 K115 [PROTO_37]
  CAPTURE VAL R45
  CAPTURE VAL R37
  CAPTURE VAL R58
  SETTABLEKS R61 R54 K116 ["getValidationStatusMessage"]
  DUPCLOSURE R61 K117 [PROTO_38]
  CAPTURE VAL R45
  CAPTURE VAL R37
  CAPTURE VAL R58
  SETTABLEKS R61 R54 K118 ["getValidationStatusColor"]
  DUPCLOSURE R61 K119 [PROTO_39]
  SETTABLEKS R61 R54 K120 ["getAssetCategoryIndex"]
  NEWCLOSURE R61 P15
  CAPTURE VAL R13
  CAPTURE REF R57
  CAPTURE VAL R19
  CAPTURE VAL R20
  SETTABLEKS R61 R54 K121 ["getDropdownItemsFor"]
  DUPCLOSURE R61 K122 [PROTO_42]
  SETTABLEKS R61 R54 K123 ["getDropdownItems"]
  DUPCLOSURE R61 K124 [PROTO_43]
  CAPTURE VAL R13
  CAPTURE VAL R21
  CAPTURE VAL R5
  CAPTURE VAL R25
  CAPTURE VAL R15
  CAPTURE VAL R20
  SETTABLEKS R61 R54 K125 ["getMissingOptionalPartsMessage"]
  DUPCLOSURE R61 K126 [PROTO_44]
  CAPTURE VAL R13
  CAPTURE VAL R21
  CAPTURE VAL R5
  CAPTURE VAL R25
  CAPTURE VAL R15
  SETTABLEKS R61 R54 K127 ["getUnknownMeshPartMessage"]
  MOVE R61 R43
  CALL R61 0 1
  JUMPIFNOT R61 [+7]
  DUPCLOSURE R61 K128 [PROTO_47]
  CAPTURE VAL R1
  CAPTURE VAL R49
  CAPTURE VAL R50
  CAPTURE VAL R53
  SETTABLEKS R61 R54 K129 ["getUgcRestrictionsWarningText"]
  DUPCLOSURE R61 K130 [PROTO_53]
  CAPTURE VAL R45
  CAPTURE VAL R37
  CAPTURE VAL R13
  CAPTURE VAL R14
  CAPTURE VAL R7
  CAPTURE VAL R58
  SETTABLEKS R61 R54 K131 ["didUpdate"]
  DUPCLOSURE R61 K132 [PROTO_54]
  SETTABLEKS R61 R54 K133 ["willUnmount"]
  DUPCLOSURE R61 K134 [PROTO_55]
  CAPTURE VAL R21
  CAPTURE VAL R45
  CAPTURE VAL R37
  CAPTURE VAL R58
  ...
  CAPTURE VAL R44
  CAPTURE VAL R38
  SETTABLEKS R61 R54 K135 ["render"]
  DUPCLOSURE R61 K136 [PROTO_56]
  DUPCLOSURE R62 K137 [PROTO_59]
  CAPTURE VAL R27
  CAPTURE VAL R47
  CAPTURE VAL R3
  CAPTURE VAL R32
  CAPTURE VAL R28
  MOVE R63 R9
  DUPTABLE R64 K140 [{"Stylizer", "Localization", "Network"}]
  GETTABLEKS R65 R8 K138 ["Stylizer"]
  SETTABLEKS R65 R64 K138 ["Stylizer"]
  GETTABLEKS R65 R8 K30 ["Localization"]
  SETTABLEKS R65 R64 K30 ["Localization"]
  MOVE R66 R47
  CALL R66 0 1
  JUMPIFNOT R66 [+2]
  MOVE R65 R10
  JUMP [+1]
  LOADNIL R65
  SETTABLEKS R65 R64 K139 ["Network"]
  CALL R63 1 1
  MOVE R64 R54
  CALL R63 1 1
  MOVE R54 R63
  GETTABLEKS R63 R6 K141 ["connect"]
  MOVE R64 R61
  MOVE R65 R62
  CALL R63 2 1
  MOVE R64 R54
