...
MAIN:
  ...
  GETTABLEKS R41 R42 K56 ["getFFlagEnableUGCForAllChecks"]
  CALL R40 1 1
  GETIMPORT R41 K5 [game]
  LOADK R43 K57 ["ToolboxConfigAssetTypeAgeIDVerificationLink"]
  LOADK R44 K58 ["https://en.help.roblox.com/hc/en-us/articles/4407282410644-Age-ID-Verification"]
  NAMECALL R41 R41 K59 ["DefineFastString"]
  CALL R41 3 1
  GETIMPORT R42 K5 [game]
  LOADK R44 K60 ["ToolboxConfigAssetTypePremiumLink"]
  LOADK R45 K61 ["https://www.roblox.com/premium/membership"]
  NAMECALL R42 R42 K59 ["DefineFastString"]
  CALL R42 3 1
  GETIMPORT R43 K5 [game]
  LOADK R45 K62 ["ToolboxFixUGCBundleValidationCryoThingy1"]
  LOADB R46 0
  NAMECALL R43 R43 K50 ["DefineFastFlag"]
  CALL R43 3 1
  GETIMPORT R44 K5 [game]
  LOADK R46 K63 ["DisableClickableErrorsBundlePublish"]
  LOADB R47 0
  ...
  LOADK R52 K49 ["BodyFirstInAssetsCategory"]
  NAMECALL R50 R50 K54 ["GetFastFlag"]
  CALL R50 2 1
  JUMPIFNOT R50 [+13]
  NEWTABLE R50 0 2
  GETTABLEKS R52 R34 K67 ["UGCBundleTypes"]
  GETTABLEKS R51 R52 K68 ["Body"]
  GETTABLEKS R53 R34 K67 ["UGCBundleTypes"]
  ...
  GETTABLEKS R57 R8 K29 ["Localization"]
  SETTABLEKS R57 R56 K29 ["Localization"]
  CALL R55 1 1
  MOVE R56 R45
  CALL R55 1 1
  MOVE R45 R55
