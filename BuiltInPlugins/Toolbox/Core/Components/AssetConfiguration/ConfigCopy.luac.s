...
MAIN:
  ...
  GETTABLEKS R27 R19 K36 ["PublishUtil"]
  CALL R26 1 1
  GETIMPORT R27 K15 [require]
  GETTABLEKS R28 R19 K37 ["Urls"]
  CALL R27 1 1
  GETIMPORT R28 K15 [require]
  GETTABLEKS R29 R19 K38 ["sanitizeRichText"]
  CALL R28 1 1
  LOADNIL R29
  JUMPIFNOT R3 [+6]
  GETIMPORT R30 K15 [require]
  GETTABLEKS R31 R19 K39 ["getIsIXPVariableEnabled"]
  CALL R30 1 1
  MOVE R29 R30
  GETIMPORT R30 K15 [require]
  GETTABLEKS R31 R7 K40 ["Dash"]
  CALL R30 1 1
  GETTABLEKS R31 R9 K41 ["UI"]
  GETTABLEKS R32 R31 K42 ["TextLabel"]
  GETTABLEKS R33 R31 K43 ["LinkText"]
  GETTABLEKS R34 R31 K44 ["List"]
  GETTABLEKS R35 R31 K45 ["Pane"]
  GETTABLEKS R36 R31 K46 ["ToggleButton"]
  GETTABLEKS R38 R9 K24 ["Util"]
  GETTABLEKS R37 R38 K47 ["StyleModifier"]
  GETIMPORT R38 K1 [game]
  LOADK R40 K48 ["GuiService"]
  NAMECALL R38 R38 K49 ["GetService"]
  CALL R38 2 1
  GETTABLEKS R39 R10 K50 ["PureComponent"]
  LOADK R41 K51 ["ConfigCopy"]
  NAMECALL R39 R39 K52 ["extend"]
  CALL R39 2 1
  DUPCLOSURE R40 K53 [PROTO_5]
  CAPTURE VAL R8
  CAPTURE VAL R38
  CAPTURE VAL R24
  CAPTURE VAL R26
  ...
  CAPTURE VAL R32
  CAPTURE VAL R21
  SETTABLEKS R40 R39 K54 ["init"]
  DUPCLOSURE R40 K55 [PROTO_8]
  CAPTURE VAL R2
  CAPTURE VAL R5
  CAPTURE VAL R8
  SETTABLEKS R40 R39 K56 ["didMount"]
  DUPCLOSURE R40 K57 [PROTO_9]
  SETTABLEKS R40 R39 K58 ["willUnmount"]
  DUPCLOSURE R40 K59 [PROTO_12]
  CAPTURE VAL R5
  CAPTURE VAL R8
  CAPTURE VAL R2
  SETTABLEKS R40 R39 K60 ["didUpdate"]
  DUPCLOSURE R40 K61 [PROTO_16]
  CAPTURE VAL R10
  CAPTURE VAL R30
  CAPTURE VAL R20
  SETTABLEKS R40 R39 K62 ["updateDistributionQuotas"]
  DUPCLOSURE R40 K63 [PROTO_17]
  CAPTURE VAL R14
  SETTABLEKS R40 R39 K64 ["getDistributionQuotaStatus"]
  NEWCLOSURE R40 P6
  CAPTURE VAL R4
  CAPTURE VAL R3
  CAPTURE REF R29
  ...
  CAPTURE VAL R37
  CAPTURE VAL R24
  SETTABLEKS R40 R39 K65 ["render"]
  MOVE R40 R18
  DUPTABLE R41 K70 [{"IXP", "Localization", "Stylizer", "Network"}]
  JUMPIFNOT R3 [+2]
  MOVE R42 R16
  JUMP [+1]
  LOADNIL R42
  SETTABLEKS R42 R41 K66 ["IXP"]
  GETTABLEKS R42 R15 K67 ["Localization"]
  SETTABLEKS R42 R41 K67 ["Localization"]
  GETTABLEKS R42 R15 K68 ["Stylizer"]
  SETTABLEKS R42 R41 K68 ["Stylizer"]
  SETTABLEKS R17 R41 K69 ["Network"]
  CALL R40 1 1
  MOVE R41 R39
  CALL R40 1 1
  MOVE R39 R40
  DUPCLOSURE R40 K71 [PROTO_19]
  CAPTURE VAL R2
  CAPTURE VAL R13
  GETTABLEKS R41 R11 K72 ["connect"]
  MOVE R42 R40
  LOADNIL R43
  CALL R41 2 1
  MOVE R42 R39
