...
MAIN:
  ...
  GETTABLEKS R28 R29 K43 ["getFFlagAudioRowPassAssetInfoToPurchaseAsset"]
  CALL R27 1 1
  GETTABLEKS R28 R2 K44 ["PureComponent"]
  LOADK R30 K45 ["AudioRow"]
  NAMECALL R28 R28 K46 ["extend"]
  CALL R28 2 1
  DUPCLOSURE R29 K47 [PROTO_0]
  SETGLOBAL R29 K48 ["secondsToMinuteString"]
  DUPTABLE R29 K51 [{"Artist", "MusicAlbum"}]
  LOADK R30 K52 ["---"]
  SETTABLEKS R30 R29 K49 ["Artist"]
  LOADK R30 K52 ["---"]
  SETTABLEKS R30 R29 K50 ["MusicAlbum"]
  DUPCLOSURE R30 K53 [PROTO_1]
  CAPTURE VAL R5
  CAPTURE VAL R29
  SETGLOBAL R30 K54 ["audioDetailsWithDefaults"]
  ...
  CAPTURE VAL R6
  CAPTURE VAL R20
  SETTABLEKS R30 R28 K56 ["init"]
  DUPCLOSURE R30 K57 [PROTO_26]
  SETTABLEKS R30 R28 K58 ["didUpdate"]
  DUPCLOSURE R30 K59 [PROTO_27]
  CAPTURE VAL R24
  CAPTURE VAL R19
  CAPTURE VAL R9
  SETTABLEKS R30 R28 K60 ["render"]
  MOVE R30 R11
  DUPTABLE R31 K66 [{"AssetAnalytics", "Stylizer", "Localization", "Plugin", "Settings", "Network"}]
  SETTABLEKS R14 R31 K61 ["AssetAnalytics"]
  GETTABLEKS R32 R10 K62 ["Stylizer"]
  SETTABLEKS R32 R31 K62 ["Stylizer"]
  GETTABLEKS R32 R10 K63 ["Localization"]
  SETTABLEKS R32 R31 K63 ["Localization"]
  GETTABLEKS R32 R10 K64 ["Plugin"]
  SETTABLEKS R32 R31 K64 ["Plugin"]
  SETTABLEKS R16 R31 K27 ["Settings"]
  SETTABLEKS R17 R31 K65 ["Network"]
  CALL R30 1 1
  MOVE R31 R28
  CALL R30 1 1
  MOVE R28 R30
  DUPCLOSURE R30 K67 [PROTO_28]
  DUPCLOSURE R31 K68 [PROTO_31]
  CAPTURE VAL R15
  CAPTURE VAL R18
  GETTABLEKS R32 R3 K69 ["connect"]
  MOVE R33 R30
  MOVE R34 R31
  CALL R32 2 1
  MOVE R33 R28
  ...
  CAPTURE VAL R2
  CAPTURE REF R28
  SETGLOBAL R32 K70 ["TypedAudioRow"]
  DUPTABLE R32 K73 [{"Component", "Generator"}]
  SETTABLEKS R28 R32 K71 ["Component"]
  GETGLOBAL R33 K70 ["TypedAudioRow"]
  SETTABLEKS R33 R32 K72 ["Generator"]
  CLOSEUPVALS R28
  RETURN R32 1
