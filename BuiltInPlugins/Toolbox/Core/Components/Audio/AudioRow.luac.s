...
PROTO_29:
  ...
  NEWCLOSURE R4 P18
  CAPTURE VAL R0
  SETTABLEKS R4 R0 K22 ["getTags"]
  NEWCLOSURE R4 P19
  CAPTURE VAL R0
  CAPTURE UPVAL U8
  CAPTURE UPVAL U7
  CAPTURE UPVAL U9
  SETTABLEKS R4 R0 K23 ["getColumns"]
  NEWCLOSURE R4 P20
  CAPTURE VAL R0
  CAPTURE UPVAL U10
  CAPTURE UPVAL U7
  ...
  CAPTURE UPVAL U9
  CAPTURE UPVAL U13
  SETTABLEKS R4 R0 K24 ["renderIcon"]
  NEWCLOSURE R4 P21
  CAPTURE VAL R0
  CAPTURE UPVAL U11
  CAPTURE UPVAL U14
  SETTABLEKS R4 R0 K25 ["renderExpandedContent"]
  RETURN R0 0
...
MAIN:
  ...
  GETTABLEKS R28 R29 K42 ["getFFlagToolboxAudioRemoveProductId"]
  CALL R27 1 1
  GETIMPORT R28 K6 [require]
  GETTABLEKS R31 R0 K15 ["Core"]
  GETTABLEKS R30 R31 K43 ["Flags"]
  GETTABLEKS R29 R30 K44 ["getFFlagAudioSequentialPurchasingAndPermissionGranting"]
  CALL R28 1 1
  GETIMPORT R29 K6 [require]
  GETTABLEKS R32 R0 K15 ["Core"]
  GETTABLEKS R31 R32 K43 ["Flags"]
  GETTABLEKS R30 R31 K45 ["getFFlagAudioRowPassAssetInfoToPurchaseAsset"]
  CALL R29 1 1
  ...
  DUPCLOSURE R33 K63 [PROTO_30]
  SETTABLEKS R33 R31 K64 ["didUpdate"]
  DUPCLOSURE R33 K65 [PROTO_31]
  CAPTURE VAL R25
  CAPTURE VAL R20
  CAPTURE VAL R9
  ...
  CALL R33 1 1
  MOVE R31 R33
  DUPCLOSURE R33 K73 [PROTO_32]
  DUPCLOSURE R34 K74 [PROTO_35]
  CAPTURE VAL R15
  CAPTURE VAL R18
