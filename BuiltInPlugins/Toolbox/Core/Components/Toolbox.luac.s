...
PROTO_15:
  ...
  JUMPIFNOT R27 [+4]
  GETUPVAL R40 1
  GETTABLEKS R39 R40 K95 ["HEADER_HEIGHT"]
  JUMP [+5]
  GETUPVAL R42 1
  GETTABLEKS R41 R42 K95 ["HEADER_HEIGHT"]
  ADD R40 R21 R41
  ADDK R39 R40 K96 [1]
  CALL R35 4 1
  SETTABLEKS R35 R34 K58 ["Position"]
  ...
  JUMPIFNOT R27 [+5]
  GETUPVAL R41 1
  GETTABLEKS R40 R41 K95 ["HEADER_HEIGHT"]
  MINUS R39 R40
  JUMP [+6]
  GETUPVAL R43 1
  GETTABLEKS R42 R43 K95 ["HEADER_HEIGHT"]
  ADD R41 R42 R21
  ADDK R40 R41 K97 [2]
  MINUS R39 R40
  CALL R35 4 1
...
MAIN:
  ...
  GETTABLEKS R52 R53 K31 ["Types"]
  GETTABLEKS R51 R52 K64 ["HomeTypes"]
  CALL R50 1 1
  GETIMPORT R51 K4 [require]
  GETTABLEKS R54 R0 K5 ["Core"]
  GETTABLEKS R53 R54 K65 ["Actions"]
  GETTABLEKS R52 R53 K66 ["SetLayoutMode"]
  CALL R51 1 1
  GETIMPORT R52 K4 [require]
  GETTABLEKS R55 R0 K5 ["Core"]
  GETTABLEKS R54 R55 K67 ["Thunks"]
  GETTABLEKS R53 R54 K68 ["LogMarketplaceSearchAnalytics"]
  CALL R52 1 1
  ...
  GETTABLEKS R55 R56 K70 ["getFFlagToolboxContentManagementCombineTabs"]
  CALL R54 1 1
  GETIMPORT R55 K4 [require]
  GETTABLEKS R59 R0 K5 ["Core"]
  GETTABLEKS R58 R59 K6 ["Util"]
  GETTABLEKS R57 R58 K7 ["SharedFlags"]
  GETTABLEKS R56 R57 K71 ["getFFlagToolboxEnableAssetRows"]
  CALL R55 1 1
  GETIMPORT R56 K4 [require]
  GETTABLEKS R60 R0 K5 ["Core"]
  GETTABLEKS R59 R60 K6 ["Util"]
  GETTABLEKS R58 R59 K7 ["SharedFlags"]
  GETTABLEKS R57 R58 K72 ["getIsIXPEnabledForListView"]
  CALL R56 1 1
  GETIMPORT R57 K4 [require]
  GETTABLEKS R60 R0 K5 ["Core"]
  GETTABLEKS R59 R60 K31 ["Types"]
  GETTABLEKS R58 R59 K73 ["LayoutMode"]
  CALL R57 1 1
  GETIMPORT R58 K4 [require]
  GETTABLEKS R61 R0 K5 ["Core"]
  GETTABLEKS R60 R61 K31 ["Types"]
  GETTABLEKS R59 R60 K74 ["Background"]
  CALL R58 1 1
  GETTABLEKS R59 R7 K75 ["PureComponent"]
  LOADK R61 K76 ["Toolbox"]
  NAMECALL R59 R59 K77 ["extend"]
  CALL R59 2 1
  DUPTABLE R60 K79 [{"Size"}]
  GETIMPORT R61 K82 [UDim2.new]
  LOADN R62 1
  LOADN R63 0
  LOADN R64 1
  LOADN R65 0
  CALL R61 4 1
  SETTABLEKS R61 R60 K78 ["Size"]
  SETTABLEKS R60 R59 K83 ["defaultProps"]
  DUPCLOSURE R60 K84 [PROTO_0]
  CAPTURE VAL R55
  CAPTURE VAL R58
  CAPTURE VAL R23
  CAPTURE VAL R54
  ...
  CAPTURE VAL R56
  CAPTURE VAL R57
  SETTABLEKS R60 R59 K85 ["handleInitialSettings"]
  DUPCLOSURE R60 K86 [PROTO_8]
  CAPTURE VAL R16
  CAPTURE VAL R23
  CAPTURE VAL R19
  CAPTURE VAL R10
  ...
  CAPTURE VAL R6
  CAPTURE VAL R17
  SETTABLEKS R60 R59 K87 ["init"]
  DUPCLOSURE R60 K88 [PROTO_9]
  SETTABLEKS R60 R59 K89 ["didUpdate"]
  DUPCLOSURE R60 K90 [PROTO_13]
  CAPTURE VAL R14
  CAPTURE VAL R23
  CAPTURE VAL R19
  CAPTURE VAL R4
  CAPTURE VAL R16
  SETTABLEKS R60 R59 K91 ["didMount"]
  DUPCLOSURE R60 K92 [PROTO_14]
  SETTABLEKS R60 R59 K93 ["willUnmount"]
  DUPCLOSURE R60 K94 [PROTO_15]
  CAPTURE VAL R23
  CAPTURE VAL R16
  CAPTURE VAL R3
  CAPTURE VAL R11
  ...
  CAPTURE VAL R29
  CAPTURE VAL R30
  SETTABLEKS R60 R59 K95 ["render"]
  MOVE R60 R46
  DUPTABLE R61 K101 [{"IXP", "Stylizer", "Localization", "Settings", "Modal", "Network"}]
  MOVE R63 R54
  CALL R63 0 1
  JUMPIF R63 [+6]
  MOVE R63 R55
  ...
  JUMP [+1]
  LOADNIL R62
  SETTABLEKS R62 R61 K96 ["IXP"]
  GETTABLEKS R62 R45 K97 ["Stylizer"]
  SETTABLEKS R62 R61 K97 ["Stylizer"]
  GETTABLEKS R62 R45 K98 ["Localization"]
  SETTABLEKS R62 R61 K98 ["Localization"]
  SETTABLEKS R47 R61 K61 ["Settings"]
  SETTABLEKS R48 R61 K99 ["Modal"]
  SETTABLEKS R49 R61 K100 ["Network"]
  CALL R60 1 1
  MOVE R61 R59
  CALL R60 1 1
  MOVE R59 R60
  DUPCLOSURE R60 K102 [PROTO_16]
  CAPTURE VAL R23
  CAPTURE VAL R6
  DUPCLOSURE R61 K103 [PROTO_24]
  CAPTURE VAL R53
  CAPTURE VAL R42
  CAPTURE VAL R41
  CAPTURE VAL R38
  ...
  CAPTURE VAL R55
  CAPTURE VAL R51
  GETTABLEKS R62 R8 K104 ["connect"]
  MOVE R63 R60
  MOVE R64 R61
  CALL R62 2 1
  MOVE R63 R59
