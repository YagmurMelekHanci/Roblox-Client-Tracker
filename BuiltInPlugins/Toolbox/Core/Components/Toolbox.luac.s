...
MAIN:
  ...
  LOADK R7 K15 ["TutorialMarketplaceTabFix"]
  LOADB R8 0
  ...
  GETTABLEKS R11 R6 K21 ["Framework"]
  CALL R10 1 1
  GETIMPORT R12 K4 [require]
  GETTABLEKS R15 R0 K5 ["Core"]
  GETTABLEKS R14 R15 K6 ["Util"]
  GETTABLEKS R13 R14 K22 ["ToolboxUtilities"]
  CALL R12 1 1
  GETTABLEKS R11 R12 K23 ["showRobloxCreatedAssets"]
  GETIMPORT R13 K4 [require]
  GETTABLEKS R16 R0 K5 ["Core"]
  GETTABLEKS R15 R16 K6 ["Util"]
  GETTABLEKS R14 R15 K22 ["ToolboxUtilities"]
  CALL R13 1 1
  GETTABLEKS R12 R13 K24 ["getHomeViewEnabledAssetTypes"]
  GETIMPORT R13 K4 [require]
  GETTABLEKS R17 R0 K5 ["Core"]
  GETTABLEKS R16 R17 K6 ["Util"]
  GETTABLEKS R15 R16 K7 ["SharedFlags"]
  GETTABLEKS R14 R15 K25 ["getIsUseWebView"]
  CALL R13 1 1
  GETIMPORT R14 K4 [require]
  GETTABLEKS R15 R0 K26 ["SharedPluginConstants"]
  CALL R14 1 1
  GETTABLEKS R16 R0 K5 ["Core"]
  GETTABLEKS R15 R16 K6 ["Util"]
  GETIMPORT R16 K4 [require]
  GETTABLEKS R17 R15 K27 ["Constants"]
  CALL R16 1 1
  GETIMPORT R17 K4 [require]
  GETTABLEKS R18 R15 K28 ["PageInfoHelper"]
  CALL R17 1 1
  GETIMPORT R18 K4 [require]
  GETTABLEKS R19 R15 K29 ["getTabs"]
  CALL R18 1 1
  GETIMPORT R19 K4 [require]
  GETTABLEKS R21 R15 K30 ["Analytics"]
  GETTABLEKS R20 R21 K30 ["Analytics"]
  CALL R19 1 1
  GETIMPORT R20 K4 [require]
  GETTABLEKS R21 R15 K31 ["isInSemanticSearchIXP"]
  CALL R20 1 1
  GETTABLEKS R22 R0 K5 ["Core"]
  GETTABLEKS R21 R22 K32 ["Types"]
  GETIMPORT R22 K4 [require]
  GETTABLEKS R23 R21 K33 ["Sort"]
  CALL R22 1 1
  GETIMPORT R23 K4 [require]
  GETTABLEKS R24 R21 K34 ["Category"]
  CALL R23 1 1
  GETIMPORT R24 K4 [require]
  GETTABLEKS R25 R21 K35 ["RequestReason"]
  CALL R24 1 1
  GETTABLEKS R26 R0 K5 ["Core"]
  GETTABLEKS R25 R26 K36 ["Components"]
  GETIMPORT R26 K4 [require]
  GETTABLEKS R27 R25 K37 ["AnnouncementDialog"]
  CALL R26 1 1
  GETIMPORT R27 K4 [require]
  GETTABLEKS R28 R25 K38 ["TabSet"]
  CALL R27 1 1
  GETIMPORT R28 K4 [require]
  GETTABLEKS R29 R25 K39 ["Header"]
  CALL R28 1 1
  GETIMPORT R29 K4 [require]
  GETTABLEKS R31 R25 K40 ["MainView"]
  GETTABLEKS R30 R31 K40 ["MainView"]
  CALL R29 1 1
  GETIMPORT R30 K4 [require]
  GETTABLEKS R31 R25 K41 ["SoundPreviewComponent"]
  CALL R30 1 1
  GETIMPORT R31 K4 [require]
  GETTABLEKS R33 R25 K42 ["Home"]
  GETTABLEKS R32 R33 K43 ["HomeWrapper"]
  CALL R31 1 1
  MOVE R33 R1
  CALL R33 0 1
  JUMPIFNOT R33 [+2]
  ...
  GETTABLEKS R35 R36 K36 ["Components"]
  GETTABLEKS R34 R35 K44 ["SearchOptions"]
  GETTABLEKS R33 R34 K44 ["SearchOptions"]
  CALL R32 1 1
  GETIMPORT R33 K4 [require]
  GETTABLEKS R38 R0 K5 ["Core"]
  GETTABLEKS R37 R38 K36 ["Components"]
  GETTABLEKS R36 R37 K44 ["SearchOptions"]
  GETTABLEKS R35 R36 K45 ["SearchOptionWrappers"]
  GETTABLEKS R34 R35 K46 ["AudioMarketplaceSearchOptions"]
  CALL R33 1 1
  MOVE R35 R1
  CALL R35 0 1
  JUMPIFNOT R35 [+14]
  ...
  GETTABLEKS R35 R36 K47 ["MarketplaceSearchOptions"]
  CALL R34 1 1
  JUMP [+1]
  LOADNIL R34
  MOVE R36 R1
  ...
  GETTABLEKS R36 R37 K48 ["InventorySearchOptions"]
  CALL R35 1 1
  JUMP [+1]
  LOADNIL R35
  GETIMPORT R36 K4 [require]
  GETTABLEKS R38 R25 K49 ["WebView"]
  GETTABLEKS R37 R38 K50 ["WebViewConnector"]
  CALL R36 1 1
  GETTABLEKS R39 R0 K5 ["Core"]
  GETTABLEKS R38 R39 K51 ["Networking"]
  GETTABLEKS R37 R38 K52 ["Requests"]
  GETIMPORT R38 K4 [require]
  GETTABLEKS R39 R37 K53 ["UpdatePageInfoAndSendRequest"]
  CALL R38 1 1
  GETIMPORT R39 K4 [require]
  GETTABLEKS R40 R37 K54 ["ChangeMarketplaceTab"]
  CALL R39 1 1
  GETIMPORT R40 K4 [require]
  GETTABLEKS R41 R37 K55 ["GetToolboxManageableGroupsRequest"]
  CALL R40 1 1
  GETIMPORT R41 K4 [require]
  GETTABLEKS R42 R37 K56 ["GetRolesRequest"]
  CALL R41 1 1
  GETIMPORT R42 K4 [require]
  GETTABLEKS R43 R37 K57 ["GetRolesDebugRequest"]
  CALL R42 1 1
  GETIMPORT R43 K4 [require]
  GETTABLEKS R44 R37 K58 ["GetRobuxBalance"]
  CALL R43 1 1
  GETIMPORT R44 K4 [require]
  GETTABLEKS R47 R0 K5 ["Core"]
  GETTABLEKS R46 R47 K59 ["ContextServices"]
  GETTABLEKS R45 R46 K60 ["IXPContext"]
  CALL R44 1 1
  GETTABLEKS R45 R10 K59 ["ContextServices"]
  GETTABLEKS R46 R45 K61 ["withContext"]
  GETIMPORT R47 K4 [require]
  GETTABLEKS R50 R0 K5 ["Core"]
  GETTABLEKS R49 R50 K59 ["ContextServices"]
  GETTABLEKS R48 R49 K62 ["Settings"]
  CALL R47 1 1
  GETIMPORT R48 K4 [require]
  GETTABLEKS R51 R0 K5 ["Core"]
  GETTABLEKS R50 R51 K59 ["ContextServices"]
  GETTABLEKS R49 R50 K63 ["ModalContext"]
  CALL R48 1 1
  GETIMPORT R49 K4 [require]
  GETTABLEKS R52 R0 K5 ["Core"]
  GETTABLEKS R51 R52 K59 ["ContextServices"]
  GETTABLEKS R50 R51 K64 ["NetworkContext"]
  CALL R49 1 1
  GETIMPORT R50 K4 [require]
  GETTABLEKS R53 R0 K5 ["Core"]
  GETTABLEKS R52 R53 K32 ["Types"]
  GETTABLEKS R51 R52 K65 ["HomeTypes"]
  CALL R50 1 1
  GETIMPORT R51 K4 [require]
  GETTABLEKS R54 R0 K5 ["Core"]
  GETTABLEKS R53 R54 K66 ["Actions"]
  GETTABLEKS R52 R53 K67 ["SetLayoutMode"]
  CALL R51 1 1
  GETIMPORT R52 K4 [require]
  GETTABLEKS R55 R0 K5 ["Core"]
  GETTABLEKS R54 R55 K68 ["Thunks"]
  GETTABLEKS R53 R54 K69 ["LogMarketplaceSearchAnalytics"]
  CALL R52 1 1
  GETIMPORT R53 K12 [game]
  LOADK R55 K70 ["DebugToolboxGetRolesRequest"]
  ...
  GETTABLEKS R58 R59 K74 ["LayoutMode"]
  CALL R57 1 1
  GETIMPORT R58 K4 [require]
  GETTABLEKS R61 R0 K5 ["Core"]
  GETTABLEKS R60 R61 K32 ["Types"]
  GETTABLEKS R59 R60 K75 ["Background"]
  CALL R58 1 1
  GETTABLEKS R59 R8 K76 ["PureComponent"]
  LOADK R61 K77 ["Toolbox"]
  NAMECALL R59 R59 K78 ["extend"]
  CALL R59 2 1
  DUPTABLE R60 K80 [{"Size"}]
  GETIMPORT R61 K83 [UDim2.new]
  LOADN R62 1
  LOADN R63 0
  LOADN R64 1
  LOADN R65 0
  CALL R61 4 1
  SETTABLEKS R61 R60 K79 ["Size"]
  SETTABLEKS R60 R59 K84 ["defaultProps"]
  DUPCLOSURE R60 K85 [PROTO_0]
  CAPTURE VAL R5
  CAPTURE VAL R55
  CAPTURE VAL R58
  CAPTURE VAL R23
  ...
  CAPTURE VAL R56
  CAPTURE VAL R57
  SETTABLEKS R60 R59 K86 ["handleInitialSettings"]
  DUPCLOSURE R60 K87 [PROTO_8]
  CAPTURE VAL R16
  CAPTURE VAL R23
  CAPTURE VAL R19
  CAPTURE VAL R11
  ...
  CAPTURE VAL R7
  CAPTURE VAL R17
  SETTABLEKS R60 R59 K88 ["init"]
  DUPCLOSURE R60 K89 [PROTO_9]
  SETTABLEKS R60 R59 K90 ["didUpdate"]
  DUPCLOSURE R60 K91 [PROTO_13]
  CAPTURE VAL R14
  CAPTURE VAL R23
  CAPTURE VAL R19
  CAPTURE VAL R4
  CAPTURE VAL R16
  SETTABLEKS R60 R59 K92 ["didMount"]
  DUPCLOSURE R60 K93 [PROTO_14]
  SETTABLEKS R60 R59 K94 ["willUnmount"]
  DUPCLOSURE R60 K95 [PROTO_15]
  CAPTURE VAL R23
  CAPTURE VAL R16
  CAPTURE VAL R3
  CAPTURE VAL R12
  ...
  CAPTURE VAL R29
  CAPTURE VAL R30
  SETTABLEKS R60 R59 K96 ["render"]
  MOVE R60 R46
  DUPTABLE R61 K102 [{"IXP", "Stylizer", "Localization", "Settings", "Modal", "Network"}]
  MOVE R63 R54
  CALL R63 0 1
  JUMPIF R63 [+6]
  MOVE R63 R55
  ...
  JUMP [+1]
  LOADNIL R62
  SETTABLEKS R62 R61 K97 ["IXP"]
  GETTABLEKS R62 R45 K98 ["Stylizer"]
  SETTABLEKS R62 R61 K98 ["Stylizer"]
  GETTABLEKS R62 R45 K99 ["Localization"]
  SETTABLEKS R62 R61 K99 ["Localization"]
  SETTABLEKS R47 R61 K62 ["Settings"]
  SETTABLEKS R48 R61 K100 ["Modal"]
  SETTABLEKS R49 R61 K101 ["Network"]
  CALL R60 1 1
  MOVE R61 R59
  CALL R60 1 1
  MOVE R59 R60
  DUPCLOSURE R60 K103 [PROTO_16]
  CAPTURE VAL R23
  CAPTURE VAL R7
  DUPCLOSURE R61 K104 [PROTO_24]
  CAPTURE VAL R53
  CAPTURE VAL R42
  CAPTURE VAL R41
  CAPTURE VAL R38
  ...
  CAPTURE VAL R55
  CAPTURE VAL R51
  GETTABLEKS R62 R9 K105 ["connect"]
  MOVE R63 R60
  MOVE R64 R61
  CALL R62 2 1
  MOVE R63 R59
