...
MAIN:
  ...
  CALL R37 1 1
  GETTABLEKS R40 R0 K5 ["Core"]
  GETTABLEKS R39 R40 K51 ["Networking"]
  GETTABLEKS R38 R39 K52 ["Requests"]
  GETIMPORT R39 K4 [require]
  GETTABLEKS R40 R38 K53 ["UpdatePageInfoAndSendRequest"]
  CALL R39 1 1
  GETIMPORT R40 K4 [require]
  GETTABLEKS R41 R38 K54 ["ChangeMarketplaceTab"]
  CALL R40 1 1
  GETIMPORT R41 K4 [require]
  GETTABLEKS R42 R38 K55 ["GetToolboxManageableGroupsRequest"]
  CALL R41 1 1
  GETIMPORT R42 K4 [require]
  GETTABLEKS R43 R38 K56 ["GetRolesRequest"]
  CALL R42 1 1
  GETIMPORT R43 K4 [require]
  GETTABLEKS R44 R38 K57 ["GetRolesDebugRequest"]
  CALL R43 1 1
  GETIMPORT R44 K4 [require]
  GETTABLEKS R45 R38 K58 ["GetRobuxBalance"]
  CALL R44 1 1
  GETIMPORT R45 K4 [require]
  GETTABLEKS R48 R0 K5 ["Core"]
  GETTABLEKS R47 R48 K59 ["ContextServices"]
  GETTABLEKS R46 R47 K60 ["IXPContext"]
  CALL R45 1 1
  GETTABLEKS R46 R11 K59 ["ContextServices"]
  GETTABLEKS R47 R46 K61 ["withContext"]
  GETIMPORT R48 K4 [require]
  GETTABLEKS R51 R0 K5 ["Core"]
  GETTABLEKS R50 R51 K59 ["ContextServices"]
  GETTABLEKS R49 R50 K62 ["Settings"]
  CALL R48 1 1
  GETIMPORT R49 K4 [require]
  GETTABLEKS R52 R0 K5 ["Core"]
  GETTABLEKS R51 R52 K59 ["ContextServices"]
  GETTABLEKS R50 R51 K63 ["ModalContext"]
  CALL R49 1 1
  GETIMPORT R50 K4 [require]
  GETTABLEKS R53 R0 K5 ["Core"]
  GETTABLEKS R52 R53 K59 ["ContextServices"]
  GETTABLEKS R51 R52 K64 ["NetworkContext"]
  CALL R50 1 1
  GETIMPORT R51 K4 [require]
  GETTABLEKS R54 R0 K5 ["Core"]
  GETTABLEKS R53 R54 K32 ["Types"]
  GETTABLEKS R52 R53 K65 ["HomeTypes"]
  CALL R51 1 1
  GETIMPORT R52 K4 [require]
  GETTABLEKS R55 R0 K5 ["Core"]
  GETTABLEKS R54 R55 K66 ["Actions"]
  GETTABLEKS R53 R54 K67 ["SetLayoutMode"]
  CALL R52 1 1
  GETIMPORT R53 K4 [require]
  GETTABLEKS R56 R0 K5 ["Core"]
  GETTABLEKS R55 R56 K68 ["Thunks"]
  GETTABLEKS R54 R55 K69 ["LogMarketplaceSearchAnalytics"]
  CALL R53 1 1
  GETIMPORT R54 K12 [game]
  LOADK R56 K70 ["DebugToolboxGetRolesRequest"]
  NAMECALL R54 R54 K14 ["GetFastFlag"]
  CALL R54 2 1
  GETIMPORT R55 K4 [require]
  GETTABLEKS R59 R0 K5 ["Core"]
  GETTABLEKS R58 R59 K6 ["Util"]
  GETTABLEKS R57 R58 K7 ["SharedFlags"]
  GETTABLEKS R56 R57 K71 ["getFFlagToolboxContentManagementCombineTabs"]
  CALL R55 1 1
  GETIMPORT R56 K4 [require]
  GETTABLEKS R60 R0 K5 ["Core"]
  GETTABLEKS R59 R60 K6 ["Util"]
  GETTABLEKS R58 R59 K7 ["SharedFlags"]
  GETTABLEKS R57 R58 K72 ["getFFlagToolboxEnableAssetRows"]
  CALL R56 1 1
  GETIMPORT R57 K4 [require]
  GETTABLEKS R61 R0 K5 ["Core"]
  GETTABLEKS R60 R61 K6 ["Util"]
  GETTABLEKS R59 R60 K7 ["SharedFlags"]
  GETTABLEKS R58 R59 K73 ["getIsIXPEnabledForListView"]
  CALL R57 1 1
  GETIMPORT R58 K4 [require]
  GETTABLEKS R61 R0 K5 ["Core"]
  GETTABLEKS R60 R61 K32 ["Types"]
  GETTABLEKS R59 R60 K74 ["LayoutMode"]
  CALL R58 1 1
  GETIMPORT R59 K4 [require]
  GETTABLEKS R62 R0 K5 ["Core"]
  GETTABLEKS R61 R62 K32 ["Types"]
  GETTABLEKS R60 R61 K75 ["Background"]
  CALL R59 1 1
  GETTABLEKS R60 R9 K76 ["PureComponent"]
  LOADK R62 K77 ["Toolbox"]
  NAMECALL R60 R60 K78 ["extend"]
  CALL R60 2 1
  DUPTABLE R61 K80 [{"Size"}]
  ...
  LOADN R66 0
  CALL R62 4 1
  SETTABLEKS R62 R61 K79 ["Size"]
  SETTABLEKS R61 R60 K84 ["defaultProps"]
  DUPCLOSURE R61 K85 [PROTO_0]
  CAPTURE VAL R56
  CAPTURE VAL R59
  CAPTURE VAL R24
  CAPTURE VAL R55
  ...
  CAPTURE VAL R57
  CAPTURE VAL R58
  SETTABLEKS R61 R60 K86 ["handleInitialSettings"]
  DUPCLOSURE R61 K87 [PROTO_8]
  CAPTURE VAL R17
  CAPTURE VAL R24
  CAPTURE VAL R20
  CAPTURE VAL R12
  ...
  CAPTURE VAL R4
  CAPTURE VAL R6
  SETTABLEKS R61 R60 K88 ["init"]
  DUPCLOSURE R61 K89 [PROTO_9]
  SETTABLEKS R61 R60 K90 ["didUpdate"]
  DUPCLOSURE R61 K91 [PROTO_13]
  CAPTURE VAL R15
  CAPTURE VAL R24
  CAPTURE VAL R20
  CAPTURE VAL R4
  ...
  CAPTURE VAL R5
  CAPTURE VAL R17
  SETTABLEKS R61 R60 K92 ["didMount"]
  DUPCLOSURE R61 K93 [PROTO_14]
  SETTABLEKS R61 R60 K94 ["willUnmount"]
  DUPCLOSURE R61 K95 [PROTO_15]
  CAPTURE VAL R24
  CAPTURE VAL R17
  CAPTURE VAL R3
  CAPTURE VAL R13
  ...
  JUMP [+1]
  LOADNIL R63
  SETTABLEKS R63 R62 K97 ["IXP"]
  GETTABLEKS R63 R46 K98 ["Stylizer"]
  SETTABLEKS R63 R62 K98 ["Stylizer"]
  GETTABLEKS R63 R46 K99 ["Localization"]
  SETTABLEKS R63 R62 K99 ["Localization"]
  SETTABLEKS R48 R62 K62 ["Settings"]
  SETTABLEKS R49 R62 K100 ["Modal"]
  SETTABLEKS R50 R62 K101 ["Network"]
  CALL R61 1 1
  MOVE R62 R60
  CALL R61 1 1
  MOVE R60 R61
  DUPCLOSURE R61 K103 [PROTO_16]
  CAPTURE VAL R24
  CAPTURE VAL R8
  DUPCLOSURE R62 K104 [PROTO_24]
  CAPTURE VAL R54
  CAPTURE VAL R43
  CAPTURE VAL R42
  CAPTURE VAL R39
  ...
  CAPTURE VAL R56
  CAPTURE VAL R52
  GETTABLEKS R63 R10 K105 ["connect"]
  MOVE R64 R61
  MOVE R65 R62
  CALL R63 2 1
  MOVE R64 R60
