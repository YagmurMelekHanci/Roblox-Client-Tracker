...
MAIN:
  ...
  GETTABLEKS R22 R23 K36 ["getFFlagEnableBodyScaleValidationSupport"]
  CALL R21 1 1
  GETIMPORT R22 K6 [require]
  GETTABLEKS R24 R1 K29 ["SharedFlags"]
  GETTABLEKS R23 R24 K37 ["getFFlagEnableBodyColorSetUploadSupport"]
  CALL R22 1 1
  ...
  CAPTURE VAL R22
  SETTABLEKS R26 R25 K94 ["getBodyColorSet"]
  DUPCLOSURE R26 K95 [PROTO_30]
  CAPTURE VAL R2
  SETTABLEKS R26 R25 K96 ["getUGCBundleTypeFromString"]
  DUPCLOSURE R26 K97 [PROTO_31]
  CAPTURE VAL R7
  SETTABLEKS R26 R25 K98 ["getAllowedAssetTypeSettingsForBundle"]
  DUPCLOSURE R26 K99 [PROTO_32]
  CAPTURE VAL R25
  CAPTURE VAL R2
  SETTABLEKS R26 R25 K100 ["getAllowedAssetTypeEnumsForBundle"]
  DUPCLOSURE R26 K101 [PROTO_33]
  CAPTURE VAL R25
  CAPTURE VAL R2
  SETTABLEKS R26 R25 K102 ["getAllowedAssetTypeEnumsForBundleWithSettings"]
  DUPCLOSURE R26 K103 [PROTO_34]
  SETTABLEKS R26 R25 K104 ["isAllowedUGCAssetType"]
  DUPCLOSURE R26 K105 [PROTO_35]
  CAPTURE VAL R25
  CAPTURE VAL R2
  CAPTURE VAL R9
  SETTABLEKS R26 R25 K106 ["getUGCBodyPartsAssetTypeMap"]
  DUPCLOSURE R26 K107 [PROTO_36]
  SETTABLEKS R26 R25 K108 ["AssetTypeRequiresFolderForUpload"]
  DUPCLOSURE R26 K109 [PROTO_37]
  CAPTURE VAL R25
  SETTABLEKS R26 R25 K110 ["createUGCBodyPartFolders"]
  DUPCLOSURE R26 K111 [PROTO_38]
  CAPTURE VAL R2
  SETTABLEKS R26 R25 K112 ["getLocalizedUGCBundleName"]
  DUPCLOSURE R26 K113 [PROTO_39]
  CAPTURE VAL R21
  SETTABLEKS R26 R25 K114 ["resetAvatarBodyPartsToOriginalSizeAndPosition"]
  DUPCLOSURE R26 K115 [PROTO_40]
  CAPTURE VAL R21
  CAPTURE VAL R25
  CAPTURE VAL R3
  SETTABLEKS R26 R25 K116 ["sanitizeForValidation"]
  MOVE R26 R16
  CALL R26 0 1
  JUMPIFNOT R26 [+8]
  DUPCLOSURE R26 K117 [PROTO_41]
  CAPTURE VAL R25
  SETTABLEKS R26 R25 K118 ["getOptionalAssetTypesForBundle"]
  DUPCLOSURE R26 K119 [PROTO_42]
  CAPTURE VAL R25
  SETTABLEKS R26 R25 K120 ["getOptionalBodyPartsNotFound"]
  JUMPIFNOT R19 [+8]
  DUPCLOSURE R26 K121 [PROTO_43]
  CAPTURE VAL R25
  SETTABLEKS R26 R25 K122 ["getAllowedAssetTypesByBundleType"]
  DUPCLOSURE R26 K123 [PROTO_44]
  CAPTURE VAL R2
  SETTABLEKS R26 R25 K124 ["getUnknownMeshPartNames"]
  DUPCLOSURE R26 K125 [PROTO_45]
  CAPTURE VAL R25
  SETTABLEKS R26 R25 K126 ["getAvatarAssetTypeAsString"]
  RETURN R25 1
