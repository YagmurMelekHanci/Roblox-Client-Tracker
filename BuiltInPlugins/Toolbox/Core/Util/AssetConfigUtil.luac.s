...
PROTO_30:
  ...
  FORGPREP R5
  GETUPVAL R13 1
  GETTABLEKS R12 R13 K13 ["BodyScaleDefaults"]
  GETTABLE R11 R12 R3
  GETTABLE R10 R11 R8
  JUMPIFEQ R9 R10 [+25]
  MOVE R12 R4
  LOADK R15 K4 ["AssetConfig"]
  LOADK R16 K14 ["BodyScaleValidationErrorNotDefaultValue"]
  DUPTABLE R17 K18 [{"scaleName", "defaultValue", "scaleType"}]
  GETUPVAL R20 1
  GETTABLEKS R19 R20 K19 ["bodyScaleNameToString"]
  GETTABLE R18 R19 R8
  SETTABLEKS R18 R17 K15 ["scaleName"]
  SETTABLEKS R10 R17 K16 ["defaultValue"]
  LOADK R19 K20 ["AvatarPartScaleType "]
  MOVE R20 R3
  CONCAT R18 R19 R20
  SETTABLEKS R18 R17 K17 ["scaleType"]
...
MAIN:
  ...
  DUPCLOSURE R25 K90 [PROTO_28]
  CAPTURE VAL R20
  SETTABLEKS R25 R24 K91 ["getBodyScaleValues"]
  MOVE R25 R20
  CALL R25 0 1
  JUMPIFNOT R25 [+9]
  DUPCLOSURE R25 K92 [PROTO_29]
  CAPTURE VAL R2
  SETTABLEKS R25 R24 K93 ["getBodyScaleType"]
  DUPCLOSURE R25 K94 [PROTO_30]
  CAPTURE VAL R24
  CAPTURE VAL R2
  SETTABLEKS R25 R24 K95 ["ValidateScaleSettings"]
  DUPCLOSURE R25 K96 [PROTO_31]
  CAPTURE VAL R21
  SETTABLEKS R25 R24 K97 ["getBodyColorSet"]
  DUPCLOSURE R25 K98 [PROTO_32]
  CAPTURE VAL R2
  SETTABLEKS R25 R24 K99 ["getUGCBundleTypeFromString"]
  DUPCLOSURE R25 K100 [PROTO_33]
  CAPTURE VAL R7
  SETTABLEKS R25 R24 K101 ["getAllowedAssetTypeSettingsForBundle"]
  DUPCLOSURE R25 K102 [PROTO_34]
  CAPTURE VAL R24
  CAPTURE VAL R2
  SETTABLEKS R25 R24 K103 ["getAllowedAssetTypeEnumsForBundle"]
  DUPCLOSURE R25 K104 [PROTO_35]
  CAPTURE VAL R24
  CAPTURE VAL R2
  SETTABLEKS R25 R24 K105 ["getAllowedAssetTypeEnumsForBundleWithSettings"]
  DUPCLOSURE R25 K106 [PROTO_36]
  SETTABLEKS R25 R24 K107 ["isAllowedUGCAssetType"]
  DUPCLOSURE R25 K108 [PROTO_37]
  CAPTURE VAL R24
  CAPTURE VAL R2
  CAPTURE VAL R9
  SETTABLEKS R25 R24 K109 ["getUGCBodyPartsAssetTypeMap"]
  DUPCLOSURE R25 K110 [PROTO_38]
  SETTABLEKS R25 R24 K111 ["AssetTypeRequiresFolderForUpload"]
  DUPCLOSURE R25 K112 [PROTO_39]
  CAPTURE VAL R24
  SETTABLEKS R25 R24 K113 ["createUGCBodyPartFolders"]
  DUPCLOSURE R25 K114 [PROTO_40]
  CAPTURE VAL R2
  SETTABLEKS R25 R24 K115 ["getLocalizedUGCBundleName"]
  DUPCLOSURE R25 K116 [PROTO_41]
  CAPTURE VAL R3
  SETTABLEKS R25 R24 K117 ["sanitizeForValidation"]
  MOVE R25 R16
  CALL R25 0 1
  JUMPIFNOT R25 [+8]
  DUPCLOSURE R25 K118 [PROTO_42]
  CAPTURE VAL R24
  SETTABLEKS R25 R24 K119 ["getOptionalAssetTypesForBundle"]
  DUPCLOSURE R25 K120 [PROTO_43]
  CAPTURE VAL R24
  SETTABLEKS R25 R24 K121 ["getOptionalBodyPartsNotFound"]
  JUMPIFNOT R19 [+8]
  DUPCLOSURE R25 K122 [PROTO_44]
  CAPTURE VAL R24
  SETTABLEKS R25 R24 K123 ["getAllowedAssetTypesByBundleType"]
  DUPCLOSURE R25 K124 [PROTO_45]
  CAPTURE VAL R2
  SETTABLEKS R25 R24 K125 ["getUnknownMeshPartNames"]
  DUPCLOSURE R25 K126 [PROTO_46]
  CAPTURE VAL R24
  SETTABLEKS R25 R24 K127 ["getAvatarAssetTypeAsString"]
  RETURN R24 1
