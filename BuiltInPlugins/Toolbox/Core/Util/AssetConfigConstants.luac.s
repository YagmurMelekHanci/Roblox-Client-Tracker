...
MAIN:
  ...
  GETTABLEKS R12 R13 K258 ["rawValue"]
  CALL R12 0 1
  GETTABLEKS R14 R8 K255 ["UGCBundleTypes"]
  GETTABLEKS R13 R14 K256 ["Body"]
  ...
  GETTABLEKS R13 R14 K192 ["DynamicHead"]
  SETTABLE R13 R11 R12
  SETTABLEKS R11 R8 K259 ["UGCBundleTypeStringToEnumeration"]
  MOVE R12 R4
  CALL R12 0 1
  JUMPIFNOT R12 [+47]
  NEWTABLE R11 16 0
  ...
  GETIMPORT R12 K152 [Enum.AssetType.LeftShoeAccessory]
  SETTABLEKS R12 R11 K151 ["LeftShoeAccessory"]
  GETIMPORT R12 K154 [Enum.AssetType.RightShoeAccessory]
  SETTABLEKS R12 R11 K153 ["RightShoeAccessory"]
  JUMP [+38]
  NEWTABLE R11 16 0
  GETIMPORT R12 K193 [Enum.AssetType.DynamicHead]
  SETTABLEKS R12 R11 K192 ["DynamicHead"]
  ...
  GETIMPORT R12 K126 [Enum.AssetType.HairAccessory]
  SETTABLEKS R12 R11 K125 ["HairAccessory"]
  SETTABLEKS R11 R8 K260 ["AllowedAssetStringsMetadataToAssetTypeMap"]
  DUPTABLE R11 K276 [{"Head", "UpperTorso", "LowerTorso", "LeftUpperLeg", "LeftLowerLeg", "LeftHand", "RightUpperArm", "RightLowerArm", "RightHand", "LeftUpperArm", "LeftLowerArm", "LeftFoot", "RightUpperLeg", "RightLowerLeg", "RightFoot", "EyebrowAccessory", "EyelashAccessory", "HairAccessory"}]
  LOADK R12 K5 ["Packages"]
  SETTABLEKS R12 R11 K261 ["Head"]
  LOADK R12 K6 ["enumerate"]
  SETTABLEKS R12 R11 K262 ["UpperTorso"]
  LOADK R12 K7 ["Core"]
  SETTABLEKS R12 R11 K263 ["LowerTorso"]
  LOADK R12 K8 ["Util"]
  SETTABLEKS R12 R11 K264 ["LeftUpperLeg"]
  LOADK R12 K9 ["SharedFlags"]
  SETTABLEKS R12 R11 K265 ["LeftLowerLeg"]
  LOADK R12 K10 ["getFFlagEnableUGCBundleUploadBodyScale"]
  SETTABLEKS R12 R11 K266 ["LeftHand"]
  LOADK R12 K11 ["Flags"]
  SETTABLEKS R12 R11 K267 ["RightUpperArm"]
  LOADK R12 K12 ["getFFlagEnableUploadingShoes"]
  SETTABLEKS R12 R11 K268 ["RightLowerArm"]
  LOADK R12 K13 ["getFFlagToolboxMoveCreatorDropdown"]
  SETTABLEKS R12 R11 K269 ["RightHand"]
  LOADK R12 K14 ["getFFlagCheckAvatarAssetPrivacy"]
  SETTABLEKS R12 R11 K270 ["LeftUpperArm"]
  LOADK R12 K15 ["convertArrayToTable"]
  SETTABLEKS R12 R11 K271 ["LeftLowerArm"]
  LOADK R12 K16 ["WIDTH"]
  SETTABLEKS R12 R11 K272 ["LeftFoot"]
  LOADK R12 K17 ["HEIGHT"]
  SETTABLEKS R12 R11 K273 ["RightUpperLeg"]
  LOADK R12 K18 ["MIN_WIDTH"]
  SETTABLEKS R12 R11 K274 ["RightLowerLeg"]
  LOADK R12 K19 ["MIN_HEIGHT"]
  SETTABLEKS R12 R11 K275 ["RightFoot"]
  ...
  SETTABLEKS R12 R11 K125 ["HairAccessory"]
  SETTABLEKS R11 R8 K277 ["UGC_BODY_PARTS"]
  MOVE R12 R4
  CALL R12 0 1
  JUMPIFNOT R12 [+8]
  DUPTABLE R11 K278 [{"LeftShoeAccessory", "RightShoeAccessory"}]
  LOADK R12 K151 ["LeftShoeAccessory"]
  SETTABLEKS R12 R11 K151 ["LeftShoeAccessory"]
  LOADK R12 K153 ["RightShoeAccessory"]
  SETTABLEKS R12 R11 K153 ["RightShoeAccessory"]
  JUMP [+1]
  LOADNIL R11
  SETTABLEKS R11 R8 K279 ["UGC_BUNDLE_PARTS"]
  NEWTABLE R11 32 0
  GETTABLEKS R13 R8 K277 ["UGC_BODY_PARTS"]
  GETTABLEKS R12 R13 K261 ["Head"]
  GETIMPORT R13 K193 [Enum.AssetType.DynamicHead]
  SETTABLE R13 R11 R12
  GETTABLEKS R13 R8 K277 ["UGC_BODY_PARTS"]
  GETTABLEKS R12 R13 K262 ["UpperTorso"]
  GETIMPORT R13 K183 [Enum.AssetType.Torso]
  SETTABLE R13 R11 R12
  GETTABLEKS R13 R8 K277 ["UGC_BODY_PARTS"]
  GETTABLEKS R12 R13 K263 ["LowerTorso"]
  GETIMPORT R13 K183 [Enum.AssetType.Torso]
  SETTABLE R13 R11 R12
  GETTABLEKS R13 R8 K277 ["UGC_BODY_PARTS"]
  GETTABLEKS R12 R13 K270 ["LeftUpperArm"]
  GETIMPORT R13 K187 [Enum.AssetType.LeftArm]
  SETTABLE R13 R11 R12
  GETTABLEKS R13 R8 K277 ["UGC_BODY_PARTS"]
  GETTABLEKS R12 R13 K271 ["LeftLowerArm"]
  GETIMPORT R13 K187 [Enum.AssetType.LeftArm]
  SETTABLE R13 R11 R12
  GETTABLEKS R13 R8 K277 ["UGC_BODY_PARTS"]
  GETTABLEKS R12 R13 K266 ["LeftHand"]
  GETIMPORT R13 K187 [Enum.AssetType.LeftArm]
  SETTABLE R13 R11 R12
  GETTABLEKS R13 R8 K277 ["UGC_BODY_PARTS"]
  GETTABLEKS R12 R13 K267 ["RightUpperArm"]
  GETIMPORT R13 K185 [Enum.AssetType.RightArm]
  SETTABLE R13 R11 R12
  GETTABLEKS R13 R8 K277 ["UGC_BODY_PARTS"]
  GETTABLEKS R12 R13 K268 ["RightLowerArm"]
  GETIMPORT R13 K185 [Enum.AssetType.RightArm]
  SETTABLE R13 R11 R12
  GETTABLEKS R13 R8 K277 ["UGC_BODY_PARTS"]
  GETTABLEKS R12 R13 K269 ["RightHand"]
  GETIMPORT R13 K185 [Enum.AssetType.RightArm]
  SETTABLE R13 R11 R12
  GETTABLEKS R13 R8 K277 ["UGC_BODY_PARTS"]
  GETTABLEKS R12 R13 K264 ["LeftUpperLeg"]
  GETIMPORT R13 K189 [Enum.AssetType.LeftLeg]
  SETTABLE R13 R11 R12
  GETTABLEKS R13 R8 K277 ["UGC_BODY_PARTS"]
  GETTABLEKS R12 R13 K265 ["LeftLowerLeg"]
  GETIMPORT R13 K189 [Enum.AssetType.LeftLeg]
  SETTABLE R13 R11 R12
  GETTABLEKS R13 R8 K277 ["UGC_BODY_PARTS"]
  GETTABLEKS R12 R13 K272 ["LeftFoot"]
  GETIMPORT R13 K189 [Enum.AssetType.LeftLeg]
  SETTABLE R13 R11 R12
  GETTABLEKS R13 R8 K277 ["UGC_BODY_PARTS"]
  GETTABLEKS R12 R13 K273 ["RightUpperLeg"]
  GETIMPORT R13 K191 [Enum.AssetType.RightLeg]
  SETTABLE R13 R11 R12
  GETTABLEKS R13 R8 K277 ["UGC_BODY_PARTS"]
  GETTABLEKS R12 R13 K274 ["RightLowerLeg"]
  GETIMPORT R13 K191 [Enum.AssetType.RightLeg]
  SETTABLE R13 R11 R12
  GETTABLEKS R13 R8 K277 ["UGC_BODY_PARTS"]
  GETTABLEKS R12 R13 K275 ["RightFoot"]
  GETIMPORT R13 K191 [Enum.AssetType.RightLeg]
  SETTABLE R13 R11 R12
  GETTABLEKS R13 R8 K277 ["UGC_BODY_PARTS"]
  ...
  SETTABLE R13 R11 R12
  SETTABLEKS R11 R8 K280 ["UGC_BODY_PART_NAMES_TO_ASSET_TYPE"]
  MOVE R12 R4
  CALL R12 0 1
  JUMPIFNOT R12 [+17]
  NEWTABLE R11 2 0
  GETTABLEKS R13 R8 K279 ["UGC_BUNDLE_PARTS"]
  GETTABLEKS R12 R13 K151 ["LeftShoeAccessory"]
  GETIMPORT R13 K152 [Enum.AssetType.LeftShoeAccessory]
  SETTABLE R13 R11 R12
  GETTABLEKS R13 R8 K279 ["UGC_BUNDLE_PARTS"]
  GETTABLEKS R12 R13 K153 ["RightShoeAccessory"]
  GETIMPORT R13 K154 [Enum.AssetType.RightShoeAccessory]
  SETTABLE R13 R11 R12
  JUMP [+1]
  LOADNIL R11
  SETTABLEKS R11 R8 K281 ["UGC_BUNDLE_PART_NAMES_TO_ASSET_TYPE"]
  MOVE R11 R3
  CALL R11 0 1
  JUMPIFNOT R11 [+90]
  DUPTABLE R11 K285 [{"Classic", "ProportionsNormal", "ProportionsSlender", "Unknown"}]
  LOADK R12 K26 ["PACKAGE_NOTE_CHARACTER_LIMIT"]
  SETTABLEKS R12 R11 K282 ["Classic"]
  LOADK R12 K27 ["TITLE_GUTTER_WIDTH"]
  SETTABLEKS R12 R11 K283 ["ProportionsNormal"]
  LOADK R12 K28 ["UDim2"]
  SETTABLEKS R12 R11 K284 ["ProportionsSlender"]
  LOADK R12 K90 ["Unknown"]
  SETTABLEKS R12 R11 K90 ["Unknown"]
  SETTABLEKS R11 R8 K286 ["BodyScaleTypes"]
  DUPTABLE R11 K287 [{"Classic", "ProportionsNormal", "ProportionsSlender"}]
  DUPTABLE R12 K293 [{"height", "width", "head", "proportion", "bodyType"}]
  LOADN R13 1
  SETTABLEKS R13 R12 K288 ["height"]
  LOADN R13 1
  SETTABLEKS R13 R12 K289 ["width"]
  LOADN R13 1
  SETTABLEKS R13 R12 K290 ["head"]
  LOADN R13 0
  SETTABLEKS R13 R12 K291 ["proportion"]
  LOADN R13 0
  SETTABLEKS R13 R12 K292 ["bodyType"]
  SETTABLEKS R12 R11 K282 ["Classic"]
  DUPTABLE R12 K293 [{"height", "width", "head", "proportion", "bodyType"}]
  LOADN R13 1
  SETTABLEKS R13 R12 K288 ["height"]
  ...
  SETTABLEKS R13 R12 K292 ["bodyType"]
  SETTABLEKS R12 R11 K284 ["ProportionsSlender"]
  SETTABLEKS R11 R8 K294 ["BodyScaleDefaults"]
  DUPTABLE R11 K295 [{"height", "width", "head", "bodyType", "proportion"}]
  LOADK R12 K40 ["Permissions"]
  SETTABLEKS R12 R11 K288 ["height"]
  LOADK R12 K41 ["SIDE_TABS"]
  SETTABLEKS R12 R11 K289 ["width"]
  LOADK R12 K42 ["Title"]
  SETTABLEKS R12 R11 K290 ["head"]
  LOADK R12 K43 ["Description"]
  SETTABLEKS R12 R11 K292 ["bodyType"]
  LOADK R12 K44 ["Price"]
  SETTABLEKS R12 R11 K291 ["proportion"]
  SETTABLEKS R11 R8 K301 ["bodyScaleNameToString"]
  MOVE R11 R5
  CALL R11 0 1
  JUMPIFNOT R11 [+18]
  DUPTABLE R11 K307 [{"NONE", "BEGIN", "VALIDATING", "SUCCESS", "FAILURE"}]
  LOADK R12 K52 ["Name"]
  SETTABLEKS R12 R11 K302 ["NONE"]
  LOADK R12 K53 ["TownAndCity"]
  SETTABLEKS R12 R11 K303 ["BEGIN"]
  LOADK R12 K54 [Enum.Genre.TownAndCity]
  SETTABLEKS R12 R11 K304 ["VALIDATING"]
  LOADK R12 K241 ["Success"]
  SETTABLEKS R12 R11 K305 ["SUCCESS"]
  LOADK R12 K55 ["Fantasy"]
  SETTABLEKS R12 R11 K306 ["FAILURE"]
  SETTABLEKS R11 R8 K312 ["VALIDATION_STATE"]
  MOVE R11 R6
  CALL R11 0 1
  JUMPIFNOT R11 [+8]
  NEWTABLE R11 0 2
  LOADK R12 K57 ["SciFi"]
  LOADK R13 K58 [Enum.Genre.SciFi]
  SETLIST R11 R12 2 [1]
  SETTABLEKS R11 R8 K315 ["assetIdStringPatterns"]
  RETURN R8 1
