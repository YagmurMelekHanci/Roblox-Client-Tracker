...
PROTO_9:
  ...
  JUMP [+1]
  LOADK R10 K26 ["studio"]
  LOADK R11 K2 ["Marketplace"]
  LOADK R12 K27 ["MarketplaceAssetImpression"]
  MOVE R13 R8
  CALL R9 4 0
  GETUPVAL R10 1
  GETTABLEKS R9 R10 K28 ["incrementAssetImpressionCounter"]
  CALL R9 0 0
...
PROTO_12:
  ...
  RETURN R0 0
  GETIMPORT R11 K16 [ipairs]
  GETUPVAL R14 0
  GETTABLEKS R12 R14 K17 ["InsertRemainsCheckDelays"]
  CALL R11 1 3
  FORGPREP_INEXT R11
  GETUPVAL R17 0
  GETTABLEKS R16 R17 K18 ["schedule"]
  MOVE R17 R15
  NEWCLOSURE R18 P0
  CAPTURE VAL R3
  CAPTURE VAL R0
...
MAIN:
  ...
  GETTABLEKS R13 R14 K24 ["getFFlagSTM5561Enabled"]
  CALL R12 1 1
  ...
  GETTABLEKS R17 R18 K28 ["getFFlagSendToolboxUnmountEvent"]
  CALL R16 1 1
  GETIMPORT R17 K9 [require]
  GETTABLEKS R21 R1 K12 ["Core"]
  GETTABLEKS R20 R21 K15 ["Util"]
  GETTABLEKS R19 R20 K23 ["SharedFlags"]
  GETTABLEKS R18 R19 K29 ["getFFlagToolboxFixInsertRemains"]
  CALL R17 1 1
  NEWTABLE R18 32 0
  SETTABLEKS R18 R18 K30 ["__index"]
  NEWTABLE R19 0 3
  LOADN R20 30
  LOADN R21 120
  LOADN R22 88
  SETLIST R19 R20 3 [1]
  SETTABLEKS R19 R18 K31 ["InsertRemainsCheckDelays"]
  ...
  CAPTURE VAL R18
  SETTABLEKS R19 R18 K35 ["mock"]
  DUPCLOSURE R19 K36 [PROTO_3]
  CAPTURE VAL R7
  CAPTURE VAL R0
  SETTABLEKS R19 R18 K37 ["getNavigationContext"]
  DUPCLOSURE R19 K38 [PROTO_4]
  SETTABLEKS R19 R18 K39 ["schedule"]
  DUPCLOSURE R19 K40 [PROTO_5]
  SETTABLEKS R19 R18 K41 ["getAssetCategoryName"]
  DUPCLOSURE R19 K42 [PROTO_6]
  SETTABLEKS R19 R18 K43 ["isAssetDataTrackable"]
  DUPCLOSURE R19 K44 [PROTO_7]
  CAPTURE VAL R18
  SETTABLEKS R19 R18 K45 ["isAssetTrackable"]
  ...
  CAPTURE VAL R6
  CAPTURE VAL R9
  SETTABLEKS R19 R18 K47 ["getTrackingAttributes"]
  ...
  CAPTURE VAL R15
  CAPTURE VAL R16
  SETTABLEKS R19 R18 K49 ["logImpression"]
  ...
  CAPTURE VAL R12
  CAPTURE VAL R9
  SETTABLEKS R19 R18 K51 ["logPreview"]
  DUPCLOSURE R19 K52 [PROTO_12]
  CAPTURE VAL R18
  CAPTURE VAL R17
  CAPTURE VAL R9
  CAPTURE VAL R11
  CAPTURE VAL R4
  CAPTURE VAL R12
  SETTABLEKS R19 R18 K53 ["logInsert"]
  DUPCLOSURE R19 K54 [PROTO_13]
  CAPTURE VAL R17
  CAPTURE VAL R12
  CAPTURE VAL R9
  SETTABLEKS R19 R18 K55 ["logRemainsOrDeleted"]
  DUPCLOSURE R19 K56 [PROTO_14]
  CAPTURE VAL R12
  CAPTURE VAL R9
  CAPTURE VAL R0
  SETTABLEKS R19 R18 K57 ["logNavigationButtonInteraction"]
  DUPCLOSURE R19 K58 [PROTO_15]
  SETTABLEKS R19 R18 K59 ["logPageView"]
  DUPCLOSURE R19 K60 [PROTO_16]
  SETTABLEKS R19 R18 K61 ["logGoBack"]
  DUPCLOSURE R19 K62 [PROTO_17]
  CAPTURE VAL R12
  CAPTURE VAL R9
  SETTABLEKS R19 R18 K63 ["onCallToActionBannerClicked"]
  DUPCLOSURE R19 K64 [PROTO_18]
  CAPTURE VAL R18
  CAPTURE VAL R4
  CAPTURE VAL R12
  CAPTURE VAL R9
  SETTABLEKS R19 R18 K65 ["logAssetMediaImpression"]
  DUPCLOSURE R19 K66 [PROTO_19]
  CAPTURE VAL R18
  CAPTURE VAL R4
  CAPTURE VAL R12
  CAPTURE VAL R9
  SETTABLEKS R19 R18 K67 ["onAssetDescriptionLinkClicked"]
  RETURN R18 1
