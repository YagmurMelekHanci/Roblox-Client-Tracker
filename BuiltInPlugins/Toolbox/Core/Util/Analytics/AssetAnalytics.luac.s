...
MAIN:
  ...
  LOADN R20 88
  SETLIST R17 R18 3 [1]
  SETTABLEKS R17 R16 K29 ["InsertRemainsCheckDelays"]
  ...
  CAPTURE VAL R7
  CAPTURE VAL R0
  SETTABLEKS R17 R16 K35 ["getNavigationContext"]
  DUPCLOSURE R17 K36 [PROTO_4]
  SETTABLEKS R17 R16 K37 ["schedule"]
  DUPCLOSURE R17 K38 [PROTO_5]
  SETTABLEKS R17 R16 K39 ["getAssetCategoryName"]
  DUPCLOSURE R17 K40 [PROTO_6]
  SETTABLEKS R17 R16 K41 ["isAssetDataTrackable"]
  DUPCLOSURE R17 K42 [PROTO_7]
  CAPTURE VAL R16
  SETTABLEKS R17 R16 K43 ["isAssetTrackable"]
  ...
  CAPTURE VAL R12
  CAPTURE VAL R9
  SETTABLEKS R17 R16 K49 ["logPreview"]
  ...
  CAPTURE VAL R12
  CAPTURE VAL R9
  SETTABLEKS R17 R16 K51 ["logInsert"]
  DUPCLOSURE R17 K52 [PROTO_13]
  CAPTURE VAL R12
  CAPTURE VAL R9
  SETTABLEKS R17 R16 K53 ["logRemainsOrDeleted"]
  DUPCLOSURE R17 K54 [PROTO_14]
  CAPTURE VAL R12
  CAPTURE VAL R9
  CAPTURE VAL R0
  SETTABLEKS R17 R16 K55 ["logNavigationButtonInteraction"]
  DUPCLOSURE R17 K56 [PROTO_15]
  SETTABLEKS R17 R16 K57 ["logPageView"]
  DUPCLOSURE R17 K58 [PROTO_16]
  SETTABLEKS R17 R16 K59 ["logGoBack"]
  DUPCLOSURE R17 K60 [PROTO_17]
  CAPTURE VAL R12
  CAPTURE VAL R9
  SETTABLEKS R17 R16 K61 ["onCallToActionBannerClicked"]
  DUPCLOSURE R17 K62 [PROTO_18]
  CAPTURE VAL R16
  CAPTURE VAL R4
  CAPTURE VAL R12
  CAPTURE VAL R9
  SETTABLEKS R17 R16 K63 ["logAssetMediaImpression"]
  DUPCLOSURE R17 K64 [PROTO_19]
  CAPTURE VAL R16
  CAPTURE VAL R4
  CAPTURE VAL R12
  CAPTURE VAL R9
  SETTABLEKS R17 R16 K65 ["onAssetDescriptionLinkClicked"]
  RETURN R16 1
