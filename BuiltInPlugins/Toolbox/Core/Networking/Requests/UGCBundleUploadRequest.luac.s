...
PROTO_11:
  ...
  MOVE R7 R1
  CALL R4 3 0
  GETIMPORT R4 K25 [Enum.AssetCreatorType.User]
  MOVE R5 R2
  GETUPVAL R6 12
  CALL R6 0 1
  JUMPIFNOT R6 [+13]
  GETUPVAL R7 9
  NAMECALL R7 R7 K26 ["getState"]
  CALL R7 1 1
  GETTABLEKS R6 R7 K27 ["groupBundlesUploadEnabledForUser"]
  JUMPIFNOT R6 [+6]
  GETUPVAL R7 13
  JUMPIFEQKNIL R7 [+4]
  GETIMPORT R4 K29 [Enum.AssetCreatorType.Group]
  GETUPVAL R5 13
  NEWTABLE R6 0 0
  LOADN R7 0
  NEWTABLE R8 0 0
  GETIMPORT R9 K31 [pairs]
  MOVE R10 R3
  CALL R9 1 3
  FORGPREP_NEXT R9
  GETUPVAL R15 14
  ...
  GETIMPORT R16 K39 [table.insert]
  CALL R16 -1 0
  FORGLOOP R9 2 [-45]
  GETUPVAL R10 16
  GETTABLEKS R9 R10 K40 ["all"]
  MOVE R10 R8
  CALL R9 1 1
  NEWCLOSURE R11 P1
  CAPTURE REF R7
  ...
  LOADK R2 K42 ["Unexpected UGCBundleUploadRequest response:"]
  MOVE R3 R0
  CALL R1 2 0
  GETUPVAL R1 2
  CALL R1 0 1
  ...
  LOADK R10 K44 ["ValidationErrorUnknown"]
...
MAIN:
  ...
  GETTABLEKS R28 R29 K41 ["getFFlagEnableUploadingGroupBundles"]
  CALL R27 1 1
  ...
  DUPCLOSURE R32 K46 [PROTO_3]
  DUPCLOSURE R33 K47 [PROTO_4]
  DUPCLOSURE R34 K48 [PROTO_5]
  CAPTURE VAL R24
  CAPTURE VAL R26
  CAPTURE VAL R23
  CAPTURE VAL R27
