...
PROTO_5:
  ...
  GETUPVAL R4 1
  DUPTABLE R5 K7 [{"backgrounds", "suggestions", "Size", "plugin"}]
  GETUPVAL R7 2
  GETTABLEKS R6 R7 K8 ["BACKGROUNDS"]
  SETTABLEKS R6 R5 K3 ["backgrounds"]
  GETUPVAL R7 3
  GETTABLEKS R6 R7 K9 ["SUGGESTIONS"]
...
MAIN:
  ...
  CALL R8 2 1
  DUPTABLE R9 K21 [{"ReloadWebBrowserWidgetAsync", "ShowWebBrowserWidgetAsync", "HideWebBrowserWidgetAsync"}]
  DUPCLOSURE R10 K22 [PROTO_0]
  SETTABLEKS R10 R9 K18 ["ReloadWebBrowserWidgetAsync"]
  DUPCLOSURE R10 K23 [PROTO_1]
  SETTABLEKS R10 R9 K19 ["ShowWebBrowserWidgetAsync"]
  DUPCLOSURE R10 K24 [PROTO_2]
  SETTABLEKS R10 R9 K20 ["HideWebBrowserWidgetAsync"]
  DUPTABLE R10 K26 [{"GetPluginComponent"}]
  DUPCLOSURE R11 K27 [PROTO_3]
  CAPTURE VAL R9
  SETTABLEKS R11 R10 K25 ["GetPluginComponent"]
  DUPCLOSURE R11 K28 [PROTO_4]
  CAPTURE VAL R4
  SETTABLEKS R11 R8 K29 ["init"]
