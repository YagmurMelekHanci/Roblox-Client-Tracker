...
PROTO_1:
  LOADNIL R2
  GETUPVAL R4 0
  GETTABLEKS R3 R4 K0 ["getAUserDesignSheet"]
  CALL R3 0 1
  GETTABLEKS R4 R1 K1 ["recordChange"]
  DUPTABLE R5 K5 [{"Name", "DisplayName", "DoChange"}]
  LOADK R6 K6 ["StyleEditor/CreateTokenSheet"]
  SETTABLEKS R6 R5 K2 ["Name"]
  LOADK R6 K7 ["StyleEditor - Create Token Sheet"]
  ...
  CAPTURE UPVAL U1
  CAPTURE UPVAL U0
  SETTABLEKS R6 R5 K4 ["DoChange"]
  CALL R4 1 0
  JUMPIFNOT R2 [+11]
  GETUPVAL R5 2
  GETTABLEKS R4 R5 K8 ["createItemId"]
  MOVE R5 R2
  CALL R4 1 1
  GETUPVAL R7 3
  MOVE R8 R4
