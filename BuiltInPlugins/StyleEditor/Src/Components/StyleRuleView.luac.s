...
MAIN:
  ...
  CALL R8 1 1
  GETTABLEKS R10 R5 K17 ["Src"]
  GETTABLEKS R9 R10 K18 ["Flags"]
  GETIMPORT R10 K12 [require]
  GETTABLEKS R11 R9 K19 ["getFFlagStyleEditorMigrateStylingV2"]
  CALL R10 1 1
  CALL R10 0 1
  GETTABLEKS R11 R8 K20 ["ContextServices"]
  GETTABLEKS R12 R11 K21 ["withContext"]
  GETTABLEKS R13 R11 K22 ["Localization"]
  GETTABLEKS R14 R8 K23 ["UI"]
  GETTABLEKS R15 R14 K24 ["IconButton"]
  GETTABLEKS R16 R14 K25 ["Pane"]
  GETTABLEKS R18 R8 K26 ["Styling"]
  GETTABLEKS R17 R18 K27 ["joinTags"]
  GETIMPORT R18 K12 [require]
  GETTABLEKS R20 R5 K17 ["Src"]
  GETTABLEKS R19 R20 K28 ["Types"]
  CALL R18 1 1
  GETIMPORT R19 K12 [require]
  GETTABLEKS R22 R5 K17 ["Src"]
  GETTABLEKS R21 R22 K29 ["Reducers"]
  GETTABLEKS R20 R21 K30 ["RootReducer"]
  CALL R19 1 1
  GETTABLEKS R21 R5 K17 ["Src"]
  GETTABLEKS R20 R21 K31 ["Actions"]
  GETIMPORT R21 K12 [require]
  GETTABLEKS R23 R20 K32 ["SessionStats"]
  GETTABLEKS R22 R23 K33 ["TrackButtonPress"]
  CALL R21 1 1
  GETIMPORT R22 K12 [require]
  GETTABLEKS R25 R5 K17 ["Src"]
  GETTABLEKS R24 R25 K34 ["Enums"]
  GETTABLEKS R23 R24 K35 ["InstancesHaveVariant"]
  CALL R22 1 1
  GETIMPORT R23 K12 [require]
  GETTABLEKS R26 R5 K17 ["Src"]
  GETTABLEKS R25 R26 K36 ["Util"]
  GETTABLEKS R24 R25 K37 ["mapDispatchToProps"]
  CALL R23 1 1
  GETIMPORT R24 K12 [require]
  GETTABLEKS R27 R5 K17 ["Src"]
  GETTABLEKS R26 R27 K36 ["Util"]
  GETTABLEKS R25 R26 K38 ["recordChange"]
  CALL R24 1 1
  MOVE R25 R0
  CALL R24 1 1
  GETIMPORT R25 K12 [require]
  GETTABLEKS R28 R5 K17 ["Src"]
  GETTABLEKS R27 R28 K36 ["Util"]
  GETTABLEKS R26 R27 K39 ["SelectorHelpers"]
  CALL R25 1 1
  GETIMPORT R26 K12 [require]
  GETTABLEKS R29 R5 K17 ["Src"]
  GETTABLEKS R28 R29 K40 ["Components"]
  GETTABLEKS R27 R28 K41 ["SelectorPropertyTable"]
  CALL R26 1 1
  GETIMPORT R27 K12 [require]
  GETTABLEKS R30 R5 K17 ["Src"]
  GETTABLEKS R29 R30 K40 ["Components"]
  GETTABLEKS R28 R29 K42 ["StyleRulePreview"]
  CALL R27 1 1
  GETIMPORT R28 K12 [require]
  GETTABLEKS R31 R5 K17 ["Src"]
  GETTABLEKS R30 R31 K43 ["Resources"]
  GETTABLEKS R29 R30 K44 ["PluginStyles"]
  CALL R28 1 1
  LOADK R31 K45 ["ButtonHeight"]
  NAMECALL R29 R28 K46 ["GetAttribute"]
  CALL R29 2 1
  LOADK R32 K47 ["PaddingSm"]
  NAMECALL R30 R28 K46 ["GetAttribute"]
  CALL R30 2 1
  LOADK R33 K48 ["Spacing"]
  NAMECALL R31 R28 K46 ["GetAttribute"]
  CALL R31 2 1
  LOADK R34 K49 ["TitleTextSize"]
  NAMECALL R32 R28 K46 ["GetAttribute"]
  CALL R32 2 1
  GETTABLEKS R33 R6 K50 ["PureComponent"]
  LOADK R35 K51 ["StyleRuleView"]
  ...
  CAPTURE VAL R32
  CAPTURE VAL R29
  SETTABLEKS R34 R33 K55 ["estimateScrollHeight"]
  DUPCLOSURE R34 K56 [PROTO_14]
  SETTABLEKS R34 R33 K57 ["createPreviewInstanceFromSelectorLink"]
  NEWCLOSURE R34 P3
  CAPTURE VAL R4
  CAPTURE REF R33
  SETTABLEKS R34 R33 K58 ["isVisible"]
  NEWCLOSURE R34 P4
  CAPTURE VAL R6
  CAPTURE VAL R4
  CAPTURE REF R33
  SETTABLEKS R34 R33 K59 ["getPreview"]
  NEWCLOSURE R34 P5
  CAPTURE REF R33
  CAPTURE VAL R6
  CAPTURE VAL R25
  SETTABLEKS R34 R33 K60 ["getDerivedStateFromProps"]
  DUPCLOSURE R34 K61 [PROTO_21]
  SETTABLEKS R34 R33 K62 ["didUpdate"]
  DUPCLOSURE R34 K63 [PROTO_22]
  CAPTURE VAL R3
  SETTABLEKS R34 R33 K64 ["didMount"]
  DUPCLOSURE R34 K65 [PROTO_23]
  SETTABLEKS R34 R33 K66 ["willUnmount"]
  ...
  CAPTURE VAL R27
  CAPTURE VAL R26
  SETTABLEKS R34 R33 K68 ["render"]
  MOVE R34 R12
  DUPTABLE R35 K69 [{"Localization"}]
  SETTABLEKS R13 R35 K22 ["Localization"]
  CALL R34 1 1
  MOVE R35 R33
  CALL R34 1 1
  MOVE R33 R34
  GETTABLEKS R34 R7 K70 ["connect"]
  DUPCLOSURE R35 K71 [PROTO_25]
  MOVE R36 R23
  CALL R34 2 1
  MOVE R35 R33
  CALL R34 1 -1
