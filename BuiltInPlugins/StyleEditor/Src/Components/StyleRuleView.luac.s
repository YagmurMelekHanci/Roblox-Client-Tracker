...
PROTO_10:
  ...
  GETTABLEKS R3 R4 K10 ["Scale"]
  MULK R2 R3 K8 [200]
  GETTABLEKS R4 R0 K9 ["Y"]
  GETTABLEKS R3 R4 K11 ["Offset"]
  ADD R1 R2 R3
...
MAIN:
  ...
  GETTABLEKS R24 R25 K40 ["ActionClickedEventType"]
  CALL R23 1 1
  GETIMPORT R24 K12 [require]
  GETTABLEKS R27 R5 K25 ["Src"]
  GETTABLEKS R26 R27 K39 ["Enums"]
  GETTABLEKS R25 R26 K41 ["InstancesHaveVariant"]
  CALL R24 1 1
  GETIMPORT R25 K12 [require]
  GETTABLEKS R28 R5 K25 ["Src"]
  GETTABLEKS R27 R28 K42 ["Util"]
  GETTABLEKS R26 R27 K43 ["mapDispatchToProps"]
  CALL R25 1 1
  GETIMPORT R26 K12 [require]
  GETTABLEKS R29 R5 K25 ["Src"]
  GETTABLEKS R28 R29 K42 ["Util"]
  GETTABLEKS R27 R28 K44 ["recordChange"]
  CALL R26 1 1
  MOVE R27 R0
  CALL R26 1 1
  GETIMPORT R27 K12 [require]
  GETTABLEKS R30 R5 K25 ["Src"]
  GETTABLEKS R29 R30 K42 ["Util"]
  GETTABLEKS R28 R29 K45 ["SelectorHelpers"]
  CALL R27 1 1
  GETIMPORT R28 K12 [require]
  GETTABLEKS R31 R5 K25 ["Src"]
  GETTABLEKS R30 R31 K42 ["Util"]
  GETTABLEKS R29 R30 K23 ["Styling"]
  CALL R28 1 1
  GETIMPORT R29 K12 [require]
  GETTABLEKS R32 R5 K25 ["Src"]
  GETTABLEKS R31 R32 K46 ["Components"]
  GETTABLEKS R30 R31 K47 ["SelectorPropertyTable"]
  CALL R29 1 1
  GETIMPORT R30 K12 [require]
  GETTABLEKS R33 R5 K25 ["Src"]
  GETTABLEKS R32 R33 K46 ["Components"]
  GETTABLEKS R31 R32 K48 ["StyleRulePreview"]
  CALL R30 1 1
  GETIMPORT R31 K51 [UDim2.fromOffset]
  LOADN R32 200
  LOADN R33 100
  CALL R31 2 1
  GETTABLEKS R32 R6 K52 ["PureComponent"]
  LOADK R34 K53 ["StyleRuleView"]
  ...
  CAPTURE VAL R28
  CAPTURE VAL R31
  SETTABLEKS R33 R32 K55 ["init"]
  DUPCLOSURE R33 K56 [PROTO_17]
  SETTABLEKS R33 R32 K57 ["createPreviewInstanceFromSelectorLink"]
  NEWCLOSURE R33 P2
  CAPTURE VAL R6
  CAPTURE VAL R4
  CAPTURE REF R32
  SETTABLEKS R33 R32 K58 ["getPreview"]
  NEWCLOSURE R33 P3
  CAPTURE REF R32
  CAPTURE VAL R6
  CAPTURE VAL R27
  SETTABLEKS R33 R32 K59 ["getDerivedStateFromProps"]
  DUPCLOSURE R33 K60 [PROTO_22]
  SETTABLEKS R33 R32 K61 ["didUpdate"]
  DUPCLOSURE R33 K62 [PROTO_23]
  CAPTURE VAL R3
  SETTABLEKS R33 R32 K63 ["didMount"]
  DUPCLOSURE R33 K64 [PROTO_24]
  SETTABLEKS R33 R32 K65 ["willUnmount"]
  ...
  CAPTURE VAL R30
  CAPTURE VAL R29
  SETTABLEKS R33 R32 K67 ["render"]
  MOVE R33 R10
  DUPTABLE R34 K68 [{"Localization"}]
  SETTABLEKS R11 R34 K19 ["Localization"]
  CALL R33 1 1
  MOVE R34 R32
  CALL R33 1 1
  MOVE R32 R33
  GETTABLEKS R33 R7 K69 ["connect"]
  DUPCLOSURE R34 K70 [PROTO_26]
  MOVE R35 R25
  CALL R33 2 1
  MOVE R34 R32
  CALL R33 1 -1
