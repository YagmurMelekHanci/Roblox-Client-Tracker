...
MAIN:
  ...
  DUPCLOSURE R29 K48 [PROTO_17]
  SETTABLEKS R29 R28 K49 ["createPreviewInstanceFromSelectorLink"]
  NEWCLOSURE R29 P2
  CAPTURE VAL R6
  CAPTURE VAL R4
  CAPTURE REF R28
  SETTABLEKS R29 R28 K50 ["getPreview"]
  NEWCLOSURE R29 P3
  CAPTURE REF R28
  CAPTURE VAL R6
  CAPTURE VAL R23
  SETTABLEKS R29 R28 K51 ["getDerivedStateFromProps"]
  DUPCLOSURE R29 K52 [PROTO_22]
  SETTABLEKS R29 R28 K53 ["didUpdate"]
  DUPCLOSURE R29 K54 [PROTO_23]
  CAPTURE VAL R3
  SETTABLEKS R29 R28 K55 ["didMount"]
  DUPCLOSURE R29 K56 [PROTO_24]
  SETTABLEKS R29 R28 K57 ["willUnmount"]
  DUPCLOSURE R29 K58 [PROTO_25]
  CAPTURE VAL R20
  CAPTURE VAL R6
  CAPTURE VAL R14
  CAPTURE VAL R23
  ...
  MOVE R29 R10
  DUPTABLE R30 K60 [{"Localization"}]
  SETTABLEKS R11 R30 K19 ["Localization"]
  CALL R29 1 1
  MOVE R30 R28
  CALL R29 1 1
  MOVE R28 R29
  GETTABLEKS R29 R7 K61 ["connect"]
  DUPCLOSURE R30 K62 [PROTO_26]
  MOVE R31 R21
  CALL R29 2 1
  MOVE R30 R28
  CALL R29 1 -1
