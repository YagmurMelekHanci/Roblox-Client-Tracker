...
PROTO_1:
  ...
  GETTABLEKS R9 R1 K30 ["OnPreviewInstanceChanged"]
  JUMPIFNOT R9 [+5]
  GETTABLEKS R9 R1 K30 ["OnPreviewInstanceChanged"]
  GETTABLEKS R10 R1 K4 ["PreviewInstance"]
  CALL R9 1 0
  RETURN R0 0
...
PROTO_5:
  ...
  LOADK R11 K21 ["PreviewGrid X-Middle X-Center X-Clip X-FitY"]
  SETTABLE R11 R9 R10
  DUPTABLE R10 K23 [{"UIPadding"}]
  GETUPVAL R12 0
  GETTABLEKS R11 R12 K3 ["createElement"]
  LOADK R12 K22 ["UIPadding"]
  DUPTABLE R13 K28 [{"PaddingLeft", "PaddingRight", "PaddingTop", "PaddingBottom"}]
  GETIMPORT R14 K31 [UDim.new]
  LOADN R15 0
  GETTABLEKS R18 R0 K32 ["state"]
  GETTABLEKS R17 R18 K33 ["padding"]
  GETTABLEKS R16 R17 K34 ["X"]
  CALL R14 2 1
  ...
  GETTABLEKS R18 R0 K32 ["state"]
  GETTABLEKS R17 R18 K33 ["padding"]
  GETTABLEKS R16 R17 K35 ["Y"]
  CALL R14 2 1
  SETTABLEKS R14 R13 K26 ["PaddingTop"]
  GETIMPORT R14 K31 [UDim.new]
  LOADN R15 0
  GETTABLEKS R18 R0 K32 ["state"]
  GETTABLEKS R17 R18 K33 ["padding"]
  GETTABLEKS R16 R17 K35 ["Y"]
  CALL R14 2 1
  SETTABLEKS R14 R13 K27 ["PaddingBottom"]
  CALL R11 2 1
