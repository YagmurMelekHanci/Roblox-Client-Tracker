...
PROTO_13:
  ...
  GETUPVAL R4 0
  GETTABLEKS R3 R4 K3 ["TokenReferenceSchema"]
  DUPTABLE R4 K7 [{"Editing", "Instance"}]
  LOADB R5 1
  ...
  MOVE R5 R1
  GETUPVAL R7 4
  GETTABLEKS R6 R7 K8 ["Path"]
  LOADN R7 2
  NAMECALL R2 R2 K9 ["updateCell"]
  CALL R2 5 1
  GETUPVAL R3 5
  MOVE R4 R2
  CALL R3 1 -1
...
PROTO_32:
  ...
  SETTABLEKS R1 R0 K12 ["adaptor"]
  NEWCLOSURE R2 P0
  CAPTURE VAL R1
  CAPTURE UPVAL U2
  CAPTURE UPVAL U3
  CAPTURE UPVAL U4
  SETTABLEKS R2 R0 K13 ["onDoubleClick"]
  NEWCLOSURE R2 P1
  CAPTURE VAL R0
  SETTABLEKS R2 R0 K14 ["canPasteProperty"]
  NEWCLOSURE R2 P2
  CAPTURE VAL R0
  SETTABLEKS R2 R0 K15 ["canPasteSelector"]
  NEWCLOSURE R2 P3
  CAPTURE VAL R1
  CAPTURE UPVAL U3
  SETTABLEKS R2 R0 K16 ["selectRow"]
  NEWCLOSURE R2 P4
  CAPTURE VAL R0
  SETTABLEKS R2 R0 K17 ["onRightClickRow"]
  NEWCLOSURE R2 P5
  CAPTURE VAL R0
  CAPTURE UPVAL U5
  CAPTURE UPVAL U6
  CAPTURE UPVAL U7
  SETTABLEKS R2 R0 K18 ["showEmptyRowContextMenu"]
  NEWCLOSURE R2 P6
  CAPTURE VAL R0
  CAPTURE UPVAL U4
  CAPTURE UPVAL U8
  ...
  CAPTURE UPVAL U6
  CAPTURE UPVAL U7
  SETTABLEKS R2 R0 K19 ["showPropertyRowContextMenu"]
  NEWCLOSURE R2 P7
  CAPTURE VAL R0
  CAPTURE UPVAL U11
  CAPTURE UPVAL U6
  SETTABLEKS R2 R0 K20 ["showContextMenu"]
...
PROTO_38:
  GETUPVAL R3 0
  DUPTABLE R4 K6 [{"tableItems", "dispatch", "setState", "newValue", "path", "columnIndex"}]
  GETUPVAL R7 1
  GETTABLEKS R6 R7 K7 ["table"]
...
MAIN:
  ...
  GETTABLEKS R38 R39 K54 ["Tree"]
  CALL R37 1 1
  GETTABLEKS R38 R37 K55 ["EditTree"]
  LOADK R41 K56 ["RowHeight"]
  NAMECALL R39 R30 K57 ["GetAttribute"]
  CALL R39 2 1
  GETTABLEKS R40 R2 K58 ["PureComponent"]
  LOADK R42 K59 ["SelectorPropertyTable"]
  ...
  DUPCLOSURE R41 K62 [PROTO_33]
  CAPTURE VAL R37
  CAPTURE VAL R5
  CAPTURE VAL R6
  SETTABLEKS R41 R40 K63 ["rebuildTableState"]
  DUPCLOSURE R41 K64 [PROTO_34]
  SETTABLEKS R41 R40 K65 ["didMount"]
  DUPCLOSURE R41 K66 [PROTO_35]
  SETTABLEKS R41 R40 K67 ["didUpdate"]
  DUPCLOSURE R41 K68 [PROTO_36]
  SETTABLEKS R41 R40 K69 ["willUnmount"]
  NEWCLOSURE R41 P5
  CAPTURE REF R40
  SETTABLEKS R41 R40 K70 ["getDerivedStateFromProps"]
  DUPCLOSURE R41 K71 [PROTO_39]
  CAPTURE VAL R6
  CAPTURE VAL R37
  CAPTURE VAL R36
  CAPTURE VAL R31
  ...
  MOVE R41 R12
  DUPTABLE R42 K75 [{"Plugin", "Localization", "Telemetry"}]
  GETTABLEKS R43 R11 K73 ["Plugin"]
  SETTABLEKS R43 R42 K73 ["Plugin"]
  GETTABLEKS R43 R11 K74 ["Localization"]
  SETTABLEKS R43 R42 K74 ["Localization"]
  SETTABLEKS R35 R42 K51 ["Telemetry"]
  CALL R41 1 1
  MOVE R42 R40
  CALL R41 1 1
  MOVE R40 R41
  GETTABLEKS R41 R3 K76 ["connect"]
  DUPCLOSURE R42 K77 [PROTO_40]
  MOVE R43 R23
  CALL R41 2 1
  MOVE R42 R40
  CALL R41 1 -1
