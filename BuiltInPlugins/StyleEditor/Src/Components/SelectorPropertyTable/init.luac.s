...
PROTO_30:
  ...
  GETTABLEKS R2 R3 K3 ["connections"]
  GETTABLEKS R1 R2 K4 ["instanceMap"]
  GETTABLEKS R2 R0 K5 ["StyleRulePropertyChanged"]
  GETUPVAL R4 2
...
PROTO_31:
  ...
  GETTABLEKS R2 R3 K1 ["instanceMap"]
  GETTABLEKS R3 R0 K2 ["StyleRulePropertyChanged"]
  MOVE R5 R1
  ...
  GETTABLEKS R8 R6 K2 ["StyleRulePropertyChanged"]
  MOVE R10 R1
  ...
  NAMECALL R3 R3 K3 ["Connect"]
  CALL R3 2 1
  SETTABLEKS R3 R2 K8 ["descendantRemovingConnection"]
  GETUPVAL R3 0
  GETTABLEKS R2 R3 K0 ["connections"]
  GETTABLEKS R3 R0 K9 ["DescendantAdded"]
  NEWCLOSURE R5 P2
  CAPTURE UPVAL U0
  CAPTURE UPVAL U1
  CAPTURE VAL R1
  NAMECALL R3 R3 K3 ["Connect"]
  CALL R3 2 1
  SETTABLEKS R3 R2 K10 ["descendantAddedConnection"]
  RETURN R0 0
...
PROTO_33:
  ...
  CAPTURE VAL R0
  CAPTURE UPVAL U22
  SETTABLEKS R2 R0 K35 ["createStyleRuleConnections"]
  NEWCLOSURE R2 P22
  CAPTURE VAL R0
  SETTABLEKS R2 R0 K36 ["removeStyleRuleConnections"]
  RETURN R0 0
...
PROTO_39:
  ...
  GETTABLEKS R4 R5 K2 ["Columns"]
  SETTABLEKS R4 R3 K2 ["Columns"]
  LOADB R4 1
  SETTABLEKS R4 R3 K3 ["ClampSize"]
  GETTABLEKS R5 R1 K1 ["table"]
  GETTABLEKS R4 R5 K4 ["Expansion"]
  SETTABLEKS R4 R3 K4 ["Expansion"]
  LOADB R4 1
  SETTABLEKS R4 R3 K5 ["FullSpanEmphasis"]
  GETUPVAL R5 1
  GETTABLEKS R4 R5 K6 ["getItemChildren"]
  SETTABLEKS R4 R3 K7 ["GetChildren"]
  GETUPVAL R5 1
  GETTABLEKS R4 R5 K8 ["getItemId"]
  SETTABLEKS R4 R3 K9 ["GetItemId"]
  LOADN R4 2
  SETTABLEKS R4 R3 K10 ["LayoutOrder"]
  GETTABLEKS R4 R0 K11 ["onAction"]
  SETTABLEKS R4 R3 K12 ["OnCellAction"]
  GETTABLEKS R4 R0 K13 ["onEdited"]
  SETTABLEKS R4 R3 K14 ["OnCellEdited"]
  GETTABLEKS R4 R0 K15 ["onDoubleClick"]
  SETTABLEKS R4 R3 K16 ["OnCellDoubleClick"]
  GETTABLEKS R4 R0 K17 ["onSizeChange"]
  SETTABLEKS R4 R3 K18 ["OnSizeChange"]
  GETUPVAL R4 2
  SETTABLEKS R4 R3 K19 ["Renderers"]
  GETTABLEKS R4 R0 K20 ["onRightClickRow"]
  SETTABLEKS R4 R3 K21 ["RightClick"]
  GETTABLEKS R5 R1 K1 ["table"]
  GETTABLEKS R4 R5 K22 ["Items"]
  SETTABLEKS R4 R3 K23 ["RootItems"]
  GETUPVAL R4 3
  SETTABLEKS R4 R3 K24 ["RowHeight"]
  GETTABLEKS R5 R1 K1 ["table"]
  GETTABLEKS R4 R5 K25 ["Selection"]
  SETTABLEKS R4 R3 K25 ["Selection"]
  LOADB R4 1
  SETTABLEKS R4 R3 K26 ["Scroll"]
  DUPTABLE R4 K28 [{"VerticalScrollBarInset"}]
  GETIMPORT R5 K32 [Enum.ScrollBarInset.ScrollBar]
  SETTABLEKS R5 R4 K27 ["VerticalScrollBarInset"]
  SETTABLEKS R4 R3 K33 ["ScrollProps"]
  LOADB R4 0
  SETTABLEKS R4 R3 K34 ["ShowHeader"]
  LOADB R4 1
  SETTABLEKS R4 R3 K35 ["UseScale"]
  LOADK R4 K36 ["compact"]
  SETTABLEKS R4 R3 K37 ["Variant"]
  GETUPVAL R5 4
  GETTABLEKS R4 R5 K38 ["Tag"]
...
MAIN:
  ...
  GETTABLEKS R34 R35 K48 ["PluginStyles"]
  CALL R33 1 1
  GETIMPORT R34 K8 [require]
  GETTABLEKS R36 R1 K21 ["Src"]
  GETTABLEKS R35 R36 K49 ["Renderers"]
  CALL R34 1 1
  GETIMPORT R35 K8 [require]
  GETTABLEKS R38 R1 K21 ["Src"]
  GETTABLEKS R37 R38 K39 ["Util"]
  GETTABLEKS R36 R37 K50 ["bind"]
  CALL R35 1 1
  GETIMPORT R36 K8 [require]
  GETTABLEKS R39 R1 K21 ["Src"]
  GETTABLEKS R38 R39 K39 ["Util"]
  GETTABLEKS R37 R38 K51 ["recordChange"]
  CALL R36 1 1
  MOVE R37 R0
  CALL R36 1 1
  GETIMPORT R37 K8 [require]
  GETTABLEKS R40 R1 K21 ["Src"]
  GETTABLEKS R39 R40 K39 ["Util"]
  GETTABLEKS R38 R39 K52 ["TreeTableHelpers"]
  CALL R37 1 1
  GETIMPORT R38 K8 [require]
  GETTABLEKS R42 R1 K21 ["Src"]
  GETTABLEKS R41 R42 K53 ["Contexts"]
  GETTABLEKS R40 R41 K54 ["Telemetry"]
  GETTABLEKS R39 R40 K55 ["TelemetryContext"]
  CALL R38 1 1
  GETIMPORT R39 K8 [require]
  GETIMPORT R41 K5 [script]
  GETTABLEKS R40 R41 K56 ["Tree"]
  CALL R39 1 1
  GETTABLEKS R40 R39 K57 ["EditTree"]
  LOADK R43 K58 ["RowHeight"]
  NAMECALL R41 R33 K59 ["GetAttribute"]
  CALL R41 2 1
  GETTABLEKS R42 R2 K60 ["PureComponent"]
  LOADK R44 K61 ["SelectorPropertyTable"]
  NAMECALL R42 R42 K62 ["extend"]
  CALL R42 2 1
  NEWCLOSURE R43 P0
  CAPTURE VAL R5
  CAPTURE VAL R39
  ...
  CAPTURE VAL R18
  CAPTURE REF R42
  SETTABLEKS R43 R42 K63 ["init"]
  DUPCLOSURE R43 K64 [PROTO_34]
  CAPTURE VAL R39
  CAPTURE VAL R5
  CAPTURE VAL R6
  SETTABLEKS R43 R42 K65 ["rebuildTableState"]
  DUPCLOSURE R43 K66 [PROTO_35]
  SETTABLEKS R43 R42 K67 ["didMount"]
  DUPCLOSURE R43 K68 [PROTO_36]
  SETTABLEKS R43 R42 K69 ["didUpdate"]
  DUPCLOSURE R43 K70 [PROTO_37]
  SETTABLEKS R43 R42 K71 ["willUnmount"]
  NEWCLOSURE R43 P5
  CAPTURE REF R42
  SETTABLEKS R43 R42 K72 ["getDerivedStateFromProps"]
  ...
  CAPTURE VAL R2
  CAPTURE VAL R10
  SETTABLEKS R43 R42 K74 ["render"]
  MOVE R43 R12
  DUPTABLE R44 K77 [{"Plugin", "Localization", "Telemetry"}]
  GETTABLEKS R45 R11 K75 ["Plugin"]
  SETTABLEKS R45 R44 K75 ["Plugin"]
  GETTABLEKS R45 R11 K76 ["Localization"]
  SETTABLEKS R45 R44 K76 ["Localization"]
  SETTABLEKS R38 R44 K54 ["Telemetry"]
  CALL R43 1 1
  MOVE R44 R42
  CALL R43 1 1
  MOVE R42 R43
  GETTABLEKS R43 R3 K78 ["connect"]
  DUPCLOSURE R44 K79 [PROTO_40]
  MOVE R45 R26
  CALL R43 2 1
  MOVE R44 R42
  CALL R43 1 -1
