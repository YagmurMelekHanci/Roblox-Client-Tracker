...
MAIN:
  ...
  SETGLOBAL R41 K62 ["connectToStyleRule"]
  NEWCLOSURE R41 P1
  CAPTURE VAL R5
  CAPTURE VAL R37
  CAPTURE VAL R38
  ...
  CAPTURE VAL R5
  CAPTURE VAL R6
  SETTABLEKS R41 R40 K65 ["rebuildTableState"]
  DUPCLOSURE R41 K66 [PROTO_35]
  SETTABLEKS R41 R40 K67 ["didMount"]
  DUPCLOSURE R41 K68 [PROTO_36]
  SETTABLEKS R41 R40 K69 ["didUpdate"]
  DUPCLOSURE R41 K70 [PROTO_37]
  SETTABLEKS R41 R40 K71 ["willUnmount"]
  NEWCLOSURE R41 P6
  CAPTURE REF R40
  SETTABLEKS R41 R40 K72 ["getDerivedStateFromProps"]
  DUPCLOSURE R41 K73 [PROTO_40]
  CAPTURE VAL R6
  CAPTURE VAL R37
  CAPTURE VAL R36
  CAPTURE VAL R31
  ...
  CAPTURE VAL R2
  CAPTURE VAL R10
  SETTABLEKS R41 R40 K74 ["render"]
  MOVE R41 R12
  DUPTABLE R42 K77 [{"Plugin", "Localization", "Telemetry"}]
  GETTABLEKS R43 R11 K75 ["Plugin"]
  SETTABLEKS R43 R42 K75 ["Plugin"]
  GETTABLEKS R43 R11 K76 ["Localization"]
  ...
  CALL R41 1 1
  MOVE R40 R41
  GETTABLEKS R41 R3 K78 ["connect"]
  DUPCLOSURE R42 K79 [PROTO_41]
  MOVE R43 R23
  CALL R41 2 1
  MOVE R42 R40
  CALL R41 1 -1
