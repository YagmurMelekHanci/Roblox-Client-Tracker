...
PROTO_6:
  ...
  JUMP [+5]
  GETUPVAL R7 3
  GETTABLEKS R6 R7 K19 ["getClassIcon"]
  LOADK R7 K20 ["Folder"]
  CALL R6 1 1
...
PROTO_7:
  ...
  GETUPVAL R4 0
  GETUPVAL R6 1
  GETTABLEKS R5 R6 K3 ["getOrderedStyleRules"]
  MOVE R6 R0
  CALL R5 1 1
  NEWCLOSURE R6 P0
  CAPTURE UPVAL U2
...
MAIN:
  ...
  GETTABLEKS R6 R7 K18 ["DesignHelpers"]
  CALL R5 1 1
  GETIMPORT R6 K8 [require]
  GETTABLEKS R9 R1 K17 ["Src"]
  GETTABLEKS R8 R9 K13 ["Util"]
  GETTABLEKS R7 R8 K19 ["MenuHelpers"]
  CALL R6 1 1
  GETIMPORT R7 K8 [require]
  GETTABLEKS R10 R1 K17 ["Src"]
  GETTABLEKS R9 R10 K13 ["Util"]
  GETTABLEKS R8 R9 K20 ["StyleSchema"]
  CALL R7 1 1
  GETIMPORT R8 K8 [require]
  GETTABLEKS R11 R1 K17 ["Src"]
  GETTABLEKS R10 R11 K21 ["Resources"]
  GETTABLEKS R9 R10 K22 ["ModernIcons"]
  CALL R8 1 1
  GETIMPORT R9 K8 [require]
  GETTABLEKS R12 R1 K17 ["Src"]
  GETTABLEKS R11 R12 K13 ["Util"]
  GETTABLEKS R10 R11 K23 ["SelectorHelpers"]
  CALL R9 1 1
  GETIMPORT R10 K8 [require]
  GETTABLEKS R13 R1 K17 ["Src"]
  GETTABLEKS R12 R13 K13 ["Util"]
  GETTABLEKS R11 R12 K24 ["StyleRuleHelpers"]
  CALL R10 1 1
  GETIMPORT R11 K8 [require]
  GETTABLEKS R14 R1 K17 ["Src"]
  GETTABLEKS R13 R14 K13 ["Util"]
  GETTABLEKS R12 R13 K25 ["TreeTableHelpers"]
  CALL R11 1 1
  GETIMPORT R12 K8 [require]
  GETTABLEKS R14 R1 K9 ["Packages"]
  GETTABLEKS R13 R14 K26 ["Dash"]
  CALL R12 1 1
  GETTABLEKS R13 R12 K27 ["collectArray"]
  GETTABLEKS R14 R12 K28 ["forEach"]
  GETTABLEKS R15 R12 K29 ["join"]
  GETTABLEKS R16 R12 K30 ["map"]
  GETTABLEKS R17 R12 K31 ["startsWith"]
  GETIMPORT R18 K34 [table.insert]
  GETIMPORT R19 K8 [require]
  GETTABLEKS R22 R1 K17 ["Src"]
  GETTABLEKS R21 R22 K21 ["Resources"]
  GETTABLEKS R20 R21 K35 ["PluginStyles"]
  CALL R19 1 1
  LOADK R22 K36 ["Icon16"]
  NAMECALL R20 R19 K37 ["GetAttribute"]
  CALL R20 2 1
  GETIMPORT R21 K8 [require]
  GETTABLEKS R23 R1 K17 ["Src"]
  GETTABLEKS R22 R23 K38 ["Types"]
  CALL R21 1 1
  NEWTABLE R22 4 0
  NEWTABLE R23 0 1
  DUPTABLE R24 K42 [{"Name", "Key", "Width"}]
  LOADK R25 K39 ["Name"]
  SETTABLEKS R25 R24 K39 ["Name"]
  LOADK R25 K39 ["Name"]
  SETTABLEKS R25 R24 K40 ["Key"]
  GETIMPORT R25 K45 [UDim.new]
  LOADN R26 1
  LOADN R27 0
  CALL R25 2 1
  SETTABLEKS R25 R24 K41 ["Width"]
  SETLIST R23 R24 1 [1]
  SETTABLEKS R23 R22 K46 ["Columns"]
  GETTABLEKS R23 R4 K44 ["new"]
  DUPTABLE R24 K49 [{"getChildren", "getId"}]
  DUPCLOSURE R25 K50 [PROTO_0]
  SETTABLEKS R25 R24 K47 ["getChildren"]
  DUPCLOSURE R25 K51 [PROTO_1]
  SETTABLEKS R25 R24 K48 ["getId"]
  CALL R23 1 1
  SETTABLEKS R23 R22 K14 ["EditTree"]
  ...
  CAPTURE VAL R15
  CAPTURE VAL R20
  SETTABLEKS R27 R22 K56 ["buildTree"]
  RETURN R22 1
