...
PROTO_23:
  ...
  GETUPVAL R12 7
  NEWTABLE R13 0 0
  DUPTABLE R14 K81 [{"Divider"}]
  GETUPVAL R16 6
  GETTABLEKS R15 R16 K12 ["createElement"]
  GETUPVAL R16 15
  DUPTABLE R17 K86 [{"ClampSize", "UseDeficit", "MinSizes", "OnSizesChange", "Sizes"}]
  LOADB R18 1
  SETTABLEKS R18 R17 K31 ["ClampSize"]
  LOADB R18 1
  SETTABLEKS R18 R17 K82 ["UseDeficit"]
  NEWTABLE R18 0 2
  GETIMPORT R19 K88 [UDim.new]
  LOADN R20 0
  LOADN R21 100
  CALL R19 2 1
  GETIMPORT R20 K88 [UDim.new]
  LOADN R21 0
  LOADN R22 100
  CALL R20 2 -1
  SETLIST R18 R19 -1 [1]
  SETTABLEKS R18 R17 K83 ["MinSizes"]
  GETTABLEKS R18 R0 K89 ["onPaneSizesChanged"]
  SETTABLEKS R18 R17 K84 ["OnSizesChange"]
  GETTABLEKS R18 R2 K28 ["PaneSizes"]
  SETTABLEKS R18 R17 K85 ["Sizes"]
  NEWTABLE R18 0 2
  MOVE R19 R9
  MOVE R20 R10
  SETLIST R18 R19 2 [1]
  CALL R15 3 1
  SETTABLEKS R15 R14 K80 ["Divider"]
  CALL R11 3 -1
  RETURN R11 -1
...
MAIN:
  ...
  SETLIST R50 R51 1 [1]
  GETTABLEKS R52 R28 K74 ["EditTree"]
  GETTABLEKS R51 R52 K72 ["new"]
  DUPTABLE R52 K77 [{"getChildren", "getId"}]
  DUPCLOSURE R53 K78 [PROTO_0]
  SETTABLEKS R53 R52 K75 ["getChildren"]
  DUPCLOSURE R53 K79 [PROTO_1]
  SETTABLEKS R53 R52 K76 ["getId"]
  CALL R51 1 1
  GETTABLEKS R52 R3 K80 ["PureComponent"]
  LOADK R54 K81 ["MainPage"]
  NAMECALL R52 R52 K82 ["extend"]
  CALL R52 2 1
  ...
  CAPTURE VAL R0
  CAPTURE VAL R49
  SETTABLEKS R53 R52 K84 ["init"]
  NEWCLOSURE R53 P3
  CAPTURE VAL R42
  CAPTURE VAL R41
  CAPTURE REF R52
  CAPTURE VAL R51
  SETTABLEKS R53 R52 K85 ["applySearch"]
  DUPCLOSURE R53 K86 [PROTO_22]
  CAPTURE VAL R35
  CAPTURE VAL R0
  CAPTURE VAL R49
  CAPTURE VAL R51
  CAPTURE VAL R43
  SETTABLEKS R53 R52 K87 ["getDerivedStateFromProps"]
  NEWCLOSURE R53 P5
  CAPTURE VAL R51
  CAPTURE VAL R43
  CAPTURE REF R52
  ...
  CAPTURE VAL R34
  CAPTURE VAL R27
  SETTABLEKS R53 R52 K88 ["render"]
  MOVE R53 R9
  DUPTABLE R54 K91 [{"Localization", "Plugin"}]
  GETTABLEKS R55 R8 K89 ["Localization"]
  SETTABLEKS R55 R54 K89 ["Localization"]
  GETTABLEKS R55 R8 K90 ["Plugin"]
  SETTABLEKS R55 R54 K90 ["Plugin"]
  CALL R53 1 1
  MOVE R54 R52
  CALL R53 1 1
  MOVE R52 R53
  GETTABLEKS R53 R4 K92 ["connect"]
  DUPCLOSURE R54 K93 [PROTO_24]
  MOVE R55 R31
  CALL R53 2 1
  MOVE R54 R52
  CALL R53 1 -1
