...
MAIN:
  ...
  GETTABLEKS R8 R9 K17 ["StyleRuleHelpers"]
  CALL R7 1 1
  GETIMPORT R8 K8 [require]
  GETTABLEKS R11 R1 K9 ["Src"]
  GETTABLEKS R10 R11 K10 ["Util"]
  GETTABLEKS R9 R10 K18 ["TreeTableHelpers"]
  CALL R8 1 1
  ...
  GETTABLEKS R12 R1 K20 ["Packages"]
  GETTABLEKS R11 R12 K21 ["Dash"]
  CALL R10 1 1
  GETTABLEKS R11 R10 K22 ["collectArray"]
  GETTABLEKS R12 R10 K23 ["forEach"]
  GETTABLEKS R13 R10 K24 ["join"]
  GETTABLEKS R14 R10 K25 ["map"]
  GETTABLEKS R15 R10 K26 ["startsWith"]
  GETIMPORT R16 K29 [table.insert]
  GETIMPORT R17 K8 [require]
  GETTABLEKS R20 R1 K9 ["Src"]
  GETTABLEKS R19 R20 K14 ["Resources"]
  GETTABLEKS R18 R19 K30 ["PluginStyles"]
  CALL R17 1 1
  LOADK R20 K31 ["Icon16"]
  NAMECALL R18 R17 K32 ["GetAttribute"]
  CALL R18 2 1
