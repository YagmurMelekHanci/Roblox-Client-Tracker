...
MAIN:
  ...
  DUPTABLE R12 K24 [{"path", "data"}]
  GETTABLEKS R13 R2 K25 ["string"]
  SETTABLEKS R13 R12 K22 ["path"]
  GETTABLEKS R13 R2 K26 ["optional"]
  GETTABLEKS R14 R2 K27 ["table"]
  CALL R13 1 1
  SETTABLEKS R13 R12 K23 ["data"]
  CALL R11 1 1
  DUPTABLE R12 K34 [{"eventName", "backends", "throttlingPercentage", "lastUpdated", "description", "links"}]
  LOADK R13 K35 ["StyleEditor_ContextMenuItemClicked"]
  ...
  LOADK R13 K38 ["Context menu item clicked."]
