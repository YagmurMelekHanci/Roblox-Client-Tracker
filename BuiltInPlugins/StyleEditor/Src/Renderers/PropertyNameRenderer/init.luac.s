PROTO_0:
  ...
  FORGPREP R2
  GETUPVAL R9 0
  GETTABLEKS R8 R9 K0 ["allProperties"]
  GETTABLE R7 R8 R6
  JUMPIFNOT R7 [+5]
  GETTABLE R8 R7 R1
  JUMPIFEQKNIL R8 [+3]
...
PROTO_1:
  ...
  FORGPREP R3
  GETUPVAL R10 1
  GETTABLEKS R9 R10 K4 ["allProperties"]
  GETTABLE R8 R9 R7
  JUMPIFNOT R8 [+5]
  GETTABLE R9 R8 R0
  JUMPIFEQKNIL R9 [+3]
...
PROTO_4:
  ...
  FORGPREP R7
  GETUPVAL R14 1
  GETTABLEKS R13 R14 K4 ["allProperties"]
...
PROTO_5:
  ...
  FORGPREP R4
  GETUPVAL R11 2
  GETTABLEKS R10 R11 K5 ["allProperties"]
  GETTABLE R9 R10 R8
  JUMPIFNOT R9 [+5]
  GETTABLE R10 R9 R0
  JUMPIFEQKNIL R10 [+3]
...
PROTO_9:
  ...
  DUPTABLE R22 K49 [{"ItemHeight"}]
  GETTABLEKS R24 R0 K0 ["Schema"]
  GETTABLEKS R23 R24 K48 ["ItemHeight"]
  SETTABLEKS R23 R22 K48 ["ItemHeight"]
  SETTABLEKS R22 R21 K50 ["DropdownMenuProps"]
  SETTABLEKS R8 R21 K51 ["OnTextChanged"]
  SETTABLEKS R9 R21 K52 ["OnFocusLost"]
  ...
  SETTABLEKS R10 R21 K53 ["GetAutocompleteItems"]
  LOADK R24 K18 ["Table"]
  ...
  GETTABLEKS R24 R25 K55 ["ErrorStyle"]
  ORK R23 R24 K54 ["PropertyCellError"]
  JUMP [+1]
  LOADNIL R23
  ...
  GETTABLEKS R19 R20 K3 ["createElement"]
  GETUPVAL R20 12
  DUPTABLE R21 K57 [{"Text", "MaxWidth"}]
  JUMPIFNOT R13 [+2]
  MOVE R22 R14
  JUMP [+5]
...
"]
  ...
  SETTABLEKS R22 R21 K17 ["Text"]
  GETUPVAL R22 13
  SETTABLEKS R22 R21 K56 ["MaxWidth"]
  CALL R19 2 1
