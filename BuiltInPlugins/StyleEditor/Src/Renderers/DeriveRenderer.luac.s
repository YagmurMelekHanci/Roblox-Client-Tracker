...
PROTO_1:
  ...
  GETUPVAL R8 3
  GETTABLEKS R7 R8 K14 ["getStudioDefaultStyleSheet"]
  CALL R7 0 1
  JUMPIFNOTEQ R6 R7 [+3]
  LOADNIL R5
  JUMP [+35]
  ...
  NEWTABLE R7 8 0
  GETUPVAL R9 5
  GETTABLEKS R8 R9 K15 ["close"]
  CALL R8 0 1
  SETTABLEKS R8 R7 K16 ["LeftIcon"]
  LOADK R8 K17 ["PointingHand"]
  SETTABLEKS R8 R7 K18 ["Cursor"]
  NEWCLOSURE R8 P0
  CAPTURE VAL R0
  SETTABLEKS R8 R7 K19 ["OnClick"]
  GETUPVAL R9 0
  GETTABLEKS R8 R9 K2 ["Tag"]
  LOADK R9 K20 ["IconOnly"]
  SETTABLE R9 R7 R8
...
MAIN:
  ...
  GETTABLEKS R10 R11 K17 ["DesignHelpers"]
  CALL R9 1 1
  LOADK R12 K18 ["ButtonHeight"]
  NAMECALL R10 R8 K19 ["GetAttribute"]
  CALL R10 2 1
  GETIMPORT R11 K4 [require]
  GETTABLEKS R14 R0 K12 ["Src"]
  GETTABLEKS R13 R14 K20 ["Renderers"]
  GETTABLEKS R12 R13 K21 ["RendererTypes"]
  CALL R11 1 1
