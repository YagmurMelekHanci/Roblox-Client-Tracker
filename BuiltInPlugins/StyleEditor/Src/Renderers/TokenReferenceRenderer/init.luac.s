...
PROTO_9:
  ...
  DUPTABLE R19 K14 [{"ItemHeight"}]
  GETTABLEKS R21 R0 K1 ["Schema"]
  GETTABLEKS R20 R21 K13 ["ItemHeight"]
  SETTABLEKS R20 R19 K13 ["ItemHeight"]
  SETTABLEKS R19 R18 K15 ["DropdownMenuProps"]
  SETTABLEKS R7 R18 K16 ["OnTextChanged"]
  SETTABLEKS R8 R18 K17 ["OnFocusLost"]
  GETTABLEKS R20 R0 K18 ["AutomaticSize"]
  JUMPIFNOT R20 [+10]
  GETIMPORT R19 K21 [UDim2.new]
  LOADN R20 1
  LOADN R21 0
  LOADN R22 0
  GETTABLEKS R24 R0 K23 ["MinimumHeight"]
  ORK R23 R24 K22 [24]
  CALL R19 4 1
  JUMP [+5]
  ...
  SETTABLEKS R1 R18 K27 ["Text"]
  SETTABLEKS R3 R18 K28 ["ForwardRef"]
  GETUPVAL R20 7
  GETTABLEKS R19 R20 K29 ["Tag"]
  JUMPIFNOT R11 [+5]
  GETTABLEKS R21 R0 K1 ["Schema"]
  GETTABLEKS R20 R21 K30 ["ErrorStyle"]
  JUMP [+1]
  LOADNIL R20
  ...
  GETTABLEKS R16 R17 K6 ["createElement"]
  GETUPVAL R17 13
  DUPTABLE R18 K32 [{"TokenInfo", "ErrorStyle"}]
  SETTABLEKS R6 R18 K31 ["TokenInfo"]
  GETTABLEKS R20 R0 K1 ["Schema"]
  GETTABLEKS R19 R20 K30 ["ErrorStyle"]
  SETTABLEKS R19 R18 K30 ["ErrorStyle"]
  CALL R16 2 1
