...
PROTO_9:
  ...
  DUPTABLE R20 K15 [{"ItemHeight"}]
  GETTABLEKS R22 R0 K1 ["Schema"]
  GETTABLEKS R21 R22 K14 ["ItemHeight"]
  SETTABLEKS R21 R20 K14 ["ItemHeight"]
  SETTABLEKS R20 R19 K16 ["DropdownMenuProps"]
  SETTABLEKS R7 R19 K17 ["OnTextChanged"]
  SETTABLEKS R8 R19 K18 ["OnFocusLost"]
  GETTABLEKS R21 R0 K19 ["AutomaticSize"]
  JUMPIFNOT R21 [+10]
  GETIMPORT R20 K22 [UDim2.new]
  LOADN R21 1
  LOADN R22 0
  LOADN R23 0
  GETTABLEKS R25 R0 K24 ["MinimumHeight"]
  ORK R24 R25 K23 [24]
  CALL R20 4 1
  JUMP [+5]
  ...
  SETTABLEKS R12 R19 K28 ["ShouldFocus"]
  SETTABLEKS R1 R19 K29 ["Text"]
  SETTABLEKS R3 R19 K30 ["ForwardRef"]
  GETUPVAL R21 7
  GETTABLEKS R20 R21 K31 ["Tag"]
  JUMPIFNOT R11 [+5]
  GETTABLEKS R22 R0 K1 ["Schema"]
  GETTABLEKS R21 R22 K32 ["ErrorStyle"]
  JUMP [+1]
  LOADNIL R21
  ...
  GETTABLEKS R17 R18 K7 ["createElement"]
  GETUPVAL R18 13
  DUPTABLE R19 K34 [{"TokenInfo", "ErrorStyle"}]
  SETTABLEKS R6 R19 K33 ["TokenInfo"]
  GETTABLEKS R21 R0 K1 ["Schema"]
  GETTABLEKS R20 R21 K32 ["ErrorStyle"]
  SETTABLEKS R20 R19 K32 ["ErrorStyle"]
  CALL R17 2 1
