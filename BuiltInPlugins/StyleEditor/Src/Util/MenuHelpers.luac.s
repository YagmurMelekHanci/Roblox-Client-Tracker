...
MAIN:
  ...
  SETTABLE R18 R16 R17
  SETLIST R15 R16 1 [1]
  SETTABLEKS R15 R14 K92 ["CategoryPlusButtonAction"]
  DUPCLOSURE R15 K93 [PROTO_3]
  CAPTURE VAL R7
  CAPTURE VAL R14
  SETTABLEKS R15 R14 K94 ["getStyleSheetCategoryActions"]
  DUPCLOSURE R15 K95 [PROTO_5]
  CAPTURE VAL R7
  SETTABLEKS R15 R14 K96 ["getAttributeTypeActions"]
  DUPCLOSURE R15 K97 [PROTO_7]
  CAPTURE VAL R7
  CAPTURE VAL R14
  SETTABLEKS R15 R14 K98 ["getClassTypeActions"]
  DUPCLOSURE R15 K99 [PROTO_12]
  CAPTURE VAL R7
  CAPTURE VAL R9
  CAPTURE VAL R14
  CAPTURE VAL R13
  CAPTURE VAL R6
  SETTABLEKS R15 R14 K100 ["getNewSelectorAction"]
  DUPCLOSURE R15 K101 [PROTO_13]
  CAPTURE VAL R13
  SETTABLEKS R15 R14 K102 ["getRenameAction"]
  DUPCLOSURE R15 K103 [PROTO_15]
  CAPTURE VAL R14
  CAPTURE VAL R7
  CAPTURE VAL R9
  SETTABLEKS R15 R14 K104 ["buildMenu"]
  DUPCLOSURE R15 K105 [PROTO_17]
  CAPTURE VAL R14
  SETTABLEKS R15 R14 K106 ["decorateClickHandlers"]
  DUPCLOSURE R15 K107 [PROTO_19]
  CAPTURE VAL R14
  CAPTURE VAL R10
  SETTABLEKS R15 R14 K108 ["trackClicks"]
  DUPCLOSURE R15 K109 [PROTO_20]
  CAPTURE VAL R14
  CAPTURE VAL R5
  SETTABLEKS R15 R14 K14 ["showContextMenu"]
  DUPCLOSURE R15 K110 [PROTO_22]
  CAPTURE VAL R8
  SETTABLEKS R15 R14 K111 ["filterHiddenActions"]
  RETURN R14 1
