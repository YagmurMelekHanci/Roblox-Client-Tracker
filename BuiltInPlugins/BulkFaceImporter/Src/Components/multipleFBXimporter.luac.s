...
PROTO_1:
  ...
  GETTABLE R17 R8 R15
  MOVE R19 R16
  NAMECALL R17 R17 K16 ["PivotTo"]
  CALL R17 2 0
  GETTABLE R17 R8 R15
  SETTABLEKS R2 R17 K17 ["Parent"]
  ADDK R9 R9 K18 [2]
  FORGLOOP R11 2 [-16]
  ADDK R3 R3 K18 [2]
  FORGLOOP R4 2 [-45]
  ...
  FORGPREP_NEXT R11
  GETTABLE R21 R8 R15
  GETTABLEKS R20 R21 K19 ["PrimaryPart"]
  GETTABLEKS R19 R20 K20 ["Size"]
  GETTABLEKS R18 R19 K21 ["Y"]
  DIVK R17 R18 K18 [2]
  GETTABLE R20 R8 R15
  GETTABLEKS R19 R20 K22 ["Humanoid"]
  GETTABLEKS R18 R19 K23 ["HipHeight"]
  ADD R16 R17 R18
  ...
  GETTABLE R18 R8 R15
  MOVE R20 R17
  NAMECALL R18 R18 K16 ["PivotTo"]
  CALL R18 2 0
  GETTABLE R18 R8 R15
  SETTABLEKS R2 R18 K17 ["Parent"]
  ADDK R9 R9 K25 [5]
  FORGLOOP R11 2 [-30]
  ADDK R3 R3 K25 [5]
  FORGLOOP R4 2 [-59]
