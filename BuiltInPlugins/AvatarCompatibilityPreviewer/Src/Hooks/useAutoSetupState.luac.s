...
PROTO_15:
  ...
  RETURN R0 0
  GETUPVAL R4 0
  GETTABLEKS R3 R4 K5 ["setAvatarPartScaleTypeValueObjects"]
  MOVE R4 R0
  MOVE R5 R1
  CALL R3 2 0
  GETUPVAL R3 1
  ...
  JUMPIFNOT R3 [+17]
  GETUPVAL R4 2
  GETTABLEKS R3 R4 K6 ["setBodyProportionScale"]
  GETTABLEKS R4 R0 K7 ["Humanoid"]
  GETTABLEKS R5 R2 K8 ["BodyProportionScale"]
  CALL R3 2 0
  GETUPVAL R4 2
  GETTABLEKS R3 R4 K9 ["setBodyTypeScale"]
  GETTABLEKS R4 R0 K7 ["Humanoid"]
  GETTABLEKS R5 R2 K10 ["BodyTypeScale"]
  CALL R3 2 0
  RETURN R0 0
  GETUPVAL R4 2
  GETTABLEKS R3 R4 K6 ["setBodyProportionScale"]
  GETTABLEKS R4 R0 K7 ["Humanoid"]
  GETTABLEKS R6 R2 K8 ["BodyProportionScale"]
  NAMECALL R7 R0 K11 ["GetScale"]
  CALL R7 1 1
  MUL R5 R6 R7
  CALL R3 2 0
  GETUPVAL R4 2
  GETTABLEKS R3 R4 K9 ["setBodyTypeScale"]
  GETTABLEKS R4 R0 K7 ["Humanoid"]
  GETTABLEKS R6 R2 K10 ["BodyTypeScale"]
  NAMECALL R7 R0 K11 ["GetScale"]
  CALL R7 1 1
  MUL R5 R6 R7
  CALL R3 2 0
...
PROTO_16:
  ...
  GETUPVAL R8 4
  MOVE R9 R6
  GETTABLEKS R10 R7 K25 ["proportions"]
  CALL R8 2 0
  GETUPVAL R8 5
  MOVE R9 R6
  MOVE R10 R3
...
PROTO_33:
  ...
  DUPCLOSURE R4 K6 [PROTO_17]
  CALL R3 1 2
  GETUPVAL R6 2
  GETTABLEKS R5 R6 K5 ["useState"]
  DUPCLOSURE R6 K7 [PROTO_18]
  CALL R5 1 2
  GETUPVAL R8 2
  ...
  DUPCLOSURE R9 K9 [PROTO_19]
  CALL R8 1 2
  GETUPVAL R11 2
  GETTABLEKS R10 R11 K5 ["useState"]
  DUPCLOSURE R11 K10 [PROTO_20]
  CALL R10 1 2
  GETUPVAL R13 2
  ...
  CAPTURE UPVAL U15
  NEWTABLE R25 0 4
  GETTABLEKS R26 R2 K22 ["startAutoSetupAsync"]
  GETTABLEKS R27 R2 K23 ["uploadModelAsync"]
  MOVE R28 R22
  GETUPVAL R30 6
  CALL R30 0 1
  JUMPIFNOT R30 [+2]
  ...
  CAPTURE VAL R20
  NEWTABLE R26 0 3
  GETTABLEKS R27 R2 K24 ["cancelAutoSetup"]
  GETTABLEKS R28 R20 K11 ["current"]
  GETUPVAL R30 6
  CALL R30 0 1
  JUMPIFNOT R30 [+2]
  MOVE R29 R15
  ...
  SETLIST R26 R27 3 [1]
  CALL R24 2 1
  DUPTABLE R25 K32 [{"cancelAutoSetup", "startAutoSetup", "activeTarget", "lastErrorType", "lastErrorTarget", "clearError", "progressState", "metadataState"}]
  SETTABLEKS R24 R25 K24 ["cancelAutoSetup"]
  SETTABLEKS R23 R25 K25 ["startAutoSetup"]
  SETTABLEKS R3 R25 K26 ["activeTarget"]
  SETTABLEKS R8 R25 K27 ["lastErrorType"]
  SETTABLEKS R10 R25 K28 ["lastErrorTarget"]
  SETTABLEKS R16 R25 K29 ["clearError"]
  SETTABLEKS R18 R25 K30 ["progressState"]
  SETTABLEKS R12 R25 K31 ["metadataState"]
  RETURN R25 1
...
MAIN:
  ...
  GETTABLEKS R19 R20 K31 ["assetUriToId"]
  CALL R18 1 1
  GETIMPORT R19 K11 [require]
  GETTABLEKS R22 R3 K12 ["Src"]
  GETTABLEKS R21 R22 K15 ["Util"]
  GETTABLEKS R20 R21 K32 ["findUnderlyingMeshAssetIds"]
  CALL R19 1 1
  GETIMPORT R20 K11 [require]
  GETTABLEKS R23 R3 K12 ["Src"]
  GETTABLEKS R22 R23 K33 ["Flags"]
  GETTABLEKS R21 R22 K34 ["getFFlagAvatarAutosetupCancel"]
  CALL R20 1 1
  GETIMPORT R21 K11 [require]
  GETTABLEKS R24 R3 K12 ["Src"]
  GETTABLEKS R23 R24 K33 ["Flags"]
  GETTABLEKS R22 R23 K35 ["getFFlagAvatarAutosetupStatusNotifications"]
  CALL R21 1 1
  GETIMPORT R22 K11 [require]
  GETTABLEKS R25 R3 K12 ["Src"]
  GETTABLEKS R24 R25 K33 ["Flags"]
  GETTABLEKS R23 R24 K36 ["getFFlagAvatarPreviewerUseAnyModel"]
  CALL R22 1 1
  GETIMPORT R23 K11 [require]
  GETTABLEKS R26 R3 K12 ["Src"]
  GETTABLEKS R25 R26 K33 ["Flags"]
  GETTABLEKS R24 R25 K37 ["getFFlagDebugAvatarPreviewerSharedCache"]
  CALL R23 1 1
  GETIMPORT R24 K11 [require]
  GETTABLEKS R27 R3 K12 ["Src"]
  GETTABLEKS R26 R27 K33 ["Flags"]
  GETTABLEKS R25 R26 K38 ["getFFlagHumanoidModelScalingFix"]
  CALL R24 1 1
  GETIMPORT R25 K11 [require]
  GETTABLEKS R28 R3 K12 ["Src"]
  GETTABLEKS R27 R28 K33 ["Flags"]
  GETTABLEKS R26 R27 K39 ["getFFlagStudioAvatarAutosetupReportsProgress"]
  CALL R25 1 1
  GETIMPORT R26 K11 [require]
  GETTABLEKS R29 R3 K12 ["Src"]
  GETTABLEKS R28 R29 K15 ["Util"]
  GETTABLEKS R27 R28 K40 ["getRotationInXZPlane"]
  CALL R26 1 1
  GETIMPORT R27 K11 [require]
  GETTABLEKS R30 R3 K12 ["Src"]
  GETTABLEKS R29 R30 K33 ["Flags"]
  GETTABLEKS R28 R29 K41 ["getFFlagStudioAvatarAutosetupCancellationTelemetry"]
  CALL R27 1 1
  DUPTABLE R28 K50 [{"Created", "Pending", "Processing", "Finalizing", "Completed", "Invalid", "Failed", "Canceled"}]
  LOADN R29 1
  SETTABLEKS R29 R28 K42 ["Created"]
  LOADN R29 2
  SETTABLEKS R29 R28 K43 ["Pending"]
  LOADN R29 3
  SETTABLEKS R29 R28 K44 ["Processing"]
  LOADN R29 4
  SETTABLEKS R29 R28 K45 ["Finalizing"]
  LOADN R29 5
  SETTABLEKS R29 R28 K46 ["Completed"]
  LOADN R29 101
  SETTABLEKS R29 R28 K47 ["Invalid"]
  LOADN R29 102
  SETTABLEKS R29 R28 K48 ["Failed"]
  LOADN R29 103
  SETTABLEKS R29 R28 K49 ["Canceled"]
  DUPCLOSURE R29 K51 [PROTO_0]
  CAPTURE VAL R6
  CAPTURE VAL R11
  CAPTURE VAL R10
  DUPCLOSURE R30 K52 [PROTO_1]
  CAPTURE VAL R13
  CAPTURE VAL R10
  CAPTURE VAL R1
  DUPCLOSURE R31 K53 [PROTO_3]
  ...
  CAPTURE VAL R7
  CAPTURE VAL R2
  DUPCLOSURE R36 K58 [PROTO_13]
  DUPCLOSURE R37 K59 [PROTO_14]
  DUPCLOSURE R38 K60 [PROTO_15]
  CAPTURE VAL R5
  CAPTURE VAL R24
  CAPTURE VAL R13
  DUPCLOSURE R39 K61 [PROTO_16]
  CAPTURE VAL R0
  CAPTURE VAL R10
  CAPTURE VAL R29
  CAPTURE VAL R30
