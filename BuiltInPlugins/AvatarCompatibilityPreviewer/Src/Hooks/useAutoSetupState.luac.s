PROTO_0:
  ...
  RETURN R0 0
  GETUPVAL R3 1
  GETTABLEKS R2 R3 K2 ["getInstanceNameWithoutClassification"]
  GETTABLEKS R3 R0 K3 ["Name"]
  CALL R2 1 1
  GETUPVAL R4 1
  GETTABLEKS R3 R4 K4 ["getAssetNamePrefix"]
  MOVE R4 R1
  CALL R3 1 1
  MOVE R5 R3
  MOVE R6 R2
  CONCAT R4 R5 R6
  SETTABLEKS R4 R0 K3 ["Name"]
  RETURN R0 0
...
PROTO_1:
  ...
  JUMPIFNOT R2 [+25]
  GETUPVAL R5 1
  GETTABLEKS R4 R5 K6 ["ATTRIBUTE_ASSET_CLASSIFICATION"]
  NAMECALL R2 R0 K7 ["GetAttribute"]
  CALL R2 2 1
  JUMPIFNOTEQKNIL R2 [+2]
  JUMP [+16]
  GETUPVAL R4 2
  GETTABLEKS R3 R4 K8 ["getInstanceNameWithoutClassification"]
  GETTABLEKS R4 R0 K9 ["Name"]
  CALL R3 1 1
  GETUPVAL R5 2
  GETTABLEKS R4 R5 K10 ["getAssetNamePrefix"]
  MOVE R5 R2
  CALL R4 1 1
  MOVE R6 R4
  MOVE R7 R3
  CONCAT R5 R6 R7
  SETTABLEKS R5 R0 K9 ["Name"]
  NAMECALL R2 R0 K11 ["GetDescendants"]
  CALL R2 1 3
  FORGPREP R2
  ...
  JUMPIFNOT R7 [+25]
  GETUPVAL R10 1
  GETTABLEKS R9 R10 K6 ["ATTRIBUTE_ASSET_CLASSIFICATION"]
  NAMECALL R7 R6 K7 ["GetAttribute"]
  CALL R7 2 1
  JUMPIFNOTEQKNIL R7 [+2]
  JUMP [+16]
  GETUPVAL R9 2
  GETTABLEKS R8 R9 K8 ["getInstanceNameWithoutClassification"]
  GETTABLEKS R9 R6 K9 ["Name"]
  CALL R8 1 1
  GETUPVAL R10 2
  GETTABLEKS R9 R10 K10 ["getAssetNamePrefix"]
  MOVE R10 R7
  CALL R9 1 1
  MOVE R11 R9
  MOVE R12 R8
  CONCAT R10 R11 R12
  SETTABLEKS R10 R6 K9 ["Name"]
  FORGLOOP R2 2 [-31]
  RETURN R0 0
...
PROTO_48:
  ...
  DUPCLOSURE R4 K6 [PROTO_30]
  CALL R3 1 2
  GETUPVAL R6 2
  GETTABLEKS R5 R6 K5 ["useState"]
  DUPCLOSURE R6 K7 [PROTO_31]
  CALL R5 1 2
  GETUPVAL R8 2
  ...
  DUPCLOSURE R9 K9 [PROTO_32]
  CALL R8 1 2
  GETUPVAL R11 2
  GETTABLEKS R10 R11 K5 ["useState"]
  DUPCLOSURE R11 K10 [PROTO_33]
  CALL R10 1 2
  GETUPVAL R13 2
...
MAIN:
  ...
  GETTABLEKS R27 R28 K41 ["getFFlagAvatarPreviewerAllowInvalidHumanoid"]
  CALL R26 1 1
  GETIMPORT R27 K11 [require]
  GETTABLEKS R30 R3 K12 ["Src"]
  GETTABLEKS R29 R30 K37 ["Flags"]
  GETTABLEKS R28 R29 K42 ["getFFlagAvatarPreviewerSortClothingUI"]
  CALL R27 1 1
  GETIMPORT R28 K11 [require]
  GETTABLEKS R31 R3 K12 ["Src"]
  GETTABLEKS R30 R31 K37 ["Flags"]
  GETTABLEKS R29 R30 K43 ["getFFlagAvatarPreviewerUseAnyModel"]
  CALL R28 1 1
  ...
  GETTABLEKS R37 R38 K15 ["Components"]
  ...
  GETTABLEKS R38 R39 K15 ["Components"]
  ...
  CAPTURE VAL R8
  DUPCLOSURE R44 K68 [PROTO_14]
  CAPTURE VAL R43
  CAPTURE VAL R33
  CAPTURE VAL R8
  CAPTURE VAL R2
  DUPCLOSURE R45 K69 [PROTO_15]
  CAPTURE VAL R26
  DUPCLOSURE R46 K70 [PROTO_16]
  DUPCLOSURE R47 K71 [PROTO_17]
  CAPTURE VAL R17
  DUPCLOSURE R48 K72 [PROTO_18]
  CAPTURE VAL R17
  DUPCLOSURE R49 K73 [PROTO_19]
  CAPTURE VAL R17
  CAPTURE VAL R14
  DUPCLOSURE R50 K74 [PROTO_20]
  CAPTURE VAL R6
  CAPTURE VAL R26
  CAPTURE VAL R14
  DUPCLOSURE R51 K75 [PROTO_22]
  CAPTURE VAL R30
  DUPCLOSURE R52 K76 [PROTO_24]
  CAPTURE VAL R31
  DUPCLOSURE R53 K77 [PROTO_25]
  CAPTURE VAL R30
  DUPCLOSURE R54 K78 [PROTO_26]
  CAPTURE VAL R30
  CAPTURE VAL R22
  CAPTURE VAL R17
  CAPTURE VAL R48
  ...
  CAPTURE VAL R51
  CAPTURE VAL R35
  DUPCLOSURE R55 K79 [PROTO_27]
  DUPCLOSURE R56 K80 [PROTO_28]
  CAPTURE VAL R55
  CAPTURE VAL R11
  DUPCLOSURE R57 K81 [PROTO_29]
  CAPTURE VAL R0
  CAPTURE VAL R11
  CAPTURE VAL R38
  CAPTURE VAL R30
