...
PROTO_46:
  ...
  LOADK R4 K0 ["FFlagAvatarPreviewerGearAccessories is not enabled"]
  GETIMPORT R2 K2 [assert]
  CALL R2 2 0
  DUPTABLE R2 K12 [{"Key", "Items", "PreviewComponent", "PublishAssetType", "WearBuiltin", "WearInstance", "CreateCustomInstanceFromSelection", "GetBuiltinItemData", "UpdateInstances"}]
  LOADK R4 K13 ["Gear"]
  MOVE R5 R1
  CONCAT R3 R4 R5
  SETTABLEKS R3 R2 K3 ["Key"]
  SETTABLEKS R0 R2 K4 ["Items"]
  GETUPVAL R3 1
  SETTABLEKS R3 R2 K5 ["PreviewComponent"]
  GETIMPORT R3 K16 [Enum.AssetType.Gear]
  SETTABLEKS R3 R2 K6 ["PublishAssetType"]
  NEWCLOSURE R3 P0
  CAPTURE VAL R1
  SETTABLEKS R3 R2 K7 ["WearBuiltin"]
  GETUPVAL R3 2
  SETTABLEKS R3 R2 K8 ["WearInstance"]
  NEWCLOSURE R3 P1
  CAPTURE VAL R1
  SETTABLEKS R3 R2 K9 ["CreateCustomInstanceFromSelection"]
  GETUPVAL R3 3
  SETTABLEKS R3 R2 K10 ["GetBuiltinItemData"]
  GETUPVAL R3 4
  SETTABLEKS R3 R2 K11 ["UpdateInstances"]
  RETURN R2 1
...
MAIN:
  ...
  GETTABLEKS R12 R13 K22 ["getFFlagAvatarPreviewerGearAccessories"]
  CALL R11 1 1
  GETTABLEKS R14 R1 K17 ["Util"]
  GETTABLEKS R13 R14 K23 ["AccessoryAndBodyToolShared"]
  GETTABLEKS R12 R13 K24 ["AssetTypeAttachmentInfo"]
  NEWTABLE R13 16 0
  ...
  CAPTURE VAL R19
  CAPTURE VAL R18
  SETTABLEKS R20 R13 K32 ["basicAccessoryPalette"]
  ...
  CAPTURE VAL R18
  CAPTURE VAL R19
  SETTABLEKS R20 R13 K34 ["layeredClothingPalette"]
  DUPCLOSURE R20 K35 [PROTO_17]
  CAPTURE VAL R7
  SETTABLEKS R20 R13 K36 ["createBodyPalette"]
  DUPCLOSURE R20 K37 [PROTO_19]
  CAPTURE VAL R13
  CAPTURE VAL R14
  CAPTURE VAL R15
  SETTABLEKS R20 R13 K38 ["createBodyCategory"]
  DUPCLOSURE R20 K39 [PROTO_22]
  CAPTURE VAL R13
  SETTABLEKS R20 R13 K40 ["createHeadPalette"]
  DUPCLOSURE R20 K41 [PROTO_26]
  CAPTURE VAL R3
  CAPTURE VAL R5
  CAPTURE VAL R8
  CAPTURE VAL R14
  CAPTURE VAL R15
  SETTABLEKS R20 R13 K42 ["createBodyAnimationPalette"]
  DUPCLOSURE R20 K43 [PROTO_34]
  CAPTURE VAL R3
  CAPTURE VAL R7
  CAPTURE VAL R16
  CAPTURE VAL R17
  ...
  CAPTURE VAL R6
  CAPTURE VAL R8
  SETTABLEKS R20 R13 K44 ["shoesPalette"]
  DUPCLOSURE R20 K45 [PROTO_38]
  CAPTURE VAL R3
  CAPTURE VAL R5
  CAPTURE VAL R8
  CAPTURE VAL R14
  CAPTURE VAL R15
  SETTABLEKS R20 R13 K46 ["emotionPalette"]
  DUPCLOSURE R20 K47 [PROTO_43]
  CAPTURE VAL R9
  CAPTURE VAL R14
  CAPTURE VAL R15
  SETTABLEKS R20 R13 K48 ["skinPalette"]
  DUPCLOSURE R20 K49 [PROTO_46]
  CAPTURE VAL R11
  CAPTURE VAL R7
  CAPTURE VAL R17
  CAPTURE VAL R19
  CAPTURE VAL R18
  SETTABLEKS R20 R13 K50 ["gearPalette"]
  RETURN R13 1
