...
MAIN:
  ...
  CAPTURE VAL R0
  SETTABLEKS R5 R4 K17 ["_clearTestingAnimateScripts"]
  DUPCLOSURE R5 K18 [PROTO_2]
  CAPTURE VAL R4
  CAPTURE VAL R0
  SETTABLEKS R5 R4 K19 ["reset"]
  DUPCLOSURE R5 K20 [PROTO_3]
  CAPTURE VAL R0
  SETTABLEKS R5 R4 K21 ["_resetAnimateScript"]
  DUPCLOSURE R5 K22 [PROTO_4]
  CAPTURE VAL R0
  SETTABLEKS R5 R4 K23 ["_replaceAnimateScript"]
  DUPCLOSURE R5 K24 [PROTO_5]
  DUPCLOSURE R6 K25 [PROTO_6]
  CAPTURE VAL R4
  CAPTURE VAL R0
  SETTABLEKS R6 R4 K26 ["test"]
  RETURN R4 1
