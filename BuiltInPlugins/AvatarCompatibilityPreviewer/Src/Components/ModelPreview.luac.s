...
PROTO_12:
  ...
  CALL R14 0 1
  JUMPIF R14 [+3]
  GETTABLEKS R13 R0 K24 ["DEPRECATED_InitialCameraPosition"]
  JUMP [+1]
  LOADNIL R13
  SETLIST R12 R13 1 [1]
  CALL R10 2 1
  ...
  NEWTABLE R13 0 2
  MOVE R14 R8
  GETTABLEKS R15 R0 K25 ["ResetCameraSignal"]
  SETLIST R13 R14 2 [1]
  CALL R11 2 0
  GETUPVAL R12 1
  GETTABLEKS R11 R12 K8 ["useEffect"]
  ...
  JUMP [+6]
  GETTABLEKS R13 R0 K0 ["Model"]
  GETTABLEKS R12 R13 K1 ["PrimaryPart"]
  GETTABLEKS R11 R12 K13 ["CFrame"]
  JUMPIFNOT R2 [+75]
  GETUPVAL R13 1
  GETTABLEKS R12 R13 K26 ["createElement"]
  GETUPVAL R13 7
  DUPTABLE R14 K42 [{"Camera", "Model", "FocusPosition", "FocusDirection", "Size", "Ambient", "EnableSky", "LightColor", "LightDirection", "PanSpeedMultiplier", "ShouldClone", "RecenterModelOnUpdate", "RecenterCameraOnUpdate", "Static", "ResetCameraPosition", "OnViewModelLoaded", "ShowResetCamera"}]
  SETTABLEKS R4 R14 K12 ["Camera"]
  SETTABLEKS R2 R14 K0 ["Model"]
  GETTABLEKS R15 R11 K43 ["Position"]
  SETTABLEKS R15 R14 K27 ["FocusPosition"]
  GETTABLEKS R15 R11 K44 ["LookVector"]
  SETTABLEKS R15 R14 K28 ["FocusDirection"]
  GETIMPORT R15 K47 [UDim2.fromScale]
  LOADN R16 1
  LOADN R17 1
  CALL R15 2 1
  SETTABLEKS R15 R14 K29 ["Size"]
  GETTABLEKS R15 R1 K30 ["Ambient"]
  SETTABLEKS R15 R14 K30 ["Ambient"]
  GETTABLEKS R15 R1 K31 ["EnableSky"]
  SETTABLEKS R15 R14 K31 ["EnableSky"]
  GETTABLEKS R15 R1 K32 ["LightColor"]
  SETTABLEKS R15 R14 K32 ["LightColor"]
  GETTABLEKS R15 R1 K33 ["LightDirection"]
  SETTABLEKS R15 R14 K33 ["LightDirection"]
  GETTABLEKS R15 R1 K34 ["PanSpeedMultiplier"]
  SETTABLEKS R15 R14 K34 ["PanSpeedMultiplier"]
  LOADB R15 0
  SETTABLEKS R15 R14 K35 ["ShouldClone"]
  LOADB R15 1
  SETTABLEKS R15 R14 K36 ["RecenterModelOnUpdate"]
  LOADB R15 1
  SETTABLEKS R15 R14 K37 ["RecenterCameraOnUpdate"]
  GETTABLEKS R15 R0 K38 ["Static"]
  SETTABLEKS R15 R14 K38 ["Static"]
  GETUPVAL R16 5
  CALL R16 0 1
  JUMPIFNOT R16 [+2]
  MOVE R15 R5
  JUMP [+3]
  GETUPVAL R16 2
  GETTABLEKS R15 R16 K48 ["DEFAULT_CAMERA_ANGLE"]
  SETTABLEKS R15 R14 K39 ["ResetCameraPosition"]
  SETTABLEKS R10 R14 K40 ["OnViewModelLoaded"]
  GETTABLEKS R15 R0 K49 ["ShowResetCameraButton"]
  SETTABLEKS R15 R14 K41 ["ShowResetCamera"]
  CALL R12 2 1
  RETURN R12 1
  LOADNIL R12
  RETURN R12 1
...
MAIN:
  ...
  GETTABLEKS R8 R9 K20 ["getFFlagAvatarPreviewerUseAnyModel"]
  CALL R7 1 1
  GETTABLEKS R8 R1 K21 ["UI"]
  GETTABLEKS R9 R8 K22 ["AssetRenderModel"]
  GETTABLEKS R11 R1 K23 ["ContextServices"]
