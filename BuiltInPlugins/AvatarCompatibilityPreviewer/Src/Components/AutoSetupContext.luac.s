...
MAIN:
  ...
  GETTABLEKS R8 R9 K19 ["getFFlagAvatarPreviewerUseAnyModel"]
  CALL R7 1 1
  GETIMPORT R8 K11 [require]
  GETTABLEKS R11 R3 K14 ["Src"]
  GETTABLEKS R10 R11 K18 ["Flags"]
  GETTABLEKS R9 R10 K20 ["getFFlagDebugAvatarPreviewerMockAutoSetup"]
  CALL R8 1 1
  GETIMPORT R9 K11 [require]
  GETTABLEKS R12 R3 K14 ["Src"]
  GETTABLEKS R11 R12 K18 ["Flags"]
  GETTABLEKS R10 R11 K21 ["getFFlagStudioAvatarAutosetupReportsProgress"]
  CALL R9 1 1
  GETIMPORT R10 K11 [require]
  GETTABLEKS R13 R3 K14 ["Src"]
  GETTABLEKS R12 R13 K18 ["Flags"]
  GETTABLEKS R11 R12 K22 ["getFFlagStudioAvatarAutoSetupGroupUpload"]
  CALL R10 1 1
