...
PROTO_32:
  ...
  JUMPIF R27 [+1]
  JUMPIFNOT R28 [+7]
  GETIMPORT R33 K42 [Color3.fromRGB]
  LOADN R34 48
  LOADN R35 197
  LOADN R36 255
  CALL R33 3 1
  ...
  GETUPVAL R29 1
  GETTABLEKS R28 R29 K45 ["Fragment"]
  NEWTABLE R29 0 0
  NEWTABLE R30 2 0
  GETUPVAL R33 10
  GETTABLEKS R32 R33 K46 ["EDITING_TOOLS_GUI_NAMES"]
  GETTABLEKS R31 R32 K47 ["BodyPoints"]
  GETUPVAL R33 20
  GETTABLEKS R32 R33 K48 ["createPortal"]
  GETUPVAL R34 1
  GETTABLEKS R33 R34 K28 ["createElement"]
  LOADK R34 K49 ["Folder"]
  DUPTABLE R35 K51 [{"ref"}]
  SETTABLEKS R5 R35 K50 ["ref"]
  MOVE R36 R2
  DUPTABLE R37 K53 [{"Dragger"}]
  ...
  MOVE R40 R26
  CALL R38 2 1
  SETTABLEKS R38 R37 K52 ["Dragger"]
  CALL R33 4 1
  GETUPVAL R34 22
  GETUPVAL R37 10
  GETTABLEKS R36 R37 K46 ["EDITING_TOOLS_GUI_NAMES"]
  GETTABLEKS R35 R36 K47 ["BodyPoints"]
  CALL R32 3 1
  SETTABLE R32 R30 R31
  GETUPVAL R33 10
  GETTABLEKS R32 R33 K46 ["EDITING_TOOLS_GUI_NAMES"]
  GETTABLEKS R31 R32 K54 ["BodyPointsToolToolbar"]
  GETUPVAL R33 1
  GETTABLEKS R32 R33 K28 ["createElement"]
  GETUPVAL R34 23
  GETTABLEKS R33 R34 K55 ["Toolbar"]
  DUPTABLE R34 K57 [{"HorizontalItems"}]
  NEWTABLE R35 0 4
  DUPTABLE R36 K63 [{"Type", "Tooltip", "Icon", "OnClick", "Selected"}]
  LOADK R37 K64 ["Button"]
  SETTABLEKS R37 R36 K58 ["Type"]
  LOADK R37 K65 ["Projection"]
  SETTABLEKS R37 R36 K59 ["Tooltip"]
  GETTABLEKS R37 R1 K66 ["ProjectionImage"]
  SETTABLEKS R37 R36 K60 ["Icon"]
  GETTABLEKS R37 R12 K67 ["toggle"]
  SETTABLEKS R37 R36 K61 ["OnClick"]
  GETTABLEKS R37 R12 K13 ["enabled"]
  SETTABLEKS R37 R36 K62 ["Selected"]
  DUPTABLE R37 K63 [{"Type", "Tooltip", "Icon", "OnClick", "Selected"}]
  LOADK R38 K64 ["Button"]
  SETTABLEKS R38 R37 K58 ["Type"]
  LOADK R38 K68 ["Symmetrical"]
  SETTABLEKS R38 R37 K59 ["Tooltip"]
  GETTABLEKS R38 R1 K69 ["SymmetricalImage"]
  SETTABLEKS R38 R37 K60 ["Icon"]
  GETTABLEKS R38 R13 K67 ["toggle"]
  SETTABLEKS R38 R37 K61 ["OnClick"]
  GETTABLEKS R38 R13 K13 ["enabled"]
  SETTABLEKS R38 R37 K62 ["Selected"]
  DUPTABLE R38 K70 [{"Type"}]
  LOADK R39 K71 ["Separator"]
  SETTABLEKS R39 R38 K58 ["Type"]
  GETTABLEKS R40 R0 K72 ["additionalToolbarItems"]
  FASTCALL1 TABLE_UNPACK R40 [+2]
  GETIMPORT R39 K74 [unpack]
  CALL R39 1 -1
  SETLIST R35 R36 -1 [1]
  SETTABLEKS R35 R34 K56 ["HorizontalItems"]
  CALL R32 2 1
  SETTABLE R32 R30 R31
  CALL R27 3 -1
  RETURN R27 -1
