...
PROTO_9:
  ...
  GETUPVAL R14 7
  DUPTABLE R15 K16 [{"Style", "Title", "MinContentSize", "Buttons", "OnButtonPressed", "OnClose"}]
  LOADK R16 K17 ["CancelAccept"]
  ...
  LOADK R18 K22 ["cancel"]
  SETTABLEKS R18 R17 K19 ["Key"]
  LOADK R20 K1 ["DisambiguationMenu"]
  LOADK R21 K23 ["Cancel"]
  NAMECALL R18 R1 K18 ["getText"]
  CALL R18 3 1
  SETTABLEKS R18 R17 K20 ["Text"]
  DUPTABLE R18 K25 [{"Key", "Text", "StyleModifier"}]
  LOADK R19 K26 ["ok"]
  SETTABLEKS R19 R18 K19 ["Key"]
  ...
  JUMP [+3]
  GETUPVAL R20 8
  GETTABLEKS R19 R20 K28 ["Disabled"]
  SETTABLEKS R19 R18 K24 ["StyleModifier"]
  SETLIST R16 R17 2 [1]
  SETTABLEKS R16 R15 K13 ["Buttons"]
  NEWCLOSURE R16 P1
  CAPTURE VAL R0
  CAPTURE UPVAL U9
  CAPTURE VAL R6
  CAPTURE VAL R8
  SETTABLEKS R16 R15 K14 ["OnButtonPressed"]
  GETTABLEKS R16 R0 K29 ["close"]
  SETTABLEKS R16 R15 K15 ["OnClose"]
  GETUPVAL R17 3
  GETTABLEKS R16 R17 K9 ["createElement"]
  GETUPVAL R17 10
  DUPTABLE R18 K32 [{"Layout", "Spacing"}]
  GETIMPORT R19 K36 [Enum.FillDirection.Vertical]
  SETTABLEKS R19 R18 K30 ["Layout"]
  GETTABLEKS R19 R2 K37 ["TitleContentsSpacing"]
  SETTABLEKS R19 R18 K31 ["Spacing"]
  DUPTABLE R19 K40 [{"CallToAction", "Contents"}]
  GETUPVAL R21 3
  GETTABLEKS R20 R21 K9 ["createElement"]
  GETUPVAL R21 11
  NEWTABLE R22 16 0
  GETIMPORT R23 K43 [Enum.AutomaticSize.Y]
  SETTABLEKS R23 R22 K41 ["AutomaticSize"]
  LOADK R25 K1 ["DisambiguationMenu"]
  LOADK R26 K38 ["CallToAction"]
  NAMECALL R23 R1 K18 ["getText"]
  CALL R23 3 1
  SETTABLEKS R23 R22 K20 ["Text"]
  GETIMPORT R23 K46 [Enum.TextXAlignment.Left]
  SETTABLEKS R23 R22 K44 ["TextXAlignment"]
  GETIMPORT R23 K49 [Enum.TextYAlignment.Top]
  SETTABLEKS R23 R22 K47 ["TextYAlignment"]
  LOADB R23 1
  SETTABLEKS R23 R22 K50 ["TextWrapped"]
  GETIMPORT R23 K53 [UDim2.fromScale]
  LOADN R24 1
  LOADN R25 0
  CALL R23 2 1
  ...
  NAMECALL R23 R3 K55 ["getNextOrder"]
  CALL R23 1 1
  ...
  CALL R20 2 1
  SETTABLEKS R20 R19 K38 ["CallToAction"]
  GETUPVAL R21 3
  GETTABLEKS R20 R21 K9 ["createElement"]
  GETUPVAL R21 12
  DUPTABLE R22 K60 [{"AutomaticCanvasSize", "Size", "LayoutOrder", "Layout", "Spacing"}]
  GETIMPORT R23 K43 [Enum.AutomaticSize.Y]
  SETTABLEKS R23 R22 K59 ["AutomaticCanvasSize"]
  GETIMPORT R23 K61 [UDim2.new]
  LOADN R24 1
  LOADN R25 0
  LOADN R26 1
  GETTABLEKS R29 R2 K37 ["TitleContentsSpacing"]
  ADD R28 R4 R29
  MINUS R27 R28
  CALL R23 4 1
  SETTABLEKS R23 R22 K54 ["Size"]
  ...
  CALL R23 1 1
  SETTABLEKS R23 R22 K56 ["LayoutOrder"]
  GETIMPORT R23 K36 [Enum.FillDirection.Vertical]
  SETTABLEKS R23 R22 K30 ["Layout"]
  GETIMPORT R23 K63 [UDim.new]
  LOADN R24 0
  GETTABLEKS R25 R2 K64 ["VerticalSpacing"]
  CALL R23 2 1
  SETTABLEKS R23 R22 K31 ["Spacing"]
  GETUPVAL R24 9
  GETTABLEKS R23 R24 K65 ["map"]
  ...
  GETUPVAL R25 14
  DUPTABLE R26 K66 [{"LayoutOrder"}]
  NAMECALL R27 R3 K55 ["getNextOrder"]
  CALL R27 1 1
  SETTABLEKS R27 R26 K56 ["LayoutOrder"]
  CALL R24 2 1
  JUMP [+1]
  LOADNIL R24
  GETUPVAL R26 9
  GETTABLEKS R25 R26 K65 ["map"]
  GETTABLEKS R26 R0 K5 ["loneMeshParts"]
  NEWCLOSURE R27 P4
  CAPTURE UPVAL U3
  CAPTURE UPVAL U15
  ...
  CALL R25 2 -1
  CALL R20 -1 1
  SETTABLEKS R20 R19 K39 ["Contents"]
  CALL R16 3 -1
  CALL R13 -1 -1
  RETURN R13 -1
...
MAIN:
  ...
  CALL R10 1 1
  GETTABLEKS R11 R3 K23 ["UI"]
  GETTABLEKS R12 R11 K24 ["Pane"]
  GETTABLEKS R13 R11 K25 ["ScrollingFrame"]
  GETTABLEKS R14 R11 K26 ["Separator"]
  GETTABLEKS R15 R11 K27 ["StyledDialog"]
  GETTABLEKS R16 R11 K28 ["TextLabel"]
  GETTABLEKS R18 R3 K29 ["ContextServices"]
  GETTABLEKS R17 R18 K30 ["Localization"]
  GETTABLEKS R19 R3 K29 ["ContextServices"]
  GETTABLEKS R18 R19 K31 ["Stylizer"]
  GETTABLEKS R20 R3 K16 ["Util"]
  GETTABLEKS R19 R20 K32 ["LayoutOrderIterator"]
  GETTABLEKS R21 R3 K16 ["Util"]
  GETTABLEKS R20 R21 K33 ["StyleModifier"]
