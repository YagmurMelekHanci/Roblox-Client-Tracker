...
PROTO_1:
  ...
  GETUPVAL R13 15
  GETTABLEKS R12 R13 K19 ["Provider"]
  CALL R11 1 -1
  SETLIST R10 R11 -1 [1]
  JUMP [+2]
  NEWTABLE R10 0 0
  ...
  GETUPVAL R13 16
  DUPTABLE R14 K21 [{"root"}]
  GETTABLEKS R16 R2 K14 ["avatar"]
  GETTABLEKS R15 R16 K22 ["WorldModel"]
  SETTABLEKS R15 R14 K20 ["root"]
  CALL R12 2 1
  GETUPVAL R14 0
  GETTABLEKS R13 R14 K5 ["createElement"]
  GETUPVAL R14 17
  DUPTABLE R15 K21 [{"root"}]
  GETTABLEKS R17 R2 K14 ["avatar"]
  GETTABLEKS R16 R17 K22 ["WorldModel"]
  SETTABLEKS R16 R15 K20 ["root"]
  CALL R13 2 1
  GETUPVAL R15 0
  ...
  GETUPVAL R18 20
  GETTABLEKS R17 R18 K19 ["Provider"]
  CALL R16 1 1
  JUMP [+1]
  LOADNIL R16
  SETLIST R11 R12 5 [1]
  GETTABLEKS R12 R0 K23 ["DEPRECATED_additionalAvatarContext"]
  JUMPIF R12 [+2]
  NEWTABLE R12 0 0
  CALL R9 3 1
