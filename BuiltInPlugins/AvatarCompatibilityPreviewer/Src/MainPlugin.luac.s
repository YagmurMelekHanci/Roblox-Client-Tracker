...
PROTO_10:
  ...
  GETUPVAL R18 14
  GETTABLEKS R17 R18 K21 ["Provider"]
  CALL R16 1 1
  JUMP [+1]
  LOADNIL R16
  SETLIST R13 R14 3 [1]
...
MAIN:
  ...
  GETTABLEKS R22 R23 K32 ["EditingTools"]
  GETTABLEKS R21 R22 K33 ["EditingWorldModelContext"]
  CALL R20 1 1
  GETIMPORT R21 K10 [require]
  GETTABLEKS R24 R3 K23 ["Src"]
  GETTABLEKS R23 R24 K30 ["Components"]
  GETTABLEKS R22 R23 K34 ["IXPServiceContext"]
  CALL R21 1 1
  GETIMPORT R22 K10 [require]
  GETTABLEKS R25 R3 K23 ["Src"]
  GETTABLEKS R24 R25 K30 ["Components"]
  GETTABLEKS R23 R24 K35 ["ContextStack"]
  CALL R22 1 1
  ...
  GETTABLEKS R25 R26 K36 ["Localization"]
  GETTABLEKS R24 R25 K38 ["LocalizedStrings"]
  GETTABLEKS R26 R3 K23 ["Src"]
  GETTABLEKS R25 R26 K30 ["Components"]
  GETIMPORT R26 K10 [require]
  GETTABLEKS R27 R25 K39 ["App"]
  CALL R26 1 1
  GETIMPORT R27 K10 [require]
  GETTABLEKS R28 R25 K40 ["TestInExperienceManager"]
  CALL R27 1 1
  GETIMPORT R28 K10 [require]
  GETTABLEKS R31 R3 K23 ["Src"]
  GETTABLEKS R30 R31 K41 ["Flags"]
  GETTABLEKS R29 R30 K42 ["getFFlagAvatarPreviewerCageEditingTools"]
  CALL R28 1 1
  GETIMPORT R29 K10 [require]
  GETTABLEKS R32 R3 K23 ["Src"]
  GETTABLEKS R31 R32 K41 ["Flags"]
  GETTABLEKS R30 R31 K43 ["getFFlagAvatarPreviewerProgressIXP"]
  CALL R29 1 1
  GETIMPORT R30 K10 [require]
  GETTABLEKS R33 R3 K23 ["Src"]
  GETTABLEKS R32 R33 K41 ["Flags"]
  GETTABLEKS R31 R32 K44 ["getFFlagUnlinkImporterAndAvatarPreview"]
  CALL R30 1 1
  GETTABLEKS R31 R6 K45 ["PureComponent"]
  ...
  CAPTURE VAL R6
  CAPTURE VAL R10
  SETTABLEKS R32 R31 K51 ["renderButtons"]
  MOVE R32 R30
  CALL R32 0 1
  JUMPIF R32 [+3]
  DUPCLOSURE R32 K52 [PROTO_8]
  SETTABLEKS R32 R31 K53 ["willUnmount"]
