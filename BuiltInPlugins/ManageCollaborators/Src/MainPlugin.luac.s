...
PROTO_8:
  ...
  CALL R12 1 1
  SETTABLEKS R12 R0 K31 ["communication"]
  GETTABLEKS R12 R0 K31 ["communication"]
  LOADK R14 K32 ["ToggleManageCollaborators"]
  NEWCLOSURE R15 P5
  CAPTURE VAL R0
  ...
  LOADK R14 K34 ["Actions"]
  NAMECALL R12 R12 K35 ["GetPluginComponent"]
  CALL R12 2 1
  DUPTABLE R15 K41 [{"DataModel", "PluginId", "PluginType", "Category", "ItemId"}]
  LOADK R16 K42 ["Standalone"]
  SETTABLEKS R16 R15 K36 ["DataModel"]
  LOADK R16 K26 ["ManageCollaborators"]
  SETTABLEKS R16 R15 K37 ["PluginId"]
  LOADK R16 K43 ["Unknown"]
  SETTABLEKS R16 R15 K38 ["PluginType"]
  LOADK R16 K34 ["Actions"]
  SETTABLEKS R16 R15 K39 ["Category"]
  LOADK R16 K44 ["Open"]
  SETTABLEKS R16 R15 K40 ["ItemId"]
  NAMECALL R13 R12 K45 ["BindToActivatedAsync"]
  CALL R13 2 1
  NEWCLOSURE R15 P6
  CAPTURE VAL R0
  NAMECALL R13 R13 K33 ["Connect"]
  CALL R13 2 1
  SETTABLEKS R13 R0 K46 ["onActionActivated"]
  RETURN R0 0
...
MAIN:
  ...
  GETTABLEKS R2 R3 K6 ["getFFlagCollaborationActions"]
  CALL R1 1 1
  CALL R1 0 1
  ...
  GETTABLEKS R15 R16 K23 ["MakeTheme"]
  CALL R14 1 1
  ...
  GETTABLEKS R19 R17 K28 ["PermissionsView"]
  CALL R18 1 1
  GETIMPORT R19 K4 [require]
  GETTABLEKS R20 R17 K29 ["SaveToRobloxView"]
  CALL R19 1 1
  ...
  GETTABLEKS R24 R25 K34 ["Controllers"]
  GETTABLEKS R23 R24 K35 ["GroupMetadataController"]
  CALL R22 1 1
  GETIMPORT R23 K4 [require]
  GETTABLEKS R26 R0 K19 ["Src"]
  GETTABLEKS R25 R26 K34 ["Controllers"]
  GETTABLEKS R24 R25 K36 ["GroupRolePermissionsController"]
  CALL R23 1 1
  GETIMPORT R24 K4 [require]
  GETTABLEKS R27 R0 K19 ["Src"]
  GETTABLEKS R26 R27 K34 ["Controllers"]
  GETTABLEKS R25 R26 K37 ["GamePermissionsController"]
  CALL R24 1 1
  GETIMPORT R25 K4 [require]
  GETTABLEKS R28 R0 K19 ["Src"]
  GETTABLEKS R27 R28 K34 ["Controllers"]
  GETTABLEKS R26 R27 K38 ["GranularPermissionsController"]
  CALL R25 1 1
  GETIMPORT R26 K4 [require]
  GETTABLEKS R29 R0 K19 ["Src"]
  GETTABLEKS R28 R29 K34 ["Controllers"]
  GETTABLEKS R27 R28 K39 ["GameMetadataController"]
  CALL R26 1 1
  GETIMPORT R27 K4 [require]
  GETTABLEKS R30 R0 K19 ["Src"]
  GETTABLEKS R29 R30 K34 ["Controllers"]
  GETTABLEKS R28 R29 K40 ["SocialController"]
  CALL R27 1 1
  GETIMPORT R28 K4 [require]
  GETTABLEKS R31 R0 K19 ["Src"]
  GETTABLEKS R30 R31 K41 ["Actions"]
  GETTABLEKS R29 R30 K42 ["ResetStore"]
  CALL R28 1 1
  ...
  CAPTURE VAL R6
  CAPTURE VAL R1
  SETTABLEKS R29 R20 K44 ["init"]
  DUPCLOSURE R29 K45 [PROTO_9]
  CAPTURE VAL R1
  SETTABLEKS R29 R20 K46 ["componentWillUnmount"]
