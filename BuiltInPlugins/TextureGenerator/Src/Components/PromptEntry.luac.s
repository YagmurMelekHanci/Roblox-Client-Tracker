...
PROTO_5:
  ...
  GETUPVAL R10 10
  GETTABLEKS R9 R10 K22 ["addOrUpdatePreview"]
  MOVE R10 R8
  CALL R9 1 0
  DUPTABLE R9 K25 [{"hash", "uuid"}]
  SETTABLEKS R2 R9 K23 ["hash"]
  GETTABLEKS R10 R8 K24 ["uuid"]
  SETTABLEKS R10 R9 K24 ["uuid"]
  GETUPVAL R11 10
  GETTABLEKS R10 R11 K26 ["addOrUpdateModelToPreview"]
  MOVE R11 R9
  CALL R10 1 0
  GETUPVAL R10 11
  LOADK R12 K27 ["GeneratedPreview"]
  GETUPVAL R13 7
  MOVE R14 R0
  GETUPVAL R16 5
  GETTABLEKS R15 R16 K28 ["seed"]
  MOVE R16 R6
  GETUPVAL R18 5
  GETTABLEKS R17 R18 K20 ["smartUVUnwrap"]
  GETUPVAL R19 5
  GETTABLEKS R18 R19 K21 ["promptMasking"]
  GETTABLEKS R19 R8 K24 ["uuid"]
  NAMECALL R10 R10 K29 ["report"]
  CALL R10 9 0
  GETUPVAL R10 12
  GETUPVAL R11 13
  GETUPVAL R12 10
