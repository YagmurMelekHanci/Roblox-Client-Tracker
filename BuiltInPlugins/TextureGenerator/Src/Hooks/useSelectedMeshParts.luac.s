...
PROTO_13:
  ...
  JUMPIFNOT R5 [+15]
  GETUPVAL R5 4
  GETTABLEKS R6 R0 K3 ["SelectionChanged"]
  NEWCLOSURE R7 P1
  CAPTURE UPVAL U2
  CAPTURE VAL R0
  CAPTURE VAL R2
  ...
  SETLIST R7 R8 1 [1]
  CALL R5 2 0
  GETIMPORT R6 K7 [table.isfrozen]
  MOVE R7 R3
  CALL R6 1 1
  JUMPIFNOT R6 [+2]
  MOVE R5 R3
  RETURN R5 1
  GETIMPORT R5 K9 [table.freeze]
  MOVE R6 R3
  CALL R5 1 1
  RETURN R5 1
...
MAIN:
  ...
  GETTABLEKS R7 R8 K15 ["getFFlagTextureGeneratorOptimizeSelection"]
  CALL R6 1 1
