...
MAIN:
  ...
  GETTABLEKS R4 R5 K8 ["FFlagConvAIFixEmptyBubbleBug"]
  CALL R3 1 1
  GETTABLEKS R2 R3 K9 ["Get"]
  GETIMPORT R4 K5 [require]
  GETTABLEKS R7 R1 K6 ["Src"]
  GETTABLEKS R6 R7 K7 ["Flags"]
  GETTABLEKS R5 R6 K10 ["FFlagConvAIFixSpamOnReload"]
  CALL R4 1 1
  GETTABLEKS R3 R4 K9 ["Get"]
  GETIMPORT R5 K5 [require]
  GETTABLEKS R8 R1 K6 ["Src"]
  GETTABLEKS R7 R8 K7 ["Flags"]
  GETTABLEKS R6 R7 K11 ["FFlagConvAIFixStreamCreationTiming"]
  CALL R5 1 1
  GETTABLEKS R4 R5 K9 ["Get"]
  NEWTABLE R5 0 0
  NEWTABLE R6 0 0
  NEWTABLE R7 0 0
  LOADK R8 K12 [""]
  ...
  CAPTURE REF R5
  CAPTURE REF R6
  SETTABLEKS R9 R0 K13 ["newRequest"]
  NEWCLOSURE R9 P1
  CAPTURE REF R8
  SETTABLEKS R9 R0 K14 ["activeStreamId"]
  NEWCLOSURE R9 P2
  CAPTURE REF R8
  SETTABLEKS R9 R0 K15 ["setActiveStreamId"]
  NEWCLOSURE R9 P3
  CAPTURE REF R5
  CAPTURE REF R7
  CAPTURE REF R6
  CAPTURE REF R8
  SETTABLEKS R9 R0 K16 ["requestStreamSubscription"]
  NEWCLOSURE R9 P4
  CAPTURE VAL R4
  CAPTURE REF R5
  SETTABLEKS R9 R0 K17 ["storeStreamPacket"]
  NEWCLOSURE R9 P5
  CAPTURE VAL R4
  CAPTURE REF R5
  CAPTURE REF R6
  ...
  CAPTURE REF R6
  CAPTURE VAL R4
  SETTABLEKS R10 R0 K18 ["activeStreamEnded"]
  NEWCLOSURE R10 P7
  CAPTURE VAL R2
  CAPTURE REF R5
  SETTABLEKS R10 R0 K19 ["isRequestEnded"]
  NEWCLOSURE R10 P8
  CAPTURE REF R5
  SETTABLEKS R10 R0 K20 ["packetExists"]
  NEWCLOSURE R10 P9
  CAPTURE REF R5
  CAPTURE REF R7
  SETTABLEKS R10 R0 K21 ["handleEarliestPacketForStream"]
  NEWCLOSURE R10 P10
  CAPTURE VAL R4
  CAPTURE VAL R3
  CAPTURE REF R5
  ...
  CAPTURE REF R6
  CAPTURE REF R8
  SETTABLEKS R10 R0 K22 ["requestEnded"]
  NEWCLOSURE R10 P11
  CAPTURE REF R5
  CAPTURE REF R6
  CAPTURE REF R7
  CAPTURE REF R8
  SETTABLEKS R10 R0 K23 ["clear"]
  NEWCLOSURE R10 P12
  CAPTURE REF R5
  SETTABLEKS R10 R0 K24 ["getStreamCache"]
  CLOSEUPVALS R5
  RETURN R0 1
