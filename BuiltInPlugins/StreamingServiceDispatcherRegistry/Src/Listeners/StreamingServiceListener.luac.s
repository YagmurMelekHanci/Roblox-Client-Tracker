...
MAIN:
  ...
  GETTABLEKS R4 R5 K12 ["CliAdapter"]
  CALL R3 1 1
  ...
  GETTABLEKS R7 R8 K8 ["Commands"]
  GETTABLEKS R6 R7 K15 ["DisplayError"]
  CALL R5 1 1
  ...
  GETTABLEKS R9 R10 K17 ["ContextCollectors"]
  GETTABLEKS R8 R9 K18 ["RecentInstancesContext"]
  CALL R7 1 1
  GETIMPORT R8 K6 [require]
  GETTABLEKS R10 R1 K13 ["Packages"]
  GETTABLEKS R9 R10 K19 ["SharedPluginConstants"]
  CALL R8 1 1
  ...
  GETTABLEKS R12 R13 K11 ["Utils"]
  GETTABLEKS R11 R12 K11 ["Utils"]
  CALL R10 1 1
  GETTABLEKS R11 R3 K21 ["GetService"]
  LOADK R12 K22 ["ChangeHistoryService"]
  CALL R11 1 1
  GETTABLEKS R12 R3 K21 ["GetService"]
  LOADK R13 K23 ["MemStorageService"]
  CALL R12 1 1
  GETTABLEKS R13 R3 K21 ["GetService"]
  LOADK R14 K24 ["StreamingService"]
  CALL R13 1 1
  GETTABLEKS R14 R3 K21 ["GetService"]
  LOADK R15 K25 ["ChatbotUIService"]
  CALL R14 1 1
  GETTABLEKS R15 R3 K21 ["GetService"]
  LOADK R16 K26 ["TweenService"]
  CALL R15 1 1
  GETTABLEKS R16 R3 K21 ["GetService"]
  LOADK R17 K27 ["HttpService"]
  CALL R16 1 1
  GETTABLEKS R17 R3 K21 ["GetService"]
  LOADK R18 K28 ["Selection"]
  CALL R17 1 1
  GETTABLEKS R18 R3 K21 ["GetService"]
  LOADK R19 K29 ["ConversationalAIAcceptanceService"]
  CALL R18 1 1
  GETIMPORT R20 K6 [require]
  GETTABLEKS R23 R1 K7 ["Src"]
  GETTABLEKS R22 R23 K30 ["Flags"]
  GETTABLEKS R21 R22 K31 ["FFlagConvAIAddCommandSearchInsertAsset"]
  CALL R20 1 1
  GETTABLEKS R19 R20 K32 ["Get"]
  GETIMPORT R21 K6 [require]
  GETTABLEKS R24 R1 K7 ["Src"]
  GETTABLEKS R23 R24 K30 ["Flags"]
  GETTABLEKS R22 R23 K33 ["FFlagConvAIFirstVariationFix"]
  CALL R21 1 1
  GETTABLEKS R20 R21 K32 ["Get"]
  GETIMPORT R22 K6 [require]
  GETTABLEKS R25 R1 K7 ["Src"]
  GETTABLEKS R24 R25 K30 ["Flags"]
  GETTABLEKS R23 R24 K34 ["FFlagConvAIFixEmptyBubbleBug"]
  CALL R22 1 1
  GETTABLEKS R21 R22 K32 ["Get"]
  GETIMPORT R23 K6 [require]
  GETTABLEKS R26 R1 K7 ["Src"]
  GETTABLEKS R25 R26 K30 ["Flags"]
  GETTABLEKS R24 R25 K35 ["FFlagConvAIFixStreamCreationTiming"]
  CALL R23 1 1
  GETTABLEKS R22 R23 K32 ["Get"]
  GETIMPORT R24 K6 [require]
  GETTABLEKS R27 R1 K7 ["Src"]
  GETTABLEKS R26 R27 K30 ["Flags"]
  GETTABLEKS R25 R26 K36 ["FFlagConvAI_ConditionalDropdown"]
  CALL R24 1 1
  GETTABLEKS R23 R24 K32 ["Get"]
  GETIMPORT R25 K6 [require]
  GETTABLEKS R28 R1 K7 ["Src"]
  GETTABLEKS R27 R28 K30 ["Flags"]
  GETTABLEKS R26 R27 K37 ["FFlagFixCurrentCameraPlacement"]
  CALL R25 1 1
  GETTABLEKS R24 R25 K32 ["Get"]
  LOADB R25 0
  NEWCLOSURE R26 P0
  CAPTURE VAL R22
  CAPTURE REF R25
  CAPTURE VAL R21
  SETGLOBAL R26 K38 ["handleCachedPacketsForStream"]
  DUPCLOSURE R26 K39 [PROTO_1]
  CAPTURE VAL R10
  CAPTURE VAL R15
  DUPCLOSURE R27 K40 [PROTO_2]
  CAPTURE VAL R2
  SETTABLEKS R27 R0 K41 ["getActionInstance"]
  DUPCLOSURE R27 K42 [PROTO_3]
  CAPTURE VAL R2
  CAPTURE VAL R23
  SETTABLEKS R27 R0 K43 ["getActionInstanceFromGuid"]
  DUPCLOSURE R27 K44 [PROTO_4]
  CAPTURE VAL R20
  CAPTURE VAL R2
  SETTABLEKS R27 R0 K45 ["onShiftAssetToId"]
  ...
  CAPTURE VAL R18
  CAPTURE VAL R26
  SETTABLEKS R27 R0 K47 ["onShiftAssetVariant"]
  ...
  CAPTURE VAL R28
  CAPTURE VAL R11
  DUPCLOSURE R30 K51 [PROTO_14]
  CAPTURE VAL R17
  CAPTURE VAL R4
  CAPTURE VAL R26
  CAPTURE VAL R29
  CAPTURE VAL R14
  SETTABLEKS R30 R0 K52 ["onAction"]
  DUPCLOSURE R30 K53 [PROTO_15]
  CAPTURE VAL R2
  CAPTURE VAL R10
  CAPTURE VAL R6
  SETTABLEKS R30 R0 K54 ["getPluginInfo"]
  DUPCLOSURE R30 K55 [PROTO_31]
  CAPTURE VAL R13
  CAPTURE VAL R16
  CAPTURE VAL R14
  CAPTURE VAL R7
  ...
  CAPTURE VAL R5
  CAPTURE VAL R10
  DUPCLOSURE R31 K56 [PROTO_32]
  CAPTURE VAL R13
  SETTABLEKS R31 R0 K57 ["destroy"]
  DUPCLOSURE R31 K58 [PROTO_33]
  CAPTURE VAL R30
  CAPTURE VAL R0
  SETTABLEKS R31 R0 K59 ["new"]
  CLOSEUPVALS R25
  RETURN R0 1
