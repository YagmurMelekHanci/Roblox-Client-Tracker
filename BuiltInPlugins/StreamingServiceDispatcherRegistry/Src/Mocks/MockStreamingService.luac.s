...
MAIN:
  ...
  GETTABLEKS R6 R7 K17 ["getFFlagConvAIMockExecuteCommandAsyncLogs"]
  CALL R5 1 1
  NEWTABLE R6 32 0
  ...
  SETTABLEKS R7 R6 K22 ["UnregisterCommand"]
  DUPCLOSURE R7 K23 [PROTO_2]
  SETTABLEKS R7 R6 K24 ["UnregisterContextCollector"]
  DUPCLOSURE R7 K25 [PROTO_3]
  SETTABLEKS R7 R6 K26 ["GetInstance"]
  DUPCLOSURE R7 K27 [PROTO_4]
  SETTABLEKS R7 R6 K28 ["RegisterCommandInternal"]
  DUPCLOSURE R7 K29 [PROTO_5]
  SETTABLEKS R7 R6 K30 ["DEPRECATED_RegisterCommand"]
  DUPCLOSURE R7 K31 [PROTO_6]
  SETTABLEKS R7 R6 K32 ["DEPRECATED_RegisterSequentialCommand"]
  DUPCLOSURE R7 K33 [PROTO_7]
  SETTABLEKS R7 R6 K34 ["RegisterContextCollector"]
  DUPCLOSURE R7 K35 [PROTO_8]
  SETTABLEKS R7 R6 K36 ["SetEphemeralVariable"]
  DUPCLOSURE R7 K37 [PROTO_9]
  SETTABLEKS R7 R6 K38 ["GetEphemeralVariable"]
  DUPCLOSURE R7 K39 [PROTO_10]
  SETTABLEKS R7 R6 K40 ["InvokeCommand"]
  DUPCLOSURE R7 K41 [PROTO_11]
  CAPTURE VAL R5
  SETTABLEKS R7 R6 K42 ["ExecuteCommandAsync"]
  DUPCLOSURE R7 K43 [PROTO_12]
  SETTABLEKS R7 R6 K44 ["SetPluginInfoCallback"]
  DUPCLOSURE R7 K45 [PROTO_13]
  SETTABLEKS R7 R6 K46 ["BindCodeToGuid"]
  DUPCLOSURE R7 K47 [PROTO_15]
  SETTABLEKS R7 R6 K48 ["RunSandboxedCode"]
  DUPCLOSURE R7 K49 [PROTO_16]
  SETTABLEKS R7 R6 K50 ["_replaceInstances"]
  DUPCLOSURE R7 K51 [PROTO_18]
  SETTABLEKS R7 R6 K52 ["CollectContexts"]
  DUPCLOSURE R7 K53 [PROTO_19]
  SETTABLEKS R7 R6 K54 ["GetPluginInfo"]
  DUPCLOSURE R7 K55 [PROTO_20]
  CAPTURE VAL R4
  CAPTURE VAL R3
  SETTABLEKS R7 R6 K56 ["SearchForAssets"]
  DUPCLOSURE R7 K57 [PROTO_21]
  SETTABLEKS R7 R6 K58 ["AttemptSaveAndSendPlaceTelemetry"]
  RETURN R6 1
