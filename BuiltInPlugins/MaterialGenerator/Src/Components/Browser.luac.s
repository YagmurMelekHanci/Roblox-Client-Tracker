...
PROTO_13:
  ...
  GETUPVAL R26 19
  DUPTABLE R27 K29 [{"LayoutOrder", "Size"}]
  GETTABLEKS R28 R0 K27 ["LayoutOrder"]
  SETTABLEKS R28 R27 K27 ["LayoutOrder"]
  GETTABLEKS R28 R0 K28 ["Size"]
  SETTABLEKS R28 R27 K28 ["Size"]
  DUPTABLE R28 K31 [{"Grid"}]
  GETUPVAL R30 1
  GETTABLEKS R29 R30 K26 ["createElement"]
  GETUPVAL R30 20
  DUPTABLE R31 K42 [{"CellGroups", "CellGroupHeader", "Items", "MaterialPreviewGeometryType", "OnClick", "OnRenderItemChildren", "OnRightClick", "Padding", "ScrollingDirection", "SelectedItemId", "ShowGridLabels"}]
  SETTABLEKS R23 R31 K32 ["CellGroups"]
  SETTABLEKS R22 R31 K23 ["CellGroupHeader"]
  SETTABLEKS R20 R31 K33 ["Items"]
  SETTABLEKS R13 R31 K34 ["MaterialPreviewGeometryType"]
  NEWCLOSURE R32 P5
  CAPTURE VAL R16
  SETTABLEKS R32 R31 K35 ["OnClick"]
  SETTABLEKS R24 R31 K36 ["OnRenderItemChildren"]
  SETTABLEKS R18 R31 K37 ["OnRightClick"]
  GETTABLEKS R32 R21 K38 ["Padding"]
  SETTABLEKS R32 R31 K38 ["Padding"]
  GETIMPORT R32 K45 [Enum.ScrollingDirection.Y]
  SETTABLEKS R32 R31 K39 ["ScrollingDirection"]
  SETTABLEKS R17 R31 K40 ["SelectedItemId"]
  LOADB R32 0
  SETTABLEKS R32 R31 K41 ["ShowGridLabels"]
  CALL R29 2 1
  SETTABLEKS R29 R28 K30 ["Grid"]
  CALL R25 3 -1
  CLOSEUPVALS R13
  RETURN R25 -1
...
MAIN:
  ...
  GETTABLEKS R20 R18 K30 ["Constants"]
  CALL R19 1 1
  GETIMPORT R20 K5 [require]
  GETTABLEKS R21 R18 K31 ["GeneratedMaterialsContext"]
  CALL R20 1 1
  GETIMPORT R21 K5 [require]
  GETTABLEKS R22 R18 K32 ["GenerationContext"]
  CALL R21 1 1
  GETIMPORT R22 K5 [require]
  GETTABLEKS R23 R18 K33 ["PluginSettingsContext"]
  CALL R22 1 1
  GETIMPORT R23 K5 [require]
  GETTABLEKS R24 R18 K34 ["PreviewContext"]
  CALL R23 1 1
  GETIMPORT R24 K5 [require]
  GETTABLEKS R25 R18 K35 ["getAllMaterialVariants"]
  CALL R24 1 1
  GETIMPORT R25 K5 [require]
  GETTABLEKS R26 R18 K36 ["getSampleCount"]
  CALL R25 1 1
  GETTABLEKS R26 R19 K37 ["SETTING_GEOMETRY_TYPE"]
  GETTABLEKS R27 R19 K38 ["SETTING_GEOMETRY_TYPE_DEFAULT"]
