...
MAIN:
  ...
  GETTABLEKS R9 R10 K19 ["GetFFlagControlRig"]
  CALL R8 1 1
  GETTABLEKS R9 R1 K20 ["PureComponent"]
  LOADK R11 K21 ["SummaryTrack"]
  NAMECALL R9 R9 K22 ["extend"]
  CALL R9 2 1
  DUPCLOSURE R10 K23 [PROTO_0]
  CAPTURE VAL R4
  CAPTURE VAL R8
  SETTABLEKS R10 R9 K24 ["getSummaryKeyframes"]
  DUPCLOSURE R10 K25 [PROTO_4]
  CAPTURE VAL R1
  CAPTURE VAL R5
  CAPTURE VAL R3
  CAPTURE VAL R7
  SETTABLEKS R10 R9 K26 ["renderKeyframe"]
  DUPCLOSURE R10 K27 [PROTO_5]
  CAPTURE VAL R1
  CAPTURE VAL R6
  SETTABLEKS R10 R9 K28 ["renderKeyframeCluster"]
  DUPCLOSURE R10 K29 [PROTO_6]
  CAPTURE VAL R4
  CAPTURE VAL R3
  SETTABLEKS R10 R9 K30 ["renderKeyframes"]
