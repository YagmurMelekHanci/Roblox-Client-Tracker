...
PROTO_10:
  ...
  GETIMPORT R5 K4 [pairs]
  GETUPVAL R8 0
  GETTABLEKS R6 R8 K5 ["GRIDSPEEDS"]
  CALL R5 1 3
  FORGPREP_NEXT R5
  JUMPIFNOTEQ R9 R3 [+9]
  GETUPVAL R12 0
  GETTABLEKS R11 R12 K5 ["GRIDSPEEDS"]
  GETTABLEKS R10 R11 K6 ["Custom"]
  JUMPIFEQ R9 R10 [+2]
  LOADB R4 0
  FORGLOOP R5 2 [-11]
  ...
  NAMECALL R8 R8 K9 ["FindFirstChildOfClass"]
  CALL R8 2 1
  GETUPVAL R11 0
  GETTABLEKS R10 R11 K5 ["GRIDSPEEDS"]
  GETTABLEKS R9 R10 K10 ["FromRig"]
  JUMPIFNOTEQ R7 R9 [+6]
  JUMPIFNOT R8 [+3]
  GETTABLEKS R7 R8 K11 ["WalkSpeed"]
  JUMP [+1]
  LOADN R7 0
  NEWTABLE R9 2 2
  LOADK R14 K12 ["Settings"]
  LOADK R15 K2 ["GridSpeed"]
  DUPTABLE R16 K14 [{"speed"}]
  SETTABLEKS R7 R16 K13 ["speed"]
  NAMECALL R12 R2 K15 ["getText"]
  CALL R12 4 1
  SETTABLEKS R12 R9 K16 ["Text"]
  LOADB R12 0
  SETTABLEKS R12 R9 K17 ["Enabled"]
  DUPTABLE R10 K21 [{"Data", "Text", "Checked", "OnItemClicked"}]
  GETUPVAL R13 0
  GETTABLEKS R12 R13 K5 ["GRIDSPEEDS"]
  GETTABLEKS R11 R12 K22 ["Static"]
  SETTABLEKS R11 R10 K18 ["Data"]
  LOADK R13 K12 ["Settings"]
  LOADK R14 K23 ["GridSpeedStatic"]
  NAMECALL R11 R2 K15 ["getText"]
  CALL R11 3 1
  SETTABLEKS R11 R10 K16 ["Text"]
  GETUPVAL R14 0
  GETTABLEKS R13 R14 K5 ["GRIDSPEEDS"]
  GETTABLEKS R12 R13 K22 ["Static"]
  JUMPIFEQ R3 R12 [+2]
  LOADB R11 0 +1
  LOADB R11 1
  SETTABLEKS R11 R10 K19 ["Checked"]
  SETTABLEKS R5 R10 K20 ["OnItemClicked"]
  DUPTABLE R11 K21 [{"Data", "Text", "Checked", "OnItemClicked"}]
  GETUPVAL R14 0
  GETTABLEKS R13 R14 K5 ["GRIDSPEEDS"]
  GETTABLEKS R12 R13 K24 ["Default"]
  SETTABLEKS R12 R11 K18 ["Data"]
  LOADK R14 K12 ["Settings"]
  LOADK R15 K25 ["GridSpeedDefault"]
  NAMECALL R12 R2 K15 ["getText"]
  CALL R12 3 1
  SETTABLEKS R12 R11 K16 ["Text"]
  GETUPVAL R15 0
  GETTABLEKS R14 R15 K5 ["GRIDSPEEDS"]
  GETTABLEKS R13 R14 K24 ["Default"]
  JUMPIFEQ R3 R13 [+2]
  LOADB R12 0 +1
  LOADB R12 1
  SETTABLEKS R12 R11 K19 ["Checked"]
  SETTABLEKS R5 R11 K20 ["OnItemClicked"]
  SETLIST R9 R10 2 [1]
  JUMPIFNOT R8 [+34]
  DUPTABLE R12 K21 [{"Data", "Text", "Checked", "OnItemClicked"}]
  GETUPVAL R15 0
  GETTABLEKS R14 R15 K5 ["GRIDSPEEDS"]
  GETTABLEKS R13 R14 K10 ["FromRig"]
  SETTABLEKS R13 R12 K18 ["Data"]
  LOADK R15 K12 ["Settings"]
  LOADK R16 K26 ["GridSpeedFromRig"]
  NAMECALL R13 R2 K15 ["getText"]
  CALL R13 3 1
  SETTABLEKS R13 R12 K16 ["Text"]
  GETUPVAL R16 0
  GETTABLEKS R15 R16 K5 ["GRIDSPEEDS"]
  GETTABLEKS R14 R15 K10 ["FromRig"]
  JUMPIFEQ R3 R14 [+2]
  LOADB R13 0 +1
  LOADB R13 1
  SETTABLEKS R13 R12 K19 ["Checked"]
  SETTABLEKS R5 R12 K20 ["OnItemClicked"]
  ...
  GETUPVAL R15 0
  GETTABLEKS R14 R15 K5 ["GRIDSPEEDS"]
  GETTABLEKS R13 R14 K6 ["Custom"]
  SETTABLEKS R13 R12 K18 ["Data"]
  LOADK R15 K12 ["Settings"]
  LOADK R16 K30 ["GridSpeedCustom"]
  NAMECALL R13 R2 K15 ["getText"]
  CALL R13 3 1
  SETTABLEKS R13 R12 K16 ["Text"]
  SETTABLEKS R4 R12 K19 ["Checked"]
  SETTABLEKS R6 R12 K20 ["OnItemClicked"]
  FASTCALL2 TABLE_INSERT R9 R12 [+4]
  MOVE R11 R9
  GETIMPORT R10 K29 [table.insert]
  CALL R10 2 0
...
PROTO_21:
  ...
  DUPTABLE R2 K12 [{"Analytics", "AnimationData", "DefaultEulerAnglesOrder", "DefaultRotationType", "FrameRate", "GridSpeed", "PlaybackSpeed", "RootInstance", "ShowEvents", "SnapMode", "TimelineUnit"}]
  ...
  GETTABLEKS R3 R1 K9 ["ShowEvents"]
  SETTABLEKS R3 R2 K9 ["ShowEvents"]
  GETTABLEKS R3 R1 K10 ["SnapMode"]
  SETTABLEKS R3 R2 K10 ["SnapMode"]
  GETTABLEKS R3 R1 K11 ["TimelineUnit"]
  SETTABLEKS R3 R2 K11 ["TimelineUnit"]
  RETURN R2 1
...
PROTO_30:
  DUPTABLE R1 K8 [{"SetDefaultEulerAnglesOrder", "SetDefaultRotationType", "SetFrameRate", "SetGridSpeed", "SetPlaybackSpeed", "SetShowEvents", "SetSnapMode", "SetTimelineUnit"}]
  NEWCLOSURE R2 P0
  CAPTURE VAL R0
  CAPTURE UPVAL U0
  ...
  CAPTURE VAL R0
  CAPTURE UPVAL U7
  SETTABLEKS R2 R1 K7 ["SetTimelineUnit"]
  RETURN R1 1
...
MAIN:
  ...
  GETTABLEKS R12 R6 K18 ["SetShowEvents"]
  CALL R11 1 1
  GETIMPORT R12 K5 [require]
  GETTABLEKS R13 R6 K19 ["SetSnapMode"]
  CALL R12 1 1
  GETIMPORT R13 K5 [require]
  GETTABLEKS R14 R6 K20 ["SetTimelineUnit"]
  CALL R13 1 1
  ...
  LOADK R20 K30 ["SettingsMenu"]
  NAMECALL R18 R18 K31 ["extend"]
  CALL R18 2 1
  DUPCLOSURE R19 K32 [PROTO_1]
  CAPTURE VAL R17
  SETTABLEKS R19 R18 K33 ["makeTimelineUnitMenu"]
  DUPCLOSURE R19 K34 [PROTO_4]
  CAPTURE VAL R17
  SETTABLEKS R19 R18 K35 ["makePlaybackSpeedMenu"]
  DUPCLOSURE R19 K36 [PROTO_7]
  CAPTURE VAL R17
  SETTABLEKS R19 R18 K37 ["makeFrameRateMenu"]
  DUPCLOSURE R19 K38 [PROTO_10]
  CAPTURE VAL R17
  SETTABLEKS R19 R18 K39 ["makeGridSpeedMenu"]
  DUPCLOSURE R19 K40 [PROTO_12]
  CAPTURE VAL R17
  SETTABLEKS R19 R18 K41 ["makeSnapMenu"]
  DUPCLOSURE R19 K42 [PROTO_14]
  CAPTURE VAL R17
  SETTABLEKS R19 R18 K43 ["makeDefaultRotationTypeMenu"]
  DUPCLOSURE R19 K44 [PROTO_16]
  CAPTURE VAL R17
  SETTABLEKS R19 R18 K45 ["makeEulerAnglesOrderMenu"]
  DUPCLOSURE R19 K46 [PROTO_18]
  SETTABLEKS R19 R18 K47 ["makeShowEvents"]
  DUPCLOSURE R19 K48 [PROTO_19]
  CAPTURE VAL R17
  SETTABLEKS R19 R18 K49 ["makeMenuActions"]
  DUPCLOSURE R19 K50 [PROTO_20]
  CAPTURE VAL R1
  CAPTURE VAL R14
  SETTABLEKS R19 R18 K51 ["render"]
  DUPCLOSURE R19 K52 [PROTO_21]
  DUPCLOSURE R20 K53 [PROTO_30]
  CAPTURE VAL R7
  CAPTURE VAL R8
  CAPTURE VAL R9
  CAPTURE VAL R10
  ...
  CAPTURE VAL R13
  MOVE R21 R5
  DUPTABLE R22 K57 [{"Localization", "Analytics", "Plugin"}]
  GETTABLEKS R23 R4 K54 ["Localization"]
  SETTABLEKS R23 R22 K54 ["Localization"]
  GETTABLEKS R23 R4 K55 ["Analytics"]
  SETTABLEKS R23 R22 K55 ["Analytics"]
  GETTABLEKS R23 R4 K56 ["Plugin"]
  SETTABLEKS R23 R22 K56 ["Plugin"]
  CALL R21 1 1
  MOVE R22 R18
  CALL R21 1 1
  MOVE R18 R21
