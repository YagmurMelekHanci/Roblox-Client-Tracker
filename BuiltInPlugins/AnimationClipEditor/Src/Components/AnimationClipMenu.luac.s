...
PROTO_14:
  ...
  GETTABLEKS R7 R1 K6 ["Plugin"]
  GETTABLEKS R9 R1 K7 ["PlayState"]
  GETUPVAL R12 0
  GETTABLEKS R11 R12 K8 ["PLAY_STATE"]
  GETTABLEKS R10 R11 K9 ["Record"]
  JUMPIFEQ R9 R10 [+2]
  LOADB R8 0 +1
  LOADB R8 1
  MOVE R9 R6
  JUMPIFNOT R9 [+12]
  GETTABLEKS R9 R6 K10 ["Metadata"]
  JUMPIFNOT R9 [+9]
  LOADB R9 0
  GETTABLEKS R11 R6 K10 ["Metadata"]
  GETTABLEKS R10 R11 K11 ["EndTick"]
  LOADN R11 0
  JUMPIFNOTLT R11 R10 [+2]
  NOT R9 R8
  NEWTABLE R10 0 12
  NAMECALL R11 R0 K12 ["makeLoadMenu"]
  CALL R11 1 1
  LOADK R14 K13 ["Save"]
  NEWCLOSURE R15 P0
  CAPTURE VAL R5
  ...
  CALL R12 3 1
  NAMECALL R13 R0 K15 ["makeSaveAsMenu"]
  CALL R13 1 1
  GETUPVAL R15 0
  GETTABLEKS R14 R15 K16 ["MENU_SEPARATOR"]
  NAMECALL R15 R0 K17 ["makeImportMenu"]
  CALL R15 1 1
  LOADK R18 K18 ["PublishToRoblox"]
  NEWCLOSURE R19 P1
  CAPTURE VAL R1
  CAPTURE VAL R7
  NAMECALL R16 R0 K14 ["makeAction"]
  CALL R16 3 1
  GETUPVAL R18 0
  GETTABLEKS R17 R18 K16 ["MENU_SEPARATOR"]
  LOADK R20 K19 ["CreateNew"]
  MOVE R21 R2
  NAMECALL R18 R0 K14 ["makeAction"]
  CALL R18 3 1
  GETUPVAL R20 0
  GETTABLEKS R19 R20 K16 ["MENU_SEPARATOR"]
  NAMECALL R20 R0 K20 ["makePriorityMenu"]
  CALL R20 1 1
  GETUPVAL R22 0
  GETTABLEKS R21 R22 K16 ["MENU_SEPARATOR"]
  LOADK R24 K21 ["OptimizeKeyframes"]
  MOVE R25 R3
  MOVE R26 R9
  NAMECALL R22 R0 K14 ["makeAction"]
  CALL R22 4 -1
  SETLIST R10 R11 -1 [1]
  GETTABLEKS R11 R0 K22 ["hasInternalPermission"]
  JUMPIFNOT R11 [+12]
  DUPTABLE R13 K25 [{"Text", "OnItemClicked"}]
  LOADK R14 K26 ["[INTERNAL] Sanitize animation"]
  SETTABLEKS R14 R13 K23 ["Text"]
  SETTABLEKS R4 R13 K24 ["OnItemClicked"]
...
MAIN:
  ...
  CALL R15 3 1
  GETTABLEKS R16 R1 K32 ["PureComponent"]
  LOADK R18 K33 ["AnimationClipMenu"]
  ...
  CAPTURE VAL R5
  SETTABLEKS R17 R16 K40 ["makeLoadMenu"]
  DUPCLOSURE R17 K41 [PROTO_7]
  CAPTURE VAL R5
  CAPTURE VAL R6
  SETTABLEKS R17 R16 K42 ["makeSaveAsMenu"]
  DUPCLOSURE R17 K43 [PROTO_8]
  CAPTURE VAL R15
  CAPTURE VAL R4
  SETTABLEKS R17 R16 K44 ["makeImportMenu"]
  DUPCLOSURE R17 K45 [PROTO_10]
  SETTABLEKS R17 R16 K46 ["makePriorityMenu"]
  DUPCLOSURE R17 K47 [PROTO_11]
  SETTABLEKS R17 R16 K48 ["makeAction"]
  DUPCLOSURE R17 K49 [PROTO_14]
  CAPTURE VAL R6
  SETTABLEKS R17 R16 K50 ["makeMenuActions"]
  DUPCLOSURE R17 K51 [PROTO_15]
  CAPTURE VAL R1
  CAPTURE VAL R9
  SETTABLEKS R17 R16 K52 ["render"]
  MOVE R17 R8
  DUPTABLE R18 K56 [{"Localization", "Plugin", "Analytics"}]
  GETTABLEKS R19 R7 K53 ["Localization"]
  SETTABLEKS R19 R18 K53 ["Localization"]
  GETTABLEKS R19 R7 K54 ["Plugin"]
  SETTABLEKS R19 R18 K54 ["Plugin"]
  GETTABLEKS R19 R7 K55 ["Analytics"]
  SETTABLEKS R19 R18 K55 ["Analytics"]
  CALL R17 1 1
  MOVE R18 R16
  CALL R17 1 1
  MOVE R16 R17
  DUPCLOSURE R17 K57 [PROTO_16]
