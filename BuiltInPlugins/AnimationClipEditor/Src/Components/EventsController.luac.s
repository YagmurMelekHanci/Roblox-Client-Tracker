...
MAIN:
  ...
  CAPTURE VAL R14
  SETTABLEKS R33 R32 K52 ["handleTimelineInputBegan"]
  DUPCLOSURE R33 K53 [PROTO_17]
  CAPTURE VAL R14
  SETTABLEKS R33 R32 K54 ["handleTimelineInputEnded"]
  DUPCLOSURE R33 K55 [PROTO_18]
  SETTABLEKS R33 R32 K56 ["handleEventRightClick"]
  DUPCLOSURE R33 K57 [PROTO_19]
  SETTABLEKS R33 R32 K58 ["handleEventInputBegan"]
  DUPCLOSURE R33 K59 [PROTO_20]
  SETTABLEKS R33 R32 K60 ["handleEventInputEnded"]
  DUPCLOSURE R33 K61 [PROTO_21]
  CAPTURE VAL R10
  CAPTURE VAL R16
  CAPTURE VAL R9
  SETTABLEKS R33 R32 K62 ["refreshEventNames"]
  DUPCLOSURE R33 K63 [PROTO_23]
  SETTABLEKS R33 R32 K64 ["didUpdate"]
  DUPCLOSURE R33 K65 [PROTO_24]
  SETTABLEKS R33 R32 K66 ["didMount"]
  DUPCLOSURE R33 K67 [PROTO_32]
  CAPTURE VAL R1
  CAPTURE VAL R11
  CAPTURE VAL R18
  CAPTURE VAL R7
  ...
  DUPCLOSURE R33 K69 [PROTO_33]
  DUPCLOSURE R34 K70 [PROTO_43]
  CAPTURE VAL R21
  CAPTURE VAL R22
  CAPTURE VAL R30
  CAPTURE VAL R23
  ...
  CAPTURE VAL R27
  MOVE R35 R6
  DUPTABLE R36 K72 [{"Analytics"}]
  GETTABLEKS R37 R5 K71 ["Analytics"]
  SETTABLEKS R37 R36 K71 ["Analytics"]
  CALL R35 1 1
  MOVE R36 R32
  CALL R35 1 1
  MOVE R32 R35
  GETTABLEKS R35 R2 K73 ["connect"]
  MOVE R36 R33
  MOVE R37 R34
  CALL R35 2 1
  MOVE R36 R32
