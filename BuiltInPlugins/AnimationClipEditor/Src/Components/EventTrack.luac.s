...
MAIN:
  ...
  GETTABLEKS R12 R9 K19 ["TrackUtils"]
  CALL R11 1 1
  GETTABLEKS R12 R3 K20 ["UI"]
  GETTABLEKS R13 R12 K21 ["Button"]
  GETTABLEKS R14 R12 K22 ["Pane"]
  GETTABLEKS R15 R12 K23 ["Tooltip"]
  GETTABLEKS R16 R1 K24 ["PureComponent"]
  LOADK R18 K25 ["EventTrack"]
  ...
  CAPTURE VAL R1
  CAPTURE VAL R7
  SETTABLEKS R17 R16 K30 ["renderEvent"]
  DUPCLOSURE R17 K31 [PROTO_7]
  CAPTURE VAL R1
  CAPTURE VAL R7
  SETTABLEKS R17 R16 K32 ["renderPreviewEvent"]
  DUPCLOSURE R17 K33 [PROTO_8]
  CAPTURE VAL R11
  SETTABLEKS R17 R16 K34 ["renderEvents"]
  DUPCLOSURE R17 K35 [PROTO_10]
  CAPTURE VAL R10
  CAPTURE VAL R2
  SETTABLEKS R17 R16 K36 ["makeFilterActions"]
  ...
  MOVE R17 R5
  DUPTABLE R18 K41 [{"Stylizer", "Localization"}]
  GETTABLEKS R19 R4 K39 ["Stylizer"]
  SETTABLEKS R19 R18 K39 ["Stylizer"]
  GETTABLEKS R19 R4 K40 ["Localization"]
  SETTABLEKS R19 R18 K40 ["Localization"]
  CALL R17 1 1
  MOVE R18 R16
  CALL R17 1 1
  MOVE R16 R17
