...
PROTO_9:
  ...
  GETUPVAL R19 2
  DUPTABLE R20 K53 [{"StartTick", "EndTick", "LastTick", "MajorInterval", "MinorInterval", "Position", "Height", "Width", "TickHeightScale", "SmallTickHeightScale", "TimelineUnit", "OnInputBegan", "OnDragMoved", "AnimationData", "FrameRate", "ZIndex"}]
  ...
  GETTABLEKS R21 R0 K57 ["onTimelineClicked"]
  SETTABLEKS R21 R20 K51 ["OnInputBegan"]
  GETTABLEKS R21 R0 K58 ["onScrubberMoved"]
  SETTABLEKS R21 R20 K52 ["OnDragMoved"]
  ...
  GETTABLEKS R18 R19 K25 ["createElement"]
  GETUPVAL R19 3
  DUPTABLE R20 K62 [{"ZIndex", "AnchorPoint", "Size", "Position", "Style", "OnClick"}]
  LOADN R21 1
  SETTABLEKS R21 R20 K31 ["ZIndex"]
  ...
  LOADK R23 K65 [0.5]
  CALL R21 2 1
  SETTABLEKS R21 R20 K59 ["AnchorPoint"]
  GETIMPORT R21 K67 [UDim2.fromOffset]
  GETUPVAL R23 0
  GETTABLEKS R22 R23 K68 ["TOGGLE_EDITOR_BUTTON_WIDTH"]
  GETUPVAL R24 0
  GETTABLEKS R23 R24 K69 ["TOGGLE_EDITOR_BUTTON_HEIGHT"]
  CALL R21 2 1
  ...
  CALL R21 2 1
  SETTABLEKS R21 R20 K46 ["Position"]
  GETTABLEKS R22 R2 K71 ["button"]
  GETTABLEKS R21 R22 K72 ["MediaControl"]
  SETTABLEKS R21 R20 K60 ["Style"]
  GETTABLEKS R21 R1 K73 ["OnToggleEditorClicked"]
  SETTABLEKS R21 R20 K61 ["OnClick"]
  DUPTABLE R21 K77 [{"Image", "Tooltip", "TeachingCallout"}]
  GETUPVAL R23 1
  GETTABLEKS R22 R23 K25 ["createElement"]
  LOADK R23 K78 ["ImageLabel"]
  DUPTABLE R24 K81 [{"BackgroundTransparency", "Size", "Position", "AnchorPoint", "Image", "ImageColor3"}]
  LOADN R25 1
  SETTABLEKS R25 R24 K79 ["BackgroundTransparency"]
  GETIMPORT R25 K35 [UDim2.new]
  LOADN R26 0
  GETUPVAL R28 0
  GETTABLEKS R27 R28 K68 ["TOGGLE_EDITOR_BUTTON_WIDTH"]
  LOADN R28 0
  GETUPVAL R30 0
  GETTABLEKS R29 R30 K69 ["TOGGLE_EDITOR_BUTTON_HEIGHT"]
  CALL R25 4 1
  ...
  GETIMPORT R25 K64 [Vector2.new]
  LOADK R26 K65 [0.5]
  LOADK R27 K65 [0.5]
  CALL R25 2 1
  SETTABLEKS R25 R24 K59 ["AnchorPoint"]
  JUMPIFNOT R11 [+5]
  GETTABLEKS R26 R2 K82 ["curveTheme"]
  GETTABLEKS R25 R26 K83 ["dopesheetButton"]
  JUMP [+4]
  GETTABLEKS R26 R2 K82 ["curveTheme"]
  GETTABLEKS R25 R26 K84 ["curveEditorButton"]
  SETTABLEKS R25 R24 K74 ["Image"]
  GETTABLEKS R26 R2 K85 ["playbackTheme"]
  GETTABLEKS R25 R26 K86 ["iconColor"]
  SETTABLEKS R25 R24 K80 ["ImageColor3"]
  CALL R22 2 1
  SETTABLEKS R22 R21 K74 ["Image"]
  GETUPVAL R23 1
  GETTABLEKS R22 R23 K25 ["createElement"]
  GETUPVAL R23 4
  DUPTABLE R24 K88 [{"TextKey"}]
  JUMPIFNOT R11 [+2]
  LOADK R25 K89 ["GoToDopesheetEditor"]
  JUMP [+1]
  LOADK R25 K90 ["GoToCurveEditor"]
  SETTABLEKS R25 R24 K87 ["TextKey"]
  CALL R22 2 1
  SETTABLEKS R22 R21 K75 ["Tooltip"]
  GETUPVAL R23 1
  GETTABLEKS R22 R23 K25 ["createElement"]
  GETUPVAL R23 5
  DUPTABLE R24 K94 [{"Offset", "DefinitionId", "LocationId"}]
  GETIMPORT R25 K64 [Vector2.new]
  LOADN R26 0
  LOADN R27 6
  CALL R25 2 1
  SETTABLEKS R25 R24 K91 ["Offset"]
  LOADK R25 K95 ["CurveEditorCallout"]
  SETTABLEKS R25 R24 K92 ["DefinitionId"]
  LOADK R25 K41 ["ToggleEditorButton"]
  SETTABLEKS R25 R24 K93 ["LocationId"]
  CALL R22 2 1
  SETTABLEKS R22 R21 K76 ["TeachingCallout"]
  CALL R18 3 1
  SETTABLEKS R18 R17 K41 ["ToggleEditorButton"]
  GETUPVAL R19 1
  GETTABLEKS R18 R19 K25 ["createElement"]
  GETUPVAL R19 6
  DUPTABLE R20 K97 [{"OnKeyPressed"}]
  NEWCLOSURE R21 P0
  CAPTURE UPVAL U7
  CAPTURE VAL R0
  SETTABLEKS R21 R20 K96 ["OnKeyPressed"]
  CALL R18 2 1
