...
MAIN:
  ...
  GETTABLEKS R43 R1 K62 ["LuaFlags"]
  GETTABLEKS R42 R43 K63 ["GetFFlagFacialAnimationRecordingInStudio"]
  CALL R41 1 1
  GETIMPORT R42 K9 [require]
  GETTABLEKS R44 R1 K62 ["LuaFlags"]
  GETTABLEKS R43 R44 K64 ["GetFFlagRigValidation"]
  CALL R42 1 1
  DUPCLOSURE R43 K65 [PROTO_1]
  CAPTURE VAL R0
  CAPTURE VAL R42
  CAPTURE VAL R32
  CAPTURE VAL R2
  CAPTURE VAL R16
  CAPTURE VAL R28
  SETTABLEKS R43 R35 K66 ["handleButtonClick"]
  DUPCLOSURE R43 K67 [PROTO_2]
  SETTABLEKS R43 R35 K68 ["createPluginButton"]
  DUPCLOSURE R43 K69 [PROTO_13]
  CAPTURE VAL R3
  CAPTURE VAL R29
  CAPTURE VAL R20
  CAPTURE VAL R21
  ...
  CAPTURE VAL R8
  CAPTURE VAL R7
  SETTABLEKS R43 R35 K72 ["getPluginSettings"]
  DUPCLOSURE R43 K73 [PROTO_15]
  CAPTURE VAL R28
  SETTABLEKS R43 R35 K74 ["setPluginSettings"]
  DUPCLOSURE R43 K75 [PROTO_16]
  CAPTURE VAL R28
  DUPCLOSURE R44 K76 [PROTO_17]
  CAPTURE VAL R28
  DUPCLOSURE R45 K77 [PROTO_18]
  CAPTURE VAL R28
  DUPCLOSURE R46 K78 [PROTO_19]
  CAPTURE VAL R28
  SETTABLEKS R46 R35 K79 ["didMount"]
  DUPCLOSURE R46 K80 [PROTO_20]
  CAPTURE VAL R39
  CAPTURE VAL R28
  SETTABLEKS R46 R35 K81 ["willUnmount"]
  DUPCLOSURE R46 K82 [PROTO_21]
  CAPTURE VAL R2
  CAPTURE VAL R14
  CAPTURE VAL R18
  CAPTURE VAL R13
  CAPTURE VAL R15
  SETTABLEKS R46 R35 K83 ["render"]
  RETURN R35 1
