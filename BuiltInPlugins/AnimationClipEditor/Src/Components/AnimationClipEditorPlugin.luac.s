...
PROTO_14:
  ...
  JUMPIFNOT R3 [+6]
  GETUPVAL R7 1
  GETTABLEKS R6 R7 K16 ["TIMELINE_UNITS"]
  GETTABLEKS R5 R6 K17 ["Seconds"]
  JUMP [+5]
  GETUPVAL R7 1
  GETTABLEKS R6 R7 K16 ["TIMELINE_UNITS"]
  GETTABLEKS R5 R6 K18 ["Frames"]
  GETTABLEKS R6 R0 K5 ["store"]
  GETUPVAL R8 3
  MOVE R9 R5
  CALL R8 1 -1
...
MAIN:
  ...
  LOADK R41 K59 ["ACEDeferClearMicrobones"]
  LOADB R42 0
  NAMECALL R39 R39 K58 ["DefineFastFlag"]
  CALL R39 3 1
  GETIMPORT R40 K1 [game]
  LOADK R42 K60 ["ACERetireSettings"]
  LOADB R43 0
  NAMECALL R40 R40 K58 ["DefineFastFlag"]
  CALL R40 3 1
  GETIMPORT R41 K9 [require]
  GETTABLEKS R43 R1 K61 ["LuaFlags"]
  GETTABLEKS R42 R43 K62 ["GetFFlagFacialAnimationRecordingInStudio"]
  CALL R41 1 1
  GETIMPORT R42 K9 [require]
  GETTABLEKS R44 R1 K61 ["LuaFlags"]
  GETTABLEKS R43 R44 K63 ["GetFFlagRigValidation"]
  CALL R42 1 1
  ...
  CAPTURE VAL R16
  CAPTURE VAL R28
  SETTABLEKS R43 R35 K65 ["handleButtonClick"]
  DUPCLOSURE R43 K66 [PROTO_2]
  SETTABLEKS R43 R35 K67 ["createPluginButton"]
  DUPCLOSURE R43 K68 [PROTO_13]
  CAPTURE VAL R3
  CAPTURE VAL R29
  CAPTURE VAL R20
  CAPTURE VAL R21
  ...
  CAPTURE VAL R38
  CAPTURE VAL R33
  SETTABLEKS R43 R35 K69 ["init"]
  DUPCLOSURE R43 K70 [PROTO_14]
  CAPTURE VAL R40
  CAPTURE VAL R28
  CAPTURE VAL R9
  CAPTURE VAL R10
  CAPTURE VAL R8
  CAPTURE VAL R7
  SETTABLEKS R43 R35 K71 ["getPluginSettings"]
  DUPCLOSURE R43 K72 [PROTO_15]
  CAPTURE VAL R28
  SETTABLEKS R43 R35 K73 ["setPluginSettings"]
  DUPCLOSURE R43 K74 [PROTO_16]
  CAPTURE VAL R28
  DUPCLOSURE R44 K75 [PROTO_17]
  CAPTURE VAL R28
  DUPCLOSURE R45 K76 [PROTO_18]
  CAPTURE VAL R28
  DUPCLOSURE R46 K77 [PROTO_19]
  CAPTURE VAL R28
  SETTABLEKS R46 R35 K78 ["didMount"]
  DUPCLOSURE R46 K79 [PROTO_20]
  CAPTURE VAL R38
  CAPTURE VAL R28
  SETTABLEKS R46 R35 K80 ["willUnmount"]
  DUPCLOSURE R46 K81 [PROTO_21]
  CAPTURE VAL R2
  CAPTURE VAL R14
  CAPTURE VAL R18
  CAPTURE VAL R13
