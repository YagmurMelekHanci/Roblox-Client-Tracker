...
MAIN:
  ...
  LOADK R39 K54 ["ACECurveEditorLink"]
  LOADK R40 K55 ["https://create.roblox.com/docs/building-and-visuals/animation/curve-editor"]
  NAMECALL R37 R37 K56 ["DefineFastString"]
  CALL R37 3 1
  GETIMPORT R38 K1 [game]
  LOADK R40 K57 ["ACEFaceRecorderLink"]
  LOADK R41 K58 ["https://create.roblox.com/docs/building-and-visuals/animation/face-recorder"]
  NAMECALL R38 R38 K56 ["DefineFastString"]
  CALL R38 3 1
  GETIMPORT R39 K1 [game]
  LOADK R41 K59 ["ACETemporaryToolHack"]
  LOADB R42 0
  NAMECALL R39 R39 K60 ["DefineFastFlag"]
  CALL R39 3 1
  GETIMPORT R40 K1 [game]
  LOADK R42 K61 ["ACEDeferClearMicrobones"]
  LOADB R43 0
  NAMECALL R40 R40 K60 ["DefineFastFlag"]
  CALL R40 3 1
  GETIMPORT R41 K1 [game]
  LOADK R43 K62 ["ACERetireSettings"]
  LOADB R44 0
  NAMECALL R41 R41 K60 ["DefineFastFlag"]
  CALL R41 3 1
  ...
  GETTABLEKS R44 R45 K65 ["GetFFlagRigValidation"]
  CALL R43 1 1
  ...
  CAPTURE VAL R16
  CAPTURE VAL R28
  SETTABLEKS R44 R35 K67 ["handleButtonClick"]
  DUPCLOSURE R44 K68 [PROTO_2]
  SETTABLEKS R44 R35 K69 ["createPluginButton"]
  ...
  CAPTURE VAL R8
  CAPTURE VAL R7
  SETTABLEKS R44 R35 K73 ["getPluginSettings"]
  DUPCLOSURE R44 K74 [PROTO_15]
  CAPTURE VAL R28
  SETTABLEKS R44 R35 K75 ["setPluginSettings"]
  ...
  CAPTURE VAL R28
  SETTABLEKS R47 R35 K80 ["didMount"]
  DUPCLOSURE R47 K81 [PROTO_20]
  CAPTURE VAL R39
  CAPTURE VAL R28
  SETTABLEKS R47 R35 K82 ["willUnmount"]
