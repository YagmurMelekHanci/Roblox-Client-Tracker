...
MAIN:
  ...
  GETTABLEKS R41 R1 K59 ["LuaFlags"]
  GETTABLEKS R40 R41 K60 ["GetFFlagFacialAnimationRecordingInStudio"]
  CALL R39 1 1
  ...
  CAPTURE VAL R16
  CAPTURE VAL R28
  SETTABLEKS R40 R35 K62 ["handleButtonClick"]
  DUPCLOSURE R40 K63 [PROTO_2]
  SETTABLEKS R40 R35 K64 ["createPluginButton"]
  ...
  DUPCLOSURE R40 K67 [PROTO_14]
  CAPTURE VAL R28
  CAPTURE VAL R9
  CAPTURE VAL R10
  CAPTURE VAL R8
  CAPTURE VAL R7
  SETTABLEKS R40 R35 K68 ["getPluginSettings"]
  DUPCLOSURE R40 K69 [PROTO_15]
  CAPTURE VAL R28
  SETTABLEKS R40 R35 K70 ["setPluginSettings"]
  DUPCLOSURE R40 K71 [PROTO_16]
  CAPTURE VAL R28
  DUPCLOSURE R41 K72 [PROTO_17]
  CAPTURE VAL R28
  DUPCLOSURE R42 K73 [PROTO_18]
  CAPTURE VAL R28
  DUPCLOSURE R43 K74 [PROTO_19]
  CAPTURE VAL R28
  SETTABLEKS R43 R35 K75 ["didMount"]
  DUPCLOSURE R43 K76 [PROTO_20]
  CAPTURE VAL R38
  CAPTURE VAL R28
  SETTABLEKS R43 R35 K77 ["willUnmount"]
  DUPCLOSURE R43 K78 [PROTO_21]
  CAPTURE VAL R2
  CAPTURE VAL R14
  CAPTURE VAL R18
  CAPTURE VAL R13
  CAPTURE VAL R15
  SETTABLEKS R43 R35 K79 ["render"]
  RETURN R35 1
