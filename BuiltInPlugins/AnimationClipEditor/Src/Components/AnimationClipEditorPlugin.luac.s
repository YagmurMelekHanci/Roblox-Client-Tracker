...
PROTO_1:
  ...
  GETUPVAL R6 3
  DUPTABLE R7 K5 [{"ErrorKey", "ErrorList"}]
  GETUPVAL R9 4
  GETTABLEKS R8 R9 K6 ["EDITOR_ERRORS_KEY"]
  SETTABLEKS R8 R7 K3 ["ErrorKey"]
  NEWTABLE R8 0 1
  DUPTABLE R9 K9 [{"id", "severity"}]
  GETUPVAL R12 4
  GETTABLEKS R11 R12 K10 ["EDITOR_ERRORS"]
  GETTABLEKS R10 R11 K11 ["OpenedWhileRunning"]
  SETTABLEKS R10 R9 K7 ["id"]
  GETUPVAL R12 4
  GETTABLEKS R11 R12 K12 ["SEVERITY"]
  GETTABLEKS R10 R11 K1 ["Error"]
  SETTABLEKS R10 R9 K8 ["severity"]
  SETLIST R8 R9 1 [1]
  SETTABLEKS R8 R7 K4 ["ErrorList"]
  CALL R5 2 -1
  CALL R2 -1 0
  RETURN R0 0
...
MAIN:
  ...
  CAPTURE VAL R16
  CAPTURE VAL R28
  SETTABLEKS R41 R35 K63 ["handleButtonClick"]
  DUPCLOSURE R41 K64 [PROTO_2]
  SETTABLEKS R41 R35 K65 ["createPluginButton"]
  ...
  CAPTURE VAL R38
  CAPTURE VAL R33
  SETTABLEKS R41 R35 K67 ["init"]
  DUPCLOSURE R41 K68 [PROTO_14]
  CAPTURE VAL R39
  CAPTURE VAL R28
  CAPTURE VAL R9
  CAPTURE VAL R10
  CAPTURE VAL R8
  CAPTURE VAL R7
  SETTABLEKS R41 R35 K69 ["getPluginSettings"]
  DUPCLOSURE R41 K70 [PROTO_15]
  CAPTURE VAL R28
  SETTABLEKS R41 R35 K71 ["setPluginSettings"]
  DUPCLOSURE R41 K72 [PROTO_16]
  CAPTURE VAL R28
  DUPCLOSURE R42 K73 [PROTO_17]
  CAPTURE VAL R28
  DUPCLOSURE R43 K74 [PROTO_18]
  CAPTURE VAL R28
  DUPCLOSURE R44 K75 [PROTO_19]
  CAPTURE VAL R28
  SETTABLEKS R44 R35 K76 ["didMount"]
  DUPCLOSURE R44 K77 [PROTO_20]
  CAPTURE VAL R38
  CAPTURE VAL R28
  SETTABLEKS R44 R35 K78 ["willUnmount"]
  DUPCLOSURE R44 K79 [PROTO_21]
  CAPTURE VAL R2
  CAPTURE VAL R14
  CAPTURE VAL R18
  CAPTURE VAL R13
  CAPTURE VAL R15
  SETTABLEKS R44 R35 K80 ["render"]
  RETURN R35 1
