...
MAIN:
  ...
  GETTABLEKS R18 R14 K27 ["ValueChanged"]
  CALL R17 1 1
  GETTABLEKS R19 R0 K13 ["Src"]
  GETTABLEKS R18 R19 K28 ["Util"]
  GETIMPORT R19 K5 [require]
  GETTABLEKS R20 R18 K29 ["AnimationData"]
  CALL R19 1 1
  GETIMPORT R20 K5 [require]
  GETTABLEKS R21 R18 K30 ["Constants"]
  CALL R20 1 1
  GETIMPORT R21 K5 [require]
  GETTABLEKS R23 R18 K31 ["DraggerSchema"]
  GETTABLEKS R22 R23 K31 ["DraggerSchema"]
  CALL R21 1 1
  GETIMPORT R22 K5 [require]
  GETTABLEKS R23 R18 K32 ["TrackUtils"]
  CALL R22 1 1
  GETIMPORT R23 K5 [require]
  GETTABLEKS R24 R18 K33 ["IKControlManager"]
  CALL R23 1 1
  GETIMPORT R24 K5 [require]
  GETTABLEKS R26 R0 K34 ["LuaFlags"]
  GETTABLEKS R25 R26 K35 ["GetFFlagSelectFromViewport"]
  CALL R24 1 1
  GETIMPORT R25 K5 [require]
  GETTABLEKS R27 R0 K34 ["LuaFlags"]
  GETTABLEKS R26 R27 K36 ["GetFFlagUseIKControls"]
  CALL R25 1 1
  GETTABLEKS R26 R1 K37 ["PureComponent"]
  LOADK R28 K38 ["DraggerWrapper"]
  ...
  CAPTURE VAL R25
  CAPTURE VAL R23
  SETTABLEKS R27 R26 K41 ["didUpdate"]
  ...
  MOVE R31 R6
  DUPTABLE R32 K54 [{"Plugin", "PluginActions", "Signals", "Mouse", "Analytics"}]
  GETTABLEKS R33 R5 K50 ["Plugin"]
  SETTABLEKS R33 R32 K50 ["Plugin"]
  GETTABLEKS R33 R5 K51 ["PluginActions"]
  SETTABLEKS R33 R32 K51 ["PluginActions"]
  SETTABLEKS R7 R32 K15 ["Signals"]
  GETTABLEKS R33 R5 K52 ["Mouse"]
  SETTABLEKS R33 R32 K52 ["Mouse"]
  GETTABLEKS R33 R5 K53 ["Analytics"]
