...
MAIN:
  ...
  GETTABLEKS R25 R0 K33 ["LuaFlags"]
  GETTABLEKS R24 R25 K34 ["GetFFlagSelectFromViewport"]
  CALL R23 1 1
  GETTABLEKS R24 R1 K35 ["PureComponent"]
  LOADK R26 K36 ["DraggerWrapper"]
  NAMECALL R24 R24 K37 ["extend"]
  CALL R24 2 1
  DUPCLOSURE R25 K38 [PROTO_0]
  CAPTURE VAL R20
  SETTABLEKS R25 R24 K39 ["didUpdate"]
  ...
  CAPTURE VAL R15
  MOVE R29 R6
  DUPTABLE R30 K50 [{"Plugin", "PluginActions", "Signals", "Mouse", "Analytics"}]
  GETTABLEKS R31 R5 K46 ["Plugin"]
  SETTABLEKS R31 R30 K46 ["Plugin"]
  GETTABLEKS R31 R5 K47 ["PluginActions"]
  SETTABLEKS R31 R30 K47 ["PluginActions"]
  SETTABLEKS R7 R30 K15 ["Signals"]
  GETTABLEKS R31 R5 K48 ["Mouse"]
  SETTABLEKS R31 R30 K48 ["Mouse"]
  GETTABLEKS R31 R5 K49 ["Analytics"]
