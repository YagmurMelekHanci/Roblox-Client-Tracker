...
PROTO_14:
  ...
  GETUPVAL R12 3
  JUMPIFNOT R12 [+4]
  NAMECALL R12 R0 K22 ["makeMenuActions"]
  CALL R12 1 1
  MOVE R11 R12
  JUMPIFNOT R2 [+20]
  GETUPVAL R13 4
  ...
  GETUPVAL R13 5
  DUPTABLE R14 K25 [{"Actions", "OnMenuOpened"}]
  GETUPVAL R16 3
  JUMPIFNOT R16 [+2]
  MOVE R15 R11
  JUMP [+3]
  NAMECALL R15 R0 K22 ["makeMenuActions"]
  CALL R15 1 1
  SETTABLEKS R15 R14 K7 ["Actions"]
  GETTABLEKS R15 R1 K24 ["OnMenuOpened"]
  SETTABLEKS R15 R14 K24 ["OnMenuOpened"]
  CALL R12 2 1
  JUMPIF R12 [+1]
  LOADNIL R12
  RETURN R12 1
...
MAIN:
  ...
  LOADK R24 K36 ["ACEEulerAnglesOrder"]
  LOADB R25 0
  NAMECALL R22 R22 K37 ["DefineFastFlag"]
  CALL R22 3 1
  NEWTABLE R23 0 6
  GETIMPORT R24 K41 [Enum.RotationOrder.XYZ]
  GETIMPORT R25 K43 [Enum.RotationOrder.XZY]
  GETIMPORT R26 K45 [Enum.RotationOrder.YXZ]
  GETIMPORT R27 K47 [Enum.RotationOrder.YZX]
  GETIMPORT R28 K49 [Enum.RotationOrder.ZXY]
  GETIMPORT R29 K51 [Enum.RotationOrder.ZYX]
  SETLIST R23 R24 6 [1]
  GETTABLEKS R24 R1 K52 ["PureComponent"]
  LOADK R26 K53 ["TrackActions"]
  NAMECALL R24 R24 K54 ["extend"]
  CALL R24 2 1
  DUPCLOSURE R25 K55 [PROTO_0]
  SETTABLEKS R25 R24 K56 ["init"]
  DUPCLOSURE R25 K57 [PROTO_2]
  CAPTURE VAL R16
  CAPTURE VAL R21
  CAPTURE VAL R17
  CAPTURE VAL R22
  SETTABLEKS R25 R24 K58 ["makeEulerAnglesOrderSubMenu"]
  DUPCLOSURE R25 K59 [PROTO_5]
  CAPTURE VAL R16
  CAPTURE VAL R17
  CAPTURE VAL R21
  CAPTURE VAL R0
  SETTABLEKS R25 R24 K60 ["makeMenuActions"]
  DUPCLOSURE R25 K61 [PROTO_6]
  SETTABLEKS R25 R24 K62 ["addAction"]
  DUPCLOSURE R25 K63 [PROTO_13]
  CAPTURE VAL R21
  CAPTURE VAL R2
  CAPTURE VAL R16
  CAPTURE VAL R19
  CAPTURE VAL R17
  SETTABLEKS R25 R24 K64 ["didMount"]
  DUPCLOSURE R25 K65 [PROTO_14]
  CAPTURE VAL R18
  CAPTURE VAL R16
  CAPTURE VAL R21
  CAPTURE VAL R22
  CAPTURE VAL R1
  CAPTURE VAL R7
  SETTABLEKS R25 R24 K66 ["render"]
  DUPCLOSURE R25 K67 [PROTO_15]
  SETTABLEKS R25 R24 K68 ["willUnmount"]
  MOVE R25 R6
  DUPTABLE R26 K72 [{"Localization", "PluginActions", "Analytics"}]
  GETTABLEKS R27 R5 K69 ["Localization"]
  SETTABLEKS R27 R26 K69 ["Localization"]
  GETTABLEKS R27 R5 K70 ["PluginActions"]
  SETTABLEKS R27 R26 K70 ["PluginActions"]
  GETTABLEKS R27 R5 K71 ["Analytics"]
  SETTABLEKS R27 R26 K71 ["Analytics"]
  CALL R25 1 1
  MOVE R26 R24
  CALL R25 1 1
  MOVE R24 R25
  DUPCLOSURE R25 K73 [PROTO_16]
  DUPCLOSURE R26 K74 [PROTO_24]
  CAPTURE VAL R8
  CAPTURE VAL R14
  CAPTURE VAL R9
  CAPTURE VAL R10
