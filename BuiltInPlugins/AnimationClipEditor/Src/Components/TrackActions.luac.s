...
MAIN:
  ...
  CAPTURE VAL R17
  CAPTURE VAL R22
  SETTABLEKS R24 R23 K44 ["makeEulerAnglesOrderSubMenu"]
  DUPCLOSURE R24 K45 [PROTO_5]
  CAPTURE VAL R16
  CAPTURE VAL R17
  CAPTURE VAL R21
  CAPTURE VAL R0
  SETTABLEKS R24 R23 K46 ["makeMenuActions"]
  DUPCLOSURE R24 K47 [PROTO_6]
  SETTABLEKS R24 R23 K48 ["addAction"]
  ...
  CAPTURE VAL R19
  CAPTURE VAL R17
  SETTABLEKS R24 R23 K50 ["didMount"]
  ...
  SETTABLEKS R24 R23 K54 ["willUnmount"]
  MOVE R24 R6
  DUPTABLE R25 K58 [{"Localization", "PluginActions", "Analytics"}]
  GETTABLEKS R26 R5 K55 ["Localization"]
  SETTABLEKS R26 R25 K55 ["Localization"]
  GETTABLEKS R26 R5 K56 ["PluginActions"]
  SETTABLEKS R26 R25 K56 ["PluginActions"]
  GETTABLEKS R26 R5 K57 ["Analytics"]
  SETTABLEKS R26 R25 K57 ["Analytics"]
  CALL R24 1 1
  MOVE R25 R23
  CALL R24 1 1
  MOVE R23 R24
  DUPCLOSURE R24 K59 [PROTO_16]
  DUPCLOSURE R25 K60 [PROTO_24]
  CAPTURE VAL R8
  CAPTURE VAL R14
  CAPTURE VAL R9
  CAPTURE VAL R10
