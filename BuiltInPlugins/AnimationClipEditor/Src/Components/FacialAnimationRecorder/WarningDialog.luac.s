...
MAIN:
  ...
  LOADK R9 K15 ["BrowserService"]
  NAMECALL R7 R7 K16 ["GetService"]
  CALL R7 2 1
  GETTABLEKS R8 R3 K17 ["Pane"]
  GETTABLEKS R9 R3 K18 ["TextLabel"]
  GETTABLEKS R11 R2 K19 ["Util"]
  GETTABLEKS R10 R11 K20 ["GetTextSize"]
  GETTABLEKS R11 R3 K21 ["StyledDialog"]
  GETTABLEKS R12 R1 K22 ["PureComponent"]
  LOADK R14 K23 ["WarningDialog"]
  ...
  CALL R15 2 0
  GETTABLEKS R16 R2 K27 ["Style"]
  GETTABLEKS R15 R16 K28 ["Colors"]
  DUPCLOSURE R16 K29 [PROTO_0]
  SETTABLEKS R16 R12 K30 ["init"]
  ...
  CAPTURE VAL R7
  CAPTURE VAL R15
  SETTABLEKS R16 R12 K32 ["render"]
  MOVE R16 R6
  DUPTABLE R17 K36 [{"Mouse", "Stylizer", "Localization"}]
  GETTABLEKS R18 R5 K33 ["Mouse"]
  SETTABLEKS R18 R17 K33 ["Mouse"]
  GETTABLEKS R18 R5 K34 ["Stylizer"]
  SETTABLEKS R18 R17 K34 ["Stylizer"]
  GETTABLEKS R18 R5 K35 ["Localization"]
