...
PROTO_7:
  ...
  CALL R6 1 1
  JUMPIFNOTEQKS R6 K8 ["table"] [+28]
  GETTABLEKS R6 R2 K9 ["ClassName"]
  JUMPIFNOTEQKS R6 K10 ["Model"] [+24]
  LOADK R8 K11 ["Humanoid"]
  NAMECALL R6 R2 K12 ["FindFirstChildOfClass"]
  CALL R6 2 1
  JUMPIF R6 [+5]
  LOADK R8 K13 ["AnimationController"]
  NAMECALL R6 R2 K12 ["FindFirstChildOfClass"]
  CALL R6 2 1
  JUMPIFNOT R6 [+13]
  GETUPVAL R7 1
  GETTABLEKS R6 R7 K14 ["buildRigHierarchy"]
  MOVE R7 R2
  CALL R6 1 1
  MOVE R4 R6
  GETUPVAL R7 1
  GETTABLEKS R6 R7 K15 ["getUnusedRigTracks"]
  MOVE R7 R2
  GETUPVAL R8 2
  CALL R6 2 1
  MOVE R5 R6
  ...
  MOVE R3 R8
  GETUPVAL R7 5
  GETTABLEKS R6 R7 K16 ["filterFacsTracks"]
  GETUPVAL R7 2
  CALL R6 1 1
  GETUPVAL R9 6
  GETTABLEKS R8 R9 K17 ["List"]
  ...
  MOVE R3 R6
  GETUPVAL R7 5
  GETTABLEKS R6 R7 K19 ["getUnusedFacs"]
  GETUPVAL R7 2
  CALL R6 1 1
  GETUPVAL R7 8
  CALL R7 0 1
...
MAIN:
  ...
  GETTABLEKS R9 R10 K17 ["GetFFlagSelectFromViewport"]
  CALL R8 1 1
