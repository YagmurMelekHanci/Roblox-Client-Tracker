...
MAIN:
  ...
  GETTABLEKS R22 R19 K31 ["CreateNewAnimation"]
  CALL R21 1 1
  GETIMPORT R22 K9 [require]
  GETTABLEKS R24 R19 K32 ["Exporting"]
  GETTABLEKS R23 R24 K33 ["LoadAnimation"]
  CALL R22 1 1
  GETIMPORT R23 K9 [require]
  GETTABLEKS R24 R19 K34 ["LoadAnimationData"]
  CALL R23 1 1
  GETIMPORT R24 K9 [require]
  GETTABLEKS R25 R19 K35 ["LoadLatestAnimation"]
  CALL R24 1 1
  GETIMPORT R25 K9 [require]
  GETTABLEKS R26 R19 K36 ["ReleaseEditor"]
  CALL R25 1 1
  GETIMPORT R26 K9 [require]
  GETTABLEKS R27 R19 K37 ["SortAndSetTracks"]
  CALL R26 1 1
  GETIMPORT R27 K9 [require]
  GETTABLEKS R28 R19 K38 ["SetSelectedTracks"]
  CALL R27 1 1
  GETTABLEKS R29 R1 K12 ["Src"]
  GETTABLEKS R28 R29 K39 ["Util"]
  GETIMPORT R29 K9 [require]
  GETTABLEKS R30 R28 K40 ["AnimationData"]
  CALL R29 1 1
  GETIMPORT R30 K9 [require]
  GETTABLEKS R31 R28 K41 ["Constants"]
  CALL R30 1 1
  GETIMPORT R31 K9 [require]
  GETTABLEKS R32 R28 K42 ["RigIK"]
  CALL R31 1 1
  GETIMPORT R32 K9 [require]
  GETTABLEKS R33 R28 K43 ["RigUtils"]
  CALL R32 1 1
  GETIMPORT R33 K9 [require]
  GETTABLEKS R35 R1 K44 ["LuaFlags"]
  GETTABLEKS R34 R35 K45 ["GetFFlagSelectFromViewport"]
  CALL R33 1 1
  GETIMPORT R34 K9 [require]
  GETTABLEKS R36 R1 K44 ["LuaFlags"]
  GETTABLEKS R35 R36 K46 ["GetFFlagCreateNewAnimation"]
  CALL R34 1 1
  GETIMPORT R35 K9 [require]
  GETTABLEKS R37 R1 K44 ["LuaFlags"]
  GETTABLEKS R36 R37 K47 ["GetFFlagRetireSkeleton"]
  CALL R35 1 1
  DUPCLOSURE R36 K48 [PROTO_1]
  CAPTURE VAL R25
  CAPTURE VAL R13
  CAPTURE VAL R17
  CAPTURE VAL R7
