PROTO_0:
  ...
  JUMPIF R6 [+35]
  GETUPVAL R7 5
  GETTABLEKS R6 R7 K15 ["rigHasErrors"]
  MOVE R7 R2
  CALL R6 1 1
  JUMPIFNOT R6 [+29]
  GETUPVAL R8 6
  ...
  GETTABLEKS R7 R3 K19 ["Instances"]
  CALL R6 1 3
  FORGPREP_NEXT R6
  GETIMPORT R11 K18 [pairs]
  GETTABLEKS R12 R10 K20 ["Tracks"]
  CALL R11 1 3
  FORGPREP_NEXT R11
  GETUPVAL R17 11
  GETTABLEKS R16 R17 K21 ["getRotationType"]
  MOVE R17 R15
  CALL R16 1 1
  GETUPVAL R18 11
  GETTABLEKS R17 R18 K22 ["getEulerAnglesOrder"]
  MOVE R18 R15
  CALL R17 1 1
  GETUPVAL R20 12
  MOVE R21 R9
  MOVE R22 R14
  GETTABLEKS R23 R15 K23 ["Type"]
  MOVE R24 R16
  MOVE R25 R17
  GETUPVAL R26 13
  CALL R20 6 -1
  ...
  FORGLOOP R6 2 [-31]
  GETUPVAL R7 14
  GETTABLEKS R6 R7 K24 ["clearMicrobones"]
  CALL R6 0 0
  JUMPIFNOT R2 [+7]
  JUMPIF R3 [+6]
  GETUPVAL R7 14
  GETTABLEKS R6 R7 K25 ["updateMicrobones"]
  MOVE R7 R2
  MOVE R8 R5
  CALL R6 2 0
  GETUPVAL R8 15
...
MAIN:
  ...
  GETTABLEKS R16 R17 K30 ["GetFFlagStudioDisambiguatePluginShortcuts"]
  CALL R15 1 1
  GETIMPORT R16 K10 [require]
  GETTABLEKS R18 R2 K29 ["LuaFlags"]
  GETTABLEKS R17 R18 K31 ["GetFFlagRigValidation"]
  CALL R16 1 1
