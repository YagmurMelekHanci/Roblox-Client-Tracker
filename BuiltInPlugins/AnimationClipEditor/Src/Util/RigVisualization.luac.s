...
PROTO_6:
  ...
  GETUPVAL R4 0
  GETTABLEKS R3 R4 K3 ["FOLDERS"]
  GETTABLEKS R2 R3 K4 ["Microbones"]
...
PROTO_9:
  ...
  GETTABLEKS R5 R6 K5 ["Microbones"]
  NAMECALL R3 R3 K6 ["FindFirstChild"]
  CALL R3 2 1
  JUMPIFNOT R3 [+78]
  NAMECALL R4 R3 K7 ["GetChildren"]
  CALL R4 1 1
  ...
  CALL R10 2 1
  LOADK R13 K11 ["Sphere"]
  NAMECALL R11 R9 K6 ["FindFirstChild"]
  CALL R11 2 1
  JUMPIFNOT R10 [+22]
  LOADK R14 K12 ["ConeHandleAdornment"]
  NAMECALL R12 R10 K13 ["IsA"]
  CALL R12 2 1
  JUMPIFNOT R12 [+17]
  GETTABLEKS R12 R10 K14 ["Color3"]
  GETUPVAL R14 0
  GETTABLEKS R13 R14 K15 ["BONE_COLOR_SELECTED"]
  JUMPIFEQ R12 R13 [+11]
  GETUPVAL R13 0
  GETTABLEKS R12 R13 K16 ["BONE_COLOR_DEFAULT"]
  SETTABLEKS R12 R10 K14 ["Color3"]
  GETUPVAL R13 0
  GETTABLEKS R12 R13 K17 ["BONE_TRANSPARENCY_DEFAULT"]
  SETTABLEKS R12 R10 K18 ["Transparency"]
  JUMPIFNOT R11 [+22]
  LOADK R14 K19 ["SphereHandleAdornment"]
  NAMECALL R12 R11 K13 ["IsA"]
  CALL R12 2 1
  JUMPIFNOT R12 [+17]
  GETTABLEKS R12 R11 K14 ["Color3"]
  GETUPVAL R14 0
  GETTABLEKS R13 R14 K15 ["BONE_COLOR_SELECTED"]
  JUMPIFEQ R12 R13 [+11]
  GETUPVAL R13 0
  ...
  GETUPVAL R13 0
  GETTABLEKS R12 R13 K17 ["BONE_TRANSPARENCY_DEFAULT"]
  SETTABLEKS R12 R11 K18 ["Transparency"]
  LOADK R14 K20 ["Part"]
  NAMECALL R12 R9 K13 ["IsA"]
  CALL R12 2 1
  JUMPIFNOT R12 [+9]
  GETUPVAL R12 1
  MOVE R13 R9
...
PROTO_11:
  ...
  GETUPVAL R7 0
  GETTABLEKS R6 R7 K6 ["FOLDERS"]
  GETTABLEKS R5 R6 K7 ["Microbones"]
  ...
  MOVE R4 R0
  CALL R3 1 1
  GETTABLEKS R4 R3 K19 ["BoneNameToBone"]
  MOVE R5 R4
  LOADNIL R6
  LOADNIL R7
  FORGPREP R5
...
PROTO_14:
  ...
  CALL R7 2 1
  LOADK R10 K12 ["Sphere"]
  NAMECALL R8 R6 K5 ["FindFirstChild"]
  CALL R8 2 1
  JUMPIFNOT R7 [+22]
  LOADK R11 K13 ["ConeHandleAdornment"]
  NAMECALL R9 R7 K14 ["IsA"]
  CALL R9 2 1
  JUMPIFNOT R9 [+17]
  GETTABLEKS R9 R7 K15 ["Color3"]
  GETUPVAL R11 0
  GETTABLEKS R10 R11 K16 ["BONE_COLOR_SELECTED"]
  JUMPIFNOTEQ R9 R10 [+11]
  GETUPVAL R10 0
  GETTABLEKS R9 R10 K17 ["BONE_COLOR_DEFAULT"]
  SETTABLEKS R9 R7 K15 ["Color3"]
  GETUPVAL R10 0
  GETTABLEKS R9 R10 K18 ["BONE_TRANSPARENCY_DEFAULT"]
  SETTABLEKS R9 R7 K19 ["Transparency"]
  JUMPIFNOT R8 [+22]
  LOADK R11 K20 ["SphereHandleAdornment"]
  NAMECALL R9 R8 K14 ["IsA"]
  CALL R9 2 1
  JUMPIFNOT R9 [+17]
  GETTABLEKS R9 R8 K15 ["Color3"]
  GETUPVAL R11 0
  GETTABLEKS R10 R11 K16 ["BONE_COLOR_SELECTED"]
  JUMPIFNOTEQ R9 R10 [+11]
  GETUPVAL R10 0
  GETTABLEKS R9 R10 K17 ["BONE_COLOR_DEFAULT"]
  SETTABLEKS R9 R8 K15 ["Color3"]
  GETUPVAL R10 0
  GETTABLEKS R9 R10 K18 ["BONE_TRANSPARENCY_DEFAULT"]
