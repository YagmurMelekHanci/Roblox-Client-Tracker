...
PROTO_8:
  ...
  GETTABLEKS R18 R19 K7 ["NameCollision"]
  NAMECALL R16 R4 K8 ["insert"]
  CALL R16 2 1
  MOVE R9 R16
  GETTABLEKS R16 R14 K5 ["Name"]
  LOADB R17 1
  SETTABLE R17 R10 R16
  GETUPVAL R16 3
  MOVE R17 R10
  CALL R16 1 1
  SETTABLEKS R16 R9 K9 ["details"]
  GETTABLEKS R16 R14 K5 ["Name"]
  LOADB R17 1
  SETTABLE R17 R7 R16
  FORGLOOP R11 2 [-29]
  ...
  GETUPVAL R20 4
  GETTABLEKS R19 R20 K6 ["RIG_ERRORS"]
  GETTABLEKS R18 R19 K10 ["BoneNameCollision"]
  NAMECALL R16 R4 K8 ["insert"]
  CALL R16 2 1
  MOVE R9 R16
  GETTABLEKS R16 R15 K5 ["Name"]
  LOADB R17 1
  SETTABLE R17 R10 R16
  GETUPVAL R16 3
  MOVE R17 R10
...
PROTO_9:
  ...
  CALL R4 0 1
  LENGTH R5 R1
  JUMPIFNOTEQKN R5 K1 [0] [+27]
  LENGTH R5 R3
  JUMPIFNOTEQKN R5 K1 [0] [+24]
  GETUPVAL R5 1
  CALL R5 0 1
  JUMPIFNOT R5 [+12]
  LENGTH R5 R2
  JUMPIFNOTEQKN R5 K1 [0] [+18]
  GETUPVAL R9 2
  ...
  GETUPVAL R9 2
  GETTABLEKS R8 R9 K2 ["RIG_ERRORS"]
  GETTABLEKS R7 R8 K5 ["NoMotors"]
  NAMECALL R5 R4 K4 ["insert"]
  CALL R5 2 0
  GETUPVAL R6 3
  GETTABLEKS R5 R6 K6 ["findRootPart"]
  MOVE R6 R0
  CALL R5 1 1
  JUMPIF R5 [+8]
  GETUPVAL R9 2
  GETTABLEKS R8 R9 K2 ["RIG_ERRORS"]
  GETTABLEKS R7 R8 K7 ["NoRoot"]
  NAMECALL R5 R4 K4 ["insert"]
  CALL R5 2 0
  RETURN R4 1
...
PROTO_14:
  ...
  GETUPVAL R12 3
  GETTABLEKS R11 R12 K23 ["RIG_ERRORS"]
  GETTABLEKS R10 R11 K25 ["MultipleParents"]
  MOVE R11 R7
...
MAIN:
  ...
  GETTABLEKS R4 R2 K10 ["keys"]
  GETIMPORT R5 K5 [require]
  GETTABLEKS R8 R0 K11 ["Src"]
  GETTABLEKS R7 R8 K12 ["Util"]
  GETTABLEKS R6 R7 K13 ["RigInfo"]
  CALL R5 1 1
  ...
  GETTABLEKS R8 R9 K15 ["ValidationResult"]
  CALL R7 1 1
  GETIMPORT R8 K5 [require]
  GETTABLEKS R10 R0 K16 ["LuaFlags"]
  GETTABLEKS R9 R10 K17 ["GetFFlagAnimationConstraints"]
  CALL R8 1 1
  GETIMPORT R9 K5 [require]
  GETTABLEKS R11 R0 K16 ["LuaFlags"]
  GETTABLEKS R10 R11 K18 ["GetFFlagRigValidation"]
  CALL R9 1 1
  NEWTABLE R10 2 0
  MOVE R11 R9
  CALL R11 0 1
  ...
  CAPTURE VAL R14
  CAPTURE VAL R16
  SETTABLEKS R17 R10 K26 ["rigHasErrors"]
  ...
  CAPTURE VAL R6
  CAPTURE VAL R5
  DUPCLOSURE R13 K29 [PROTO_11]
  CAPTURE VAL R7
  CAPTURE VAL R6
  CAPTURE VAL R8
  CAPTURE VAL R5
  DUPCLOSURE R14 K30 [PROTO_13]
  CAPTURE VAL R7
  CAPTURE VAL R5
  CAPTURE VAL R8
  CAPTURE VAL R6
  ...
  CAPTURE VAL R8
  CAPTURE VAL R5
  DUPCLOSURE R17 K33 [PROTO_17]
  CAPTURE VAL R7
  CAPTURE VAL R5
  CAPTURE VAL R6
  DUPCLOSURE R18 K34 [PROTO_18]
  CAPTURE VAL R7
  CAPTURE VAL R5
  CAPTURE VAL R6
  ...
  CAPTURE VAL R18
  CAPTURE VAL R8
  SETTABLEKS R19 R10 K36 ["validate"]
  RETURN R10 1
