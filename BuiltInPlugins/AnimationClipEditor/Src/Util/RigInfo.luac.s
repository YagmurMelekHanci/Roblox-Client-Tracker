...
MAIN:
  ...
  CALL R2 1 1
  DUPTABLE R3 K12 [{"Cache", "FaceControlsCache"}]
  DUPTABLE R4 K15 [{"CacheRig", "CacheData"}]
  LOADNIL R5
  SETTABLEKS R5 R4 K13 ["CacheRig"]
  LOADNIL R5
  SETTABLEKS R5 R4 K14 ["CacheData"]
  SETTABLEKS R4 R3 K10 ["Cache"]
  DUPTABLE R4 K15 [{"CacheRig", "CacheData"}]
  LOADNIL R5
  SETTABLEKS R5 R4 K13 ["CacheRig"]
  LOADNIL R5
  SETTABLEKS R5 R4 K14 ["CacheData"]
  SETTABLEKS R4 R3 K11 ["FaceControlsCache"]
  DUPCLOSURE R4 K16 [PROTO_0]
  CAPTURE VAL R4
  DUPCLOSURE R5 K17 [PROTO_1]
  CAPTURE VAL R2
  SETTABLEKS R5 R3 K18 ["getTemporaryConstraints"]
  DUPCLOSURE R5 K19 [PROTO_2]
  CAPTURE VAL R3
  SETTABLEKS R5 R3 K20 ["usingTemporaryConstraints"]
  DUPCLOSURE R5 K21 [PROTO_3]
  CAPTURE VAL R3
  CAPTURE VAL R4
  SETTABLEKS R5 R3 K22 ["getConstraints"]
  DUPCLOSURE R5 K23 [PROTO_5]
  CAPTURE VAL R3
  CAPTURE VAL R1
  SETTABLEKS R5 R3 K24 ["buildRigHierarchy"]
  DUPCLOSURE R5 K25 [PROTO_6]
  SETTABLEKS R5 R3 K26 ["isR15Humanoid"]
  DUPCLOSURE R5 K27 [PROTO_7]
  SETTABLEKS R5 R3 K28 ["isR6Humanoid"]
  DUPCLOSURE R5 K29 [PROTO_8]
  CAPTURE VAL R3
  CAPTURE VAL R4
  SETTABLEKS R5 R3 K30 ["findRootPart"]
  DUPCLOSURE R5 K31 [PROTO_9]
  SETTABLEKS R5 R3 K32 ["getAnimationController"]
  DUPCLOSURE R5 K33 [PROTO_10]
  CAPTURE VAL R3
  SETTABLEKS R5 R3 K34 ["getAnimator"]
  DUPCLOSURE R5 K35 [PROTO_11]
  SETTABLEKS R5 R3 K36 ["getPart0"]
  DUPCLOSURE R5 K37 [PROTO_12]
  SETTABLEKS R5 R3 K38 ["getPart1"]
  DUPCLOSURE R5 K39 [PROTO_13]
  CAPTURE VAL R4
  SETTABLEKS R5 R3 K40 ["getMotors"]
  DUPCLOSURE R5 K41 [PROTO_14]
  CAPTURE VAL R4
  SETTABLEKS R5 R3 K42 ["getBones"]
  DUPCLOSURE R5 K43 [PROTO_15]
  CAPTURE VAL R4
  SETTABLEKS R5 R3 K44 ["getAnimationConstraints"]
  DUPCLOSURE R5 K45 [PROTO_17]
  CAPTURE VAL R3
  CAPTURE VAL R2
  SETTABLEKS R5 R3 K46 ["getUnusedRigTracks"]
  DUPCLOSURE R5 K47 [PROTO_18]
  CAPTURE VAL R3
  SETTABLEKS R5 R3 K48 ["clearCache"]
  DUPCLOSURE R5 K49 [PROTO_19]
  CAPTURE VAL R3
  CAPTURE VAL R4
  SETTABLEKS R5 R3 K50 ["getRigInfo"]
  DUPCLOSURE R5 K51 [PROTO_20]
  CAPTURE VAL R3
  CAPTURE VAL R4
  SETTABLEKS R5 R3 K52 ["getFaceControls"]
  DUPCLOSURE R5 K53 [PROTO_21]
  CAPTURE VAL R3
  SETTABLEKS R5 R3 K54 ["getPartByName"]
  DUPCLOSURE R5 K55 [PROTO_22]
  CAPTURE VAL R3
  SETTABLEKS R5 R3 K56 ["getBoneByName"]
  RETURN R3 1
