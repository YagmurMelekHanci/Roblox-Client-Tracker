...
MAIN:
  ...
  DUPCLOSURE R17 K67 [PROTO_24]
  CAPTURE VAL R6
  CAPTURE VAL R13
  SETTABLEKS R17 R16 K68 ["removeExtraKeyframes"]
  DUPCLOSURE R17 K69 [PROTO_26]
  CAPTURE VAL R9
  CAPTURE VAL R6
  SETTABLEKS R17 R16 K70 ["getSelectionBounds"]
  DUPCLOSURE R17 K71 [PROTO_27]
  CAPTURE VAL R6
  CAPTURE VAL R1
  SETTABLEKS R17 R16 K72 ["getEventBounds"]
  DUPCLOSURE R17 K73 [PROTO_28]
  CAPTURE VAL R13
  CAPTURE VAL R6
  CAPTURE VAL R16
  SETTABLEKS R17 R16 K74 ["promoteToChannels"]
  DUPCLOSURE R17 K75 [PROTO_29]
  SETTABLEKS R17 R16 K76 ["isChannelAnimation"]
  DUPCLOSURE R17 K77 [PROTO_30]
  CAPTURE VAL R9
  SETTABLEKS R17 R16 K78 ["getTrack"]
  DUPCLOSURE R17 K79 [PROTO_31]
  CAPTURE VAL R6
  SETTABLEKS R17 R16 K80 ["hasFacsData"]
  DUPCLOSURE R17 K81 [PROTO_32]
  CAPTURE VAL R6
  CAPTURE VAL R8
  CAPTURE VAL R3
  CAPTURE VAL R10
  DUPCLOSURE R18 K82 [PROTO_34]
  CAPTURE VAL R13
  CAPTURE VAL R17
  CAPTURE VAL R6
  CAPTURE VAL R9
  SETTABLEKS R18 R16 K83 ["clearTrackSequences"]
  RETURN R16 1
