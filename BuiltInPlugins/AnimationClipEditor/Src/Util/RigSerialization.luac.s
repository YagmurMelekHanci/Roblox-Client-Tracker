...
PROTO_25:
  ...
  GETTABLEKS R8 R1 K29 ["Metadata"]
  GETTABLEKS R9 R0 K9 ["Name"]
  SETTABLEKS R9 R8 K9 ["Name"]
  GETTABLEKS R9 R0 K30 ["Loop"]
  SETTABLEKS R9 R8 K31 ["Looping"]
  GETTABLEKS R9 R0 K32 ["Priority"]
  SETTABLEKS R9 R8 K32 ["Priority"]
  SETTABLEKS R3 R8 K33 ["EndTick"]
  LOADB R9 1
  SETTABLEKS R9 R8 K34 ["IsChannelAnimation"]
  GETTABLEKS R9 R0 K10 ["Guid"]
  SETTABLEKS R9 R8 K10 ["Guid"]
  LOADK R11 K35 ["AnimationRigData"]
  NAMECALL R9 R0 K36 ["FindFirstChildOfClass"]
  CALL R9 2 1
  JUMPIFNOT R9 [+2]
  SETTABLEKS R9 R8 K37 ["AnimationRig"]
  MOVE R10 R1
  MOVE R11 R4
  MOVE R12 R5
  MOVE R13 R6
...
PROTO_26:
  ...
  GETGLOBAL R20 K29 ["makeVector3Curve"]
  GETTABLEKS R22 R18 K30 ["Components"]
  GETUPVAL R25 3
  ...
  JUMPIFNOT R20 [+9]
  GETUPVAL R23 3
  GETTABLEKS R22 R23 K31 ["PROPERTY_KEYS"]
  GETTABLEKS R21 R22 K32 ["Position"]
  SETTABLEKS R21 R20 K9 ["Name"]
  SETTABLEKS R19 R20 K33 ["Parent"]
  GETGLOBAL R21 K34 ["makeRotationCurve"]
  GETTABLEKS R23 R18 K30 ["Components"]
  GETUPVAL R26 3
  GETTABLEKS R25 R26 K31 ["PROPERTY_KEYS"]
  GETTABLEKS R24 R25 K35 ["Rotation"]
  GETTABLE R22 R23 R24
  CALL R21 1 1
  JUMPIFNOT R21 [+28]
  GETUPVAL R24 3
  GETTABLEKS R23 R24 K31 ["PROPERTY_KEYS"]
  GETTABLEKS R22 R23 K35 ["Rotation"]
  SETTABLEKS R22 R21 K9 ["Name"]
  SETTABLEKS R19 R21 K33 ["Parent"]
  JUMP [+18]
  GETTABLEKS R20 R18 K24 ["Type"]
  GETUPVAL R23 3
  GETTABLEKS R22 R23 K25 ["TRACK_TYPES"]
  GETTABLEKS R21 R22 K36 ["Facs"]
  JUMPIFNOTEQ R20 R21 [+10]
  GETGLOBAL R20 K37 ["makeFacsCurve"]
  MOVE R21 R18
  CALL R20 1 1
  JUMPIFNOT R20 [+4]
  ...
  SETTABLEKS R19 R20 K33 ["Parent"]
  GETUPVAL R21 4
  GETTABLEKS R20 R21 K38 ["countKeyframes"]
  MOVE R21 R18
  CALL R20 1 1
  ADD R8 R8 R20
  ADDK R9 R9 K39 [1]
  FORGLOOP R14 2 [-96]
  NEWTABLE R14 0 0
  GETTABLEKS R15 R0 K40 ["Events"]
  GETIMPORT R16 K23 [pairs]
  GETTABLEKS R17 R15 K41 ["Data"]
  CALL R16 1 3
  FORGPREP_NEXT R16
  ...
  FORGLOOP R21 2 [-8]
  FORGLOOP R16 2 [-15]
  GETTABLEKS R16 R15 K42 ["NamedKeyframes"]
  JUMPIFNOT R16 [+15]
  NEWTABLE R16 0 0
  GETIMPORT R17 K23 [pairs]
  GETTABLEKS R18 R15 K42 ["NamedKeyframes"]
  CALL R17 1 3
  FORGPREP_NEXT R17
  SETTABLE R21 R16 R20
  FORGLOOP R17 2 [-2]
  GETUPVAL R18 3
  GETTABLEKS R17 R18 K43 ["NAMED_KEYFRAMES_CHANNEL"]
  ...
  LOADK R22 K44 ["MarkerCurve"]
  CALL R21 1 1
  SETTABLEKS R19 R21 K9 ["Name"]
  SETTABLEKS R3 R21 K33 ["Parent"]
  GETIMPORT R22 K23 [pairs]
  MOVE R23 R20
  CALL R22 1 3
  FORGPREP_NEXT R22
  GETUPVAL R29 3
  GETTABLEKS R28 R29 K45 ["TICK_FREQUENCY"]
  DIV R27 R25 R28
  MOVE R30 R27
  MOVE R31 R26
  NAMECALL R28 R21 K46 ["InsertMarkerAtTime"]
  CALL R28 3 0
  ADDK R10 R10 K39 [1]
  FORGLOOP R22 2 [-11]
  FORGLOOP R16 2 [-26]
...
MAIN:
  ...
  CAPTURE VAL R5
  DUPCLOSURE R19 K26 [PROTO_9]
  DUPCLOSURE R20 K27 [PROTO_10]
  CAPTURE VAL R5
  SETGLOBAL R20 K28 ["fillFloatCurve"]
  DUPCLOSURE R20 K29 [PROTO_11]
  CAPTURE VAL R5
  SETGLOBAL R20 K30 ["fillQuaternionCurve"]
  DUPCLOSURE R20 K31 [PROTO_12]
  CAPTURE VAL R5
  SETGLOBAL R20 K32 ["makeVector3Curve"]
  DUPCLOSURE R20 K33 [PROTO_13]
  SETGLOBAL R20 K34 ["makeQuaternionCurve"]
  DUPCLOSURE R20 K35 [PROTO_14]
  CAPTURE VAL R5
  SETGLOBAL R20 K36 ["makeEulerCurve"]
  DUPCLOSURE R20 K37 [PROTO_15]
  CAPTURE VAL R5
  SETGLOBAL R20 K38 ["makeRotationCurve"]
  DUPCLOSURE R20 K39 [PROTO_16]
  SETGLOBAL R20 K40 ["makeFacsCurve"]
  ...
  CAPTURE VAL R4
  CAPTURE VAL R8
  SETGLOBAL R21 K43 ["readCurve"]
  DUPCLOSURE R21 K44 [PROTO_19]
  CAPTURE VAL R4
  CAPTURE VAL R5
  SETGLOBAL R21 K45 ["readFacsCurves"]
  DUPCLOSURE R21 K46 [PROTO_22]
  CAPTURE VAL R12
  CAPTURE VAL R4
  CAPTURE VAL R6
  CAPTURE VAL R5
  CAPTURE VAL R13
  CAPTURE VAL R14
  SETTABLEKS R21 R11 K47 ["fromKeyframeSequence"]
  DUPCLOSURE R21 K48 [PROTO_23]
  CAPTURE VAL R7
  CAPTURE VAL R16
  CAPTURE VAL R5
  CAPTURE VAL R18
  CAPTURE VAL R20
  SETTABLEKS R21 R11 K49 ["toKeyframeSequence"]
  DUPCLOSURE R21 K50 [PROTO_25]
  CAPTURE VAL R4
  CAPTURE VAL R15
  CAPTURE VAL R5
  CAPTURE VAL R9
  CAPTURE VAL R6
  SETTABLEKS R21 R11 K51 ["fromCurveAnimation"]
  DUPCLOSURE R21 K52 [PROTO_26]
  CAPTURE VAL R7
  CAPTURE VAL R16
  CAPTURE VAL R19
  CAPTURE VAL R5
  CAPTURE VAL R9
  CAPTURE VAL R20
  SETTABLEKS R21 R11 K53 ["toCurveAnimation"]
  DUPCLOSURE R21 K54 [PROTO_27]
  CAPTURE VAL R4
  CAPTURE VAL R11
  SETTABLEKS R21 R11 K55 ["toAnimationAsset"]
  RETURN R11 1
