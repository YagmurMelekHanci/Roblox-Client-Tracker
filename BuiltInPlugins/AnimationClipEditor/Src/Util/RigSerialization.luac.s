...
PROTO_23:
  ...
  CALL R14 0 1
  JUMPIF R14 [+17]
  GETTABLEKS R16 R13 K23 ["Type"]
  GETUPVAL R19 2
  GETTABLEKS R18 R19 K24 ["INSTANCE_TYPES"]
  GETTABLEKS R17 R18 K25 ["Rig"]
  JUMPIFEQ R16 R17 [+2]
  LOADB R15 0 +1
  LOADB R15 1
  FASTCALL2K ASSERT R15 K26 [+4]
  LOADK R16 K26 ["Can only export Rig animations to KeyframeSequence."]
  GETIMPORT R14 K2 [assert]
  CALL R14 2 0
  GETTABLEKS R14 R13 K27 ["Tracks"]
  GETUPVAL R15 3
  MOVE R16 R14
  MOVE R17 R9
  MOVE R18 R11
  MOVE R19 R10
  CALL R15 4 1
  GETIMPORT R16 K29 [pairs]
  MOVE R17 R14
  CALL R16 1 3
  FORGPREP_NEXT R16
  GETIMPORT R21 K29 [pairs]
  GETTABLEKS R22 R20 K30 ["Keyframes"]
  CALL R21 1 3
  FORGPREP_NEXT R21
  GETUPVAL R28 2
  GETTABLEKS R27 R28 K31 ["TICK_FREQUENCY"]
  DIV R26 R25 R27
  GETTABLE R27 R12 R25
  JUMPIF R27 [+10]
  GETIMPORT R28 K9 [Instance.new]
  LOADK R29 K32 ["Keyframe"]
  CALL R28 1 1
  SETTABLEKS R26 R28 K33 ["Time"]
  SETTABLEKS R5 R28 K34 ["Parent"]
  MOVE R27 R28
  SETTABLE R27 R12 R25
  GETTABLEKS R28 R20 K23 ["Type"]
  GETTABLEKS R30 R20 K35 ["Data"]
  ...
  FORGLOOP R21 2 [-35]
  FORGLOOP R16 2 [-43]
  GETIMPORT R16 K38 [ipairs]
  GETTABLEKS R17 R3 K30 ["Keyframes"]
  CALL R16 1 3
  FORGPREP_INEXT R16
  GETTABLEKS R22 R3 K35 ["Data"]
  GETTABLE R21 R22 R20
  GETIMPORT R22 K29 [pairs]
  MOVE R23 R21
  CALL R22 1 3
  FORGPREP_NEXT R22
  GETUPVAL R29 2
  GETTABLEKS R28 R29 K31 ["TICK_FREQUENCY"]
  DIV R27 R20 R28
  GETTABLE R28 R12 R20
  JUMPIF R28 [+10]
  GETIMPORT R29 K9 [Instance.new]
  LOADK R30 K32 ["Keyframe"]
  CALL R29 1 1
  SETTABLEKS R27 R29 K33 ["Time"]
  SETTABLEKS R5 R29 K34 ["Parent"]
  MOVE R28 R29
  SETTABLE R28 R12 R20
  GETIMPORT R29 K9 [Instance.new]
  LOADK R30 K39 ["KeyframeMarker"]
  MOVE R31 R28
  CALL R29 2 1
  SETTABLEKS R25 R29 K11 ["Name"]
  SETTABLEKS R26 R29 K40 ["Value"]
  ADDK R7 R7 K36 [1]
  FORGLOOP R22 2 [-27]
  ...
  MOVE R19 R5
  CALL R16 3 0
  NAMECALL R16 R5 K41 ["GetKeyframes"]
  CALL R16 1 1
  MOVE R17 R5
  LENGTH R18 R16
  MOVE R19 R6
...
PROTO_25:
  ...
  GETTABLEKS R2 R0 K9 ["Name"]
  GETUPVAL R5 2
  GETTABLEKS R4 R5 K11 ["INSTANCE_TYPES"]
  GETTABLEKS R3 R4 K12 ["Rig"]
  GETTABLEKS R4 R0 K10 ["Guid"]
  CALL R1 3 1
...
MAIN:
  ...
  GETTABLEKS R11 R12 K19 ["GetFFlagRetireSkeleton"]
  CALL R10 1 1
  ...
  CAPTURE VAL R4
  CAPTURE VAL R8
  SETGLOBAL R22 K45 ["readCurve"]
  DUPCLOSURE R22 K46 [PROTO_19]
  CAPTURE VAL R4
  CAPTURE VAL R5
  SETGLOBAL R22 K47 ["readFacsCurves"]
  ...
  CAPTURE VAL R14
  CAPTURE VAL R15
  SETTABLEKS R22 R12 K49 ["fromKeyframeSequence"]
  DUPCLOSURE R22 K50 [PROTO_23]
  CAPTURE VAL R7
  CAPTURE VAL R10
  CAPTURE VAL R5
  CAPTURE VAL R17
  CAPTURE VAL R19
  CAPTURE VAL R21
  SETTABLEKS R22 R12 K51 ["toKeyframeSequence"]
  DUPCLOSURE R22 K52 [PROTO_25]
  CAPTURE VAL R10
  CAPTURE VAL R4
  CAPTURE VAL R5
  CAPTURE VAL R16
  CAPTURE VAL R9
  CAPTURE VAL R6
  SETTABLEKS R22 R12 K53 ["fromCurveAnimation"]
  DUPCLOSURE R22 K54 [PROTO_26]
  CAPTURE VAL R7
  CAPTURE VAL R10
  CAPTURE VAL R5
  CAPTURE VAL R17
  ...
  CAPTURE VAL R9
  CAPTURE VAL R21
  SETTABLEKS R22 R12 K55 ["toCurveAnimation"]
  DUPCLOSURE R22 K56 [PROTO_27]
  CAPTURE VAL R4
  CAPTURE VAL R12
  SETTABLEKS R22 R12 K57 ["toAnimationAsset"]
  RETURN R12 1
