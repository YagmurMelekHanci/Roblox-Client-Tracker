...
MAIN:
  ...
  GETTABLEKS R5 R0 K11 ["LuaFlags"]
  GETTABLEKS R4 R5 K12 ["GetFFlagFixDynamicTrackSelection"]
  CALL R3 1 1
  NEWTABLE R4 8 0
  DUPCLOSURE R5 K13 [PROTO_0]
  SETTABLEKS R5 R4 K14 ["getRelativePath"]
  MOVE R5 R3
  CALL R5 0 1
  JUMPIF R5 [+4]
  DUPCLOSURE R5 K15 [PROTO_1]
  CAPTURE VAL R2
  SETTABLEKS R5 R4 K16 ["getPathValue"]
  DUPCLOSURE R5 K17 [PROTO_2]
  SETTABLEKS R5 R4 K18 ["equals"]
  DUPCLOSURE R5 K19 [PROTO_3]
  CAPTURE VAL R4
  SETTABLEKS R5 R4 K20 ["findPath"]
  DUPCLOSURE R5 K21 [PROTO_4]
  CAPTURE VAL R4
  CAPTURE VAL R1
  SETTABLEKS R5 R4 K22 ["removePath"]
  DUPCLOSURE R5 K23 [PROTO_5]
  SETTABLEKS R5 R4 K24 ["toString"]
  RETURN R4 1
