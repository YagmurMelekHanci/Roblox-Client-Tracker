...
MAIN:
  ...
  GETTABLEKS R14 R4 K20 ["DEPRECATED_UpdateQueueItem"]
  CALL R13 1 1
  ...
  CALL R16 1 1
  DUPTABLE R17 K34 [{"activeSessionCount", "parsing", "progress", "progressGoal", "searchTerm", "sessionCount", "sessionQueue"}]
  LOADN R18 0
  ...
  GETTABLEKS R18 R1 K36 ["createReducer"]
  MOVE R19 R17
  NEWTABLE R20 16 0
  GETTABLEKS R21 R8 K37 ["name"]
  DUPCLOSURE R22 K38 [PROTO_0]
  CAPTURE VAL R17
  SETTABLE R22 R20 R21
  GETTABLEKS R21 R5 K37 ["name"]
  DUPCLOSURE R22 K39 [PROTO_1]
  CAPTURE VAL R3
  CAPTURE VAL R15
  SETTABLE R22 R20 R21
  GETTABLEKS R21 R13 K37 ["name"]
  MOVE R23 R16
  CALL R23 0 1
  JUMPIFNOT R23 [+2]
  LOADNIL R22
  ...
  CAPTURE VAL R3
  SETTABLE R22 R20 R21
  GETTABLEKS R21 R7 K37 ["name"]
  DUPCLOSURE R22 K41 [PROTO_3]
  CAPTURE VAL R15
  SETTABLE R22 R20 R21
  GETTABLEKS R21 R6 K37 ["name"]
  DUPCLOSURE R22 K42 [PROTO_4]
  SETTABLE R22 R20 R21
  GETTABLEKS R21 R9 K37 ["name"]
  DUPCLOSURE R22 K43 [PROTO_5]
  CAPTURE VAL R3
  SETTABLE R22 R20 R21
  GETTABLEKS R21 R10 K37 ["name"]
  DUPCLOSURE R22 K44 [PROTO_6]
  CAPTURE VAL R3
  SETTABLE R22 R20 R21
  GETTABLEKS R21 R11 K37 ["name"]
  DUPCLOSURE R22 K45 [PROTO_7]
  CAPTURE VAL R3
  SETTABLE R22 R20 R21
  GETTABLEKS R21 R12 K37 ["name"]
