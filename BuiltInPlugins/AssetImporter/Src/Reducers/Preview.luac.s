...
MAIN:
  ...
  GETTABLEKS R16 R6 K23 ["SetPreviewInstance"]
  CALL R15 1 1
  GETIMPORT R16 K5 [require]
  GETTABLEKS R17 R6 K24 ["SetSelectedImportItem"]
  CALL R16 1 1
  GETIMPORT R17 K5 [require]
  GETTABLEKS R18 R6 K25 ["SetTreeChecked"]
  CALL R17 1 1
  GETIMPORT R18 K5 [require]
  GETTABLEKS R19 R6 K26 ["SetTreeExpansion"]
  CALL R18 1 1
  DUPTABLE R19 K39 [{"activeQueueItem", "assetImportSession", "errorNodeChecked", "filename", "hasInvalidPackageId", "importDataChecked", "importDataCheckedCount", "importDataExpansion", "importTree", "managedGroups", "previewInstance", "selectedImportItem"}]
  GETTABLEKS R20 R5 K40 ["new"]
  CALL R20 0 1
  SETTABLEKS R20 R19 K27 ["activeQueueItem"]
  LOADNIL R20
  SETTABLEKS R20 R19 K28 ["assetImportSession"]
  LOADB R20 0
  SETTABLEKS R20 R19 K29 ["errorNodeChecked"]
  LOADK R20 K41 [""]
  SETTABLEKS R20 R19 K30 ["filename"]
  LOADB R20 0
  SETTABLEKS R20 R19 K31 ["hasInvalidPackageId"]
  NEWTABLE R20 0 0
  SETTABLEKS R20 R19 K32 ["importDataChecked"]
  LOADN R20 255
  SETTABLEKS R20 R19 K33 ["importDataCheckedCount"]
  NEWTABLE R20 0 0
  SETTABLEKS R20 R19 K34 ["importDataExpansion"]
  LOADNIL R20
  SETTABLEKS R20 R19 K35 ["importTree"]
  NEWTABLE R20 0 0
  SETTABLEKS R20 R19 K36 ["managedGroups"]
  LOADNIL R20
  SETTABLEKS R20 R19 K37 ["previewInstance"]
  LOADNIL R20
  SETTABLEKS R20 R19 K38 ["selectedImportItem"]
  GETTABLEKS R20 R1 K42 ["createReducer"]
  MOVE R21 R19
  NEWTABLE R22 16 0
  GETTABLEKS R23 R8 K43 ["name"]
  DUPCLOSURE R24 K44 [PROTO_0]
  CAPTURE VAL R3
  SETTABLE R24 R22 R23
  GETTABLEKS R23 R9 K43 ["name"]
  DUPCLOSURE R24 K45 [PROTO_1]
  CAPTURE VAL R3
  SETTABLE R24 R22 R23
  GETTABLEKS R23 R14 K43 ["name"]
  DUPCLOSURE R24 K46 [PROTO_2]
  CAPTURE VAL R3
  SETTABLE R24 R22 R23
  GETTABLEKS R23 R12 K43 ["name"]
  DUPCLOSURE R24 K47 [PROTO_3]
  CAPTURE VAL R3
  SETTABLE R24 R22 R23
  GETTABLEKS R23 R13 K43 ["name"]
  DUPCLOSURE R24 K48 [PROTO_4]
  CAPTURE VAL R3
  SETTABLE R24 R22 R23
  GETTABLEKS R23 R15 K43 ["name"]
  DUPCLOSURE R24 K49 [PROTO_5]
  CAPTURE VAL R3
  SETTABLE R24 R22 R23
  GETTABLEKS R23 R16 K43 ["name"]
  DUPCLOSURE R24 K50 [PROTO_6]
  CAPTURE VAL R3
  SETTABLE R24 R22 R23
  GETTABLEKS R23 R17 K43 ["name"]
  DUPCLOSURE R24 K51 [PROTO_7]
  CAPTURE VAL R3
  SETTABLE R24 R22 R23
  GETTABLEKS R23 R10 K43 ["name"]
  DUPCLOSURE R24 K52 [PROTO_8]
  CAPTURE VAL R3
  SETTABLE R24 R22 R23
  GETTABLEKS R23 R18 K43 ["name"]
  DUPCLOSURE R24 K53 [PROTO_9]
  CAPTURE VAL R3
  SETTABLE R24 R22 R23
  GETTABLEKS R23 R11 K43 ["name"]
  DUPCLOSURE R24 K54 [PROTO_10]
  CAPTURE VAL R3
  SETTABLE R24 R22 R23
  GETTABLEKS R23 R7 K43 ["name"]
  DUPCLOSURE R24 K55 [PROTO_11]
  CAPTURE VAL R19
  SETTABLE R24 R22 R23
  CALL R20 2 -1
  RETURN R20 -1
