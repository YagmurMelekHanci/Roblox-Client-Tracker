...
MAIN:
  ...
  GETTABLEKS R19 R20 K27 ["getFFlagImportQueuePerSessionState"]
  CALL R18 1 1
  GETIMPORT R19 K5 [require]
  GETTABLEKS R21 R0 K10 ["Src"]
  GETTABLEKS R20 R21 K23 ["Types"]
  CALL R19 1 1
  DUPTABLE R20 K37 [{"managedGroups", "showError", "showParsingWidget", "showPreview", "showProgress", "showQueue", "showUploadWidget", "uploading", "uploadWidgetItem"}]
  NEWTABLE R21 0 0
  SETTABLEKS R21 R20 K28 ["managedGroups"]
  LOADB R21 0
  SETTABLEKS R21 R20 K29 ["showError"]
  LOADB R21 0
  SETTABLEKS R21 R20 K30 ["showParsingWidget"]
  LOADB R21 0
  SETTABLEKS R21 R20 K31 ["showPreview"]
  LOADB R21 0
  SETTABLEKS R21 R20 K32 ["showProgress"]
  LOADB R21 0
  SETTABLEKS R21 R20 K33 ["showQueue"]
  LOADB R21 0
  SETTABLEKS R21 R20 K34 ["showUploadWidget"]
  LOADB R21 0
  SETTABLEKS R21 R20 K35 ["uploading"]
  NEWTABLE R21 0 0
  SETTABLEKS R21 R20 K36 ["uploadWidgetItem"]
  GETTABLEKS R21 R1 K38 ["createReducer"]
  MOVE R22 R20
  NEWTABLE R23 16 0
  GETTABLEKS R24 R5 K39 ["name"]
  DUPCLOSURE R25 K40 [PROTO_0]
  CAPTURE VAL R20
  SETTABLE R25 R23 R24
  GETTABLEKS R24 R6 K39 ["name"]
  DUPCLOSURE R25 K41 [PROTO_1]
  CAPTURE VAL R3
  SETTABLE R25 R23 R24
  GETTABLEKS R24 R7 K39 ["name"]
  DUPCLOSURE R25 K42 [PROTO_2]
  CAPTURE VAL R3
  SETTABLE R25 R23 R24
  GETTABLEKS R24 R8 K39 ["name"]
  DUPCLOSURE R25 K43 [PROTO_3]
  CAPTURE VAL R3
  SETTABLE R25 R23 R24
  GETTABLEKS R24 R9 K39 ["name"]
  DUPCLOSURE R25 K44 [PROTO_4]
  CAPTURE VAL R3
  SETTABLE R25 R23 R24
  GETTABLEKS R24 R10 K39 ["name"]
  DUPCLOSURE R25 K45 [PROTO_5]
  CAPTURE VAL R3
  SETTABLE R25 R23 R24
  GETTABLEKS R24 R12 K39 ["name"]
  DUPCLOSURE R25 K46 [PROTO_6]
  CAPTURE VAL R3
  SETTABLE R25 R23 R24
  GETTABLEKS R24 R11 K39 ["name"]
  MOVE R26 R17
  CALL R26 0 1
  JUMPIFNOT R26 [+3]
  ...
  LOADNIL R25
  SETTABLE R25 R23 R24
  GETTABLEKS R24 R13 K39 ["name"]
  DUPCLOSURE R25 K48 [PROTO_8]
  CAPTURE VAL R3
  SETTABLE R25 R23 R24
  GETTABLEKS R24 R14 K39 ["name"]
  MOVE R26 R18
  CALL R26 0 1
  JUMPIFNOT R26 [+2]
  LOADNIL R25
  JUMP [+2]
  DUPCLOSURE R25 K49 [PROTO_9]
  CAPTURE VAL R3
  SETTABLE R25 R23 R24
  GETTABLEKS R24 R15 K39 ["name"]
  DUPCLOSURE R25 K50 [PROTO_10]
  CAPTURE VAL R3
  SETTABLE R25 R23 R24
  CALL R21 2 -1
  RETURN R21 -1
