...
PROTO_2:
  ...
  JUMP [+5]
  GETTABLEKS R4 R0 K4 ["AssetIds"]
  GETTABLEKS R5 R1 K5 ["Id"]
  GETTABLE R3 R4 R5
  SETTABLEKS R3 R2 K8 ["SourceAssetId"]
  GETTABLEKS R3 R1 K2 ["AddModelToInventory"]
  JUMPIFNOT R3 [+48]
  GETTABLEKS R3 R1 K3 ["ShouldImport"]
  JUMPIFNOT R3 [+45]
  GETTABLEKS R3 R1 K9 ["ImportAsPackage"]
  JUMPIFNOT R3 [+42]
  ...
  GETUPVAL R6 2
  GETTABLEKS R5 R6 K14 ["LoadPackageAssetAsync"]
  GETUPVAL R6 2
  MOVE R7 R3
  CALL R4 3 2
  JUMPIF R4 [+5]
  GETIMPORT R6 K16 [error]
  LOADK R7 K17 ["Error trying to insert asset from import"]
  CALL R6 1 0
  RETURN R0 0
  GETTABLEN R2 R5 1
  ...
  GETUPVAL R3 2
  MOVE R5 R2
  NAMECALL R3 R3 K18 ["Insert"]
  CALL R3 2 0
  GETTABLEKS R3 R1 K19 ["InsertWithScenePosition"]
  JUMPIF R3 [+19]
  GETUPVAL R3 3
  CALL R3 0 1
  LOADK R6 K20 ["Model"]
  NAMECALL R4 R2 K21 ["IsA"]
  CALL R4 2 1
  JUMPIFNOT R4 [+5]
  MOVE R6 R3
  NAMECALL R4 R2 K22 ["MoveTo"]
  CALL R4 2 0
  JUMP [+7]
  LOADK R6 K23 ["MeshPart"]
  NAMECALL R4 R2 K21 ["IsA"]
  CALL R4 2 1
  JUMPIFNOT R4 [+2]
  SETTABLEKS R3 R2 K24 ["Position"]
  GETUPVAL R3 4
  ...
  MOVE R6 R2
  SETLIST R5 R6 1 [1]
  NAMECALL R3 R3 K27 ["Set"]
  CALL R3 2 0
  GETUPVAL R3 7
  GETIMPORT R6 K29 [game]
  GETTABLEKS R5 R6 K30 ["Workspace"]
  GETTABLEKS R4 R5 K31 ["CurrentCamera"]
  MOVE R5 R2
  CALL R3 2 0
  RETURN R0 0
...
MAIN:
  ...
  GETTABLEKS R8 R9 K18 ["getFFlagAssetImportEnableImportQueueModal"]
  CALL R7 1 1
  GETIMPORT R8 K11 [require]
  GETTABLEKS R11 R0 K12 ["Src"]
  GETTABLEKS R10 R11 K15 ["Flags"]
  GETTABLEKS R9 R10 K19 ["getFFlagAssetImportSetSourceAssetId"]
  CALL R8 1 1
