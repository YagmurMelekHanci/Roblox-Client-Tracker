PROTO_0:
  ...
  JUMPIFNOT R8 [+27]
  JUMPIF R7 [+26]
  NAMECALL R11 R0 K11 ["getState"]
  CALL R11 1 1
  GETTABLEKS R10 R11 K12 ["Sessions"]
  GETTABLEKS R9 R10 K13 ["sessionQueue"]
  GETTABLE R8 R9 R6
  GETUPVAL R11 14
  MOVE R12 R8
  DUPTABLE R13 K16 [{"state", "enabled"}]
  GETUPVAL R16 15
  GETTABLEKS R15 R16 K17 ["SessionState"]
  GETTABLEKS R14 R15 K18 ["Invalid"]
  SETTABLEKS R14 R13 K14 ["state"]
  LOADB R14 0
  SETTABLEKS R14 R13 K15 ["enabled"]
  CALL R11 2 -1
  ...
  GETUPVAL R11 14
  MOVE R12 R8
  DUPTABLE R13 K20 [{"session"}]
  SETTABLEKS R7 R13 K19 ["session"]
  CALL R11 2 -1
  NAMECALL R9 R0 K0 ["dispatch"]
  CALL R9 -1 0
  JUMP [+7]
...
MAIN:
  ...
  GETTABLEKS R15 R16 K24 ["getFFlagAssetImportEnableImportQueueModal"]
  CALL R14 1 1
  GETIMPORT R15 K11 [require]
  GETTABLEKS R18 R1 K8 ["Src"]
  GETTABLEKS R17 R18 K23 ["Flags"]
  GETTABLEKS R16 R17 K25 ["getFFlagAssetImportStartSessionAsync"]
  CALL R15 1 1
  GETIMPORT R16 K11 [require]
  GETTABLEKS R19 R1 K8 ["Src"]
  GETTABLEKS R18 R19 K23 ["Flags"]
  GETTABLEKS R17 R18 K26 ["getFFlagImportQueueSessionThunksRefactor"]
  CALL R16 1 1
  GETIMPORT R17 K11 [require]
  GETTABLEKS R20 R1 K8 ["Src"]
  GETTABLEKS R19 R20 K23 ["Flags"]
  GETTABLEKS R18 R19 K27 ["getFFlagAssetImportQDialogFileTypeFilter"]
  CALL R17 1 1
