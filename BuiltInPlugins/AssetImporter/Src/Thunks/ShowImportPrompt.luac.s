PROTO_0:
  ...
  JUMP [+4]
  GETUPVAL R1 3
  NAMECALL R1 R1 K2 ["PickMeshFileWithPrompt"]
  CALL R1 1 1
  LENGTH R2 R1
  ...
  GETUPVAL R8 3
  MOVE R10 R6
  NAMECALL R8 R8 K4 ["StartSessionWithPathAsync"]
  CALL R8 2 1
  MOVE R7 R8
  JUMP [+6]
  GETUPVAL R8 3
  MOVE R10 R6
  NAMECALL R8 R8 K5 ["StartSessionWithPath"]
  CALL R8 2 1
  MOVE R7 R8
  GETUPVAL R10 9
  MOVE R11 R6
  ...
  GETUPVAL R4 3
  MOVE R6 R3
  NAMECALL R4 R4 K4 ["StartSessionWithPathAsync"]
  CALL R4 2 1
  MOVE R1 R4
  GETUPVAL R6 11
  LOADB R7 0
...
MAIN:
  ...
  GETTABLEKS R19 R20 K28 ["getFFlagAssetImportQueuedSessionRefactor"]
  CALL R18 1 1
  ...
  GETTABLEKS R21 R22 K30 ["getFFlagAssetImportStartSessionAsync"]
  CALL R20 1 1
  GETIMPORT R21 K11 [require]
  GETTABLEKS R24 R1 K8 ["Src"]
  GETTABLEKS R23 R24 K27 ["Flags"]
  GETTABLEKS R22 R23 K31 ["getFFlagAssetImportParseDialog"]
  CALL R21 1 1
