PROTO_0:
  ...
  NAMECALL R8 R0 K14 ["getState"]
  CALL R8 1 1
  GETTABLEKS R7 R8 K19 ["Dialogs"]
  GETTABLEKS R6 R7 K20 ["showPreview"]
  JUMPIFNOT R6 [+6]
  GETUPVAL R8 10
  MOVE R9 R4
  CALL R8 1 -1
  ...
  CALL R8 1 1
  GETTABLEKS R7 R8 K19 ["Dialogs"]
  GETTABLEKS R6 R7 K21 ["showUploadWidget"]
  JUMPIFNOT R6 [+6]
  GETUPVAL R8 11
  MOVE R9 R4
  CALL R8 1 -1
...
MAIN:
  ...
  GETTABLEKS R12 R13 K22 ["getFFlagImportQueueFixGroupFetch"]
  CALL R11 1 1
  GETIMPORT R12 K7 [require]
  GETTABLEKS R15 R0 K4 ["Src"]
  GETTABLEKS R14 R15 K21 ["Flags"]
  GETTABLEKS R13 R14 K23 ["getFFlagImportQueueFixFileMiscount"]
  CALL R12 1 1
