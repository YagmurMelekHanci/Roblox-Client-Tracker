...
PROTO_14:
  ...
  GETTABLEKS R7 R8 K11 ["showQueue"]
  JUMPIFNOT R7 [+11]
  MOVE R9 R4
...
MAIN:
  ...
  GETTABLEKS R13 R14 K23 ["QueuedSession"]
  CALL R12 1 1
  GETTABLEKS R14 R1 K14 ["Src"]
  GETTABLEKS R13 R14 K24 ["Thunks"]
  GETIMPORT R14 K9 [require]
  GETTABLEKS R15 R13 K25 ["ShowImportPreview"]
  CALL R14 1 1
  GETIMPORT R15 K9 [require]
  GETTABLEKS R16 R13 K26 ["PickTextureFileWithPrompt"]
  CALL R15 1 1
  GETIMPORT R16 K9 [require]
  GETTABLEKS R19 R1 K14 ["Src"]
  GETTABLEKS R18 R19 K27 ["Flags"]
  GETTABLEKS R17 R18 K28 ["getFFlagAssetImportEnableImportQueueModal"]
  CALL R16 1 1
  GETIMPORT R17 K9 [require]
  GETTABLEKS R20 R1 K14 ["Src"]
  GETTABLEKS R19 R20 K27 ["Flags"]
  GETTABLEKS R18 R19 K29 ["getFFlagImportQueueFixRibbonToggle"]
  CALL R17 1 1
  LOADK R20 K30 ["FileController"]
  NAMECALL R18 R4 K31 ["extend"]
  CALL R18 2 1
  ...
  CAPTURE VAL R6
  SETTABLEKS R19 R18 K37 ["DEPRECATED_cleanupPreview"]
  DUPCLOSURE R19 K38 [PROTO_9]
  CAPTURE VAL R8
  CAPTURE VAL R10
  SETTABLEKS R19 R18 K39 ["DEPRECATED_onSessionCanceled"]
  ...
  CAPTURE VAL R8
  CAPTURE VAL R7
  SETTABLEKS R19 R18 K43 ["onPluginButtonClicked"]
  DUPCLOSURE R19 K44 [PROTO_13]
  SETTABLEKS R19 R18 K45 ["requestFilePicker"]
  DUPCLOSURE R19 K46 [PROTO_14]
  CAPTURE VAL R16
  CAPTURE VAL R17
  SETTABLEKS R19 R18 K47 ["_onFilePicked"]
  DUPCLOSURE R19 K48 [PROTO_16]
  SETTABLEKS R19 R18 K49 ["requestFileSwap"]
  DUPCLOSURE R19 K50 [PROTO_17]
  CAPTURE VAL R14
  SETTABLEKS R19 R18 K51 ["_onFileSwapped"]
  DUPCLOSURE R19 K52 [PROTO_18]
  CAPTURE VAL R0
  CAPTURE VAL R15
  SETTABLEKS R19 R18 K53 ["pickTextureFileWithPrompt"]
  DUPCLOSURE R19 K54 [PROTO_20]
  CAPTURE VAL R14
  SETTABLEKS R19 R18 K55 ["requestPreview"]
  RETURN R18 1
