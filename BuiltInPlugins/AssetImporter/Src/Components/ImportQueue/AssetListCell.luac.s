...
PROTO_7:
  ...
  LOADK R3 K3 ["ImportQueuePerSessionStateBugfix"]
  NAMECALL R1 R1 K4 ["GetFastFlag"]
  CALL R1 2 1
  JUMPIFNOT R1 [+8]
  GETTABLEKS R2 R0 K5 ["CellProps"]
  GETTABLEKS R1 R2 K6 ["ShowUploadWidget"]
  GETTABLEKS R2 R0 K7 ["Row"]
  CALL R1 1 0
  RETURN R0 0
  GETTABLEKS R2 R0 K7 ["Row"]
  GETTABLEKS R1 R2 K8 ["state"]
  GETUPVAL R4 1
  GETTABLEKS R3 R4 K9 ["SessionState"]
  GETTABLEKS R2 R3 K10 ["Imported"]
  JUMPIFNOTEQ R1 R2 [+8]
  GETTABLEKS R2 R0 K5 ["CellProps"]
  GETTABLEKS R1 R2 K6 ["ShowUploadWidget"]
  GETTABLEKS R2 R0 K7 ["Row"]
...
PROTO_22:
  ...
  GETUPVAL R13 1
  GETTABLEKS R12 R13 K11 ["SessionState"]
  GETTABLEKS R11 R12 K14 ["Imported"]
  JUMPIFNOTEQ R10 R11 [+38]
  GETTABLEKS R11 R2 K2 ["uploadResults"]
  GETTABLEKS R10 R11 K15 ["Succeeded"]
  JUMPIFNOT R10 [+2]
  MOVE R8 R4
  JUMP [+1]
  MOVE R8 R5
  ...
  GETTABLEKS R10 R11 K16 ["createElement"]
  GETUPVAL R11 3
  DUPTABLE R12 K22 [{"IconSize", "LeftIcon", "OnClick", "Style", "Size", "LayoutOrder"}]
  SETTABLEKS R6 R12 K17 ["IconSize"]
  SETTABLEKS R8 R12 K18 ["LeftIcon"]
  GETTABLEKS R13 R0 K23 ["onStatusClicked"]
  SETTABLEKS R13 R12 K19 ["OnClick"]
  ...
  MOVE R8 R5
  GETUPVAL R11 2
  GETTABLEKS R10 R11 K28 ["createFragment"]
  DUPTABLE R11 K31 [{"Layout", "Alert"}]
  GETUPVAL R13 2
  GETTABLEKS R12 R13 K16 ["createElement"]
  LOADK R13 K32 ["UIListLayout"]
  DUPTABLE R14 K35 [{"HorizontalAlignment", "VerticalAlignment"}]
  GETIMPORT R15 K38 [Enum.HorizontalAlignment.Center]
  SETTABLEKS R15 R14 K33 ["HorizontalAlignment"]
  GETIMPORT R15 K39 [Enum.VerticalAlignment.Center]
  SETTABLEKS R15 R14 K34 ["VerticalAlignment"]
  CALL R12 2 1
  ...
  GETTABLEKS R12 R13 K16 ["createElement"]
  GETUPVAL R13 3
  DUPTABLE R14 K22 [{"IconSize", "LeftIcon", "OnClick", "Style", "Size", "LayoutOrder"}]
  SETTABLEKS R6 R14 K17 ["IconSize"]
  SETTABLEKS R8 R14 K18 ["LeftIcon"]
  GETTABLEKS R15 R0 K23 ["onStatusClicked"]
  SETTABLEKS R15 R14 K19 ["OnClick"]
  LOADK R15 K24 ["IconOnly"]
...
MAIN:
  ...
  GETTABLEKS R23 R0 K22 ["Src"]
  GETTABLEKS R22 R23 K27 ["Types"]
  CALL R21 1 1
  GETIMPORT R22 K5 [require]
  GETTABLEKS R25 R0 K22 ["Src"]
  GETTABLEKS R24 R25 K33 ["Flags"]
  GETTABLEKS R23 R24 K34 ["getFFlagImportQueueGADesignFixes"]
  CALL R22 1 1
  GETIMPORT R23 K5 [require]
  GETTABLEKS R26 R0 K22 ["Src"]
  GETTABLEKS R25 R26 K33 ["Flags"]
  GETTABLEKS R24 R25 K35 ["getFFlagImportQueuePerSessionState"]
  CALL R23 1 1
  GETIMPORT R24 K37 [game]
  LOADK R26 K38 ["ImportQueuePerSessionStateBugfix"]
  LOADB R27 0
  NAMECALL R24 R24 K39 ["DefineFastFlag"]
  CALL R24 3 0
  GETTABLEKS R24 R1 K40 ["PureComponent"]
  LOADK R26 K41 ["AssetListCell"]
  NAMECALL R24 R24 K42 ["extend"]
  CALL R24 2 1
  DUPCLOSURE R25 K43 [PROTO_16]
  CAPTURE VAL R21
  CAPTURE VAL R1
  CAPTURE VAL R9
  CAPTURE VAL R14
  ...
  DUPCLOSURE R25 K45 [PROTO_17]
  CAPTURE VAL R23
  CAPTURE VAL R1
  CAPTURE VAL R7
  SETTABLEKS R25 R24 K46 ["renderCheckboxCell"]
  ...
  CAPTURE VAL R9
  CAPTURE VAL R14
  SETTABLEKS R25 R24 K48 ["renderAssetCell"]
  DUPCLOSURE R25 K49 [PROTO_19]
  CAPTURE VAL R23
  CAPTURE VAL R1
  CAPTURE VAL R16
  CAPTURE VAL R13
  CAPTURE VAL R21
  SETTABLEKS R25 R24 K50 ["renderPresetCell"]
  ...
  CAPTURE VAL R13
  CAPTURE VAL R21
  SETTABLEKS R25 R24 K52 ["renderCreatorCell"]
  DUPCLOSURE R25 K53 [PROTO_21]
  CAPTURE VAL R22
  CAPTURE VAL R1
  CAPTURE VAL R11
  CAPTURE VAL R10
  SETTABLEKS R25 R24 K54 ["renderPathCell"]
  DUPCLOSURE R25 K55 [PROTO_22]
  CAPTURE VAL R23
  CAPTURE VAL R21
  CAPTURE VAL R1
  CAPTURE VAL R8
  SETTABLEKS R25 R24 K56 ["renderStatusCell"]
  DUPCLOSURE R25 K57 [PROTO_23]
  CAPTURE VAL R22
  SETTABLEKS R25 R24 K58 ["getContent"]
  DUPCLOSURE R25 K59 [PROTO_24]
  CAPTURE VAL R22
  CAPTURE VAL R5
  CAPTURE VAL R1
  CAPTURE VAL R11
  SETTABLEKS R25 R24 K60 ["render"]
  GETTABLEKS R25 R3 K61 ["withContext"]
  DUPTABLE R26 K63 [{"Localization", "FileController", "PresetController", "QueueController", "Plugin"}]
  SETTABLEKS R4 R26 K10 ["Localization"]
  SETTABLEKS R18 R26 K30 ["FileController"]
  SETTABLEKS R19 R26 K31 ["PresetController"]
  SETTABLEKS R20 R26 K32 ["QueueController"]
  GETTABLEKS R27 R3 K62 ["Plugin"]
