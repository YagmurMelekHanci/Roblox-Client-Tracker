...
PROTO_6:
  ...
  CALL R3 2 -1
  CALL R2 -1 0
  GETTABLEKS R2 R0 K13 ["OnInteract"]
  CALL R2 0 0
  GETUPVAL R2 0
  NEWTABLE R4 0 0
...
PROTO_7:
  ...
  JUMPIFNOTEQKS R3 K3 ["ImportName"] [+20]
  ...
  GETUPVAL R5 0
  GETTABLEKS R4 R5 K0 ["props"]
  GETTABLEKS R3 R4 K10 ["UpdatePreviewInstance"]
  GETUPVAL R6 0
  GETTABLEKS R5 R6 K0 ["props"]
  GETTABLEKS R4 R5 K4 ["Instance"]
  NAMECALL R4 R4 K11 ["GetPreview"]
  CALL R4 1 -1
  CALL R3 -1 0
  GETTABLEKS R3 R1 K12 ["SetErrorNodeChecked"]
  GETUPVAL R4 3
  GETTABLEKS R5 R1 K13 ["ImportTree"]
  CALL R4 1 -1
  CALL R3 -1 0
  GETTABLEKS R3 R1 K14 ["OnInteract"]
  CALL R3 0 0
  RETURN R0 0
...
PROTO_8:
  ...
  CALL R5 2 -1
  CALL R4 -1 0
  GETTABLEKS R4 R1 K14 ["OnInteract"]
  CALL R4 0 0
  RETURN R0 0
...
PROTO_20:
  DUPTABLE R1 K3 [{"UpdatePreviewInstance", "SetErrorNodeChecked", "UpdateSessionInfo"}]
  NEWCLOSURE R2 P0
  CAPTURE VAL R0
  CAPTURE UPVAL U0
  ...
  CAPTURE VAL R0
  CAPTURE UPVAL U2
  SETTABLEKS R2 R1 K2 ["UpdateSessionInfo"]
  RETURN R1 1
...
MAIN:
  ...
  GETTABLEKS R24 R25 K33 ["DataTypes"]
