...
PROTO_12:
  DUPTABLE R1 K1 [{"UpdatePreviewInstance"}]
  NEWCLOSURE R2 P0
  CAPTURE VAL R0
  CAPTURE UPVAL U0
...
MAIN:
  ...
  CAPTURE VAL R15
  SETTABLEKS R19 R18 K36 ["handleCameraTransition"]
  DUPCLOSURE R19 K37 [PROTO_8]
  SETTABLEKS R19 R18 K38 ["willUpdate"]
  ...
  MOVE R19 R5
  DUPTABLE R20 K43 [{"Stylizer"}]
  SETTABLEKS R6 R20 K13 ["Stylizer"]
  CALL R19 1 1
  MOVE R20 R18
  CALL R19 1 1
  MOVE R18 R19
