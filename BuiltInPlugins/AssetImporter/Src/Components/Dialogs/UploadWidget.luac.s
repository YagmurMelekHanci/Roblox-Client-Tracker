...
PROTO_10:
  ...
  CALL R12 0 1
  JUMPIFNOT R12 [+17]
  GETTABLEKS R12 R0 K25 ["isErrorsExpanded"]
  GETTABLEKS R14 R1 K5 ["UploadWidgetItem"]
  GETTABLEKS R13 R14 K26 ["uploadErrorsExpanded"]
  CALL R12 1 1
  JUMPIFNOT R12 [+9]
  GETIMPORT R12 K29 [Vector2.new]
  GETTABLEKS R13 R5 K30 ["ExpandedWidth"]
  GETTABLEKS R14 R5 K31 ["ExpandedHeight"]
  CALL R12 2 1
  MOVE R11 R12
  JUMP [+8]
  GETIMPORT R12 K29 [Vector2.new]
  GETTABLEKS R13 R5 K32 ["Width"]
  GETTABLEKS R14 R5 K33 ["Height"]
  CALL R12 2 1
  MOVE R11 R12
  GETUPVAL R13 3
  GETTABLEKS R12 R13 K34 ["createElement"]
  GETUPVAL R13 4
  DUPTABLE R14 K44 [{"Enabled", "MinContentSize", "Modal", "Resizable", "Title", "Buttons", "ButtonHorizontalAlignment", "OnClose", "OnButtonPressed", "Style"}]
  GETUPVAL R16 0
  CALL R16 0 1
  JUMPIFNOT R16 [+3]
  GETTABLEKS R15 R1 K45 ["ShowUploadWidget"]
  JUMP [+2]
  GETTABLEKS R15 R1 K46 ["ShowProgress"]
  SETTABLEKS R15 R14 K35 ["Enabled"]
  SETTABLEKS R11 R14 K36 ["MinContentSize"]
  GETUPVAL R16 1
  CALL R16 0 1
  JUMPIFNOT R16 [+4]
  GETUPVAL R16 5
  ...
  JUMP [+1]
  LOADB R15 0
  SETTABLEKS R15 R14 K37 ["Modal"]
  LOADB R15 1
  SETTABLEKS R15 R14 K38 ["Resizable"]
  GETTABLEKS R15 R1 K39 ["Title"]
  SETTABLEKS R15 R14 K39 ["Title"]
  SETTABLEKS R10 R14 K40 ["Buttons"]
  GETUPVAL R16 1
  CALL R16 0 1
  JUMPIFNOT R16 [+3]
  GETIMPORT R15 K50 [Enum.HorizontalAlignment.Right]
  JUMP [+2]
  GETIMPORT R15 K52 [Enum.HorizontalAlignment.Center]
  SETTABLEKS R15 R14 K41 ["ButtonHorizontalAlignment"]
  GETTABLEKS R15 R0 K53 ["onClose"]
  SETTABLEKS R15 R14 K42 ["OnClose"]
  GETTABLEKS R15 R0 K54 ["onButtonPressed"]
  SETTABLEKS R15 R14 K43 ["OnButtonPressed"]
  GETUPVAL R16 1
  CALL R16 0 1
  JUMPIFNOT R16 [+2]
  LOADK R15 K55 ["ImportDialog"]
  JUMP [+1]
  LOADNIL R15
  SETTABLEKS R15 R14 K9 ["Style"]
  DUPTABLE R15 K59 [{"Layout", "ContentInfo", "Separator"}]
  GETUPVAL R17 1
  CALL R17 0 1
  JUMPIFNOT R17 [+11]
  GETUPVAL R17 3
  ...
  DUPTABLE R18 K62 [{"FillDirection"}]
  GETIMPORT R19 K64 [Enum.FillDirection.Vertical]
  SETTABLEKS R19 R18 K61 ["FillDirection"]
  CALL R16 2 1
  JUMP [+1]
  LOADNIL R16
  SETTABLEKS R16 R15 K56 ["Layout"]
  GETTABLEKS R16 R0 K65 ["getWidgetContent"]
  MOVE R17 R6
  CALL R16 1 1
  SETTABLEKS R16 R15 K57 ["ContentInfo"]
  GETUPVAL R17 1
  CALL R17 0 1
  JUMPIFNOT R17 [+17]
  GETTABLEKS R17 R1 K23 ["Uploading"]
  JUMPIF R17 [+14]
  GETUPVAL R17 3
  GETTABLEKS R16 R17 K34 ["createElement"]
  GETUPVAL R17 6
  DUPTABLE R18 K68 [{"DominantAxis", "LayoutOrder"}]
  GETIMPORT R19 K69 [Enum.DominantAxis.Width]
  SETTABLEKS R19 R18 K66 ["DominantAxis"]
  LOADN R19 2
  SETTABLEKS R19 R18 K67 ["LayoutOrder"]
  CALL R16 2 1
  JUMP [+1]
  LOADNIL R16
  SETTABLEKS R16 R15 K58 ["Separator"]
  CALL R12 3 -1
  RETURN R12 -1
...
MAIN:
  ...
  GETTABLEKS R22 R23 K38 ["getFFlagAssetImportQueuedSessionRefactor"]
  CALL R21 1 1
  ...
  GETTABLEKS R25 R26 K41 ["getFFlagDebugAssetImportPlugin"]
  CALL R24 1 1
  GETIMPORT R25 K9 [require]
  GETTABLEKS R28 R0 K22 ["Src"]
  GETTABLEKS R27 R28 K37 ["Flags"]
  GETTABLEKS R26 R27 K42 ["getFFlagAssetImportErrorMessageDialog"]
  CALL R25 1 1
