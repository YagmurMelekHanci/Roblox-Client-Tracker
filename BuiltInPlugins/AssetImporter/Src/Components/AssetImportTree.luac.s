...
PROTO_11:
  ...
  GETUPVAL R7 6
  DUPTABLE R8 K13 [{"Size", "LayoutOrder", "Layout"}]
  ...
  DUPTABLE R9 K21 [{"StatusCount"}]
  SETTABLEKS R4 R9 K20 ["StatusCount"]
  CALL R6 3 -1
  RETURN R6 -1
...
MAIN:
  ...
  GETTABLEKS R16 R8 K22 ["IconButton"]
  GETTABLEKS R17 R1 K23 ["Util"]
  GETTABLEKS R18 R17 K24 ["LayoutOrderIterator"]
  GETIMPORT R19 K5 [require]
  GETTABLEKS R22 R0 K25 ["Src"]
  GETTABLEKS R21 R22 K26 ["Components"]
  GETTABLEKS R20 R21 K27 ["TreeViewToolbar"]
  CALL R19 1 1
  GETIMPORT R20 K5 [require]
  GETTABLEKS R23 R0 K25 ["Src"]
  GETTABLEKS R22 R23 K28 ["Actions"]
  GETTABLEKS R21 R22 K29 ["SetSelectedImportItem"]
  CALL R20 1 1
  GETIMPORT R21 K5 [require]
  GETTABLEKS R24 R0 K25 ["Src"]
  GETTABLEKS R23 R24 K28 ["Actions"]
  GETTABLEKS R22 R23 K30 ["SetTreeExpansion"]
  CALL R21 1 1
  GETIMPORT R22 K5 [require]
  GETTABLEKS R25 R0 K25 ["Src"]
  GETTABLEKS R24 R25 K31 ["Thunks"]
  GETTABLEKS R23 R24 K32 ["UpdateChecked"]
  CALL R22 1 1
  GETIMPORT R23 K5 [require]
  GETTABLEKS R26 R0 K25 ["Src"]
  GETTABLEKS R25 R26 K31 ["Thunks"]
  GETTABLEKS R24 R25 K33 ["UpdatePreviewInstance"]
  CALL R23 1 1
  GETIMPORT R24 K5 [require]
  GETTABLEKS R27 R0 K25 ["Src"]
  GETTABLEKS R26 R27 K34 ["Resources"]
  GETTABLEKS R25 R26 K35 ["StatusLevel"]
  CALL R24 1 1
  GETIMPORT R25 K5 [require]
  GETTABLEKS R29 R0 K25 ["Src"]
  GETTABLEKS R28 R29 K36 ["Utility"]
  GETTABLEKS R27 R28 K37 ["Status"]
  GETTABLEKS R26 R27 K38 ["countStatusLevelsForTree"]
  CALL R25 1 1
  GETIMPORT R26 K5 [require]
  GETTABLEKS R30 R0 K25 ["Src"]
  GETTABLEKS R29 R30 K36 ["Utility"]
  GETTABLEKS R28 R29 K37 ["Status"]
  GETTABLEKS R27 R28 K39 ["getFirstDescendantWithStatus"]
  CALL R26 1 1
  GETIMPORT R27 K5 [require]
  GETTABLEKS R30 R0 K25 ["Src"]
  GETTABLEKS R29 R30 K36 ["Utility"]
  GETTABLEKS R28 R29 K40 ["trimFilename"]
  CALL R27 1 1
  GETIMPORT R28 K5 [require]
  GETTABLEKS R31 R0 K25 ["Src"]
  GETTABLEKS R30 R31 K41 ["Controllers"]
  GETTABLEKS R29 R30 K42 ["PresetController"]
  CALL R28 1 1
  GETIMPORT R29 K5 [require]
  GETTABLEKS R32 R0 K25 ["Src"]
  GETTABLEKS R31 R32 K36 ["Utility"]
  GETTABLEKS R30 R31 K43 ["DebugFlags"]
  CALL R29 1 1
  GETIMPORT R30 K5 [require]
  GETTABLEKS R33 R0 K25 ["Src"]
  GETTABLEKS R32 R33 K36 ["Utility"]
  GETTABLEKS R31 R32 K44 ["createCalloutComponents"]
  CALL R30 1 1
  GETIMPORT R31 K46 [game]
  LOADK R33 K47 ["UseImportNameForRoot"]
  LOADB R34 0
  NAMECALL R31 R31 K48 ["DefineFastFlag"]
  CALL R31 3 1
  GETIMPORT R32 K5 [require]
  GETTABLEKS R35 R0 K25 ["Src"]
  GETTABLEKS R34 R35 K49 ["Flags"]
  GETTABLEKS R33 R34 K50 ["getFFlagAssetImportWarningIconJump"]
  CALL R32 1 1
  GETTABLEKS R33 R2 K51 ["PureComponent"]
  LOADK R35 K52 ["AssetImportTree"]
  NAMECALL R33 R33 K53 ["extend"]
  CALL R33 2 1
  DUPCLOSURE R34 K54 [PROTO_1]
  DUPCLOSURE R35 K55 [PROTO_2]
  CAPTURE VAL R24
  CAPTURE VAL R2
  CAPTURE VAL R11
  CAPTURE VAL R14
  ...
  CAPTURE VAL R12
  CAPTURE VAL R15
  SETTABLEKS R38 R33 K59 ["init"]
  DUPCLOSURE R38 K60 [PROTO_16]
  CAPTURE VAL R24
  CAPTURE VAL R2
  CAPTURE VAL R16
  CAPTURE VAL R26
  SETTABLEKS R38 R33 K61 ["getStatusIcon"]
  DUPCLOSURE R38 K62 [PROTO_18]
  CAPTURE VAL R18
  CAPTURE VAL R25
  CAPTURE VAL R30
  CAPTURE VAL R37
  ...
  CAPTURE VAL R10
  CAPTURE VAL R36
  SETTABLEKS R38 R33 K63 ["render"]
  MOVE R38 R5
  DUPTABLE R39 K65 [{"Localization", "Stylizer", "Plugin", "PresetController"}]
  SETTABLEKS R6 R39 K12 ["Localization"]
  SETTABLEKS R7 R39 K13 ["Stylizer"]
  GETTABLEKS R40 R4 K64 ["Plugin"]
  SETTABLEKS R40 R39 K64 ["Plugin"]
  SETTABLEKS R28 R39 K42 ["PresetController"]
  CALL R38 1 1
  MOVE R39 R33
  CALL R38 1 1
  MOVE R33 R38
  DUPCLOSURE R38 K66 [PROTO_19]
  DUPCLOSURE R39 K67 [PROTO_24]
  CAPTURE VAL R20
  CAPTURE VAL R21
  CAPTURE VAL R22
  CAPTURE VAL R23
  GETTABLEKS R40 R3 K68 ["connect"]
  MOVE R41 R38
  MOVE R42 R39
  CALL R40 2 1
  MOVE R41 R33
