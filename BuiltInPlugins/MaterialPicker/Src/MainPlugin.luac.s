...
PROTO_1:
  ...
  CALL R5 0 1
  JUMPIFNOT R5 [+2]
  LOADK R4 K15 ["Tabs/BuiltIn_HomeTab/Material"]
  JUMP [+1]
  LOADK R4 K16 ["Tabs/Home/Material"]
  ...
  CALL R6 0 1
  JUMPIFNOT R6 [+2]
  LOADK R5 K17 ["Tabs/BuiltIn_ModelTab/Material"]
  JUMP [+1]
  LOADK R5 K18 ["Tabs/Model/Material"]
  SETTABLEKS R5 R4 K3 ["ItemId"]
  LOADNIL R5
  MOVE R8 R3
  NAMECALL R6 R2 K19 ["GetWidgetAsync"]
  CALL R6 2 1
  MOVE R9 R4
  NAMECALL R7 R2 K19 ["GetWidgetAsync"]
  CALL R7 2 1
  GETTABLEKS R8 R6 K20 ["Exists"]
  JUMPIFNOT R8 [+5]
  GETTABLEKS R8 R6 K21 ["Visible"]
  JUMPIFNOT R8 [+2]
  MOVE R5 R3
  JUMP [+7]
  GETTABLEKS R8 R7 K20 ["Exists"]
  JUMPIFNOT R8 [+4]
  GETTABLEKS R8 R7 K21 ["Visible"]
  JUMPIFNOT R8 [+1]
  MOVE R5 R4
  MOVE R10 R0
  DUPTABLE R11 K26 [{"TargetWidgetUri", "TargetAnchorPoint", "SubjectAnchorPoint", "Offset"}]
  SETTABLEKS R5 R11 K22 ["TargetWidgetUri"]
  GETIMPORT R12 K29 [Vector2.new]
  LOADN R13 0
  LOADN R14 1
  CALL R12 2 1
  SETTABLEKS R12 R11 K23 ["TargetAnchorPoint"]
  GETIMPORT R12 K29 [Vector2.new]
  LOADN R13 0
  LOADN R14 0
  CALL R12 2 1
  ...
  NAMECALL R8 R1 K30 ["SetAttachmentAsync"]
  CALL R8 3 0
  RETURN R0 0
...
MAIN:
  ...
  GETTABLEKS R28 R29 K42 ["getFFlagRibbonConfigUniqueControlsIdentifiers"]
  CALL R27 1 1
  GETTABLEKS R29 R0 K6 ["Src"]
  GETTABLEKS R28 R29 K43 ["Components"]
  GETIMPORT R29 K5 [require]
  GETTABLEKS R30 R28 K44 ["MainView"]
  CALL R29 1 1
  GETTABLEKS R30 R6 K45 ["PureComponent"]
  LOADK R32 K46 ["MainPlugin"]
  NAMECALL R30 R30 K47 ["extend"]
  CALL R30 2 1
  GETIMPORT R31 K50 [string.format]
  LOADK R32 K51 ["rbxasset://textures/MaterialFramework/%s/Material.png"]
  LOADK R33 K52 ["Light"]
  CALL R31 2 1
  GETIMPORT R32 K50 [string.format]
  LOADK R33 K51 ["rbxasset://textures/MaterialFramework/%s/Material.png"]
  LOADK R34 K53 ["Dark"]
  CALL R32 2 1
  DUPCLOSURE R33 K54 [PROTO_0]
  CAPTURE VAL R31
  CAPTURE VAL R32
  DUPCLOSURE R34 K55 [PROTO_21]
  CAPTURE VAL R6
  CAPTURE VAL R16
  CAPTURE VAL R24
  CAPTURE VAL R25
  ...
  CAPTURE VAL R21
  CAPTURE VAL R0
  SETTABLEKS R34 R30 K56 ["init"]
  DUPCLOSURE R34 K57 [PROTO_22]
  CAPTURE VAL R24
  CAPTURE VAL R25
  SETTABLEKS R34 R30 K58 ["willUnmount"]
  DUPCLOSURE R34 K59 [PROTO_24]
  CAPTURE VAL R6
  CAPTURE VAL R9
  CAPTURE VAL R25
  CAPTURE VAL R24
  ...
  CAPTURE VAL R1
  CAPTURE VAL R2
  SETTABLEKS R34 R30 K60 ["renderButtons"]
  DUPCLOSURE R34 K61 [PROTO_26]
  CAPTURE VAL R26
  CAPTURE VAL R6
  CAPTURE VAL R11
  CAPTURE VAL R29
  CAPTURE VAL R24
  SETTABLEKS R34 R30 K62 ["renderPopup"]
  DUPCLOSURE R34 K63 [PROTO_28]
  CAPTURE VAL R12
  CAPTURE VAL R14
  CAPTURE VAL R13
  CAPTURE VAL R6
