...
MAIN:
  ...
  LOADK R31 K47 ["RibbonControlsRefactor"]
  NAMECALL R29 R29 K46 ["GetFastFlag"]
  CALL R29 2 1
  GETTABLEKS R31 R0 K6 ["Src"]
  GETTABLEKS R30 R31 K48 ["Components"]
  GETIMPORT R31 K5 [require]
  GETTABLEKS R32 R30 K49 ["MainView"]
  CALL R31 1 1
  GETTABLEKS R32 R6 K50 ["PureComponent"]
  ...
  LOADK R35 K57 ["Light"]
  CALL R33 2 1
  GETIMPORT R34 K55 [string.format]
  LOADK R35 K56 ["rbxasset://textures/MaterialFramework/%s/Material.png"]
  LOADK R36 K58 ["Dark"]
  CALL R34 2 1
  DUPCLOSURE R35 K59 [PROTO_0]
  CAPTURE VAL R33
  CAPTURE VAL R34
  DUPCLOSURE R36 K60 [PROTO_21]
  CAPTURE VAL R6
  CAPTURE VAL R16
  CAPTURE VAL R24
  CAPTURE VAL R25
  ...
  CAPTURE VAL R21
  CAPTURE VAL R0
  SETTABLEKS R36 R32 K61 ["init"]
  DUPCLOSURE R36 K62 [PROTO_22]
  CAPTURE VAL R24
  CAPTURE VAL R25
  SETTABLEKS R36 R32 K63 ["willUnmount"]
  DUPCLOSURE R36 K64 [PROTO_24]
  CAPTURE VAL R6
  CAPTURE VAL R9
  CAPTURE VAL R25
  CAPTURE VAL R28
  ...
  CAPTURE VAL R1
  CAPTURE VAL R2
  SETTABLEKS R36 R32 K65 ["renderButtons"]
  DUPCLOSURE R36 K66 [PROTO_26]
  CAPTURE VAL R26
  CAPTURE VAL R6
  CAPTURE VAL R11
  CAPTURE VAL R31
  CAPTURE VAL R24
  SETTABLEKS R36 R32 K67 ["renderPopup"]
  DUPCLOSURE R36 K68 [PROTO_28]
  CAPTURE VAL R12
  CAPTURE VAL R14
  CAPTURE VAL R13
  CAPTURE VAL R6
